...
De Lsv2-serie functies hoge doorvoer en lage latentie en rechtstreeks toegewezen lokale NVMe-opslag die wordt uitgevoerd op de [AMD EPYC<sup>TM</sup> 7551 processor](https://www.amd.com/en/products/epyc-7000-series) met een alle core versterking van 2.55 GHz en een maximale versterking van 3.0 GHz. De Lsv2-serie VM's zijn verkrijgbaar in grootten van 8 op 80 vCPU in de configuratie van een gelijktijdige multithreading.  Er is 8 GiB geheugen per vCPU en één 1,92 TB NVMe SSD M.2 apparaat per 8 Vcpu, met maximaal 19,2 TB (10x1.92TB) beschikbaar is op de L80s v2.
...
Preminu opslag in cache opslaan: Niet ondersteund
...
|---------------|-----------|-------------|--------------------------|----------------|---------------------------------------------------|-------------------------------------------|------------------------------|------------------------------| 
| Standard_L8s_v2   |  8 |  64 |  80 |  1x1.92 TB  | 340,000 / 2000 | N/A | 16 | 2 / 3200  | 
| Standard_L16s_v2  | 16 | 128 | 160 |  2x1.92 TB  | 680,000 / 4.500 | N/A | 32 | 4 / 6400  | 
