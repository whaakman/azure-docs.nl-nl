...
### <a name="create-an-administrator-credential-in-the-azure-ad-b2c-tenant"></a>Create an administrator credential in the Azure AD B2C tenant.
...
### <a name="set-up-the-key-container"></a>Set up the key container
