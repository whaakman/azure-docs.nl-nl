...
| Poolgrootte (eDTU's)  |  **1200** | **1600** | **2000** | **2500** | 
|:---|---:|---:|---:| ---: | ---: | ---: | ---: |---: |---: |---: |
| Maximale opslag per pool* | 1,2 TB | 1,6 TB | 2 TB | 2,4 TB | 
| Maximumaantal databases per pool | 500 | 500 | 500 | 500 | 500 | 
| Maximaal aantal gelijktijdige werknemers per groep |  2400 | 3200 | 4000 | 5000 |
| Maximaal aantal gelijktijdige aanmeldingen per groep |  2400 | 3200 | 4000 | 5000 | 
...
| Maximaal aantal gelijktijdige sessies per groep | 30.000 | 30.000 | 30.000 | 30.000 | 30.000 | 
| Minimaal aantal eDTU’s per database | {0,25,50,75,<br>125} | {0,25,50,75,<br>125,250} | {0,25,50,75,<br>125,250,500} | {0,25,50,75,<br>125,250,500,<br>1000} | {0,25,50,75,<br>125,250,500,<br>1000} | 
| Maximaal aantal eDTU’s per database | {25,50,75,<br>125} | {25,50,75,<br>125,250} | {25,50,75,<br>125,250,500} | {25,50,75,<br>125,250,500,<br>1000} | {25,50,75,<br>125,250,500,<br>1000} |  
||||||||

### <a name="premium-elastic-pool-limits-continued"></a>Limieten voor Premium elastische pools (vervolg)

| Poolgrootte (eDTU's)  |  **2000** | **2500** | **3000** | **3500** | 
|:---|---:|---:|---:| ---: | ---: | ---: | ---: |---: |---: |---: |
| Maximale opslag per pool* | 750 GB| 750 GB| 750 GB| 750 GB| 
| Maximumaantal databases per pool | 100 | 100 | 100 | 100 | 100 | 
| Maximaal aantal gelijktijdige werknemers per groep |  3200 | 4000 | 4800 | 5600 | 
| Maximaal aantal gelijktijdige aanmeldingen per groep |  3200 | 4000 | 4800 | 5600 | 
| Maximaal aantal gelijktijdige sessies per groep | 30.000 | 30.000 | 30.000 | 30.000 | 30.000 | 
| Minimaal aantal eDTU’s per database | {0,25,50,75,<br>125,250,500,<br>1000,1750} | {0,25,50,75,<br>125,250,500,<br>1000,1750} | {0,25,50,75,<br>125,250,500,<br>1000,1750} | {0,25,50,75,<br>125,250,500,<br>1000,1750} | 
| Maximaal aantal eDTU’s per database | {25,50,75,<br>125,250,500,<br>1000,1750} | {25,50,75,<br>125,250,500,<br>1000,1750} | {25,50,75,<br>125,250,500,<br>1000,1750} | {25,50,75,<br>125,250,500,<br>1000,1750} | 
||||||||
