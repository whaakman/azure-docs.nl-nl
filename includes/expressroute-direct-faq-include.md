...
### <a name="what-locations-will-the-100gbps-expressroute-direct-be-available-for-public-preview"></a>Welk netwerklocaties 100Gbps ExpressRoute rechtstreekse is beschikbaar voor openbare Preview? 
...
ExpressRoute Direct biedt klanten direct 100Gbps poortparen in de algemene Microsoft-backbone. De scenario's die de grootste voordelen van van klanten voorzien zijn: grote gegevensopname, fysieke isolatie voor gereguleerde markten, en toegewezen capaciteit voor burst-scenario, zoals rendering. 
