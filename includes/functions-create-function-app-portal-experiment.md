...
2. Gebruik voor de functie-app de instellingen die in de tabel onder de afbeelding zijn opgegeven.
    ...
    | **OS** | Windows | Hosten zonder server is momenteel alleen beschikbaar wanneer u gebruikmaakt van Windows. Bekijk [Uw eerste Linux-functie maken vanuit Azure CLI](../articles/azure-functions/functions-create-first-azure-function-azure-cli-linux.md) voor meer informatie over hosten met Linux. |
