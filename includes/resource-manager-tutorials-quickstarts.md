...
- Snelstartgidsen
    ...
    |[Gebruik Visual Studio Code](../articles/azure-resource-manager/resource-manager-quickstart-create-templates-use-visual-studio-code.md)|Leer hoe u met Visual Studio Code sjablonen kunt maken en bewerken en hoe u de Azure Cloud-shell kunt gebruiken om sjablonen te implementeren.|
...
- Zelfstudies
    ...
    |[Gebruiksvoorwaarden](../articles/azure-resource-manager/resource-manager-tutorial-use-conditions.md)|Resources implementeren op basis van bepaalde parameterwaarden. In de zelfstudie definieert u een sjabloon voor het maken van een nieuw opslagaccount of maakt u gebruik van een bestaand opslagaccount op basis van de waarde van een parameter.|
    ...
    |[Zelfstudie: Problemen met implementaties van Resource Manager-sjablonen oplossen](../articles/azure-resource-manager/resource-manager-tutorial-troubleshoot.md)|Probleemoplossing voor implementatieproblemen sjabloon.|
