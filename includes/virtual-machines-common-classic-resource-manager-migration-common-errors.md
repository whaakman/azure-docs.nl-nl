# <a name="common-errors-during-classic-to-azure-resource-manager-migration"></a>Common errors during Classic to Azure Resource Manager migration
...
## <a name="list-of-errors"></a>List of errors
...
#### <a name="verifying-the-issue"></a>Verifying the issue
...
#### <a name="mitigating-the-issue"></a>Mitigating the issue
...
### <a name="moving-a-vm-to-a-different-subscription-after-completing-migration"></a>Moving a VM to a different subscription after completing migration
