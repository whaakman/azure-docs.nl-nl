...
| Het virtuele netwerk {naam-virtueel-netwerk} bestaat niet. |Dit kan gebeuren als u het virtuele netwerk hebt gemaakt in de nieuwe Azure portal. De werkelijke naam van Virtueelnetwerk heeft het patroon ' groep * \<VNET-naam > " |
