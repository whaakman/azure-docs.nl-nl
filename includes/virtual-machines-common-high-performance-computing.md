...
## <a name="solution-architectures"></a>Solution architectures
...
## <a name="hpc-cluster-and-grid-solutions"></a>HPC cluster and grid solutions
...
### <a name="grid-managers"></a>Grid managers
...
## <a name="solution-partners"></a>Solution partners
...
* Learn more about Big Compute solutions for [engineering simulation](https://simulation.azure.com/), [rendering](https://simulation.azure.com/), and [banking and capital markets](https://finance.azure.com/).
