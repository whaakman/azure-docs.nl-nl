...
3. Geef op de blade **Nieuw account** de gewenste configuratie op voor het Azure Cosmos DB-account. 
    ...
    Vul de velden op de blade **Nieuw account** in en gebruik de gegevens in de volgende schermopname hierbij als richtlijn. Wanneer u uw account hebt ingesteld, kiest u unieke waarden die niet overeenkomen met die in de schermafbeelding. 
 
    ![De nieuwe blade Azure Cosmos DB](./media/cosmos-db-create-dbaccount/create-nosql-db-databases-json-tutorial-2.png)

    Instelling|Voorgestelde waarde|Beschrijving
    ---|---|---
    Id|*Unieke waarde*|Een unieke naam die uw Azure Cosmos DB-account aanduidt. De tekenreeks *documents.azure.com* is toegevoegd aan de id die u hebt opgegeven om uw URI te maken. Gebruik daarom een unieke maar identificeerbare id. De id mag alleen kleine letters, cijfers en het koppelteken (-) bevatten en moet 3 tot 50 tekens lang zijn.
