...
1. Selecteer de virtuele machine in de portal. De *DNS-naam* is momenteel leeg. Selecteer **openbaar IP-adres**:
...
2. Geef de gewenste DNS-naam en selecteer vervolgens **opslaan**.
   ...
   ![Voer in een DNS-naamlabel voor uw openbare IP-resource](./media/virtual-machines-common-portal-create-fqdn/dnsNameLabel.PNG)
