...
Als u niet wilt gebruiken van Azure Cloud Shell, Azure PowerShell lokaal installeren in plaats daarvan. Zorg ervoor dat de nieuwste versie van de Az van Azure PowerShell-module om op te halen van recente functionaliteit installeren. Zie voor meer informatie, [Azure PowerShell installeren](/powershell/azure/overview).
