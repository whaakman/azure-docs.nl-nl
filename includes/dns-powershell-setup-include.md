...
Open de PowerShell-console en maak verbinding met uw account. Zie voor meer informatie, [Meld u aan met AzureRM](/powershell/azure/azurerm/authenticate-azureps).
