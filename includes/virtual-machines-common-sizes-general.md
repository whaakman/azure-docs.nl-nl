...
Grootten uit de Dsv3-serie zijn gebaseerd op Intel XEON ® E5-2673 v4-processors van 2,3 GHz (Broadwell) en kunnen maar liefst 3,5 GHz bereiken door de Intel Turbo Boost Technology 2.0 en maken gebruik van Premium Storage. De Dsv3-serie biedt een combinatie van CPU, geheugen en lokale schijfcapaciteit voor de meeste productiewerkbelastingen.


| Grootte             | vCPU | Geheugen: GiB | Lokale SSD: GiB | Max. aantal gegevensschijven | Maximale doorvoer voor schijven met caching en lokale schijven: IOPS/MBps (cachegrootte in GiB) | Max. doorvoer voor schijf zonder caching: IOPS/MBps | Maximum aantal NIC's/verwachte netwerkprestaties (Mbps) |
|------------------|-----------|-------------|----------------|----------------|-----------------------------------------------------------------------|-------------------------------------------|------------------------------------------------|
...
Grootten uit de Dv3-serie zijn gebaseerd op Intel XEON ® E5-2673 v4-processors van 2,3 GHz (Broadwell) en kunnen maar liefst 3,5 GHz bereiken door de Intel Turbo Boost Technology 2.0. De Dv3-serie biedt een combinatie van CPU, geheugen en lokale schijfcapaciteit voor de meeste productiewerkbelastingen.
...
| Grootte             | vCPU | Geheugen: GiB | Lokale SSD: GiB | Max. aantal gegevensschijven | Maximale doorvoer voor schijven met caching en lokale schijven: IOPS/MBps (cachegrootte in GiB) | Max. doorvoer voor schijf zonder caching: IOPS/MBps | Maximum aantal NIC's/verwachte netwerkprestaties (Mbps) |
|------------------|-----------|-------------|----------------|----------------|-----------------------------------------------------------------------|-------------------------------------------|------------------------------------------------|
| Standard_D2_v3  | 2         | 8           | 16             | 4              | 4,000 / 32 (50)                                                       | 3200 / 48                                | 2/gemiddeld                                   |
| Standard_D4_v3  | 4         | 16          | 32             | 8              | 8,000 / 64 (100)                                                      | 6400 / 96                                | 2/gemiddeld                                   |
| Standard_D8_v3  | 8         | 32          | 64             | 16             | 16,000 / 128 (200)                                                    | 12.800 / 192                              | 4/hoog                                       |
| Standard_D16_v3 | 16        | 64          | 128            | 32             | 32,000 / 256 (400)                                                    | 25.600 / 384                              | 8/hoog                                       |
...
| Grootte | CPU-kernen | Geheugen: GiB | Lokale SSD: GiB | Max. aantal gegevensschijven | Maximale doorvoer voor schijven met caching en lokale schijven: IOPS/MBps (cachegrootte in GiB) | Max. doorvoer voor schijf zonder caching: IOPS/MBps | Maximum aantal NIC's/verwachte netwerkprestaties (Mbps) |
| --- | --- | --- | --- | --- | --- | --- | --- |
...
| Grootte              | CPU-kernen | Geheugen: GiB | Lokale SSD: GiB | Maximale lokale schijfdoorvoer: IOPS / MBps lezen / MBps schrijven | Maximumaantal gegevensschijven / doorvoer: IOPS | Maximum aantal NIC's/verwachte netwerkprestaties (Mbps) |
|-------------------|-----------|-------------|----------------|----------------------------------------------------------|-----------------------------------|------------------------------|
...
| Grootte | CPU-kernen | Geheugen: GiB | Lokale HDD: GiB | Max. aantal gegevensschijven | Max. doorvoer gegevensschijf: IOPS | Maximum aantal NIC's/verwachte netwerkprestaties (Mbps)  |
| --- | --- | --- | --- | --- | --- | --- |
...
|Grootte - grootte\naam |CPU-kernen|Geheugen|NIC's (max.)|Maximumgrootte van tijdelijke schijf |Met maximaal gegevensschijven 1023 GB elk)|Met maximaal IOPS (300 per schijf)|
|---|---|---|---|---|---|---|
