...
ms.locfileid: "38732747"
---
## <a name="copy-your-credentials-from-the-azure-portal"></a>Kopieer uw referenties van de Azure Portal

De voorbeeldtoepassing moet de toegang tot uw opslagaccount verifiëren. Om te verifiëren geeft u de toepassing de referenties van uw opslagaccount in de vorm van een verbindingsreeks. Om uw opslagaccountreferenties te zien, doet u het volgende:
...
4. Noteer de naam van uw opslagaccount. Deze moet u opgeven om te verifiëren.   
5. Zoek de waarde van de **Sleutel** onder **key1** en klik op de knop **Kopiëren** om de accountsleutel te kopiëren.

    ![Schermopname waarin een accountsleutel vanuit de Azure Portal wordt gekopieerd](media/storage-copy-account-key-portal/portal-account-key.png)
