...
#### <a name="option-2-restrict-access-to-your-application-to-users-in-a-specific-list-of-organizations"></a>Optie 2: Toegang tot uw toepassing voor gebruikers in een specifieke lijst van organisaties beperken
