...
1. Het Hive-querybestand (HQL) uploaden naar de **scriptmap** van de container **adfgetstarted**.
2. Het invoerbestand uploaden naar de map **inputdata** van de container **adfgetstarted**. 
...
1. De Azure-opslag voorbereiden voor de zelfstudie:
   ...
   3. Navigeer naar de map c:\adfgetstarted en voer de volgende opdracht uit. Met deze opdracht wordt het bestand **input.log** geüpload naar het opslagaccount (de container **adfgetstarted** en de map **inputdata**). Vervang **StorageAccountName** met de naam van uw opslagaccount en **Storage Key** met de opslagaccountsleutel.
      ...
      > [!NOTE]
      > Met deze opdracht wordt in de Azure Blob-opslag een container gemaakt met de naam **adfgetstarted** en wordt het bestand **input.log** van uw lokale schijf gekopieerd naar de map **inputdata** in de container. 
      > 
      > 
   4. Nadat het bestand is geüpload, ziet u uitvoer die lijkt op de volgende uitvoer uit AzCopy.
   ...
   5. Voer de volgende opdracht uit om het bestand **partitionweblogs.hql** te uploaden naar de **scriptmap** van de container **adfgetstarted**. Dit is de opdracht: 
