...
| [Azure PowerShell](../articles/virtual-machines/windows/multiple-nics.md) | Gebruik [nieuw AzureRmNetworkInterface](/powershell/module/azurerm.network/new-azurermnetworkinterface) met de **- PublicIpAddressId** -parameter voor de id van het openbare IP-adres dat u eerder hebt gemaakt. |
| [Azure-CLI](../articles/virtual-machines/linux/multiple-nics.md) | Als u de id van het openbare IP-adres dat u eerder hebt gemaakt, gebruik [az netwerk nic maken](https://docs.microsoft.com/cli/azure/network/nic#create) met de **--openbare-ip-adres** parameter. |
