> [!NOTE]
> De algemene Azure Storage-bibliotheek voor .NET (Preview) is vereist om deze zelfstudie te voltooien. U kunt de nieuwste versie downloaden op [NuGet](https://www.nuget.org/packages/Microsoft.Azure.Storage.Common/).
> 
