...
3. Voer het nummer van het Knowledge Base (KB) van de hotfix die u downloaden wilt, bijvoorbeeld in het zoekvak van de Microsoft Update Catalog **3179904**, en klik vervolgens op **Search**.
   
    De hotfix-wordt weergegeven, bijvoorbeeld **cumulatieve Software bundel Update 2.2 voor StorSimple 8000-serie**.
...
5. Zoeken naar aanvullende hotfixes die worden vermeld in de bovenstaande tabel (**3103616**, **3146621**), en elk aan de mandje toe te voegen.
...
4. Typ **J** wanneer u wordt gevraagd de hotfixinstallatie te bevestigen.
   ...
   > [!IMPORTANT]
   > Als 2.2 Update installeert, moet u alleen het binaire bestand voorafgegaan door 'all-hcsmdssoftwareudpate' installeren. Installeer de configuratie-items en de MDS-agent-update die vooraf worden gegaan door alle cismdsagentupdatebundle niet. Om dit te doen, treedt een fout. 
...
1. Wanneer de software-update is voltooid, controleert u de versies van de systeemsoftware. Type:
   ...
   * `MdsAgentVersion: 30.0.4698.16` 
     ...
     > 
     > 
2. Herhaal stap 3-5 voor de installatie van de resterende hotfixes van de normale modus.
   
   * De iSCSI-update KB3146621
   * De WMI-update KB3103616
3. Deze stap overslaan als u Update 2 bijwerkt. Als u een eerdere versie dan Update 2 bijwerkt, moet u ook downloaden:
