...
1. Selecteer in de linkerbovenhoek van de portal **een resource maken**.
   ...
   ![Een resource maken in Azure Portal](./media/aml-create-in-portal/portal-create-a-resource-05-2019.png)

1. Voer in de zoekbalk typt, **Machine Learning**. Selecteer de **werkruimte van Machine Learning-service** zoekresultaat.

   ![Zoeken naar een werkruimte](./media/aml-create-in-portal/allservices-search-05-2019.png)

1. In de **ML-werkruimte in service** venster **maken** om te beginnen.

    ![Knop maken](./media/aml-create-in-portal/portal-create-button-05-2019.png)
...
1. In de **ML-werkruimte in service** in het deelvenster voor het configureren van uw werkruimte.
   ...
   Resourcegroep | Een bestaande resourcegroep gebruiken in uw abonnement, of voer een naam in om een nieuwe resourcegroep te maken. Een resourcegroep bevat verwante resources voor een Azure-oplossing. In dit voorbeeld gebruiken we **docs-aml**. 
   ...
   ![Werkruimte maken](./media/aml-create-in-portal/workspace-create-main-tab-05-2019.png)

1. Selecteer eerst het maakproces **revisie + maken**.

    ![Maken](./media/aml-create-in-portal/workspace-create-main-review-button-05-2019.png)
...
1. Controleer de Werkruimteconfiguratie van uw. Als deze juist is, selecteert u **maken**. Het kan even duren om de werkruimte te maken.
    ...
    ![Maken](./media/aml-create-in-portal/workspace-create-review-tab-05-2019.png)
...
1. Wanneer het proces is voltooid, wordt er een bericht voor de implementatie weergegeven. Het is ook aanwezig in de sectie meldingen. Als u de nieuwe werkruimte, selecteert u **naar de resource gaan**.
   ...
   ![Status van het maken van werkruimte](./media/aml-create-in-portal/notifications-05-2019.png)
