...
## <a name="traffic-manager-load-balancing-for-cloud-services-and-websites"></a>Traffic Manager load balancing for cloud services and websites
...
## <a name="azure-load-balancing-for-virtual-machines"></a>Azure load balancing for virtual machines
...
## <a name="load-balancer-considerations"></a>Load balancer considerations
