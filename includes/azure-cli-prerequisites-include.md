...
Als u wilt de stappen in dit artikel uitvoert, moet u [installeren van de Azure-opdrachtregelinterface voor Mac, Linux en Windows (Azure CLI)](../articles/cli-install-nodejs.md) en u moet [Meld u aan bij Azure](/cli/azure/authenticate-azure-cli). 
