...
> 
> Microsoft raadt u aan met behulp van Azure Active Directory (Azure AD)-verificatie voor uw Blob en Queue storage-toepassingen (preview) indien mogelijk voor een betere beveiliging. Zie voor meer informatie, [verifiëren van toegang tot Azure-blobs en wachtrijen met behulp van Azure Active Directory (preview)](https://docs.microsoft.com/azure/storage/common/storage-auth-aad).
