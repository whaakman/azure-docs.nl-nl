...
4. Typ **AppBackend** in het vak **Naam** en selecteer **OK**. 
   
    ![Het venster Nieuw project][B1]

5. Selecteer in het venster **Nieuw ASP.NET-project** het selectievakje **Web-API** en selecteer vervolgens **OK**.
   
    ![Het venster Nieuw ASP.NET-project][B2]

6. Selecteer een abonnement in het venster **Microsoft Azure Web App configureren** en voer in de lijst **App Service-plan** een van de volgende acties uit:
