...
De runtime in de volgende opdracht is ingesteld op `NODE|6.9`. Als u wilt zien alle ondersteunde runtimes, [az webapp lijst-runtimes](/cli/azure/webapp#list-runtimes). 
