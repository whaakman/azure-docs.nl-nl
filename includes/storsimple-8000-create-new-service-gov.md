...
ms.locfileid: "66118244"
---
#### <a name="to-create-a-new-service"></a>Een nieuwe service maken
1. Uw Microsoft-accountreferenties gebruiken om aan te melden bij de [Microsoft Azure Government-Portal](https://portal.azure.us/).
2. Klik in de Government-Portal op **+** en klik vervolgens op de markt op **alle**. Zoek naar _Fysieke StorSimple_. Selecteer en klik op **Serie met fysieke StorSimple-apparaten** en klik vervolgens op **Maken**. U kunt ook in de Government-portal, klikt u op **+** en klik vervolgens onder **opslag**, klikt u op **serie met fysieke StorSimple-apparaat**.
3. Voer de volgende stappen uit op de blade **StorSimple-apparaatbeheerfunctie**:
   ...
   4. Geef een **locatie** voor uw service op. Locatie verwijst naar de geografische regio waar u uw apparaat implementeert. Selecteer **USGov Iowa** of **USGov Virginia**.
