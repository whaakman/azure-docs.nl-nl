...
3. De beschikbaarheid van groep-clusterrol offline halen. In **Failoverclusterbeheer** onder **rollen**, met de rechtermuisknop op de rol en selecteert u **functie stoppen**.

4. <a name="congroup"></a>Configureer de IP-resource voor de beschikbaarheidsgroep.
...
5. <a name = "dependencyGroup"></a>Controleer de SQL Server-beschikbaarheidsgroepresource afhankelijk van de client access point.
...
6. <a name="listname"></a>Controleer de afhankelijk van het IP-adres van client access point resource.
...
7. <a name="setparam"></a>Stel de clusterparameters in PowerShell.
...
8. De beschikbaarheid van groep clusterrol online brengen. In **Failoverclusterbeheer** onder **rollen**, klik met de rechtermuisknop op de rol en selecteer **rol starten**.
...
2. Met de rechtermuisknop op **IP-adres**, en selecteer **eigenschappen**.

3. Kopieer de **naam** van het IP-adres. Kan het zijn `Cluster IP Address`. 

4. <a name="setwsfcparam"></a>Stel de clusterparameters in PowerShell.
