...
ms.locfileid: "35296455"
---
# <a name="get-started-with-the-sharepoint-online-connector"></a>Aan de slag met de SharePoint Online-connector
De SharePoint Online connector gebruiken voor het beheren van SharePoint-lijsten.  
...
### <a name="create-a-connection-to-sharepoint-online"></a>Maak een verbinding met SharePoint Online
