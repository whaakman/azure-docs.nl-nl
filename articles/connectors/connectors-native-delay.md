...
| Weergavenaam | Naam van eigenschap | Description |
| --- | --- | --- |
| Jaar * |timestamp |Het jaar te vertragen tot (GMT) |
| Maand * |timestamp |De maand te vertragen tot (GMT) |
| Dag * |timestamp |Voor het uitstellen tot (GMT) |
