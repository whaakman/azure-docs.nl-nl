---
title: De connector Google Drive in logic apps toevoegen | Microsoft Docs
description: Overzicht van de connector Google Drive met parameters van de REST-API
services: 
suite: 
documentationcenter: 
...
Nadat u de verbinding hebt gemaakt, kunt u de Google Drive-eigenschappen, zoals de naam van de map pad of de bestandsnaam invoeren. 

## <a name="connector-specific-details"></a>Connector-specifieke details

Alle triggers en acties die zijn gedefinieerd in de swagger bekijken en ziet u ook de beperkingen in de [connector details](/connectors/googledrive/).
