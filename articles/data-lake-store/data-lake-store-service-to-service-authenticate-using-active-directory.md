...
> [!NOTE]
> Als u van plan uw Azure Active Directory-toepassing naar een specifieke map beperken bent, u moet ook op te geven die dezelfde Azure Active directory-toepassing **Execute** permisison naar de hoofdmap waarmee toegang tot het maken van het bestand via de. NET-SDK.
