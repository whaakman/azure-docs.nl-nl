...
1. Leid de gebruiker via de toepassing om naar de volgende URL:
   ...
   > [!NOTE]
   > \<REDIRECT-URI> moet zijn gecodeerd om te worden gebruikt in een URL. In dat geval voor https://localhost, gebruik `https%3A%2F%2Flocalhost`)
   > 
   > 
