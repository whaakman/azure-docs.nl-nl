...
U kunt uw sjabloon en de parameterbestanden waarden testen zonder het distribueren van alle resources met [az implementatie valideren](/cli/azure/group/deployment#az_group_deployment_validate). 
