---
title: Azure Resource Manager-resourceproviders door Azure-services
description: Geeft een lijst van alle naamruimten van de resource provider voor Azure Resource Manager en ziet u de Azure-service voor die naamruimte.
author: tfitzmac
...
ms.locfileid: "67442596"
---
# <a name="resource-providers-for-azure-services"></a>Resourceproviders voor Azure-services

In dit artikel laat zien hoe de naamruimten van providers voor resource is toegewezen aan Azure-services.

## <a name="match-resource-provider-to-service"></a>De resourceprovider vergelijken met service

| De naamruimte van de resource-provider | Azure-service |
| --------------------------- | ------------- |
...
| Microsoft.ClassicInfrastructureMigrate | Migratie van de klassieke implementatie-model |
| Microsoft.ClassicNetwork | Klassieke implementatie model virtueel netwerk |
...
| Microsoft.Compute | [Virtuele Machines](/azure/virtual-machines/) |
| Microsoft.Consumption | [Kostenbeheer](/azure/cost-management/) |
...
| Microsoft.CostManagement | [Kostenbeheer](/azure/cost-management/) |
| Microsoft.CustomerInsights | Customer Insights |
| Microsoft.CustomerLockbox | Klanten-Lockbox voor Microsoft Azure |
| Microsoft.CustomProviders | [Azure aangepaste Providers](../managed-applications/custom-providers-overview.md) |
...
| Microsoft.DataMigration | [Azure Database migratieservice](/azure/dms/) |
| Microsoft.DBforMariaDB | [Azure Database voor MariaDB](/azure/mariadb/) |
...
| Microsoft.HardwareSecurityModules | [Azure toegewezen HSM](../dedicated-hsm/index.yml) |
...
| Microsoft.Solutions | [Door Azure beheerde toepassingen](../managed-applications/index.yml) |
...
| Microsoft.VMwareCloudSimple | [Azure VMware-oplossing door CloudSimple](/azure/vmware-cloudsimple/) |
...
Zie voor meer informatie over de resourceproviders [Azure resourceproviders en typen](resource-manager-supported-services.md)
