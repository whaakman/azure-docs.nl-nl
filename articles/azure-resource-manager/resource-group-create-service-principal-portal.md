...
U hebt uw Azure Active Directory-toepassing en service-principal gemaakt.
...
1. Selecteer de rol die u wilt toewijzen aan de toepassing. Om toe te staan de toepassing uitvoeren van acties zoals **opnieuw opstarten**, **start** en **stoppen** instanties, selecteer de **Inzender** rol. Azure Active Directory-toepassingen worden niet standaard weergegeven in de beschikbare opties. Als u uw toepassing zoekt, zoeken naar de naam en selecteer deze.
...
1. U ziet uw rol. Als u hebt de **gebruiker** rol, moet u ervoor zorgen dat niet-beheerders kunnen toepassingen registreren.
