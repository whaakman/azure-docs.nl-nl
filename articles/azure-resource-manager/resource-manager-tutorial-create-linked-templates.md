...
* Volg [Zelfstudie: Meerdere resource-instanties maken met Resource Manager-sjablonen](./resource-manager-tutorial-create-multiple-instances.md).
...
5. Selecteer **Bestand**>**Opslaan als** om nog een exemplaar te maken van het bestand met de naam **linkedTemplate.json**.
...
Raadpleeg de sectie [De sjabloon implementeren](./resource-manager-tutorial-create-multiple-instances.md#deploy-the-template) voor de implementatieprocedure.
...
In deze zelfstudie gaat u gekoppelde sjablonen ontwikkelen en implementeren. Voor meer informatie over hoe u Azure-resources implementeert in meerdere regio's en hoe u veilige implementatiemethoden gebruikt, raadpleegt u


> [!div class="nextstepaction"]
> [Azure Deployment Manager gebruiken](./deployment-manager-tutorial.md)
