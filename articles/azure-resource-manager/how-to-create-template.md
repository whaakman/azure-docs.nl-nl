...
* De [parameters](resource-group-authoring-templates.md#parameters) sectie waarin de waarden die u opgeven tijdens de implementatie van kunt het aanpassen van de infrastructuur die is geïmplementeerd. 
