...
# Snelstartgidsen
## [Sjablonen maken - portal](resource-manager-quickstart-create-templates-use-the-portal.md)
## [Sjablonen maken - VS Code](resource-manager-quickstart-create-templates-use-visual-studio-code.md)
## [Sjablonen maken - Visual Studio](vs-azure-tools-resource-groups-deployment-projects-create-deploy.md)
...
### [EA-abonnementen maken](programmatically-create-subscription.md)
### [Toegang verlenen om EA-abonnementen te maken](grant-access-to-create-subscription.md)
...
## Problemen oplossen
### [Implementatiefouten oplossen](resource-manager-common-deployment-errors.md)
