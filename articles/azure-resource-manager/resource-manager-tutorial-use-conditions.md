...
* [Een resource in een Azure Resource Manager-sjabloon voorwaardelijk implementeren](/azure/architecture/building-blocks/extending-templates/conditional-deploy.md).
