...
De AAD-functies de mogelijkheid inrichten oplossing accelerators beheren en gebruikers in een oplossingsverbetering beheren.
...
* De hoofdbeheerder kan een accelerators basis en standaard oplossing inrichten.

### <a name="domain-user"></a>Domeingebruiker

Er zijn veel domeingebruikers per AAD-tenant:

* Een domeingebruiker kunt inrichten een basic oplossingsverbetering via de [azureiotsuite.com] [ lnk-azureiotsuite] site.
