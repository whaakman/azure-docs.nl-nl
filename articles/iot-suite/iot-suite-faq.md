...
### <a name="what-sdks-can-i-use-to-develop-device-clients-for-the-preconfigured-solutions"></a>Welke SDK's kan ik gebruiken voor het ontwikkelen van apparaatclients voor de vooraf geconfigureerde oplossingen?
