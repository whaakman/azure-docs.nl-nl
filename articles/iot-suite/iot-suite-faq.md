...
1. Download uw Bing Kaarten-API voor Enterprise-querysleutel in de [Azure portal][lnk-azure-portal]: 
   ...
   3. U ziet twee sleutels: hoofdsleutel en querysleutel. Kopieer de waarde voor querysleutel.
      ...
      > [!NOTE]
      > U hebt geen Bing Kaarten-API voor Enterprise-account? Maak er een in [Azure Portal][lnk-azure-portal] door te klikken op + Nieuw, te zoeken naar Bing Kaarten-API voor Enterprise en de aanwijzingen te volgen om een account te maken.
      > 
      > 
