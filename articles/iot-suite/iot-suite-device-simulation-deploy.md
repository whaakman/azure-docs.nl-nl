...
1. Aanmelden bij [azureiotsuite.com](https://www.azureiotsuite.com) met behulp van uw Azure accountreferenties en klikt u op **+** om een nieuwe oplossing te maken:
    ...
    ![Een nieuwe oplossing maken](media/iot-suite-device-simulation-deploy/createnewsolution.png)

1. Klik op **Selecteer** op de **apparaat simulatie** tegel:

    ![Kies de simulatie van apparaat](media/iot-suite-device-simulation-deploy/select.png)
...
1. Klik op **Oplossing maken** om het inrichtingsproces te starten. Dit proces duurt gewoonlijk enkele minuten om uit te voeren:
    ...
    ![Details apparaat simulatie-oplossing](media/iot-suite-device-simulation-deploy/createsolution.png)
...
1. Op de **ingerichte oplossingen** pagina, klikt u op **starten** onder uw nieuwe apparaat simulatie-oplossing:
    ...
    ![Kies nieuwe oplossing](media/iot-suite-device-simulation-deploy/newsolution.png)
...
1. U kunt informatie weergeven over de oplossing van uw apparaat simulatie in het deelvenster die wordt weergegeven. Kies **dashboard van de oplossing** verbinding maken met uw apparaat simulatie-oplossing.
    ...
    ![Oplossing Configuratiescherm](media/iot-suite-device-simulation-deploy/properties.png)
...
Nu dat u de simulatie van apparaat-oplossing hebt geïmplementeerd, wordt de volgende stap is het [verkennen van de mogelijkheden van de oplossing apparaat simulatie](./iot-suite-device-simulation-explore.md).
