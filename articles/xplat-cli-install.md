...
To install the CLI from an npm package, you need the latest Node.js and npm installed on your system. Then, run the following command to install the Azure CLI package published at [npmjs.com](https://www.npmjs.com). (On Linux distributions, you might need to use **sudo** to successfully run the **npm** command.)

    npm install -g azure-cli

> [!NOTE]
> If you need to install or update Node.js and npm on your Linux distribution or OS, see the documentation at [Nodejs.org](https://nodejs.org/en/download/package-manager/). We recommend that you install the most recent Node.js LTS version (4.x). If you use an older version, you might get installation errors. 
> 
> 
