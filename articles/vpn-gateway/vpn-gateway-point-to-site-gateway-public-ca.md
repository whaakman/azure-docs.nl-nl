...
1. Op een clientcomputer, bladert u naar pad `%appdata%/Microsoft/Network/Connections/Cm/<gatewayID>`. In de map van de Gateway-ID, kunt u het certificaat weergeven.
