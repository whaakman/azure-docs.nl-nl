<properties
   pageTitle="Een punt-naar-site-VPN-gatewayverbinding met een Azure-netwerk configureren met behulp van Azure Portal | Microsoft Azure"
...
8. Selecteer de gateway **Grootte**. Dit is de gateway-SKU die u gaat gebruiken om uw virtuele netwerkgateway te maken. In de portal is de standaard-SKU **Basic**. Zie [Informatie over VPN-gatewayinstellingen](../articles/vpn-gateway/vpn-gateway-about-vpn-gateway-settings.md#gwsku) voor informatie over gateway-SKU's.
