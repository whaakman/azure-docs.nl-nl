...
## <a name="gatewaysubnet"></a>4. Een gatewaysubnet maken
...
## <a name="LocalNetworkGateway"></a>6. Een lokale netwerkgateway maken
...
## <a name="VerifyConnection"></a>9. De VPN-verbinding controleren
