...
> [!NOTE]
> For more information about fault domains and update domains, see [Manage the availability of virtual machines][Manage the availability of virtual machines].
> 
> 
...
> [!NOTE]
> There is currently a limit of 100 VMs per availability set. For more information, see [Azure subscription and service limits, quotas, and constraints](../azure-subscription-service-limits.md).
> 
> 
