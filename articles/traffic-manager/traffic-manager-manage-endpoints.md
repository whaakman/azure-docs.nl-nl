...
>[AZURE.NOTE]  In dit artikel wordt het gebruik van de klassieke portal uitgelegd. De klassieke Azure Portal ondersteunt alleen het maken en de toewijzing van cloudservices en Web-apps als eindpunten. De nieuwe [Azure Portal](https://portal.azure.com) is de voorkeursinterface.
