...
De volgende voorbeelden ziet u query's over Log Analytics-werkruimten om terug te keren samengevatte tellingen van die nodig zijn voor hun classificatie van de tabel voor het bijwerken van de huidige werkruimte en een andere werkruimte met de naam  *contosoretail it*. 
