...
* [Zoeken in logboeken](log-analytics-queries.md) voor meer informatie over het analyseren van gedetailleerde gegevens van de SQL-statuscontrole en aanbevelingen.
