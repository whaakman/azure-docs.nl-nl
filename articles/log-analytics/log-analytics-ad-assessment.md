...
![afbeelding van de tegel AD-statuscontrole](./media/log-analytics-ad-assessment/ad-healthcheck-summary-tile.png)

![afbeelding van AD Health Check-dashboard](./media/log-analytics-ad-assessment/ad-healthcheck-dashboard-01.png)
...
2. Gebruik de volgende query uit om de lijst met aanbevelingen die zijn mislukt voor computers in uw omgeving.
    ...
    ```
    Hier volgt een schermopname van de zoeken in Logboeken-query:<br><br> ![mislukte aanbevelingen](./media/log-analytics-ad-assessment/ad-failed-recommendations.png)
...
* Gebruik [zoekopdrachten in Logboeken in Log Analytics](log-analytics-queries.md) voor meer informatie over het analyseren van gedetailleerde gegevens AD Health Check en aanbevelingen.
