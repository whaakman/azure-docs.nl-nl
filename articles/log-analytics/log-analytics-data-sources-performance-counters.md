...
Configureren van prestatiemeteritems van de [gegevens in het menu in-logboekanalyse-instellingen](log-analytics-data-sources.md#configuring-data-sources).
...
De volgende tabel bevat de objecten en de items die u in het configuratiebestand opgeven kunt.  Er zijn extra items beschikbaar voor bepaalde toepassingen zoals beschreven in [verzamelen van prestatiemeteritems voor Linux-toepassingen in Log Analytics](log-analytics-data-sources-linux-applications.md).
