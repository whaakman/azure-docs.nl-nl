...
Informatie over het configureren van logboekanalyse voor het ophalen van Service Fabric-Logboeken in deze sectie. De logboeken kunnen u bekijken, analyseren en oplossen van problemen in het cluster of de toepassingen en services die worden uitgevoerd in het cluster, met de Azure portal.
