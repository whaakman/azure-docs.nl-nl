---
title: Gebruik Terraform modules voor het maken van een load balanced Linux VM infrastructuur in Azure
description: Informatie over het gebruik van Terraform modules voor het maken van een cluster van Linux virtuele machine met een load balancer in Azure
...
---
# <a name="create-a-vm-cluster-with-terraform-using-custom-hcl"></a>Een VM-cluster maken met aangepaste lijst met compatibele hardware met Terraform
...
> * De configuratie voor het maken van het cluster toe te passen
...
![Terraform plannen](media/terraformPlanVmsWithModules.png)


## <a name="create-the-virtual-machines-with-apply"></a>De virtuele machines maken met toepassen

Voer `terraform apply` voor het inrichten van de VM-cluster in Azure.

![Terraform toepassen](media/terraformApplyVmsWithModules.png)

## <a name="next-steps"></a>Volgende stappen

- Bladeren in de lijst van [Azure Terraform modules](https://registry.terraform.io/modules/Azure)
- Maak een [virtuele-machineschaalset met Terraform]()