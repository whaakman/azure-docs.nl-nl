...
## <a name="3-view-performance-reports"></a>3: Rapporten weergeven
...
## <a name="4-make-changes-and-compare-performance"></a>4: Breng wijzigingen aan en vergelijken van prestaties
