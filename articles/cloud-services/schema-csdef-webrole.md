...
|vmsize|tekenreeks|Optioneel. Stel deze waarde wijzigen van de grootte van de virtuele machine die wordt toegewezen aan de rol. De standaardwaarde is `Small`. Zie voor meer informatie, [VM-groottes voor Cloud Services](cloud-services-sizes-specs.md).|  
...
|physicalDirectory|tekenreeks|De locatie van de map met inhoud voor de hoofdmap van de site. De locatie kan worden opgegeven als een absoluut pad of ten opzichte van het .csdef-locatie.|  
...
| Kenmerk | Type | Beschrijving |  
| --------- | ---- | ----------- |  
|naam|tekenreeks|Vereist. Hiermee geeft u een unieke naam in voor de virtuele map.|  
...
| Kenmerk | Type | Beschrijving |  
| --------- | ---- | ----------- |  
|naam|tekenreeks|Vereist. Hiermee geeft u een unieke naam in voor de binding.|  
|EndpointName|tekenreeks|Vereist. Hiermee geeft u de naam van het eindpunt moet worden verbonden.|  
|hostHeader|tekenreeks|Optioneel. Hiermee geeft u de naam van een host waarmee u voor het hosten van meerdere sites met verschillende hostnamen, op de combinatie van een enkel IP-adres/poort.|  
