...
Voor **Azure CDN Standard van Microsoft** profielen, alle bestanden komen in aanmerking voor compressie. Echter, een bestand moet van een MIME-type dat is [geconfigureerd voor compressie](#enabling-compression).
