...
[Azure PowerShell](/powershell/azure/overview) is een van de snelste en krachtigste manieren voor het beheren van uw Azure-services. Gebruik de `Get-AzureStorageBlob` cmdlet om op te halen van een verwijzing naar de blob, stel de `.ICloudBlob.Properties.CacheControl` eigenschap. 
