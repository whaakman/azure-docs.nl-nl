...
* **Vulnerability to SQL Injection**: Deze waarschuwing wordt geactiveerd wanneer een fout wordt gedetecteerd op een database. Deze waarschuwing kan duiden op een mogelijk beveiligingsprobleem met SQL-injectieaanvallen.
* **Unusual access from unfamiliar location**: deze waarschuwing wordt geactiveerd wanneer er op een server een poging is gedetecteerd om toegang vanaf een onbekend IP-adres te krijgen, en wanneer een dergelijke poging in de afgelopen periode niet heeft plaatsgevonden.
