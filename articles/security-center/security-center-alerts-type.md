<properties
   pageTitle="Beveiligingswaarschuwingen per type in Azure Security Center | Microsoft Azure"
...
# Beveiligingswaarschuwingen per type in Azure Security Center
...
## Welk type waarschuwingen zijn er beschikbaar?
...
### Query's op meerdere domeinaccounts uitgevoerd
...
### Beveiligingslek met betrekking tot SQL-injectie
...
### Ongebruikelijke toegang vanaf onbekende locatie
...
In dit document bent u meer te weten gekomen over de verschillende soorten beveiligingswaarschuwingen in Security Center. Zie de volgende onderwerpen voor meer informatie over Security Center:
