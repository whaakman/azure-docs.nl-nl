...
> [!NOTE]
> De informatie in dit document is van toepassing op de preview-versie van Azure Security Center. In dit document wordt de service geïntroduceerd aan de hand van een voorbeeldimplementatie.
> 
> 
...
> [!NOTE]
> Gegevens verzamelen en een opslagaccount per regio kiezen wordt geconfigureerd op abonnementsniveau.
> 
> 
