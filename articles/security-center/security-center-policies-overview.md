...
ms.locfileid: "52315712"
---
# <a name="security-center-settings"></a>Security Center-instellingen
...
- **Beveiligingsbeleid**: Hiermee bepaalt u welke besturingselementen Security Center bewaakt en wordt aanbevolen. U kunt bewerken de [beveiligingsbeleid](security-center-azure-policy.md) in Security Center. U kunt ook [Azure Policy](security-center-azure-policy.md) voor het maken van nieuwe definities, definiëren van extra beleidsregels en toewijzen van beleidsregels binnen beheergroepen. 
