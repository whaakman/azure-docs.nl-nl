<properties
   pageTitle="Azure Security Center en Azure Virtual Machines | Microsoft Azure"
...
# Azure Security Center en Azure Virtual Machines
...
>[AZURE.NOTE] Zie [Introduction to Azure Security Center](security-center-intro.md) (Inleiding tot Azure Security Center) voor meer informatie over Azure Security Center.
...
>[AZURE.NOTE] Zie het artikel [Beveiligingsbeleid instellen](security-center-policies.md) voor meer informatie over elk **Preventiebeleid**.

## Aanbevelingen voor beveiliging beheren
...
| [Beveiligingsproblemen herstellen](security-center-vulnerability-assessment-recommendations.md#review-recommendation) | Hiermee ziet u beveiligingsproblemen in het systeem en in de toepassing die zijn gedetecteerd met de oplossing voor beveiligingslekken die op de VM is geïnstalleerd. |

>[AZURE.NOTE] Zie het artikel [Managing security recommendations](security-center-recommendations.md) (Aanbevelingen voor beveiliging beheren) voor meer informatie over aanbevelingen.
