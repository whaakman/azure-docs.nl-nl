...
De [Azure Resource Manager resource provider operations](../role-based-access-control/resource-provider-operations.md#microsoftapimanagement) artikel bevat de lijst met machtigingen die kunnen worden verleend op het niveau van API Management.
...
Zie voor meer informatie over toegangsbeheer op basis van rollen in Azure, de volgende artikelen:
  ...
  * [Azure Resource Manager resource provider-bewerkingen](../role-based-access-control/resource-provider-operations.md#microsoftapimanagement)
