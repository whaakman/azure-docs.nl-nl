...
![product toevoegen](media/api-management-howto-add-products/added-product.png)
...
![product-API toevoegen](media/api-management-howto-add-products/add-product-api.png)
