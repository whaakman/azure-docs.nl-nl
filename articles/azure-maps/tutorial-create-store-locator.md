...
1. Voeg de volgende `meta`-tags toe aan de `head` van *index.html*. De tags definiëren de tekenset (UTF-8), geven aan dat Internet Explorer en Edge de nieuwste browserversies moeten gebruiken en specificeren een viewport die goed werkt voor responsieve lay-outs.
