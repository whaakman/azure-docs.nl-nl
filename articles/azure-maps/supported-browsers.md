---
title: Ondersteunde webbrowsers - Azure-kaarten | Microsoft Docs
description: Meer informatie over ondersteunde webbrowsers voor Azure Maps Web SDK
author: rbrundritt
ms.author: richbrun
ms.date: 03/25/2019
ms.topic: conceptual
...
Azure Maps Web SDK biedt ondersteuning voor de volgende webbrowsers.
...
> [!TIP]
> Als u een kaart in een mobiele toepassingsweergave een webweergave besturingselement wilt insluiten, vindt u met behulp van de [npm-pakket van de Azure Maps Web SDK](https://www.npmjs.com/package/azure-maps-control) beter om te verwijzen naar de CDN gehost versie van de SDK. Zo beperkt u tijd te laden als de SDK al worden op het apparaat van de gebruiker en niet moeten worden gedownload tijdens runtime.
...
Als u oudere webbrowsers die mogelijk niet ondersteund of beperkt worden ondersteund voor WebGL als doel moet, is het raadzaam de Services van Azure kaarten gebruiken in combinatie met een open-source kaartbesturingselement zoals [brochure](https://leafletjs.com/). 
