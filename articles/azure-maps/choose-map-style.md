...
Het tweede codeblok vormt een stijl selector met behulp van de atlas [StyleControl](/javascript/api/azure-maps-control/atlas.control.stylecontrol) constructor.
