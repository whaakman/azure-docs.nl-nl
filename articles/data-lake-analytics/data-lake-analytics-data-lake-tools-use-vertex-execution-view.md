...
* Totale gegevens lezen/geschreven: De gegevens zijn gelezen of weggeschreven door deze hoekpunt.
* Status/afsluiten Status: De definitieve status wanneer het hoekpunt wordt beëindigd.
* Afsluiten: / mislukt-Type: De fout bij het hoekpunt is mislukt.
...
* GUID proces/Maker: GUID voor de persoon die of het huidige actieve hoekpunt.
