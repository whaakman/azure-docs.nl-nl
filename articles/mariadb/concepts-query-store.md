---
title: Query Store in Azure Database voor MariaDB
description: In dit artikel beschrijft de functie voor Query Store in Azure Database voor MariaDB
author: ajlam
ms.author: andrela
ms.service: mariadb
ms.topic: conceptual
...
1. Meld u aan bij Azure portal en selecteer uw Azure Database voor MariaDB-server.
...
- Als een MariaDB-server de parameter heeft `default_transaction_read_only` , Query Store niet kan vastleggen van gegevens.
