...
| --- | --- |
| Treffers in cache |Het aantal treffers sleutel tijdens het opgegeven interval voor rapportage. Dit wordt toegewezen aan `keyspace_hits` van de Redis [INFO](http://redis.io/commands/info) opdracht. |
