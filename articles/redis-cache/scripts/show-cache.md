...
Dit script gebruikt de volgende opdrachten voor het ophalen van de gegevens van een Azure Redis-Cache-exemplaar. Elke opdracht in de tabel is een koppeling naar specifieke documentatie over de opdracht.
