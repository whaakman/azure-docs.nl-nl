...
|**Web-app plus cache**||
| [Een WebApp verbinden met een redis-cache](./../app-service/scripts/app-service-cli-app-service-redis.md) | Hiermee maakt u een Azure-web-app en een redis-cache en vervolgens voegt u de details van de redis-verbinding toe aan de app-instellingen. |
|**Cache verwijderen**||
