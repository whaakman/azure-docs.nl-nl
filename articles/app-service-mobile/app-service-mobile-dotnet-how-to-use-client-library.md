...
* **Xamarin Studio** met de rechtermuisknop op uw project, klikt u op **toevoegen** > **NuGet-pakketten toevoegen**, zoekt de `Microsoft.Azure.Mobile.Client `van het pakket en klik vervolgens op **pakket toevoegen** .
