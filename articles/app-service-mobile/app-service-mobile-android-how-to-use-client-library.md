...
1. Deze code toevoegen aan de *Project* niveau **build.gradle** bestand:
...
Voeg tot slot `com.android.support:customtabs:28.0.0` aan de lijst met afhankelijkheden in de `build.gradle` bestand:
