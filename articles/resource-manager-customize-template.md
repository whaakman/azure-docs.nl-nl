---
title: Een geëxporteerde Resource Manager-sjabloon aanpassen | Microsoft Docs
...
1. Gebruik een van de volgende opties om de implementatie uit te voeren met behulp van uw eigen script.
...
2. Als u de geëxporteerde sjabloon en scripts hebt gedownload, zoek dan het bestand **deploy.ps1** (voor PowerShell) of **deploy.sh**-bestand (voor Azure CLI) op.
