...
## <a name="updating-the-collector-vm"></a>De Collector-VM bijwerken

Het is raadzaam die continu Windows-updates worden uitgevoerd op het Collector-apparaat.
...
- Als u de Collector gedurende meer dan 45 dagen gebruikt hebt, raden wij houden van de machine bijgewerkt op alle tijden door actieve Windows update.
