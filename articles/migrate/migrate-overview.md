...
- U kunt een Azure Migrate-project alleen maken in de regio US - west-centraal of US - oost. Dit heeft geen invloed op uw mogelijkheid voor het plannen van de migratie naar een Azure-doellocatie. De locatie van het migratieproject wordt alleen gebruikt om de gedetecteerde metagegevens uit de on-premises omgeving op te slaan.
...
5.  De metagegevens worden doorgegeven aan het Azure Migrate-project. U kunt ze bekijken in de Azure-portal.
