...
![Advisor-aanbevelingen](./media/tutorial-acm-opt-recommendations/advisor-recommendations.png)
...
![Details van de aanbeveling](./media/tutorial-acm-opt-recommendations/recommendation-details.png)
...
![Details van de virtuele machine](./media/tutorial-acm-opt-recommendations/vm-details.png)
...
![Grootte van de virtuele machine](./media/tutorial-acm-opt-recommendations/resize-vm.png)
...
![Kies een grootte](./media/tutorial-acm-opt-recommendations/choose-size.png)
...
![Melding formaat is gewijzigd](./media/tutorial-acm-opt-recommendations/resized-notification.png)
