...
ms.locfileid: "34800918"
---
# <a name="plan-for-enhancing-data-security-through-a-strong-identity-solution"></a>Plan voor het verbeteren van de beveiliging van gegevens via een oplossing voor sterke identiteit
De eerste stap bij het beveiligen van gegevens is om te bepalen wie toegang heeft tot die gegevens. Bovendien moet u een oplossing die kan worden geïntegreerd met uw systeem te bieden van authenticatie en autorisatiemogelijkheden hebben. Verificatie en autorisatie worden vaak verward met elkaar en hun rollen verkeerd begrepen. In werkelijkheid zijn ze verschillend zijn, zoals wordt weergegeven in de afbeelding hieronder:

![](./media/hybrid-id-design-considerations/mobile-devicemgt-lifecycle.png)

**Fasen van de levenscyclus van mobiele apparaten**

Bij het plannen van uw oplossing voor hybride identiteit, dat u begrijpt de beveiligingsvereisten van de gegevens voor uw bedrijf en welke opties zijn beschikbaar voor de beste voldoen aan deze vereisten.
...
Is het nodig dat de oplossing voor hybride identiteit geschikt voor gebruik van zowel is on-premises en in de cloud identity management-resources voor het identificeren van de gebruiker voordat deze toegang tot de gegevens verleent. Zorg ervoor dat de volgende vragen worden beantwoord volgens de vereisten van uw organisatie bij het plannen van uw oplossing voor hybride identiteit:
