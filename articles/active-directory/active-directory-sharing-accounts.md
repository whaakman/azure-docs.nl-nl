...
* [Toewijzing van updategroep](users-groups-roles/groups-self-service-management.md)
...
* Gebruik [toewijzing op basis van een groep](users-groups-roles/groups-saasapps.md) en selecteer de optie voor het invoeren van een gedeelde referenties
