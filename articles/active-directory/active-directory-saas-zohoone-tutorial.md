...
4. Typ in het zoekvak **Zoho één**, selecteer **Zoho één** van resultaat deelvenster klik vervolgens op **toevoegen** om toe te voegen van de toepassing.
    ...
    ![Een Zoho in de lijst met resultaten](./media/active-directory-saas-zohoone-tutorial/tutorial_zohoone_addfromgallery.png)
...
2. Op de **eenmalige aanmelding** dialoogvenster Selecteer **modus** als **op basis van SAML aanmelding** voor eenmalige aanmelding inschakelen.
    ...
    ![Dialoogvenster voor eenmalige aanmelding](./media/active-directory-saas-zohoone-tutorial/tutorial_zohoone_samlbase.png)
...
3. Op de **Zoho één domein en URL's** sectie, voert u de volgende stappen uit als u wilt configureren, de toepassing in **IDP** modus gestart:
    ...
    ![Zoho één domein en URL's van eenmalige aanmelding informatie](./media/active-directory-saas-zohoone-tutorial/tutorial_zohoone_url.png)
...
5. Op de **SAML-certificaat voor ondertekening van** sectie, klikt u op **certificaat (Base64)** en sla het certificaatbestand op uw computer.
    ...
    ![De downloadkoppeling certificaat](./media/active-directory-saas-zohoone-tutorial/tutorial_zohoone_certificate.png) 

6. Klik op **opslaan** knop.

    ![Knop Single Sign-On opslaan configureren](./media/active-directory-saas-zohoone-tutorial/tutorial_general_400.png)
...
7. Op de **Zoho één configuratie** sectie, klikt u op **configureren met één Zoho** openen **eenmalige aanmelding configureren** venster. Kopieer de **Sign-Out URL's en SAML Single Sign-On Service** van de **Naslaggids punt.**
    ...
    ![Zoho één configuratie](./media/active-directory-saas-zohoone-tutorial/tutorial_zohoone_configure.png) 
...
9. Op de **organisatie** tabblad, klikt u op **Setup** onder **SAML-verificatie**.
    ...
    ![Een Zoho org](./media/active-directory-saas-zohoone-tutorial/tutorial_zohoone_setup.png)

10. Voer de volgende stappen uit op de pop-pagina:

    ![Een Zoho sig](./media/active-directory-saas-zohoone-tutorial/tutorial_zohoone_save.png)
...
11. Na het opslaan van de SAML-verificatie-instellingen, kopieert u de **SAML-Identfier** waarde en gebruikt deze waarde in de **antwoord-URL** in de Azure-portal onder **Zoho één domein en URL's** sectie.
    ...
    ![Een Zoho saml](./media/active-directory-saas-zohoone-tutorial/tutorial_zohoone_samlidenti.png)

12. Ga naar de **domeinen** tabblad en klik vervolgens op **domein toevoegen**.

    ![Zoho één domein](./media/active-directory-saas-zohoone-tutorial/tutorial_zohoone_domain.png)

13. Op de **domein toevoegen** pagina, voert u de volgende stappen uit:

    ![Zoho één toevoegen domein](./media/active-directory-saas-zohoone-tutorial/tutorial_zohoone_adddomain.png)
...
1. Klik in de Azure-portal in het linkerdeelvenster op het **Azure Active Directory** knop.
    ...
    ![De Azure Active Directory-knop](./media/active-directory-saas-zohoone-tutorial/create_aaduser_01.png)

2. Als u wilt weergeven in de lijst met gebruikers, gaat u naar **gebruikers en groepen**, en klik vervolgens op **alle gebruikers**.

    !['Gebruikers en groepen' en 'Alle gebruikers' koppelingen](./media/active-directory-saas-zohoone-tutorial/create_aaduser_02.png)

3. Openen van de **gebruiker** in het dialoogvenster klikt u op **toevoegen** boven aan de **alle gebruikers** in het dialoogvenster.

    ![De knop toevoegen](./media/active-directory-saas-zohoone-tutorial/create_aaduser_03.png)

4. In de **gebruiker** dialoogvenster vak, voert u de volgende stappen uit:

    ![Het dialoogvenster gebruiker](./media/active-directory-saas-zohoone-tutorial/create_aaduser_04.png)
...
2. Op de **gebruikers** tabblad, klik op **gebruiker logo**.
    ...
    ![Zoho één gebruiker](./media/active-directory-saas-zohoone-tutorial/tutorial_zohoone_users.png)

3. Op de **gebruiker toevoegen** pagina, voert u de volgende stappen uit:

    ![Zoho één toevoegen gebruiker](./media/active-directory-saas-zohoone-tutorial/tutorial_zohoone_adduser.png)
...
2. Selecteer in de lijst met toepassingen **Zoho één**.
    ...
    ![De Zoho één koppeling in de lijst met toepassingen](./media/active-directory-saas-zohoone-tutorial/tutorial_zohoone_app.png)  
