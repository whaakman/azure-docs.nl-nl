...
| Azure AD Connect-synchronisatieserver |![Azure AD Connect-synchronisatieserver](./media/active-directory-aadconnect-topologies/LegendSync1.png) |
| Azure AD Connect-synchronisatieserver "faseringsmodus" |![Azure AD Connect-synchronisatieserver "faseringsmodus"](./media/active-directory-aadconnect-topologies/LegendSync2.png) |
...
| Azure AD Connect-synchronisatieserver, gedetailleerde |![Azure AD Connect-synchronisatieserver, gedetailleerde](./media/active-directory-aadconnect-topologies/LegendSync4.png) |
...
![Topologie voor één forest en één tenant](./media/active-directory-aadconnect-topologies/SingleForestSingleDirectory.png)
...
![Topologie voor meerdere forests en één tenant](./media/active-directory-aadconnect-topologies/MultiForestSingleDirectory.png)
...
![Optie voor de vertegenwoordiging van gebruikers slechts één keer op alle mappen](./media/active-directory-aadconnect-topologies/MultiForestUsersOnce.png)
...
![Optie voor het gebruik van het e-mailkenmerk voor overeenkomende als er gebruikers-id's in meerdere mappen bestaan](./media/active-directory-aadconnect-topologies/MultiForestUsersMail.png)
...
![Optie voor het gebruik van de ObjectSID- en msExchMasterAccountSID kenmerken voor het afstemmen van wanneer identiteiten in meerdere mappen bestaan](./media/active-directory-aadconnect-topologies/MultiForestUsersObjectSID.png)
...
Als u een grotere organisatie bent, dan kunt u overwegen om te gebruiken de [Office 365 PreferredDataLocation](active-directory-aadconnectsync-feature-preferreddatalocation.md) functie. Hiermee kunt u bepalen in welke datacentrumregio van de gebruiker resources zich bevinden.

## <a name="staging-server"></a>Staging-server
![Staging-server in een topologie](./media/active-directory-aadconnect-topologies/MultiForestStaging.png)
...
![Niet-ondersteunde topologie voor meerdere forests en meerdere mappen, met GALSync gericht op Azure AD](./media/active-directory-aadconnect-topologies/MultiForestMultiDirectoryGALSync1Unsupported.png) ![Niet-ondersteunde topologie voor meerdere forests en meerdere mappen, met GALSync te focussen op on-premises Active Directory](./media/active-directory-aadconnect-topologies/MultiForestMultiDirectoryGALSync2Unsupported.png)
...
Zie voor informatie over het installeren van Azure AD Connect voor deze scenario's, [aangepaste installatie van Azure AD Connect](active-directory-aadconnect-get-started-custom.md).
