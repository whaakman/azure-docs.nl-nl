...
![Adreslijsten](media/active-directory-aadconnect-existing-database/db6.png)
...
- [Azure AD Connect installeren met behulp van een bestaande ADSync-database](active-directory-aadconnect-existing-database.md)
- [Azure AD Connect installeren met SQL-gedelegeerde beheerdersmachtigingen](active-directory-aadconnect-sql-delegation.md)
