...
Het kenmerk is gesynchroniseerd met Azure AD Connect.  U kunt tijdens de installatie van de domeinen die zijn geverifieerd en de waarden die niet weergeven.
...
In sommige omgevingen mogen eindgebruikers alleen worden op de hoogte van het e-mailadres en niet de UPN.  Het gebruik van e-mailadres wordt mogelijk veroorzaakt door een zakelijke beleid of een afhankelijkheid van lokale line-of-business-toepassing.

Alternatieve aanmeldings-ID kunt u een aanmeldingservaring configureren waar gebruikers kunnen aanmelden met een kenmerk dan de UPN, zoals e-mail.
...
Wanneer een gebruikersobject is gesynchroniseerd met een Azure AD-Tenant voor de eerste keer, wordt Azure AD gecontroleerd van de volgende items in de gegeven volgorde en stelt u de MailNickName kenmerk-waarde naar de eerste bestaande:
...
- Nadat de initiële synchronisatie van het gebruikersobject-updates voor de on-premises e-kenmerk en het primaire SMTP-adres heeft geen invloed op de Azure AD-MailNickName of het kenmerk UserPrincipalName.
