...
- [Eigenschappen van een gebruiker met Azure Active Directory B2B-samenwerking](../../active-directory/active-directory-b2b-user-properties.md#key-properties-of-the-azure-ad-b2b-collaboration-user)
