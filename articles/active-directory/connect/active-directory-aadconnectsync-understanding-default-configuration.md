...
Lees voor meer informatie over de details van het configuratiemodel, [Understanding declaratieve inrichting](active-directory-aadconnectsync-understanding-declarative-provisioning.md).
...
![Pictogram van de Synchronization Rules Editor](./media/active-directory-aadconnectsync-understanding-default-configuration/sre.png)
...
![Synchronisatieregels inkomend](./media/active-directory-aadconnectsync-understanding-default-configuration/syncrulesinbound.png)
...
Omdat met deze regel een regel voor out-of-box wordt, ontvangt u een waarschuwing weergegeven bij het openen van de regel. U maakt een [wijzigingen aan de regels voor out-of-box](active-directory-aadconnectsync-best-practices-changing-default-configuration.md), zodat u wordt gevraagd wat uw intenties zijn. In dit geval wilt u alleen om de regel weer te geven. Selecteer **Nee**.
...
![Beschrijving van tabblad synchroon regeleditor ](./media/active-directory-aadconnectsync-understanding-default-configuration/syncruledescription.png)
...
![Scoping tabblad in de editor voor synchronisatie-regel ](./media/active-directory-aadconnectsync-understanding-default-configuration/syncrulescopingfilter.png)
...
![Scoping tabblad in de editor voor synchronisatie-regel ](./media/active-directory-aadconnectsync-understanding-default-configuration/syncrulescopingfilterout.png)
...
![Tabblad regels in de editor voor synchronisatie-regel toevoegen ](./media/active-directory-aadconnectsync-understanding-default-configuration/syncrulejoinrules.png)
...
* Lees ook de werking van de configuratie van de out-of-box in [inzicht krijgen in gebruikers en contactpersonen](active-directory-aadconnectsync-understanding-users-and-contacts.md)
* Zien hoe u een praktische wijzigen met behulp van declaratieve inrichting [hoe u een wijziging in de standaardconfiguratie](active-directory-aadconnectsync-change-the-configuration.md).

**Overzichtsonderwerpen**

* [Azure AD Connect-synchronisatie: inzicht in en synchronisatie aanpassen](active-directory-aadconnectsync-whatis.md)
