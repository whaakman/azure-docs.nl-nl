...
![Gegevens van uw AD FS](./media/active-directory-aadconnectfed-ssl-update/adfsserverinfo.png)
...
![Selecteer servers om bij te werken](./media/active-directory-aadconnectfed-ssl-update/selectservers.png)
