...
* [Identificeren en oplossen van problemen voor een groep in Azure Active Directory](users-groups-roles/licensing-groups-resolve-problems.md)
* [Hoe gebruikers met een afzonderlijke licentie migreren naar het Groepslicenties in Azure Active Directory](users-groups-roles/licensing-groups-migrate-users.md)
* [Azure Active Directory-groep op basis van aanvullende scenario's-licentieverlening](users-groups-roles/licensing-group-advanced.md)
