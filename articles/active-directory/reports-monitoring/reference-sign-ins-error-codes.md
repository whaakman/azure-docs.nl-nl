...
In plaats van Azure Portal kunt u ook de [rapportage-API](concept-reporting-api.md) gebruiken voor toegang tot aanmeldingsgegevens.
...
Raadpleeg [Aanmeldactiviteitenrapporten in Azure Active Directory Portal](concept-sign-ins.md) voor meer informatie.
