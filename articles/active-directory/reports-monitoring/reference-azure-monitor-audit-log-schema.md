---
title: Interpreteren van de Azure Active Directory-schema audit log in Azure Monitor | Microsoft Docs
description: Beschrijf de Azure AD audit log-schema voor gebruik in Azure Monitor
