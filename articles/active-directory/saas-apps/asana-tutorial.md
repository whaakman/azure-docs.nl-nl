...
4. Typ in het zoekvak **Asana**, selecteer **Asana** van resultaat deelvenster klik vervolgens op **toevoegen** om toe te voegen van de toepassing.
    ...
    ![Een Azure AD-testgebruiker maken](./media/asana-tutorial/tutorial_asana_addfromgallery.png)
...
2. Op de **eenmalige aanmelding** dialoogvenster Selecteer **modus** als **op basis van SAML aanmelding** voor eenmalige aanmelding inschakelen.
    ...
    ![Dialoogvenster voor eenmalige aanmelding](./media/asana-tutorial/tutorial_asana_samlbase.png)

3. Op de **Asana domein en de URL's** sectie, voert u de volgende stappen uit:

    ![URL's en Asana domein eenmalige aanmelding informatie](./media/asana-tutorial/tutorial_asana_url.png)
...
5. Klik op **opslaan** knop.
    ...
    ![Knop Single Sign-On opslaan configureren](./media/asana-tutorial/tutorial_general_400.png)
...
8. Op de **organisatie-instellingen** venster, klikt u op **beheer**. Klik vervolgens op **leden moeten zich aanmelden via SAML** zodat de SSO-configuratie. Het uitvoeren van de volgende stappen:
    ...
    ![Eenmalige aanmelding, organisatie-instellingen configureren](./media/asana-tutorial/tutorial_asana_10.png)  
...
3. Openen van de **gebruiker** dialoogvenster, klikt u op **toevoegen** boven aan het dialoogvenster.
    ...
    ![Een Azure AD-testgebruiker maken](./media/asana-tutorial/create_aaduser_03.png)
...
Het doel van deze sectie is het maken van een gebruiker Britta Simon in Asana genoemd. Asana ondersteunt automatisch gebruikers inrichten, dit is standaard ingeschakeld. U vindt meer informatie [hier](asana-provisioning-tutorial.md) over het configureren van automatische gebruikers inrichten.
...
2. Selecteer in de lijst met toepassingen **Asana**.
    ...
    ![De koppeling Asana in de lijst met toepassingen](./media/asana-tutorial/tutorial_asana_app.png)
