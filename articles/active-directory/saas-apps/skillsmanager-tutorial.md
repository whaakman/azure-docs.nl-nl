...
3. **[Maak een testgebruiker vaardigheden Manager](#create-a-skills-manager-test-user)**  : als u wilt een equivalent van Britta Simon in vaardigheden Manager die is gekoppeld aan de Azure AD-weergave van de gebruiker hebben.
...
6. Op de **vaardigheden Manager configuratie** sectie, klikt u op **vaardigheden Manager configureren** openen **aanmelding configureren** venster. Kopiëren de **afmelding-URL, SAML-entiteit-ID en Single Sign-On Service URL voor SAML-** uit de **Naslaggids sectie.**
