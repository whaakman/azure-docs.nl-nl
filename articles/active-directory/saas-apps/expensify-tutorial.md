...
4. Typ in het zoekvak **Expensify**, selecteer **Expensify** van resultaat deelvenster klik vervolgens op **toevoegen** om toe te voegen van de toepassing.
    ...
    ![In de lijst met resultaten expensify](./media/expensify-tutorial/tutorial_expensify_addfromgallery.png)
...
2. Op de **eenmalige aanmelding** dialoogvenster Selecteer **modus** als **op basis van SAML aanmelding** voor eenmalige aanmelding inschakelen.
    ...
    ![Dialoogvenster voor eenmalige aanmelding](./media/expensify-tutorial/tutorial_expensify_samlbase.png)

3. Op de **Expensify domein en de URL's** sectie, voert u de volgende stappen uit:

    ![Domein- en URL's eenmalige aanmelding informatie expensify](./media/expensify-tutorial/tutorial_expensify_url.png)
...
5. Klik op **opslaan** knop.
    ...
    ![Knop Single Sign-On opslaan configureren](./media/expensify-tutorial/tutorial_general_400.png)
