...
2. Op de **eenmalige aanmelding** dialoogvenster Selecteer **modus** als **op basis van SAML aanmelding** voor eenmalige aanmelding inschakelen.
    ...
    ![Dialoogvenster voor eenmalige aanmelding](./media/benefitsolver-tutorial/tutorial_benefitsolver_samlbase.png)

3. Op de **Benefitsolver domein en de URL's** sectie, voert u de volgende stappen uit:

    ![URL's en Benefitsolver domein eenmalige aanmelding informatie](./media/benefitsolver-tutorial/tutorial_benefitsolver_url.png)
...
7. Klik op **opslaan** knop.
    ...
    ![Knop Single Sign-On opslaan configureren](./media/benefitsolver-tutorial/tutorial_general_400.png)
