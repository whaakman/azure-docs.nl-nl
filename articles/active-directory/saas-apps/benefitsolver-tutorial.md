...
3. **[Maak een testgebruiker Benefitsolver](#create-a-benefitsolver-test-user)**  : als u wilt een equivalent van Britta Simon in Benefitsolver die is gekoppeld aan de Azure AD-weergave van de gebruiker hebben.
...
3. Op de **Benefitsolver domein en URL's** sectie, voert u de volgende stappen uit:
...
4. Uw toepassing Benefitsolver wordt verwacht dat de SAML-asserties ondertekend in een specifieke indeling, die vereist dat u om toe te voegen van aangepast kenmerktoewijzingen aan uw **saml-token kenmerken** configuratie.
...
8. Het configureren van eenmalige aanmelding op **Benefitsolver** zijde, moet u voor het verzenden van de gedownloade **Metadata XML** naar [Benefitsolver ondersteuningsteam](https://www.businessolver.com/contact).
