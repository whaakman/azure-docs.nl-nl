...
- Een SSO Kantega voor eenmalige aanmelding JIRA ingeschakeld abonnement
...
In deze sectie maakt u configureert en test Azure AD eenmalige aanmelding met Kantega SSO voor JIRA op basis van een testgebruiker 'Julia steen' genoemd.

Voor eenmalige aanmelding om te werken, moet Azure AD om te weten wat de gebruiker equivalent in Kantega SSO voor JIRA is aan een gebruiker in Azure AD. Met andere woorden, moet een koppeling relatie tussen een Azure AD-gebruiker en de gerelateerde gebruiker in Kantega SSO voor JIRA tot stand worden gebracht.

In Kantega SSO voor JIRA, wijs de waarde van de **gebruikersnaam** in Azure AD als de waarde van de **gebruikersnaam** de relatie van de koppeling tot stand brengen.
...
In deze sectie maakt u schakelt Azure AD eenmalige aanmelding in de Azure-portal en configureren van eenmalige aanmelding in uw Kantega SSO voor JIRA-toepassing.

**Voor het configureren van Azure AD eenmalige aanmelding met Kantega SSO voor JIRA, moet u de volgende stappen uitvoeren:**

1. In de Azure-portal op de **Kantega SSO voor JIRA** toepassingspagina integratie, klikt u op **eenmalige aanmelding**.
...
### <a name="creating-a-kantega-sso-for-jira-test-user"></a>Het maken van een SSO Kantega voor JIRA testgebruiker

Als u wilt dat Azure AD-gebruikers zich aanmelden bij JIRA, moeten ze worden ingericht voor JIRA. In Kantega SSO voor JIRA is inrichten een handmatige taak.
...
Wanneer u op de Kantega SSO voor JIRA-tegel in het toegangsvenster, u moet u automatisch aangemeld bij uw Kantega SSO voor JIRA-toepassing.
