---
title: 'Zelfstudie: Azure Active Directory-integratie met brug | Microsoft Docs'
...
1. Op de **Bridge-domein en URL's** sectie, voert u de volgende stappen uit:
    ...
    a. In de **aanmeldings-URL** tekstvak, een URL met behulp van het volgende patroon: `https://<company name>.bridgeapp.com`

    b. In de **id** tekstvak, een URL met behulp van het volgende patroon: `https://<company name>.bridgeapp.com`

    > [!NOTE] 
    > Deze waarden zijn niet echt. Werk deze waarden met de werkelijke aanmeldings-URL en -id. Neem contact op met [Bridge-Client-ondersteuningsteam](https://community.bridgeapp.com/community/help) om deze waarden te verkrijgen. 
