...
1. Typ in het zoekvak **hoeksteen OnDemand**.

    ![Het maken van een Azure AD-testgebruiker](./media/cornerstone-ondemand-tutorial/tutorial_cornerstoneondemand_search.png)

1. Selecteer in het deelvenster resultaten **hoeksteen OnDemand**, en klik vervolgens op **toevoegen** om toe te voegen van de toepassing.
...
1. **[Het maken van een testgebruiker hoeksteen OnDemand](#creating-a-cornerstone-ondemand-test-user)**  : als u wilt een equivalent van Britta Simon in hoeksteen OnDemand die is gekoppeld aan de Azure AD-weergave van de gebruiker hebben.
...
1. Op de **hoeksteen OnDemand domein en URL's** sectie, voert u de volgende stap:
...
1. Op de **hoeksteen OnDemand configuratie** sectie, klikt u op **configureren hoeksteen OnDemand** openen **aanmelding configureren** venster. Kopiëren de **afmelding URL's en SAML Single Sign-On Service** uit de **Naslaggids sectie.**
...
1. Selecteer in de lijst met toepassingen, **hoeksteen OnDemand**.
