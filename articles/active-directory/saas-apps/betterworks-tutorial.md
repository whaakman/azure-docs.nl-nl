...
1. Op de **BetterWorks domein en URL's** sectie, als u wilt configureren van de toepassing in **IDP gestart door modus**:
    ...
    a. In de **id** tekstvak, een URL met behulp van het volgende patroon: `https://app.betterworks.com/saml2/metadata/`

    b. In de **antwoord-URL** tekstvak, een URL met behulp van het volgende patroon: `https://app.betterworks.com/saml2/acs/`
...
1. BetterWorks toepassing verwacht het SAML-asserties ondertekend in een specifieke indeling. Configureer de volgende claims voor deze toepassing. U kunt de waarden van deze kenmerken vanuit beheren de "**kenmerk**" tabblad van de toepassing. De volgende Schermafbeelding toont een voorbeeld voor deze. 
