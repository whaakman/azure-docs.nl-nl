...
3. **[Maak een testgebruiker FactSet](#create-a-factset-test-user)**  : als u wilt een equivalent van Britta Simon in FactSet die is gekoppeld aan de Azure AD-weergave van de gebruiker hebben.
...
3. Op de **FactSet domein en URL's** sectie, voert u de volgende stappen uit:
...
6. Het configureren van eenmalige aanmelding op **FactSet** zijde, moet u voor het verzenden van de gedownloade **Metadata XML** naar [FactSet ondersteuningsteam](mailto:support@factset.com). Ze stelt u deze optie om de SAML SSO-verbinding instellen goed aan beide zijden.
