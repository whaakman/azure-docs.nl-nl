...
1. Op de **FactSet domein en URL's** sectie, voert u de volgende stappen uit:
    ...
    a. In de **aanmeldings-URL** tekstvak, een URL met behulp van het volgende patroon: `https://login.factset.com/services/auth-test?idpid=<GUID>`
...
1. Klik op **opslaan** knop.
    ...
    ![Configureren van eenmalige aanmelding opslaan](./media/factset-tutorial/tutorial_general_400.png)

1. Het configureren van eenmalige aanmelding op **FactSet** zijde, moet u voor het verzenden van de gedownloade **Metadata XML** naar [FactSet ondersteuningsteam](mailto:support@factset.com). Ze stelt u deze optie om de SAML SSO-verbinding instellen goed aan beide zijden.
...
In deze sectie maakt u een gebruiker met de naam van Britta Simon in FactSet. Werken met [FactSet ondersteuningsteam](mailto:support@factset.com) om toe te voegen de gebruikers in het FactSet-platform. Gebruikers moeten worden gemaakt en worden geactiveerd voordat u eenmalige aanmelding gebruiken. 
