...
4. Typ in het zoekvak **Kantega SSO voor Bamboe**.
    ...
    ![Een Azure AD-testgebruiker maken](./media/kantegassoforbamboo-tutorial/tutorial_kantegassoforbamboo_search.png)
...
5. Selecteer in het deelvenster resultaten **Kantega SSO voor Bamboe**, en klik vervolgens op **toevoegen** om toe te voegen van de toepassing.
    ...
    ![Een Azure AD-testgebruiker maken](./media/kantegassoforbamboo-tutorial/tutorial_kantegassoforbamboo_addfromgallery.png)
...
7. In een ander browservenster, meld u aan bij uw lokale Bamboe server als beheerder.
...
1. In de **Azure-portal**, klik op het navigatiedeelvenster links **Azure Active Directory** pictogram.
    ...
    ![Een Azure AD-testgebruiker maken](./media/kantegassoforbamboo-tutorial/create_aaduser_01.png) 

2. Als u wilt weergeven in de lijst met gebruikers, gaat u naar **gebruikers en groepen** en klik op **alle gebruikers**.
    
    ![Een Azure AD-testgebruiker maken](./media/kantegassoforbamboo-tutorial/create_aaduser_02.png) 

3. Openen van de **gebruiker** dialoogvenster, klikt u op **toevoegen** boven aan het dialoogvenster.
 
    ![Een Azure AD-testgebruiker maken](./media/kantegassoforbamboo-tutorial/create_aaduser_03.png) 

4. Op de **gebruiker** dialoogvenster pagina, voert u de volgende stappen uit:
 
    ![Een Azure AD-testgebruiker maken](./media/kantegassoforbamboo-tutorial/create_aaduser_04.png) 
...
1. Meld u aan bij uw lokale Bamboe server als beheerder.
