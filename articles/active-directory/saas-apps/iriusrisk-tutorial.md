...
3. **[Maak een testgebruiker IriusRisk](#create-a-iriusrisk-test-user)**  : als u wilt een equivalent van Britta Simon in IriusRisk die is gekoppeld aan de Azure AD-weergave van de gebruiker hebben.
...
3. Op de **IriusRisk domein en URL's** sectie, voert u de volgende stappen uit:
...
6. Het configureren van eenmalige aanmelding op **IriusRisk** zijde, moet u voor het verzenden van de gedownloade **Metadata XML** naar [IriusRisk ondersteuningsteam](mailto:info@continuumsecurity.net). Ze stelt u deze optie om de SAML SSO-verbinding instellen goed aan beide zijden.
