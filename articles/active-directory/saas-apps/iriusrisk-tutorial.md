...
2. Op de **eenmalige aanmelding** dialoogvenster Selecteer **modus** als **op basis van SAML aanmelding** voor eenmalige aanmelding inschakelen.
    ...
    ![Dialoogvenster voor eenmalige aanmelding](./media/iriusrisk-tutorial/tutorial_iriusrisk_samlbase.png)

3. Op de **IriusRisk domein en de URL's** sectie, voert u de volgende stappen uit:

    ![URL's en IriusRisk domein eenmalige aanmelding informatie](./media/iriusrisk-tutorial/tutorial_iriusrisk_url.png)
...
5. Klik op **opslaan** knop.
    ...
    ![Knop Single Sign-On opslaan configureren](./media/iriusrisk-tutorial/tutorial_general_400.png)
