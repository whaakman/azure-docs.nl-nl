...
2. Op de **eenmalige aanmelding** dialoogvenster Selecteer **modus** als **op basis van SAML aanmelding** voor eenmalige aanmelding inschakelen.
    ...
    ![Dialoogvenster voor eenmalige aanmelding](./media/bamboo-tutorial/tutorial_bamboo_samlbase.png)
...
3. Op de **SAML SSO voor Bamboe door resolutie GmbH domein en URL's** sectie, voert u de volgende stappen uit als u wilt configureren van de toepassing in de IDP geïnitieerd modus:
    ...
    ![SAML SSO voor Bamboe door resolutie GmbH domein en één URL's aanmelding informatie](./media/bamboo-tutorial/tutorial_bamboo_url.png)
...
4. Controleer **weergeven geavanceerde instellingen voor URL** en voer de volgende stap als u wilt configureren van de toepassing in **SP** modus gestart:
    ...
    ![SAML SSO voor Bamboe door resolutie GmbH domein en één URL's aanmelding informatie](./media/bamboo-tutorial/tutorial_bamboo_url1.png)
...
6. Klik op **opslaan** knop.
    ...
    ![Knop Single Sign-On opslaan configureren](./media/bamboo-tutorial/tutorial_general_400.png)
