...
3. **[Maak een testgebruiker MobileIron](#create-a-mobileiron-test-user)**  : als u wilt een equivalent van Britta Simon in MobileIron die is gekoppeld aan de Azure AD-weergave van de gebruiker hebben.
...
3. Op de **MobileIron domein en URL's** sectie, voert u de volgende stappen uit als u wilt configureren van de toepassing in **IDP** modus gestart:
...
7. In een ander browservenster aanmelden bij uw bedrijf MobileIron site als beheerder.
...
9. Kopieer de waarden van **sleutel** en **Host** en plak ze voor het voltooien van de URL's in de **MobileIron domein en URL's** sectie in Azure portal.

    ![Knop van de beheerder voor eenmalige aanmelding configureren](./media/mobileiron-tutorial/key.png)

10. In de **metagegevensbestand exporteren uit AAD en importeer MobileIron Cloud veld** klikt u op **bestand kiezen** voor het uploaden van de metagegevens van de gedownloade vanuit Azure portal. Klik op **gedaan** eenmaal geüploade.
...
2. Ga naar **gebruikers** en klikt u op **toevoegen** > **één gebruiker**.
