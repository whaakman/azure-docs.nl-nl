...
3. Op de **Aravo domein en URL's** sectie, voert u de volgende stappen uit:
    ...
    b. In het tekstvak **Antwoord-URL** typt u een URL met behulp van het volgende patroon: `https://<companyname>.aravo.com/aems/login.do`

    > [!NOTE] 
    > Dit zijn geen echte waarden. Werk deze waarden bij met de werkelijke id en antwoord-URL. Neem contact op met [Aravo ondersteuningsteam](https://www.aravo.com/about-us/contact/) om deze waarden te verkrijgen.
