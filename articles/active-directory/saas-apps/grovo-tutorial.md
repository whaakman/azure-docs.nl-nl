...
2. Op de **eenmalige aanmelding** dialoogvenster Selecteer **modus** als **op basis van SAML aanmelding** voor eenmalige aanmelding inschakelen.
    ...
    ![Dialoogvenster voor eenmalige aanmelding](./media/grovo-tutorial/tutorial_grovo_samlbase.png)
...
3. Op de **Grovo domein en de URL's** sectie, voert u de volgende stappen uit als u wilt configureren, de toepassing in **IDP** modus gestart:
    ...
    ![URL's en Grovo domein eenmalige aanmelding informatie](./media/grovo-tutorial/tutorial_grovo_url.png)
...
4. Controleer **weergeven geavanceerde instellingen voor URL**, voer de volgende stap:
    ...
    ![URL's en Grovo domein eenmalige aanmelding informatie](./media/grovo-tutorial/tutorial_grovo_url1.png)
    ...
    ![URL's en Grovo domein eenmalige aanmelding informatie](./media/grovo-tutorial/tutorial_grovo_url2.png)
...
6. In de **gebruikerskenmerken** sectie op de **eenmalige aanmelding** dialoogvenster SAML-token kenmerk configureren zoals wordt weergegeven in de afbeelding en de volgende stappen uitvoeren:
    ...
    ![Eenmalige aanmelding configureren toevoegen](./media/grovo-tutorial/tutorial_attribute_04.png)

    ![Eenmalige aanmelding Addattb configureren](./media/grovo-tutorial/tutorial_attribute_05.png)
...
8. Klik op **opslaan** knop.
    ...
    ![Knop Single Sign-On opslaan configureren](./media/grovo-tutorial/tutorial_general_400.png)
