...
1. Op de **Tidemark domein en URL's** sectie, voert u de volgende stappen uit:
    ...
    > [!NOTE] 
    > Dit zijn geen echte waarden. Werk deze waarden bij met de daadwerkelijke aanmeldings-URL en id. Neem contact op met [Tidemark Client ondersteuningsteam](http://www.tidemark.com/contact-us) om deze waarden te verkrijgen. 
