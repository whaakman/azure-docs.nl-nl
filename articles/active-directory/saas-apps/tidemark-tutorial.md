...
3. **[Het maken van een testgebruiker Tidemark](#creating-a-tidemark-test-user)**  : als u wilt een equivalent van Britta Simon in Tidemark die is gekoppeld aan de Azure AD-weergave van de gebruiker hebben.
...
3. Op de **Tidemark domein en URL's** sectie, voert u de volgende stappen uit:
...
6. Op de **Tidemark configuratie** sectie, klikt u op **configureren Tidemark** openen **aanmelding configureren** venster. Kopiëren de **afmelding-URL, SAML-entiteit-ID en Single Sign-On Service URL voor SAML-** uit de **Naslaggids sectie.**
