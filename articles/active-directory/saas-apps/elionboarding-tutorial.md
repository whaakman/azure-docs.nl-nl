...
1. Typ in het zoekvak **Eli Onboarding**, selecteer **Eli Onboarding** van resultaat deelvenster klik vervolgens op **toevoegen** om toe te voegen van de toepassing.
...
1. **[Maak een testgebruiker Eli Onboarding](#create-an-eli-onboarding-test-user)**  : als u wilt een equivalent van Britta Simon in Eli Onboarding die is gekoppeld aan de Azure AD-weergave van de gebruiker hebben.
...
1. Op de **Eli Onboarding domein en URL's** sectie, voert u de volgende stappen uit:
...
1. Het configureren van eenmalige aanmelding op **Eli Onboarding** zijde, moet u voor het verzenden van de gedownloade **Metadata XML** naar [Eli Onboarding-ondersteuningsteam](mailto:support@geteli.com). Ze stelt u deze optie om de SAML SSO-verbinding instellen goed aan beide zijden.
...
1. Selecteer in de lijst met toepassingen, **Eli Onboarding**.
