...
1. Op de **BGS Online domein en URL's** sectie, voert u de volgende stappen uit:
    ...
    > [!NOTE] 
    > Deze waarden zijn niet echt. Werk deze waarden met de werkelijke id en de antwoord-URL. Neem contact op met [BGS Online ondersteuningsteam](mailTo:bgsdashboardteam@millwardbrown.com) om deze waarden te verkrijgen.
