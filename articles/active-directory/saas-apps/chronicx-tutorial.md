...
3. **[Maak een testgebruiker ChronicX®](#create-a-chronicx®-test-user)**  : als u wilt een equivalent van Britta Simon in ChronicX® die is gekoppeld aan de Azure AD-weergave van de gebruiker hebben.
...
6. Het configureren van eenmalige aanmelding op **ChronicX®** zijde, moet u voor het verzenden van de gedownloade **Metadata XML** naar [ChronicX® ondersteuningsteam](https://www.casebank.com/contact-us/). Ze stelt u deze optie om de SAML SSO-verbinding instellen goed aan beide zijden.
