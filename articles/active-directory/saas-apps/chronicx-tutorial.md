...
2. Op de **eenmalige aanmelding** dialoogvenster Selecteer **modus** als **op basis van SAML aanmelding** voor eenmalige aanmelding inschakelen.
    ...
    ![Dialoogvenster voor eenmalige aanmelding](./media/chronicx-tutorial/tutorial_chronicx_samlbase.png)

3. Op de **ChronicX®-domein en URL's** sectie, voert u de volgende stappen uit:

    ![ChronicX®-domein en URL's van eenmalige aanmelding informatie](./media/chronicx-tutorial/tutorial_chronicx_url.png)
...
5. Klik op **opslaan** knop.
    ...
    ![Knop Single Sign-On opslaan configureren](./media/chronicx-tutorial/tutorial_general_400.png)
