...
3. **[Maak een testgebruiker Bersin](#create-a-bersin-test-user)**  : als u wilt een equivalent van Britta Simon in Bersin die is gekoppeld aan de Azure AD-weergave van de gebruiker hebben.
...
3. Op de **Bersin domein en URL's** sectie, voert u de volgende stappen uit als u wilt configureren van de toepassing in **IDP** modus gestart:
...
4. Als u wilt configureren van de toepassing in **SP** gestart modus, de volgende stap uitvoeren:
    ...
    In de **aanmeldings-URL** tekstvak, een URL typen: `https://www.bersin.com/Login.aspx`
...
6. Klik op **opslaan** knop.
    ...
    ![Configureren van eenmalige aanmelding opslaan](./media/bersin-tutorial/tutorial_general_400.png)
    
7. Het configureren van eenmalige aanmelding op **Bersin** zijde, moet u voor het verzenden van de gedownloade **Metadata XML** naar [Bersin ondersteuningsteam](mailto:USBersinServiceClient@deloitte.com). Ze stelt u deze optie om de SAML SSO-verbinding instellen goed aan beide zijden.
...
In deze sectie maakt u een gebruiker met de naam van Britta Simon in Bersin. Werken met de [Bersin ondersteuningsteam](mailto:USBersinServiceClient@deloitte.com) om toe te voegen de gebruikers in het platform Bersin of het domein dat nodig is om te worden opgenomen in de whitelist in het Bersin-platform. Als het domein is toegevoegd door het team, krijgen automatisch gebruikers ingericht voor het Bersin-platform. Gebruikers moeten worden gemaakt en worden geactiveerd voordat u eenmalige aanmelding gebruiken.
