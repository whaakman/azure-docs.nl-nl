...
2. Op de **eenmalige aanmelding** dialoogvenster Selecteer **modus** als **op basis van SAML aanmelding** voor eenmalige aanmelding inschakelen.
    ...
    ![Dialoogvenster voor eenmalige aanmelding](./media/bersin-tutorial/tutorial_bersin_samlbase.png)
...
3. Op de **Bersin domein en de URL's** sectie, voert u de volgende stappen uit als u wilt configureren, de toepassing in **IDP** modus gestart:
    ...
    ![URL's en Bersin domein eenmalige aanmelding informatie](./media/bersin-tutorial/tutorial_bersin_url.png)
...
4. Als u wilt configureren van de toepassing in **SP** geïnitieerd modus, voer de volgende stap:
    ...
    ![URL's en Bersin domein eenmalige aanmelding informatie](./media/bersin-tutorial/tutorial_bersin_url1.png)
...
6. Klik op **opslaan** knop.
    ...
    ![Knop Single Sign-On opslaan configureren](./media/bersin-tutorial/tutorial_general_400.png)
