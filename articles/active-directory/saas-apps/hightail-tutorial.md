...
1. Hightail toepassing verwacht het SAML-asserties ondertekend in een specifieke indeling. Configureer de volgende claims voor deze toepassing. U kunt de waarden van deze kenmerken vanuit beheren de **'Kenmerk'** tabblad van de toepassing. In de volgende schermopname ziet u een voorbeeld hiervan. 
