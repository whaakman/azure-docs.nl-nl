...
6. Om in te schakelen JIT wordt ingericht, wordt uw toepassing iLMS de SAML-asserties ondertekend verwacht in een specifieke indeling, waarvoor u aangepaste kenmerktoewijzingen toevoegen aan de configuratie van de SAML-token kenmerken. In de volgende schermafbeelding wordt de lijst met standaardkenmerken weergegeven. Klik op **bewerken** pictogram om gebruikerskenmerken dialoogvenster te openen.
