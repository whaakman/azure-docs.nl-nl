...
1. Domo uit de galerie toevoegen
2. Configureren en testen van Azure AD eenmalige aanmelding

## <a name="adding-domo-from-the-gallery"></a>Domo uit de galerie toevoegen
Voor het configureren van de integratie van Domo in Azure AD, moet u Domo uit de galerie toevoegen aan de lijst met beheerde SaaS-apps.
...
4. Typ in het zoekvak **Domo**.
    ...
    ![Een Azure AD-testgebruiker maken](./media/domo-tutorial/tutorial_domo_search.png)

5. Selecteer in het deelvenster resultaten **Domo**, en klik vervolgens op **toevoegen** om toe te voegen van de toepassing.

    ![Een Azure AD-testgebruiker maken](./media/domo-tutorial/tutorial_domo_addfromgallery.png)
...
Voor eenmalige aanmelding werkt, moet Azure AD weten wat de gebruiker equivalent in Domo is voor een gebruiker in Azure AD. Met andere woorden, moet een koppeling relatie tussen een Azure AD-gebruiker en de betreffende gebruiker in Domo tot stand worden gebracht.

Wijs in Domo, de waarde van de **gebruikersnaam** in Azure AD als de waarde van de **gebruikersnaam** de relatie van de koppeling tot stand brengen.
...
3. **[Maken van een testgebruiker Domo](#creating-a-domo-test-user)**  - Domo die is gekoppeld aan de Azure AD-weergave van de gebruiker van een exemplaar van Britta Simon bevatten.
4. **[Toewijzen van de Azure AD-testgebruiker](#assigning-the-azure-ad-test-user)**  - Britta Simon gebruik van Azure AD eenmalige aanmelding inschakelen.
5. **[Testen van eenmalige aanmelding](#testing-single-sign-on)**  : om te controleren of de configuratie werkt.

### <a name="configuring-azure-ad-single-sign-on"></a>Eenmalige aanmelding Azure AD configureren

In dit gedeelte Azure AD eenmalige aanmelding inschakelen in de Azure portal en eenmalige aanmelding in uw toepassing Domo configureren.

**Voor het configureren van Azure AD eenmalige aanmelding met Domo, moet u de volgende stappen uitvoeren:**

1. In de Azure-portal op de **Domo** toepassing Integratiepagina, klikt u op **eenmalige aanmelding**.
...
3. Op de **Domo domein en de URL's** sectie, voert u de volgende stappen uit:

    ![Eenmalige aanmelding configureren](./media/domo-tutorial/tutorial_domo_url.png)

    a. In de **aanmeldings-URL** textbox, typ een URL met het volgende patroon volgen: `https://<companyname>.domo.com`
    ...
    > [!NOTE] 
    > Deze waarden zijn niet echt. Deze waarden bijwerken met het werkelijke aanmeldings-URL en de id. Neem contact op met [Domo Client ondersteuningsteam](mailto:support@domo.com) ophalen van deze waarden.

4. De SAML-asserties verwacht Domo toepassing in een specifieke indeling. Configureer de volgende claims voor deze toepassing. U kunt beheren de waarden van deze kenmerken van de '**gebruikerskenmerken**' sectie op de pagina van de toepassing-integratie. De volgende Schermafbeelding toont een voorbeeld voor deze configuratie. 
...
8. Op de **Domo configuratie** sectie, klikt u op **configureren Domo** openen **eenmalige aanmelding configureren** venster. Kopieer de **Sign-Out-URL, SAML entiteit-ID en SAML Single Sign-On Service-URL** van de **Naslaggids punt.**   

   ![Eenmalige aanmelding configureren](./media/domo-tutorial/tutorial_domo_configure.png) 

9. Eenmalige aanmelding configureren op **Domo** zijde, navigeer naar de Domo Knowledge Base-artikel gevonden [hier](http://knowledge.domo.com?cid=azuread), en volg de instructies.
...
1. In de **Azure-portal**, klik op het navigatiedeelvenster links **Azure Active Directory** pictogram.
    ...
    ![Een Azure AD-testgebruiker maken](./media/domo-tutorial/create_aaduser_01.png) 

2. Als u wilt weergeven in de lijst met gebruikers, gaat u naar **gebruikers en groepen** en klik op **alle gebruikers**.
    
    ![Een Azure AD-testgebruiker maken](./media/domo-tutorial/create_aaduser_02.png) 

3. Openen van de **gebruiker** dialoogvenster, klikt u op **toevoegen** boven aan het dialoogvenster.
 
    ![Een Azure AD-testgebruiker maken](./media/domo-tutorial/create_aaduser_03.png) 

4. Op de **gebruiker** dialoogvenster pagina, voert u de volgende stappen uit:
 
    ![Een Azure AD-testgebruiker maken](./media/domo-tutorial/create_aaduser_04.png) 
...
Het doel van deze sectie is het maken van een gebruiker Britta Simon in Domo genoemd. Domo ondersteunt just-in-time-inrichting, dit is standaard ingeschakeld.
...
In deze sectie schakelt u Britta Simon gebruikt Azure eenmalige aanmelding toegang verlenen aan Domo.

![Gebruiker toewijzen][200] 

**Britta Simon om aan te wijzen Domo, moet u de volgende stappen uitvoeren:**
...
Als u op de tegel Domo in het deelvenster toegang, u moet ophalen automatisch aangemeld bij uw toepassing Domo.
