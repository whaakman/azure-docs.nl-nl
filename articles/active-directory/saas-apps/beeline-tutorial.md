...
1. Op de **BeeLine domein en URL's** sectie, voert u de volgende stappen uit:
    ...
    a. In de **id** tekstvak, een URL met behulp van het volgende patroon: `https://projects.beeline.net/<instancename>`
    ...
    > [!NOTE] 
    > Deze waarden zijn niet echt. Werk deze waarden met de werkelijke id en de antwoord-URL. Neem contact op met [BeeLine ondersteuningsteam](https://www.beeline.com/contact-us/) om deze waarden te verkrijgen.
 
1. Op de **SAML-handtekeningcertificaat** sectie, klikt u op **Metadata XML** en sla het bestand met metagegevens op uw computer.

    ![Eenmalige aanmelding configureren](./media/beeline-tutorial/tutorial_beeline_certificate.png) 

1. Uw toepassing Beeline wordt verwacht dat de SAML-asserties ondertekend in een specifieke indeling. Neem contact op met [BeeLine ondersteuningsteam](https://www.beeline.com/contact-us/) eerst om te identificeren van de juiste gebruikers-id die in de toepassing worden toegewezen. Neem even ook de richtlijnen van [BeeLine ondersteuningsteam](https://www.beeline.com/contact-us/) over het kenmerk dat moet worden gebruikt voor deze toewijzing. U kunt de waarde van dit kenmerk van beheren de **gebruikerskenmerken** tabblad van de toepassing. De volgende Schermafbeelding toont een voorbeeld voor deze. We hebben hier toegewezen de **gebruikers-id** claim met de **userprincipalname** kenmerk, waarmee u unieke gebruikers-ID, die wordt verzonden naar de toepassing Beeline in het elke geslaagde SAML-antwoord.
