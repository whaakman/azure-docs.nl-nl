...
2. Op de **eenmalige aanmelding** dialoogvenster Selecteer **modus** als **op basis van SAML aanmelding** voor eenmalige aanmelding inschakelen.
    ...
    ![Dialoogvenster voor eenmalige aanmelding](./media/clever-tutorial/tutorial_clever_samlbase.png)

3. Op de **slimme domein en de URL's** sectie, voert u de volgende stappen uit:

    ![Slimme domein en de URL's van eenmalige aanmelding informatie](./media/clever-tutorial/tutorial_clever_url.png)
...
7. Klik op **opslaan** knop.
    ...
    ![Knop Single Sign-On opslaan configureren](./media/clever-tutorial/tutorial_general_400.png)
