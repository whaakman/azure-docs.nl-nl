...
3. **[Maken van een N2F - onkostennota testgebruiker](#create-a-n2f---expense-reports-test-use) ** - dat een equivalent van Britta Simon in N2F - onkostennota's dat is gekoppeld aan de Azure AD-weergave van de gebruiker.
...
5. Op de **SAML-handtekeningcertificaat** sectie, klikt u op de knop kopiëren om te kopiëren **App-Url voor federatieve metagegevens** en plak deze in Kladblok.
    ...
    ![De downloadkoppeling certificaat](./media/n2f-expensereports-tutorial/tutorial_n2f-expensereports_certificate.png)

6. Klik op **opslaan** knop.

    ![Configureren van eenmalige aanmelding opslaan](./media/n2f-expensereports-tutorial/tutorial_general_400.png)
