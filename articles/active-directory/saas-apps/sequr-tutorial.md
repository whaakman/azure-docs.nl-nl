...
3. **[Maak een testgebruiker Sequr](#create-a-sequr-test-user)**  : als u wilt een equivalent van Britta Simon in Sequr die is gekoppeld aan de Azure AD-weergave van de gebruiker hebben.
...
3. Op de **Sequr domein en URL's** sectie, voert u de volgende stappen uit als u wilt configureren van de toepassing in **IDP** modus gestart:
...
7. Op de **Sequr configuratie** sectie, klikt u op **configureren Sequr** openen **aanmelding configureren** venster. Kopiëren de **Single Sign-On Service URL voor SAML** uit de **Naslaggids sectie.**

    ![Sequr configuratie](./media/sequr-tutorial/tutorial_sequr_configure.png)

8. In een ander browservenster aanmelden bij uw bedrijf Sequr site als beheerder.

9. Klik op de **integraties** in het linkernavigatievenster.

    ![Sequr configuratie](./media/sequr-tutorial/configure1.png)

10. Schuif omlaag naar de **Single Sign-On** sectie en klikt u op **beheren**.
