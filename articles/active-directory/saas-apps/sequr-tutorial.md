...
2. Op de **eenmalige aanmelding** dialoogvenster Selecteer **modus** als **op basis van SAML aanmelding** voor eenmalige aanmelding inschakelen.
    ...
    ![Dialoogvenster voor eenmalige aanmelding](./media/sequr-tutorial/tutorial_sequr_samlbase.png)
...
3. Op de **Sequr domein en de URL's** sectie, voert u de volgende stappen uit als u wilt configureren, de toepassing in **IDP** modus gestart:
    ...
    ![URL's en Sequr domein eenmalige aanmelding informatie](./media/sequr-tutorial/tutorial_sequr_url.png)

    In de **id** textbox, typ de URL: `https://login.sequr.io`

4. Controleer **weergeven geavanceerde instellingen voor URL** en voer de volgende stap als u wilt configureren van de toepassing in **SP** modus gestart:

    ![URL's en Sequr domein eenmalige aanmelding informatie](./media/sequr-tutorial/tutorial_sequr_url1.png)
...
6. Klik op **opslaan** knop.
    ...
    ![Knop Single Sign-On opslaan configureren](./media/sequr-tutorial/tutorial_general_400.png)
