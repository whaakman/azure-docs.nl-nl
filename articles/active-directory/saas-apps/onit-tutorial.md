...
2. Op de **eenmalige aanmelding** dialoogvenster Selecteer **modus** als **op basis van SAML aanmelding** voor eenmalige aanmelding inschakelen.
    ...
    ![Dialoogvenster voor eenmalige aanmelding](./media/onit-tutorial/tutorial_onit_samlbase.png)

3. Op de **Onit domein en de URL's** sectie, voert u de volgende stappen uit:

    ![URL's en Onit domein eenmalige aanmelding informatie](./media/onit-tutorial/tutorial_onit_url.png)
...
7. Klik op **opslaan** knop.
    ...
    ![Knop Single Sign-On opslaan configureren](./media/onit-tutorial/tutorial_general_400.png)
