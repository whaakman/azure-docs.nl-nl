...
3. **[Maak een testgebruiker Onit](#create-an-onit-test-user)**  : als u wilt een equivalent van Britta Simon in Onit die is gekoppeld aan de Azure AD-weergave van de gebruiker hebben.
...
3. Op de **Onit domein en URL's** sectie, voert u de volgende stappen uit:
...
5. Onit toepassing verwacht het SAML-asserties ondertekend in een specifieke indeling. Configureer de volgende claims voor deze toepassing. U kunt de waarden van deze kenmerken vanuit beheren de **"Atrribute"** tabblad van de toepassing. De volgende Schermafbeelding toont een voorbeeld voor deze. 
...
8. Op de **Onit configuratie** sectie, klikt u op **configureren Onit** openen **aanmelding configureren** venster. Kopiëren de **URL van de afmelding, Single Sign-On Service URL voor SAML-** uit de **Naslaggids sectie.**

    ![Onit configuratie](./media/onit-tutorial/tutorial_onit_configure.png)

9. Meld u in een ander browservenster in uw bedrijf Onit site als beheerder.
...
12. Klik op de **Security** tabblad.
    
    ![Gegevens bewerken bedrijf](./media/onit-tutorial/IC791176.png "bedrijfsgegevens bewerken")

13. Op de **Security** tabblad, voert u de volgende stappen uit:
