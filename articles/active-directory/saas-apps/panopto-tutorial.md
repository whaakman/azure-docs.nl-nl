...
3. **[Het maken van een testgebruiker Panopto](#creating-a-panopto-test-user)**  : als u wilt een equivalent van Britta Simon in Panopto die is gekoppeld aan de Azure AD-weergave van de gebruiker hebben.
...
3. Op de **Panopto domein en URL's** sectie, voert u de volgende stappen uit:

    ![Eenmalige aanmelding configureren](./media/panopto-tutorial/tutorial_panopto_url.png)

    In de **aanmeldings-URL** tekstvak, een URL met behulp van het volgende patroon: `https://<tenant-name>.panopto.com`

    > [!NOTE] 
    > Deze waarde is niet echt. Deze waarde bijwerken met de werkelijke aanmeldings-URL. Neem contact op met [Panopto Client ondersteuningsteam](mailto:support@panopto.com‎) deze waarde op te halen. 
...
6. Op de **Panopto configuratie** sectie, klikt u op **configureren Panopto** openen **aanmelding configureren** venster. Kopiëren de **SAML entiteit-ID en Single Sign-On Service URL voor SAML-** uit de **Naslaggids sectie.**

    ![Eenmalige aanmelding configureren](./media/panopto-tutorial/tutorial_panopto_configure.png) 

7. In een ander browservenster aanmelden bij uw bedrijf Panopto site als beheerder.

8. Klik in de werkbalk aan de linkerkant op **System**, en klik vervolgens op **id-Providers**.
...
10. In de sectie voor SAML-provider, moet u de volgende stappen uitvoeren:
