...
3. Op de **Salesforce sandbox-domein en URL's** sectie, voert u de volgende stappen uit:
...
12. In het gedeelte SAML Single Sign-On-instellingen op de volgende stappen uitvoeren:
...
2. In de **verificatieconfiguratie** sectie, klikt u op **bewerken**, naarmate **verificatieservice**, selecteer de naam van de SAML Single Sign-On-instelling in de vorige uit en klik tot slot **opslaan**.
