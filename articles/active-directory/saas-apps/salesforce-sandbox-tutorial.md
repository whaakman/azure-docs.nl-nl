...
2. Op de **eenmalige aanmelding** dialoogvenster Selecteer **modus** als **op basis van SAML aanmelding** voor eenmalige aanmelding inschakelen.
    ...
    ![Dialoogvenster voor eenmalige aanmelding](./media/salesforce-sandbox-tutorial/tutorial_salesforcesandbox_samlbase.png)

3. Op de **Salesforce sandbox-domein en de URL's** sectie, voert u de volgende stappen uit:

    ![SalesForce sandbox-domein en de URL's van eenmalige aanmelding informatie](./media/salesforce-sandbox-tutorial/tutorial_salesforcesandbox_url.png)
...
5. Klik op **opslaan** knop.
    ...
    ![Knop Single Sign-On opslaan configureren](./media/salesforce-sandbox-tutorial/tutorial_general_400.png)
