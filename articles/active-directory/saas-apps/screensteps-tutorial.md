...
2. Op de **eenmalige aanmelding** dialoogvenster Selecteer **modus** als **op basis van SAML aanmelding** voor eenmalige aanmelding inschakelen.
    ...
    ![Dialoogvenster voor eenmalige aanmelding](./media/screensteps-tutorial/tutorial_screensteps_samlbase.png)

3. Op de **ScreenSteps domein en de URL's** sectie, voert u de volgende stappen uit:

    ![URL's en ScreenSteps domein eenmalige aanmelding informatie](./media/screensteps-tutorial/tutorial_screensteps_url.png)
...
5. Klik op **opslaan** knop.
    ...
    ![Knop Single Sign-On opslaan configureren](./media/screensteps-tutorial/tutorial_general_400.png)
...
11. In de **maken één aanmelding eindpunt** sectie, voert u de volgende stappen uit:
    ...
    ![Maak een verificatie-eindpunt](./media/screensteps-tutorial/ic778526.png "een verificatie-eindpunt maken")
