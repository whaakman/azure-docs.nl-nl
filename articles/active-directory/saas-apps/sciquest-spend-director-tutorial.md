...
4. Typ in het zoekvak **SciQuest besteden directeur**, selecteer **SciQuest besteden directeur** van resultaat deelvenster klik vervolgens op **toevoegen** om toe te voegen van de toepassing.
    ...
    ![SciQuest besteden directeur in de lijst met resultaten](./media/sciquest-spend-director-tutorial/tutorial_sciquestspenddirector_addfromgallery.png)
...
2. Op de **eenmalige aanmelding** dialoogvenster Selecteer **modus** als **op basis van SAML aanmelding** voor eenmalige aanmelding inschakelen.
    ...
    ![Dialoogvenster voor eenmalige aanmelding](./media/sciquest-spend-director-tutorial/tutorial_sciquestspenddirector_samlbase.png)

3. Op de **SciQuest besteden directeur domein en de URL's** sectie, voert u de volgende stappen uit:

    ![URL's en SciQuest besteden directeur domein één aanmelding informatie](./media/sciquest-spend-director-tutorial/tutorial_sciquestspenddirector_url.png)
...
5. Klik op **opslaan** knop.
    ...
    ![Knop Single Sign-On opslaan configureren](./media/sciquest-spend-director-tutorial/tutorial_general_400.png)
...
2. Selecteer in de lijst met toepassingen **SciQuest besteden directeur**.
    ...
    ![De koppeling SciQuest besteden directeur in de lijst met toepassingen](./media/sciquest-spend-director-tutorial/tutorial_sciquestspenddirector_app.png)  
