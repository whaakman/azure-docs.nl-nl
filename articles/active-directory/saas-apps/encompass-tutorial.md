...
3. **[Maak een testgebruiker Encompass](#create-a-encompass-test-user)**  : als u wilt een equivalent van Britta Simon in Encompass die is gekoppeld aan de Azure AD-weergave van de gebruiker hebben.
...
3. Op de **omvatten domein en URL's** sectie, voert u de volgende stappen uit:
...
6. Op de **omvatten configuratie** sectie, klikt u op **configureren omvatten** openen **aanmelding configureren** venster. Kopiëren de **afmelding-URL en Single Sign-On Service URL voor SAML-** uit de **Naslaggids sectie.**
