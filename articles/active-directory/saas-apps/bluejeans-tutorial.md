...
4. Typ in het zoekvak **BlueJeans**.
    ...
    ![Een Azure AD-testgebruiker maken](./media/bluejeans-tutorial/tutorial_bluejeans_search.png)

5. Selecteer in het deelvenster resultaten **BlueJeans**, en klik vervolgens op **toevoegen** om toe te voegen van de toepassing.

    ![Een Azure AD-testgebruiker maken](./media/bluejeans-tutorial/tutorial_bluejeans_addfromgallery.png)
...
9. In de **beveiliging** sectie, voert u de volgende stappen uit:
   ...
   ![SAML voor eenmalige aanmelding](./media/bluejeans-tutorial/IC785869.png "SAML voor eenmalige aanmelding")
...
1. In de **Azure-portal**, klik op het navigatiedeelvenster links **Azure Active Directory** pictogram.
    ...
    ![Een Azure AD-testgebruiker maken](./media/bluejeans-tutorial/create_aaduser_01.png)

2. Als u wilt weergeven in de lijst met gebruikers, gaat u naar **gebruikers en groepen** en klik op **alle gebruikers**.

    ![Een Azure AD-testgebruiker maken](./media/bluejeans-tutorial/create_aaduser_02.png)

3. Openen van de **gebruiker** dialoogvenster, klikt u op **toevoegen** boven aan het dialoogvenster.

    ![Een Azure AD-testgebruiker maken](./media/bluejeans-tutorial/create_aaduser_03.png)

4. Op de **gebruiker** dialoogvenster pagina, voert u de volgende stappen uit:

    ![Een Azure AD-testgebruiker maken](./media/bluejeans-tutorial/create_aaduser_04.png) 
...
Het doel van deze sectie is het maken van een gebruiker Britta Simon in BlueJeans genoemd. BlueJeans ondersteunt automatisch gebruikers inrichten, dit is standaard ingeschakeld. U vindt meer informatie [hier](bluejeans-provisioning-tutorial.md) over het configureren van automatische gebruikers inrichten.
...
* [Gebruikers inrichten configureren](bluejeans-provisioning-tutorial.md)
