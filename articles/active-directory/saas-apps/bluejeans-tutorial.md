...
1. Typ in het zoekvak **BlueJeans**.

    ![Het maken van een Azure AD-testgebruiker](./media/bluejeans-tutorial/tutorial_bluejeans_search.png)

1. Selecteer in het deelvenster resultaten **BlueJeans**, en klik vervolgens op **toevoegen** om toe te voegen van de toepassing.
...
1. **[Het maken van een testgebruiker BlueJeans](#creating-a-bluejeans-test-user)**  : als u wilt een equivalent van Britta Simon in BlueJeans die is gekoppeld aan de Azure AD-weergave van de gebruiker hebben.
...
1. Op de **BlueJeans domein en URL's** sectie, voert u de volgende stappen uit:
...
1. Op de **BlueJeans configuratie** sectie, klikt u op **configureren BlueJeans** openen **aanmelding configureren** venster. Kopiëren de **afmelding-URL, de URL van wijzigen wachtwoord en de Single Sign-On Service URL voor SAML-** uit de **Naslaggids sectie.**
...
1. Ga naar **ADMIN \> groepsinstellingen \> Security**.
...
1. Verdergaan met de volgende stappen uit:
...
1. Ga naar **ADMIN \> gebruikers beheren \> gebruiker toevoegen**.
...
1. Selecteer in de lijst met toepassingen, **BlueJeans**.
