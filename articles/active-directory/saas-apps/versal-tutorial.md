...
1. Op de **Vigatie domein en URL's** sectie, voert u de volgende stappen uit:
    ...
    b. In de **antwoord-URL** tekstvak, een URL met behulp van het volgende patroon: `https://versal.com/sso/saml/orgs/<organization_id>`
...
1. Klik op **opslaan** knop.
    ...
    ![Configureren van eenmalige aanmelding opslaan](./media/versal-tutorial/tutorial_general_400.png)
