...
4. Typ in het zoekvak **Jostle**.
    ...
    ![Een Azure AD-testgebruiker maken](./media/jostle-tutorial/tutorial_jostle_search.png)

5. Selecteer in het deelvenster resultaten **Jostle**, en klik vervolgens op **toevoegen** om toe te voegen van de toepassing.

    ![Een Azure AD-testgebruiker maken](./media/jostle-tutorial/tutorial_jostle_addfromgallery.png)
...
3. Op de **Jostle domein en de URL's** sectie, voert u de volgende stappen uit:
    ...
    ![Eenmalige aanmelding configureren](./media/jostle-tutorial/tutorial_jostle_url.png)
...
4. Op de **SAML-certificaat voor ondertekening van** sectie, klikt u op **Metadata XML** en sla het bestand met metagegevens op uw computer.
    ...
    ![Eenmalige aanmelding configureren](./media/jostle-tutorial/tutorial_jostle_certificate.png) 

5. Klik op **opslaan** knop.

    ![Eenmalige aanmelding configureren](./media/jostle-tutorial/tutorial_general_400.png)
...
1. In de **Azure-portal**, klik op het navigatiedeelvenster links **Azure Active Directory** pictogram.
    ...
    ![Een Azure AD-testgebruiker maken](./media/jostle-tutorial/create_aaduser_01.png) 

2. Als u wilt weergeven in de lijst met gebruikers, gaat u naar **gebruikers en groepen** en klik op **alle gebruikers**.
    
    ![Een Azure AD-testgebruiker maken](./media/jostle-tutorial/create_aaduser_02.png) 

3. Openen van de **gebruiker** dialoogvenster, klikt u op **toevoegen** boven aan het dialoogvenster.
 
    ![Een Azure AD-testgebruiker maken](./media/jostle-tutorial/create_aaduser_03.png) 

4. Op de **gebruiker** dialoogvenster pagina, voert u de volgende stappen uit:
 
    ![Een Azure AD-testgebruiker maken](./media/jostle-tutorial/create_aaduser_04.png) 
