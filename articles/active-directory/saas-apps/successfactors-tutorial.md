...
2. Op de **eenmalige aanmelding** dialoogvenster Selecteer **modus** als **op basis van SAML aanmelding** voor eenmalige aanmelding inschakelen.
    ...
    ![Dialoogvenster voor eenmalige aanmelding](./media/successfactors-tutorial/tutorial_successfactors_samlbase.png)

3. Op de **SuccessFactors domein en de URL's** sectie, voert u de volgende stappen uit:

    ![URL's en SuccessFactors domein eenmalige aanmelding informatie](./media/successfactors-tutorial/tutorial_successfactors_url.png)
...
5. Klik op **opslaan** knop.
    ...
    ![Knop Single Sign-On opslaan configureren](./media/successfactors-tutorial/tutorial_general_400.png)
...
10. Systeemeigen naar onderstaande schermafbeelding en de volgende acties uitvoeren:
    ...
    i. Kopieer de inhoud van het gedownloade certificaatbestand van Azure-portal en plakt u deze in de **SAML verifiëren certificaat** textbox.
