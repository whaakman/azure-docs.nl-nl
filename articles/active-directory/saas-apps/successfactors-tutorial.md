...
3. **[Maak een testgebruiker SuccessFactors](#create-a-successfactors-test-user)**  : als u wilt een equivalent van Britta Simon in SuccessFactors die is gekoppeld aan de Azure AD-weergave van de gebruiker hebben.
...
3. Op de **SuccessFactors domein en URL's** sectie, voert u de volgende stappen uit:
...
6. Op de **SuccessFactors configuratie** sectie, klikt u op **configureren SuccessFactors** openen **aanmelding configureren** venster. Kopiëren de **afmelding-URL, SAML-entiteit-ID en Single Sign-On Service URL voor SAML-** uit de **Naslaggids sectie.**
