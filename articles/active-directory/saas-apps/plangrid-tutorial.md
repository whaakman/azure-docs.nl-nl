...
2. Op de **eenmalige aanmelding** dialoogvenster Selecteer **modus** als **op basis van SAML aanmelding** voor eenmalige aanmelding inschakelen.
    ...
    ![Dialoogvenster voor eenmalige aanmelding](./media/plangrid-tutorial/tutorial_plangrid_samlbase.png)
...
3. Op de **PlanGrid domein en de URL's** sectie, voert u de volgende stappen uit als u wilt configureren, de toepassing in **IDP** modus gestart:
    ...
    ![URL's en PlanGrid domein eenmalige aanmelding informatie](./media/plangrid-tutorial/tutorial_plangrid_url1.png)

    In de **id (entiteit-ID)** textbox, typ de URL: `https://io.plangrid.com/sessions/saml/metadata`

4. Controleer **weergeven geavanceerde instellingen voor URL** en voer de volgende stap als u wilt configureren van de toepassing in **SP** modus gestart:

    ![URL's en PlanGrid domein eenmalige aanmelding informatie](./media/plangrid-tutorial/tutorial_plangrid_url2.png)
...
6. Klik op **opslaan** knop.
    ...
    ![Knop Single Sign-On opslaan configureren](./media/plangrid-tutorial/tutorial_general_400.png)
