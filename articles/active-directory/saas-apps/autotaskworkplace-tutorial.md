...
2. Op de **eenmalige aanmelding** dialoogvenster Selecteer **modus** als **op basis van SAML aanmelding** voor eenmalige aanmelding inschakelen.
    ...
    ![Dialoogvenster voor eenmalige aanmelding](./media/autotaskworkplace-tutorial/tutorial_autotaskworkplace_samlbase.png)
...
3. Als u wilt configureren van de toepassing in **IDP** geïnitieerd modus, voert u de volgende stappen uit op de **Autotask werkplek domein en de URL's** sectie:
    ...
    ![Autotask werkplek domein en URL's eenmalige aanmelding-informatie voor IDP](./media/autotaskworkplace-tutorial/tutorial_autotaskworkplace_url.png)
...
4. Als u wilt configureren van de toepassing in **SP** geïnitieerd modus selectievakje **weergeven geavanceerde instellingen voor URL** en voer de volgende stappen uit:
    ...
    ![Autotask werkplek domein en URL's eenmalige aanmelding-informatie voor SP](./media/autotaskworkplace-tutorial/tutorial_autotaskworkplace_url1.png)
...
6. Klik op **opslaan** knop.
    ...
    ![Knop Single Sign-On opslaan configureren](./media/autotaskworkplace-tutorial/tutorial_general_400.png)
