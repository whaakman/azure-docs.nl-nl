...
Als u eenmalige aanmelding wilt configureren op **Bynder** , moet u de gedownloade **META gegevensxml** en de juiste gekopieerde url's verzenden van Azure Portal naar Bynder ondersteunings [team](https://www.bynder.com/en/support/). Ze stelt u deze optie om de SAML SSO-verbinding instellen goed aan beide zijden.
