...
## <a name="adding-bynder-from-the-gallery"></a>Bynder uit de galerie toevoegen
...
In deze sectie configureert en test eenmalige aanmelding Azure AD met Bynder op basis van een testgebruiker 'Britta Simon' genoemd.

Voor eenmalige aanmelding werkt, moet Azure AD weten wat de gebruiker equivalent in Bynder is voor een gebruiker in Azure AD. Met andere woorden, moet een koppeling relatie tussen een Azure AD-gebruiker en de betreffende gebruiker in Bynder tot stand worden gebracht.

Wijs in Bynder, de waarde van de **gebruikersnaam** in Azure AD als de waarde van de **gebruikersnaam** de relatie van de koppeling tot stand brengen.
...
3. **[Maak een testgebruiker Bynder](#create-a-bynder-test-user)**  - Bynder die is gekoppeld aan de Azure AD-weergave van de gebruiker van een exemplaar van Britta Simon bevatten.
4. **[Toewijzen van de Azure AD-testgebruiker](#assign-the-azure-ad-test-user)**  - Britta Simon gebruik van Azure AD eenmalige aanmelding inschakelen.
5. **[Test eenmalige aanmelding](#test-single-sign-on)**  : om te controleren of de configuratie werkt.

### <a name="configure-azure-ad-single-sign-on"></a>Eenmalige aanmelding Azure AD configureren

In dit gedeelte Azure AD eenmalige aanmelding inschakelen in de Azure portal en eenmalige aanmelding in uw toepassing Bynder configureren.

**Voor het configureren van Azure AD eenmalige aanmelding met Bynder, moet u de volgende stappen uitvoeren:**

1. In de Azure-portal op de **Bynder** toepassing Integratiepagina, klikt u op **eenmalige aanmelding**.

    ![Koppeling voor eenmalige aanmelding configureren][4]

2. Op de **eenmalige aanmelding** dialoogvenster Selecteer **modus** als **op basis van SAML aanmelding** voor eenmalige aanmelding inschakelen.
 
    ![Dialoogvenster voor eenmalige aanmelding](./media/bynder-tutorial/tutorial_bynder_samlbase.png)

3. Op de **Bynder domein en de URL's** sectie, voert u de volgende stappen uit als u wilt configureren, de toepassing in **IDP** modus gestart:

    ![URL's en Bynder domein eenmalige aanmelding informatie](./media/bynder-tutorial/tutorial_bynder_url.png)
...
4. Controleer **weergeven geavanceerde instellingen voor URL** en voer de volgende stap als u wilt configureren van de toepassing in **SP** modus gestart:
    ...
    ![URL's en Bynder domein eenmalige aanmelding informatie](./media/bynder-tutorial/tutorial_bynder_url1.png)
...
6. Klik op **opslaan** knop.
    ...
    ![Knop Single Sign-On opslaan configureren](./media/bynder-tutorial/tutorial_general_400.png)

7. Eenmalige aanmelding configureren op **Bynder** zijde, moet u de gedownloade verzenden **Metadata XML** naar [Bynder ondersteuningsteam](https://www.bynder.com/en/support/). Ze deze instelling zodat de SAML SSO-verbinding juist is ingesteld op beide zijden ingesteld.
