...
3. **[Het maken van een testgebruiker Jobbadmin](#creating-a-jobbadmin-test-user)**  : als u wilt een equivalent van Britta Simon in Jobbadmin die is gekoppeld aan de Azure AD-weergave van de gebruiker hebben.
...
3. Op de **Jobbadmin domein en URL's** sectie, voert u de volgende stappen uit:
...
6. Het configureren van eenmalige aanmelding op **Jobbadmin** zijde, moet u voor het verzenden van de gedownloade **Metadata XML** naar [Jobbadmin ondersteuningsteam](https://www.jobbnorge.no/om-oss/kontakt-oss). Ze stelt u deze optie om de SAML SSO-verbinding instellen goed aan beide zijden.
