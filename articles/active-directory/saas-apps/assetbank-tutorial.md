...
1. Op de **Asset Bank domein en URL's** sectie, voert u de volgende stappen uit:
    ...
    a. In de **aanmeldings-URL** tekstvak, een URL met behulp van het volgende patroon: `https://<companyname>.assetbank-server.com`

    b. In de **id** tekstvak, een URL met behulp van het volgende patroon: `https://<companyname>.assetbank-server.com/shibboleth`

    > [!NOTE] 
    > Deze waarden zijn niet echt. Werk deze waarden met de werkelijke aanmeldings-URL en -id. Neem contact op met [Asset Bank Client ondersteuningsteam](mailto:support@assetbank.co.uk) om deze waarden te verkrijgen. 
