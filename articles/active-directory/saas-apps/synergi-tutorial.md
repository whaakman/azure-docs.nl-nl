...
3. **[Maak een testgebruiker Synergi](#create-a-synergi-test-user)**  : als u wilt een equivalent van Britta Simon in Synergi die is gekoppeld aan de Azure AD-weergave van de gebruiker hebben.
...
3. Op de **Synergi domein en URL's** sectie, voert u de volgende stappen uit:

    ![Synergi domein en URL's, eenmalige aanmelding informatie](./media/synergi-tutorial/tutorial_synergi_url.png)

    a. In de **id** tekstvak, een URL met behulp van het volgende patroon: `https://<company name>.irmsecurity.com`

    b. In de **antwoord-URL** tekstvak, een URL met behulp van het volgende patroon: `https://<company name>.irmsecurity.com/sso/<organization id>`

    > [!NOTE] 
    > Deze waarden zijn niet echt. Werk deze waarden met de werkelijke id en de antwoord-URL. Neem contact op met [Synergi ondersteuningsteam](https://www.irmsecurity.com/contact/) om deze waarden te verkrijgen.
...
4. Op de **SAML-handtekeningcertificaat** sectie, klikt u op **Certificate(Base64)** en slaat u het certificaatbestand op uw computer.
    ...
    ![De downloadkoppeling certificaat](./media/synergi-tutorial/tutorial_synergi_certificate.png) 

5. Klik op **opslaan** knop.

    ![Configureren van eenmalige aanmelding opslaan](./media/synergi-tutorial/tutorial_general_400.png)

6. Op de **Synergi configuratie** sectie, klikt u op **configureren Synergi** openen **aanmelding configureren** venster. Kopiëren de **afmelding URL en SAML entiteit-ID** uit de **Naslaggids sectie.**

    ![Synergi configuratie](./media/synergi-tutorial/tutorial_synergi_configure.png) 

7. Het configureren van eenmalige aanmelding op **Synergi** zijde, moet u voor het verzenden van de gedownloade **Certificate(Base64), afmelding URL en SAML entiteit-ID** naar [Synergi ondersteuningsteam](https://www.irmsecurity.com/contact/).
...
In deze sectie maakt u een gebruiker met de naam van Britta Simon in Synergi. Werken met [Synergi ondersteuningsteam](https://www.irmsecurity.com/contact/) om toe te voegen de gebruikers in het Synergi-platform. Gebruikers moeten worden gemaakt en worden geactiveerd voordat u eenmalige aanmelding gebruiken.
