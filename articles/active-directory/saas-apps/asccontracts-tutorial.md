...
3. **[Het maken van een testgebruiker ASC contracten](#creating-an-asc-contracts-test-user)**  : als u wilt een equivalent van Britta Simon in ASC-opdrachten die is gekoppeld aan de Azure AD-weergave van de gebruiker hebben.
...
3. Op de **ASC contracten domein en URL's** sectie, voert u de volgende stappen uit:
...
6. Het configureren van eenmalige aanmelding op **ASC contracten** zijde, contact opnemen met ondersteuning van ASC netwerken Inc. (ASC) op **613.599.6178** en geef ze de gedownloade **Metadata XML**. Ze instellen hebben de SAML SSO-verbinding juist ingesteld voor beide zijden van deze toepassing.
