...
1. Op de **ASC contracten domein en URL's** sectie, voert u de volgende stappen uit:
    ...
    b. In het tekstvak **Antwoord-URL** typt u een URL met behulp van het volgende patroon: `https://<subdomain>.asccontracts.com/shibboleth.sso/login`

    > [!NOTE] 
    > Dit zijn geen echte waarden. Werk deze waarden bij met de werkelijke id en antwoord-URL. Neem contact op met ASC netwerken Inc. (ASC)-team via **613.599.6178** om deze waarden te verkrijgen.
...
1. Het configureren van eenmalige aanmelding op **ASC contracten** zijde, aanroepen van ASC netwerken Inc. (ASC) ondersteuning op **613.599.6178** en geef ze de gedownloade **Metadata XML**. Ze instellen hebben de SAML SSO-verbinding juist ingesteld voor beide zijden van deze toepassing.
...
Werken met ASC netwerken Inc. Het ondersteuningsteam (ASC) op **613.599.6178** zodat gebruikers toegevoegd aan de ASC-contracten-platform.
