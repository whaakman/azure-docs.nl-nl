...
3. **[Maak een testgebruiker KnowledgeOwl](#create-a-knowledgeowl-test-user)**  : als u wilt een equivalent van Britta Simon in KnowledgeOwl die is gekoppeld aan de Azure AD-weergave van de gebruiker hebben.
...
3. Op de **KnowledgeOwl domein en URL's** sectie, voert u de volgende stappen uit als u wilt configureren van de toepassing in **IDP** modus gestart:
...
9. Op de **KnowledgeOwl configuratie** sectie, klikt u op **configureren KnowledgeOwl** openen **aanmelding configureren** venster. Kopiëren de **afmelding-URL, SAML-entiteit-ID en Single Sign-On Service URL voor SAML-** uit de **Naslaggids sectie.**

    ![KnowledgeOwl configuratie](./media/knowledgeowl-tutorial/tutorial_knowledgeowl_configure.png)

10. Meld u in een ander browservenster in uw bedrijf KnowledgeOwl site als beheerder.

11. Klik op **instellingen** en selecteer vervolgens **Security**.

    ![KnowledgeOwl configuratie](./media/knowledgeowl-tutorial/configure1.png)

12. Schuif omlaag in maximaal de **SAML SSO-integratie** en voer de volgende stappen uit:
