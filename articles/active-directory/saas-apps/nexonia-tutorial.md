...
3. **[Maak een testgebruiker Nexonia](#create-a-nexonia-test-user)**  : als u wilt een equivalent van Britta Simon in Nexonia die is gekoppeld aan de Azure AD-weergave van de gebruiker hebben.
...
3. Op de **Nexonia domein en URL's** sectie, voert u de volgende stappen uit:
...
6. Op de **Nexonia configuratie** sectie, klikt u op **configureren Nexonia** openen **aanmelding configureren** venster. Kopiëren de **afmelding-URL, SAML-entiteit-ID en Single Sign-On Service URL voor SAML-** uit de **Naslaggids sectie.**
