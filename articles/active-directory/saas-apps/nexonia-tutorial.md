...
2. Op de **eenmalige aanmelding** dialoogvenster Selecteer **modus** als **op basis van SAML aanmelding** voor eenmalige aanmelding inschakelen.
    ...
    ![Dialoogvenster voor eenmalige aanmelding](./media/nexonia-tutorial/tutorial_nexonia_samlbase.png)

3. Op de **Nexonia domein en de URL's** sectie, voert u de volgende stappen uit:

    ![URL's en Nexonia domein eenmalige aanmelding informatie](./media/nexonia-tutorial/tutorial_nexonia_url.png)
...
5. Klik op **opslaan** knop.
    ...
    ![Knop Single Sign-On opslaan configureren](./media/nexonia-tutorial/tutorial_general_400.png)
