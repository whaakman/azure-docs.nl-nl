...
3. **[Maak een testgebruiker FiscalNote](#create-a-fiscalnote-test-user)**  : als u wilt een equivalent van Britta Simon in FiscalNote die is gekoppeld aan de Azure AD-weergave van de gebruiker hebben.
...
3. Op de **FiscalNote domein en URL's** sectie, voert u de volgende stappen uit:
...
8. Op de **FiscalNote configuratie** sectie, klikt u op **configureren FiscalNote** openen **aanmelding configureren** venster. Kopiëren de **afmelding-URL, SAML-entiteit-ID en Single Sign-On Service URL voor SAML-** uit de **Naslaggids sectie.**
