...
2. Op de **eenmalige aanmelding** dialoogvenster Selecteer **modus** als **op basis van SAML aanmelding** voor eenmalige aanmelding inschakelen.
    ...
    ![Dialoogvenster voor eenmalige aanmelding](./media/fiscalnote-tutorial/tutorial_fiscalnote_samlbase.png)

3. Op de **FiscalNote domein en de URL's** sectie, voert u de volgende stappen uit:

    ![URL's en FiscalNote domein eenmalige aanmelding informatie](./media/fiscalnote-tutorial/tutorial_fiscalnote_url.png)
...
7. Klik op **opslaan** knop.
    ...
    ![Knop Single Sign-On opslaan configureren](./media/fiscalnote-tutorial/tutorial_general_400.png)
