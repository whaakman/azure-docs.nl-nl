...
3. **[Maak een testgebruiker Mobile Xpense](#create-a-mobile-xpense-test-user)**  : als u wilt een equivalent van Britta Simon in Mobile Xpense die is gekoppeld aan de Azure AD-weergave van de gebruiker hebben.
...
3. Op de **Mobile Xpense domein en URL's** sectie, voert u de volgende stappen uit als u wilt configureren van de toepassing in de modus voor IDP gestart:
...
7. Het configureren van eenmalige aanmelding op **Mobile Xpense** zijde, moet u voor het verzenden van de gedownloade **Metadata XML** naar [Mobile Xpense ondersteuningsteam](http://www.mobilexpense.net/contact). Ze stelt u deze optie om de SAML SSO-verbinding instellen goed aan beide zijden.
