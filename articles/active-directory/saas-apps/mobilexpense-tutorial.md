...
1. Op de **Mobile Xpense domein en URL's** sectie, voert u de volgende stappen uit als u wilt configureren van de toepassing in de modus voor IDP gestart:
    ...
    b. In het tekstvak **Antwoord-URL** typt u een URL met behulp van het volgende patroon: `https://<sub-domain>.mobilexpense.com/NET/SSO/SAML20/SAML/AssertionConsumerService.aspx`
...
1. Controleer **geavanceerde URL-instellingen weergeven** en voer de volgende stap als u wilt configureren van de toepassing in **SP** modus gestart:
    ...
    Typ in het tekstvak **Aanmeldings-URL** een URL met het volgende patroon: `https://<sub-domain>.mobilexpense.com/<customername>`
     
    > [!NOTE] 
    > Dit zijn geen echte waarden. Werk deze waarden met de werkelijke antwoord-URL en de aanmeldings-URL. Neem contact op met [Mobile Xpense Client ondersteuningsteam](https://www.mobilexpense.net/contact) om deze waarden te verkrijgen. 
...
1. Klik op **opslaan** knop.
    ...
    ![De knop voor enkelvoudige aanmelding configureren](./media/mobilexpense-tutorial/tutorial_general_400.png)

1. Het configureren van eenmalige aanmelding op **Mobile Xpense** zijde, moet u voor het verzenden van de gedownloade **Metadata XML** naar [Mobile Xpense ondersteuningsteam](https://www.mobilexpense.net/contact). Het team stelt de instellingen zo in dat de verbinding tussen SAML en eenmalige aanmelding aan beide zijden goed is ingesteld.
...
In deze sectie maakt u een gebruiker met de naam van Britta Simon in MobileXpense. werken met [MobileXpense ondersteuningsteam](https://www.mobilexpense.net/contact) om toe te voegen de gebruikers in het MobileXpense-platform. Er moeten gebruikers worden gemaakt en geactiveerd voordat u eenmalige aanmelding kunt gebruiken. 
