...
2. Op de **eenmalige aanmelding** dialoogvenster Selecteer **modus** als **op basis van SAML aanmelding** voor eenmalige aanmelding inschakelen.
    ...
    ![Dialoogvenster voor eenmalige aanmelding](./media/edigitalresearch-tutorial/tutorial_edigitalresearch_samlbase.png)

3. Op de **eDigitalResearch domein en de URL's** sectie, voert u de volgende stappen uit:

    ![eDigitalResearch domein en de URL's eenmalige aanmelding informatie](./media/edigitalresearch-tutorial/tutorial_edigitalresearch_url.png)
...
5. Klik op **opslaan** knop.
    ...
    ![Knop Single Sign-On opslaan configureren](./media/edigitalresearch-tutorial/tutorial_general_400.png)
