...
2. Op de **eenmalige aanmelding** dialoogvenster Selecteer **modus** als **op basis van SAML aanmelding** voor eenmalige aanmelding inschakelen.
    ...
    ![Dialoogvenster voor eenmalige aanmelding](./media/opal-tutorial/tutorial_opal_samlbase.png)

3. Op de **Opal domein en de URL's** sectie, voert u de volgende stappen uit:

    ![URL's en Opal domein eenmalige aanmelding informatie](./media/opal-tutorial/tutorial_opal_url.png)
...
5. In de **gebruikerskenmerken** sectie op de **eenmalige aanmelding** dialoogvenster SAML-token kenmerk configureren zoals wordt weergegeven in de afbeelding en de volgende stappen uitvoeren:
    ...
    ![Eenmalige aanmelding configureren toevoegen](./media/opal-tutorial/tutorial_attribute_04.png)

    ![Eenmalige aanmelding Addattb configureren](./media/opal-tutorial/tutorial_attribute_05.png)
...
7. Klik op **opslaan** knop.
    ...
    ![Knop Single Sign-On opslaan configureren](./media/opal-tutorial/tutorial_general_400.png) 
