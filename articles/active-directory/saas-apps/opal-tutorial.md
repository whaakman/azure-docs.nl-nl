...
1. Het configureren van eenmalige aanmelding op **Opal** zijde, moet u voor het verzenden van de gedownloade **Metadata XML** naar [Opal ondersteuningsteam](mailto:support@workwithopal.com). Ze stelt u deze optie om de SAML SSO-verbinding instellen goed aan beide zijden.
