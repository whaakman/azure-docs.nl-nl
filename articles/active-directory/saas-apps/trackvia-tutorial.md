...
2. Op de **eenmalige aanmelding** dialoogvenster Selecteer **modus** als **op basis van SAML aanmelding** voor eenmalige aanmelding inschakelen.
    ...
    ![Dialoogvenster voor eenmalige aanmelding](./media/trackvia-tutorial/tutorial_trackvia_samlbase.png)
...
3. Op de **TrackVia domein en de URL's** sectie, voert u de volgende stappen uit als u wilt configureren, de toepassing in **IDP** modus gestart:
    ...
    ![URL's en TrackVia domein eenmalige aanmelding informatie](./media/trackvia-tutorial/tutorial_trackvia_url.png)

    In de **id** textbox, typ de waarde: `TrackVia`

4. Controleer **weergeven geavanceerde instellingen voor URL** en voer de volgende stap als u wilt configureren van de toepassing in **SP** modus gestart:

    ![URL's en TrackVia domein eenmalige aanmelding informatie](./media/trackvia-tutorial/tutorial_trackvia_url1.png)
...
6. Klik op **opslaan** knop.
    ...
    ![Knop Single Sign-On opslaan configureren](./media/trackvia-tutorial/tutorial_general_400.png)
