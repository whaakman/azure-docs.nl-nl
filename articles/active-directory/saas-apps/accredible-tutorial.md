...
2. Op de **eenmalige aanmelding** dialoogvenster Selecteer **modus** als **op basis van SAML aanmelding** voor eenmalige aanmelding inschakelen.
    ...
    ![Dialoogvenster voor eenmalige aanmelding](./media/accredible-tutorial/tutorial_accredible_samlbase.png)

3. Op de **Accredible domein en de URL's** sectie, voert u de volgende stappen uit:

    ![URL's en Accredible domein eenmalige aanmelding informatie](./media/accredible-tutorial/tutorial_accredible_url.png)
...
5. Klik op **opslaan** knop.
    ...
    ![Knop Single Sign-On opslaan configureren](./media/accredible-tutorial/tutorial_general_400.png)
