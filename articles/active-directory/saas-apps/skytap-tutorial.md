...
1. Het configureren van eenmalige aanmelding op **Skytap** zijde, moet u voor het verzenden van de gedownloade **Metadata XML** naar [Skytap ondersteuningsteam](mailto:support@skytap.com). Ze stelt u deze optie om de SAML SSO-verbinding instellen goed aan beide zijden.
