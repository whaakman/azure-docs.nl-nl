...
1. Op de **Teamwork.com domein en URL's** sectie, voert u de volgende stappen uit:
    ...
    a. Typ in het tekstvak **Aanmeldings-URL** een URL met het volgende patroon: `https://<company name>.teamwork.com`
...
1. Klik op **opslaan** knop.
    ...
    ![De knop voor enkelvoudige aanmelding configureren](./media/teamwork-tutorial/tutorial_general_400.png)

1. Het configureren van eenmalige aanmelding op **Teamwork.com** zijde, moet u voor het verzenden van de gedownloade **Metadata XML** naar [Teamwork.com ondersteuningsteam](mailto:support@teamwork.com). Het team stelt de instellingen zo in dat de verbinding tussen SAML en eenmalige aanmelding aan beide zijden goed is ingesteld.
