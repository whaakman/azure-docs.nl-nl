...
3. **[Maak een testgebruiker Spacio](#create-a-spacio-test-user)**  : als u wilt een equivalent van Britta Simon in Spacio die is gekoppeld aan de Azure AD-weergave van de gebruiker hebben.
...
3. Op de **Spacio domein en URL's** sectie, voert u de volgende stappen uit:
...
6. Het configureren van eenmalige aanmelding op **Spacio** zijde, moet u voor het verzenden van de **App-Url voor federatieve metagegevens** naar [Spacio ondersteuningsteam](mailto:support@spac.io). Ze stelt u deze optie om de SAML SSO-verbinding instellen goed aan beide zijden.
