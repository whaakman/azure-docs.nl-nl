...
3. **[Het maken van een testgebruiker ThirdLight](#creating-a-thirdlight-test-user)**  : als u wilt een equivalent van Britta Simon in ThirdLight die is gekoppeld aan de Azure AD-weergave van de gebruiker hebben.
...
3. Op de **ThirdLight domein en URL's** sectie, voert u de volgende stappen uit:

    ![Eenmalige aanmelding configureren](./media/thirdlight-tutorial/tutorial_thirdlight_url.png)

    a. In de **aanmeldings-URL** tekstvak, een URL met behulp van het volgende patroon: `https://<subdomain>.thirdlight.com/`

    b. In de **id** tekstvak, een URL met behulp van het volgende patroon: `https://<subdomain>.thirdlight.com/saml/sp`

    > [!NOTE] 
    > Deze waarden zijn niet echt. Deze waarden met de werkelijke aanmeldings-URL en Identiifer bijwerken. Neem contact op met [ThirdLight Client ondersteuningsteam](https://www.thirdlight.com/support) om deze waarden te verkrijgen. 
...
6. In een ander browservenster aanmelden bij uw bedrijf ThirdLight site als beheerder.
...
8. In de sectie SAML2-configuratie moet u de volgende stappen uitvoeren:
...
5. Voer **de gebruikersnaam, naam of beschrijving, E-mail, kiest u een vooraf ingestelde of een groep van de nieuwe leden** van een geldige AAD-account dat u inrichten wilt.
