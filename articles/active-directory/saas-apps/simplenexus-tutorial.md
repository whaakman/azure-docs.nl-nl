...
4. Typ in het zoekvak **SimpleNexus**.
    ...
    ![Een Azure AD-testgebruiker maken](./media/simplenexus-tutorial/tutorial_simplenexus_search.png)

5. Selecteer in het deelvenster resultaten **SimpleNexus**, en klik vervolgens op **toevoegen** om toe te voegen van de toepassing.

    ![Een Azure AD-testgebruiker maken](./media/simplenexus-tutorial/tutorial_simplenexus_addfromgallery.png)
...
3. Op de **SimpleNexus domein en de URL's** sectie, voert u de volgende stappen uit:
    ...
    > [!NOTE] 
    > Deze waarden zijn niet echt. Deze waarden bijwerken met het werkelijke aanmeldings-URL en de id. Neem contact op met [SimpleNexus Client ondersteuningsteam](https://simplenexus.com/sn/contact-us/) ophalen van deze waarden. 
...
6. Eenmalige aanmelding configureren op **SimpleNexus** zijde, moet u de gedownloade verzenden **Metadata XML** naar [SimpleNexus ondersteuningsteam](https://simplenexus.com/sn/contact-us/). Ze deze instelling zodat de SAML SSO-verbinding juist is ingesteld op beide zijden ingesteld.
...
1. In de **Azure-portal**, klik op het navigatiedeelvenster links **Azure Active Directory** pictogram.
    ...
    ![Een Azure AD-testgebruiker maken](./media/simplenexus-tutorial/create_aaduser_01.png) 

2. Als u wilt weergeven in de lijst met gebruikers, gaat u naar **gebruikers en groepen** en klik op **alle gebruikers**.
    
    ![Een Azure AD-testgebruiker maken](./media/simplenexus-tutorial/create_aaduser_02.png) 

3. Openen van de **gebruiker** dialoogvenster, klikt u op **toevoegen** boven aan het dialoogvenster.
 
    ![Een Azure AD-testgebruiker maken](./media/simplenexus-tutorial/create_aaduser_03.png) 

4. Op de **gebruiker** dialoogvenster pagina, voert u de volgende stappen uit:
 
    ![Een Azure AD-testgebruiker maken](./media/simplenexus-tutorial/create_aaduser_04.png) 
