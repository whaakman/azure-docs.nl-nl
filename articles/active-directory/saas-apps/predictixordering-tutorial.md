...
2. Op de **eenmalige aanmelding** dialoogvenster Selecteer **modus** als **op basis van SAML aanmelding** voor eenmalige aanmelding inschakelen.
    ...
    ![Dialoogvenster voor eenmalige aanmelding](./media/predictixordering-tutorial/tutorial_predictixordering_samlbase.png)

3. Op de **Predictix ordening domein en de URL's** sectie, voert u de volgende stappen uit:

    ![URL's en Predictix ordening domein eenmalige aanmelding informatie](./media/predictixordering-tutorial/tutorial_predictixordering_url.png)
...
5. Klik op **opslaan** knop.
    ...
    ![Knop Single Sign-On opslaan configureren](./media/predictixordering-tutorial/tutorial_general_400.png)
...
6. Op de **Predictix ordening configuratie** sectie, klikt u op **Predictix ordening configureren** openen **eenmalige aanmelding configureren** venster. Kopieer de **Sign-Out-URL, SAML entiteit-ID en SAML Single Sign-On Service-URL** van de **Naslaggids punt.**
    ...
    ![Predictix ordening configuratie](./media/predictixordering-tutorial/tutorial_predictixordering_configure.png) 
...
2. Selecteer in de lijst met toepassingen **Predictix ordening**.
    ...
    ![De koppeling Predictix ordening in de lijst met toepassingen](./media/predictixordering-tutorial/tutorial_predictixordering_app.png)  
