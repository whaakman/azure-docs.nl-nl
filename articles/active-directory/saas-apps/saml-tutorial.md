...
4. Typ in het zoekvak **SAML 1.1 Token ingeschakeld LOB-App**, selecteer **SAML 1.1 Token ingeschakeld LOB-App** van resultaat deelvenster klik vervolgens op **toevoegen** om toe te voegen van de toepassing.
...
3. **[Maak een SAML 1.1-Token ingeschakeld testgebruiker LOB-App](#create-a-saml-11-token-enabled-lob-app-test-user)**  : als u wilt hebben een equivalent van Britta Simon in SAML 1.1 Token ingeschakeld LOB-App die is gekoppeld aan de Azure AD-weergave van de gebruiker.
...
3. Op de **SAML 1.1 Token ingeschakeld LOB-App-domein en URL's** sectie, voert u de volgende stappen uit:
...
7. Op de **SAML 1.1 Token ingeschakeld LOB-App-configuratie** sectie, klikt u op **SAML 1.1 Token configureren ingeschakeld LOB-App** openen **aanmelding configureren** venster. Kopiëren de **afmelding-URL, SAML-entiteit-ID en Single Sign-On Service URL voor SAML-** uit de **Naslaggids sectie.**
...
2. Selecteer in de lijst met toepassingen, **SAML 1.1 Token ingeschakeld LOB-App**.
