...
1. Op de **Workrite domein en URL's** sectie, voert u de volgende stappen uit:
    ...
    In de **aanmeldings-URL** tekstvak, een URL met behulp van het volgende patroon: `https://app.workrite.co.uk/securelogin/samlgateway.aspx?id=<uniqueid>`
...
1. Klik op **opslaan** knop.
    ...
    ![Configureren van eenmalige aanmelding opslaan](./media/workrite-tutorial/tutorial_general_400.png)
