...
1. Op de **Workrite domein en URL's** sectie, voert u de volgende stappen uit:
    ...
    > [!NOTE] 
    > Deze waarde is niet echt. Werk deze waarde bij met de werkelijke aanmeldings-URL. Neem contact op met [Workrite Client ondersteuningsteam](mailto:support@workrite.co.uk) deze waarde op te halen.
