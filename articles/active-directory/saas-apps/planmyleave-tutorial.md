...
3. **[Maak een testgebruiker PlanMyLeave](#create-a-planmyleave-test-user)**  : als u wilt een equivalent van Britta Simon in PlanMyLeave die is gekoppeld aan de Azure AD-weergave van de gebruiker hebben.
...
3. Op de **PlanMyLeave domein en URL's** sectie, voert u de volgende stappen uit:
...
6. Op de **PlanMyLeave configuratie** sectie, klikt u op **configureren PlanMyLeave** openen **aanmelding configureren** venster. Kopiëren de **Single Sign-On Service URL voor SAML** uit de **Naslaggids sectie.**

    ![PlanMyLeave configuratie](./media/planmyleave-tutorial/tutorial_planmyleave_configure.png) 
7. In een ander browservenster, meld u aan bij uw tenant PlanMyLeave als beheerder.
...
10. Op de **Update SAML-instellingen** sectie, voert u de volgende stappen uit:
