...
2. Op de **eenmalige aanmelding** dialoogvenster Selecteer **modus** als **op basis van SAML aanmelding** voor eenmalige aanmelding inschakelen.
    ...
    ![Dialoogvenster voor eenmalige aanmelding](./media/planmyleave-tutorial/tutorial_planmyleave_samlbase.png)

3. Op de **PlanMyLeave domein en de URL's** sectie, voert u de volgende stappen uit:

    ![URL's en PlanMyLeave domein eenmalige aanmelding informatie](./media/planmyleave-tutorial/tutorial_planmyleave_url.png)
...
5. Klik op **opslaan** knop.
    ...
    ![Knop Single Sign-On opslaan configureren](./media/planmyleave-tutorial/tutorial_general_400.png)
...
8. Ga naar **Setup van System**. Klik op de **beveiligingsbeheer** sectie Klik **bedrijf SAML-instellingen** .
    ...
    ![App-zijde eenmalige aanmelding configureren](./media/planmyleave-tutorial/tutorial_planmyleave_002.png) 

9. Op de **SAML instellingen** sectie, klikt u op het pictogram van de editor.

    ![App-zijde eenmalige aanmelding configureren](./media/planmyleave-tutorial/tutorial_planmyleave_003.png)

10. Op de **SAML-Update-instellingen** sectie, voert u de volgende stappen uit:

    ![App-zijde eenmalige aanmelding configureren](./media/planmyleave-tutorial/tutorial_planmyleave_004.png)
