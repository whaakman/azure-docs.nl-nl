...
2. Op de **eenmalige aanmelding** dialoogvenster Selecteer **modus** als **op basis van SAML aanmelding** voor eenmalige aanmelding inschakelen.
    ...
    ![Dialoogvenster voor eenmalige aanmelding](./media/cylanceprotect-tutorial/tutorial_cylanceprotect_samlbase.png)

3. Op de **CylancePROTECT domein en de URL's** sectie, voert u de volgende stappen uit:

    ![URL's en CylancePROTECT domein eenmalige aanmelding informatie](./media/cylanceprotect-tutorial/tutorial_cylanceprotect_url.png)
...
5. Klik op **opslaan** knop.
    ...
    ![Knop Single Sign-On opslaan configureren](./media/cylanceprotect-tutorial/tutorial_general_400.png)
