...
1. Op de **Vidyard domein en URL's** sectie, voert u de volgende stappen uit als u wilt configureren van de toepassing in **IDP** modus gestart:
    ...
    b. In het tekstvak **Antwoord-URL** typt u een URL met behulp van het volgende patroon: `https://secure.vidyard.com/sso/saml/<unique id>/consume`
...
1. Controleer **geavanceerde URL-instellingen weergeven** en voer de volgende stap als u wilt configureren van de toepassing in **SP** modus gestart:
    ...
    Typ in het tekstvak **Aanmeldings-URL** een URL met het volgende patroon: `https://secure.vidyard.com/sso/saml/<unique id>/login`
...
1. Op de **SAML-handtekeningcertificaat** sectie, klikt u op **Certificate(Base64)** en slaat u het certificaatbestand op uw computer.
    ...
    ![De link om het certificaat te downloaden](./media/vidyard-tutorial/tutorial_vidyard_certificate.png) 

1. Klik op **opslaan** knop.

    ![De knop voor enkelvoudige aanmelding configureren](./media/vidyard-tutorial/tutorial_general_400.png)
