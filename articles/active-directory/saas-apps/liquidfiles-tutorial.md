...
1. Op de **LiquidFiles domein en URL's** sectie, voert u de volgende stappen uit:
    ...
    a. Typ in het tekstvak **Aanmeldings-URL** een URL met het volgende patroon: `https://<YOUR_SERVER_URL>/saml/init`

    b. In de **id** tekstvak, een URL met behulp van het volgende patroon: `https://<YOUR_SERVER_URL>`

    c. b. In het tekstvak **Antwoord-URL** typt u een URL met behulp van het volgende patroon: `https://<YOUR_SERVER_URL>/saml/consume`

    > [!NOTE] 
    > Dit zijn geen echte waarden. Deze waarden bijwerken met de werkelijke URL aanmeldings-id en antwoord-URL. Neem contact op met [LiquidFiles Client ondersteuningsteam](https://www.liquidfiles.com/support.html) om deze waarden te verkrijgen. 
