...
* U kunt uw gebruikers worden automatisch aangemeld LiquidFiles (Single Sign-On) met hun Azure AD-accounts inschakelen.
...
* LiquidFiles eenmalige aanmelding ingeschakeld abonnement

## <a name="scenario-description"></a>Scenariobeschrijving

In deze zelfstudie gaat u in een testomgeving eenmalige aanmelding van Azure AD configureren en testen.

* Biedt ondersteuning voor LiquidFiles **SP** gestart door SSO
...
4. Typ in het zoekvak **LiquidFiles**, selecteer **LiquidFiles** van resultaat deelvenster klik vervolgens op **toevoegen** om toe te voegen van de toepassing.

    ![LiquidFiles in de lijst met resultaten](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Azure AD-eenmalige aanmelding configureren en testen

In deze sectie kunt u configureren en testen Azure AD eenmalige aanmelding met LiquidFiles op basis van een testgebruiker met de naam **Britta Simon**.
Voor eenmalige aanmelding om te werken, moet een koppeling relatie tussen een Azure AD-gebruiker en de gerelateerde gebruiker in LiquidFiles tot stand worden gebracht.
...
2. **[Configureren van eenmalige aanmelding LiquidFiles](#configure-liquidfiles-single-sign-on)**  : als u wilt de Single Sign-On-instellingen configureren op de toepassing aan clientzijde.
3. **[Een Azure AD-testgebruiker maken](#create-an-azure-ad-test-user)**: als u Azure AD-eenmalige aanmelding wil testen met Britta Simon.
4. **[De testgebruiker van Azure AD-toewijzen](#assign-the-azure-ad-test-user)**: als u wilt dat Britta Simon gebruik kan maken van Azure AD-eenmalige aanmelding.
5. **[Maken van de testgebruiker LiquidFiles](#create-liquidfiles-test-user)**  : als u wilt een equivalent van Britta Simon in LiquidFiles die is gekoppeld aan de Azure AD-weergave van de gebruiker hebben.
...
1. In de [Azure-portal](https://portal.azure.com/)op de **LiquidFiles** toepassing integratie weergeeft, schakelt **eenmalige aanmelding**.
...
4. In de sectie **Standaard SAML-configuratie** voert u de volgende stappen uit:
    ...
    ![LiquidFiles domein en URL's, eenmalige aanmelding informatie](common/sp-identifier-reply.png)
...
7. Op de **LiquidFiles instellen** sectie, kopieert u de juiste URL('s) volgens uw behoeften.
...
### <a name="configure-liquidfiles-single-sign-on"></a>LiquidFiles voor eenmalige aanmelding configureren
...
1. Op de **configuratie voor eenmalige aanmelding** pagina, de volgende stappen uitvoeren
    ...
    e. Typ de waarde in het tekstvak indeling van de id `urn:oasis:names:tc:SAML:1.1:nameid-format:emailAddress`.

    f. Typ de waarde in het tekstvak Authn Context `urn:oasis:names:tc:SAML:2.0:ac:classes:PasswordProtectedTransport`.
...
1. Selecteer in de Azure portal, **bedrijfstoepassingen**, selecteer **alle toepassingen**en selecteer vervolgens **LiquidFiles**.
...
### <a name="create-liquidfiles-test-user"></a>LiquidFiles testgebruiker maken
...
Wanneer u op de tegel LiquidFiles in het toegangsvenster, moet u worden automatisch aangemeld bij de LiquidFiles waarvoor u eenmalige aanmelding hebt ingesteld. Zie [Introduction to the Access Panel](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction) (Inleiding tot het toegangsvenster) voor meer informatie over het toegangsvenster.
