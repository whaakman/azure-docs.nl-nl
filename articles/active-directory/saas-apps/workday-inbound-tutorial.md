...
description: Informatie over het configureren van Azure Active Directory voor het automatisch inrichten en gebruikersaccounts aan Workday ongedaan in te richten.
 ...
 * Laat de **minuten voor de time-out sessie** met de standaardwaarde van 0, dit voorkomt dat de gebruiker sessies voortijdig een time-out opgetreden.
    ...
    ![Maken van de systeemgebruiker integratie](./media/workday-inbound-tutorial/IC750980.png "integratie systeemgebruiker maken")
...
1. Zoek en selecteer de nieuwe beveiligingsgroep voor de integratie met de naam.
...
1. Klik op **machtigingen bewerken**, en klik op de **machtigingen bewerken** dialoogvenster pagina, de nieuwe beveiligingsgroep toevoegen aan de lijst met beveiligingsgroepen met **ophalen** en **plaatsen**  integratie machtigingen.
    ...
    ![Machtigingen bewerken](./media/workday-inbound-tutorial/IC750989.png "machtigingen bewerken")  

1. Herhaal stap 1-4 hierboven voor elk van deze resterende beveiligingsbeleid:
...
1. De taak op het volgende scherm voltooien door het selectievakje **bevestigen**, en klik vervolgens op **OK**.
...
6. Als u wilt uw toewijzingen opslaan, klikt u op **opslaan** boven aan de sectie toewijzing van kenmerken.
...
13. Selecteer in de opdracht balk van Workday Studio **bestand > bestand openen...**  en open het XML-bestand dat u hebt opgeslagen. Dit geopend in de Workday Studio XML-editor.

    ![Werkdag Studio](./media/workday-inbound-tutorial/WDstudio3.PNG)

14. Navigeren in de bestandsstructuur **/env: Envelope > env: Body > wd:Get_Workers_Response > wd:Response_Data > Word: Worker** om gegevens van uw gebruikers te zoeken. 

15. Onder **Word: Worker**vinden van het kenmerk dat u wilt toevoegen en selecteer deze.

16. Kopieer de XPath-expressie voor het geselecteerde kenmerk buiten de **documentpad** veld.

1. Verwijder de **/env:Envelope / env / wd:Get_Workers_Response / wd:Response_Data /** voorvoegsel van de gekopieerde expressie.

18. Als het laatste item in de gekopieerde expressie is van een knooppunt (voorbeeld: "/ Word: Birth_Date '), Voeg **/text()** aan het einde van de expressie. Dit is niet nodig als een kenmerk is het laatste item (voorbeeld: '/@wd: type ').
...
11. Selecteer **opslaan** hierboven, en vervolgens **Ja** naar het dialoogvenster. Sluit het scherm van de toewijzing van kenmerken als deze nog steeds geopend.
