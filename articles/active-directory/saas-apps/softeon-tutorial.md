...
3. **[Het maken van een testgebruiker Softeon WMS](#creating-a-softeon-wms-test-user)**  : als u wilt een equivalent van Britta Simon in Softeon WMS die is gekoppeld aan de Azure AD-weergave van de gebruiker hebben.
...
3. Op de **Softeon WMS domein en URL's** sectie, voert u de volgende stappen uit:

    ![Eenmalige aanmelding configureren](./media/softeon-tutorial/tutorial_softeon_url.png)

    a. In de **aanmeldings-URL** tekstvak, een URL met behulp van het volgende patroon: `https://<companyname>.softeon.com/<instancename>`

    b. In de **id** tekstvak, een URL met behulp van het volgende patroon: `https://<companyname>.softeon.com/sp`

    > [!NOTE] 
    > Deze waarden zijn niet echt. Werk deze waarden met de werkelijke aanmeldings-URL en -id. Neem contact op met [Softeon WMS Client ondersteuningsteam](mailto:contact@softeon.com) om deze waarden te verkrijgen. 
