...
2. Op de **eenmalige aanmelding** dialoogvenster Selecteer **modus** als **op basis van SAML aanmelding** voor eenmalige aanmelding inschakelen.
    ...
    ![SAML op basis van eenmalige aanmelding](./media/tinfoil-security-tutorial/tutorial_tinfoil-security_samlbase.png)
...
4. Op de **SAML-certificaat voor ondertekening van** sectie, Kopieer de **VINGERAFDRUK** waarde.
    ...
    ![Certificaat voor ondertekening van SAML-sectie](./media/tinfoil-security-tutorial/tutorial_tinfoil-security_certificate.png) 
...
6. Klik op **opslaan** knop.
    ...
    ![knop Opslaan](./media/tinfoil-security-tutorial/tutorial_general_400.png)
...
1. In de **Azure-portal**, klik op het navigatiedeelvenster links **Azure Active Directory** pictogram.
    ...
    ![Een Azure AD-testgebruiker maken](./media/tinfoil-security-tutorial/create_aaduser_01.png) 
...
4. Op de **gebruiker** dialoogvenster pagina, voert u de volgende stappen uit:
    ...
    ![Een Azure AD-testgebruiker maken](./media/tinfoil-security-tutorial/create_aaduser_04.png) 
