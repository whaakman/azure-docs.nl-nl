...
2. Op de **eenmalige aanmelding** dialoogvenster Selecteer **modus** als **op basis van SAML aanmelding** voor eenmalige aanmelding inschakelen.
    ...
    ![Dialoogvenster voor eenmalige aanmelding](./media/agiloft-tutorial/tutorial_agiloft_samlbase.png)
...
3. Op de **Agiloft domein en de URL's** sectie, voert u de volgende stappen uit als u wilt configureren van de toepassing in de IDP geïnitieerd modus:
    ...
    ![URL's en Agiloft domein eenmalige aanmelding informatie](./media/agiloft-tutorial/tutorial_agiloft_url.png)
...
4. Controleer **weergeven geavanceerde instellingen voor URL** en voer de volgende stap als u wilt configureren van de toepassing in **SP** modus gestart:
    ...
    ![URL's en Agiloft domein eenmalige aanmelding informatie](./media/agiloft-tutorial/tutorial_agiloft_url1.png)
...
6. Klik op **opslaan** knop.
    ...
    ![Knop Single Sign-On opslaan configureren](./media/agiloft-tutorial/tutorial_general_400.png)
