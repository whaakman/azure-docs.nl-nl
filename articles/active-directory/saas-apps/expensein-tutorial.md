...
1. In een ander browservenster aanmelden bij ExpenseIn als beheerder.

2. Klik op **Admin** boven aan de pagina en navigeer vervolgens naar **Single Sign-On** en klikt u op **toevoegen provider**.

     ![ExpenseIn configuratie](./media/expenseIn-tutorial/config01.png)

3. Op de **nieuwe id-Provider** pop, voer de volgende stappen uit:
    ...
    b. In de **doel-Url** tekst vak, plak de waarde van **aanmeldings-URL**, die u hebt gekopieerd vanuit Azure portal.

    c. In de **verlener** tekst vak, plak de waarde van **Azure AD-id**, die u hebt gekopieerd vanuit Azure portal.

    d. Het certificaat (Base64) openen in Kladblok, Kopieer de inhoud en plak deze in de **certificaat** in het tekstvak.
...
In deze sectie schakelt u B. Simon Azure eenmalige aanmelding door toegang te verlenen aan ExpenseIn gebruiken.
