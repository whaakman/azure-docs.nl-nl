...
5. Op de **verificatie-instellingen** pagina, de volgende stappen uitvoeren
    ...
    c. Typ `https://schemas.xmlsoap.org/ws/2005/05/identity/claims/emailaddress` in het tekstvak **E-mailadres**.
   
    d. In de **voornaam** tekstvak `type https://schemas.xmlsoap.org/ws/2005/05/identity/claims/givenname`.
   
    e. In de **achternaam** tekstvak `type https://schemas.xmlsoap.org/ws/2005/05/identity/claims/surname`.
