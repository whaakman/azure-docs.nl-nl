...
4. Typ in het zoekvak **AppDynamics**.
    ...
    ![Een Azure AD-testgebruiker maken](./media/appdynamics-tutorial/tutorial_appdynamics_search.png)

5. Selecteer in het deelvenster resultaten **AppDynamics**, en klik vervolgens op **toevoegen** om toe te voegen van de toepassing.

    ![Een Azure AD-testgebruiker maken](./media/appdynamics-tutorial/tutorial_appdynamics_addfromgallery.png)
...
10. In de **verificatieprovider** sectie, voert u de volgende stappen uit:
    ...
    e. Klik op **Opslaan**.
     ...
     ![Sla](./media/appdynamics-tutorial/ic777673.png "opslaan")
...
1. In de **Azure-portal**, klik op het navigatiedeelvenster links **Azure Active Directory** pictogram.
    ...
    ![Een Azure AD-testgebruiker maken](./media/appdynamics-tutorial/create_aaduser_01.png) 

2. Als u wilt weergeven in de lijst met gebruikers, gaat u naar **gebruikers en groepen** en klik op **alle gebruikers**.
    
    ![Een Azure AD-testgebruiker maken](./media/appdynamics-tutorial/create_aaduser_02.png) 

3. Openen van de **gebruiker** dialoogvenster, klikt u op **toevoegen** boven aan het dialoogvenster.
 
    ![Een Azure AD-testgebruiker maken](./media/appdynamics-tutorial/create_aaduser_03.png) 

4. Op de **gebruiker** dialoogvenster pagina, voert u de volgende stappen uit:
 
    ![Een Azure AD-testgebruiker maken](./media/appdynamics-tutorial/create_aaduser_04.png) 
...
2. Ga naar **gebruikers**, en klik vervolgens op **+** openen de **gebruiker maken** dialoogvenster.
    ...
    ![Gebruikers](./media/appdynamics-tutorial/ic790229.png "gebruikers")

3. In de **gebruiker maken** sectie, voert u de volgende stappen uit:
   
    ![Gebruiker maken](./media/appdynamics-tutorial/ic790230.png "gebruiker maken")
