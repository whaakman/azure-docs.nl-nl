...
2. Op de **eenmalige aanmelding** dialoogvenster Selecteer **modus** als **op basis van SAML aanmelding** voor eenmalige aanmelding inschakelen.
    ...
    ![Dialoogvenster voor eenmalige aanmelding](./media/dealpath-tutorial/tutorial_dealpath_samlbase.png)

3. Op de **Dealpath domein en de URL's** sectie, voert u de volgende stappen uit:

    ![URL's en Dealpath domein eenmalige aanmelding informatie](./media/dealpath-tutorial/tutorial_dealpath_url.png)
...
5. Klik op **opslaan** knop.
    ...
    ![Knop Single Sign-On opslaan configureren](./media/dealpath-tutorial/tutorial_general_400.png)
