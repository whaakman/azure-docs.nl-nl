...
3. **[Maak een testgebruiker Dealpath](#create-a-dealpath-test-user)**  : als u wilt een equivalent van Britta Simon in Dealpath die is gekoppeld aan de Azure AD-weergave van de gebruiker hebben.
...
3. Op de **Dealpath domein en URL's** sectie, voert u de volgende stappen uit:

    ![Dealpath domein en URL's, eenmalige aanmelding informatie](./media/dealpath-tutorial/tutorial_dealpath_url.png)

    a. In de **aanmeldings-URL** tekstvak, een URL met behulp van het volgende patroon: `https://app.dealpath.com/account/login`

    b. In de **id** tekstvak, een URL met behulp van het volgende patroon: `https://api.dealpath.com/saml/metadata/<ID>`
...
4. Op de **SAML-handtekeningcertificaat** sectie, klikt u op **certificaat (Base64)** en slaat u het certificaatbestand op uw computer.
    ...
    ![De downloadkoppeling certificaat](./media/dealpath-tutorial/tutorial_dealpath_certificate.png) 

5. Klik op **opslaan** knop.

    ![Configureren van eenmalige aanmelding opslaan](./media/dealpath-tutorial/tutorial_general_400.png)

6. Op de **Dealpath configuratie** sectie, klikt u op **configureren Dealpath** openen **aanmelding configureren** venster. Kopiëren de **SAML entiteit-ID en Single Sign-On Service URL voor SAML-** uit de **Naslaggids sectie.**
...
8. In de rechterbovenhoek, klikt u op **Systeembeheer** en navigeer naar **integraties**, klik dan in **SAML 2.0-verificatie** sectie klikt u op **Update-instellingen**:
