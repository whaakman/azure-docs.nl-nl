...
1. Op de **leveren domein beveiligen en URL's** sectie, voert u de volgende stappen uit:
    ...
    a. In de **aanmeldings-URL** tekstvak, een URL met behulp van het volgende patroon: `https://<companyname>.i-securedeliver.jp/sd/<tenantname>/jsf/login/sso`

    b. In de **id** tekstvak, een URL met behulp van het volgende patroon: `https://<companyname>.i-securedeliver.jp/sd/<tenantname>/postResponse`

    > [!NOTE] 
    > Deze waarden zijn niet echt. Werk deze waarden met de werkelijke aanmeldings-URL en -id. Neem contact op met [leveren Client beveiligde ondersteuningsteam](mailto:iw-sd-support@fujifilm.com) om deze waarden te verkrijgen. 
