...
1. Op de **AwardSpring domein en URL's** sectie, voert u de volgende stappen uit als u wilt configureren van de toepassing in **IDP** modus gestart:
    ...
    b. In het tekstvak **Antwoord-URL** typt u een URL met behulp van het volgende patroon: `https://<subdomain>.awardspring.com/SignIn/SamlAcs`
...
1. Controleer **geavanceerde URL-instellingen weergeven** en voer de volgende stap als u wilt configureren van de toepassing in **SP** modus gestart:
    ...
    Typ in het tekstvak **Aanmeldings-URL** een URL met het volgende patroon: `https://<subdomain>.awardspring.com/`
     
    > [!NOTE] 
    > Dit zijn geen echte waarden. Werk deze waarden bij met de werkelijke id, antwoord-URL en aanmeldings-URL. Neem contact op met [AwardSpring Client ondersteuningsteam](mailto:support@awardspring.com) om deze waarden te verkrijgen. 
...
1. Klik op **opslaan** knop.
    ...
    ![De knop voor enkelvoudige aanmelding configureren](./media/awardspring-tutorial/tutorial_general_400.png)
    
1. Het configureren van eenmalige aanmelding op **AwardSpring** zijde, moet u voor het verzenden van de gedownloade **Metadata XML** naar [AwardSpring ondersteuningsteam](mailto:support@awardspring.com). Het team stelt de instellingen zo in dat de verbinding tussen SAML en eenmalige aanmelding aan beide zijden goed is ingesteld.
