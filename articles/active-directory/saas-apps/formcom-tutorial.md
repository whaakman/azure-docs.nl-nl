...
3. **[Maak een testgebruiker Form.com](#create-a-formcom-test-user)**  : als u wilt een equivalent van Britta Simon in Form.com die is gekoppeld aan de Azure AD-weergave van de gebruiker hebben.
...
3. Op de **Form.com domein en URL's** sectie, voert u de volgende stappen uit:

    ![Form.com domein en URL's, eenmalige aanmelding informatie](./media/formcom-tutorial/tutorial_form.com_url.png)

    a. In de **aanmeldings-URL** tekstvak, een URL met behulp van het volgende patroon: `https://<subdomain>.wa-form.com`
    ...
    > [!NOTE]
    > Deze waarden zijn niet echt. Werk deze waarden met de werkelijke aanmeldings-URL, antwoord-URL en -id. Neem contact op met [Form.com Client ondersteuningsteam](https://form.com/about/company/contact-us/) om deze waarden te verkrijgen.
...
5. Klik op **opslaan** knop.
    ...
    ![Configureren van eenmalige aanmelding opslaan](./media/formcom-tutorial/tutorial_general_400.png)

6. Op de **Form.com configuratie** sectie, klikt u op **configureren Form.com** openen **aanmelding configureren** venster. Kopiëren de **Single Sign-On Service URL voor SAML** uit de **Naslaggids sectie.**

    ![Form.com configuratie](./media/formcom-tutorial/tutorial_form.com_configure.png) 

7. Het configureren van eenmalige aanmelding op **Form.com** zijde, moet u voor het verzenden van de gedownloade **certificaat (Base64)**, **App-Url voor federatieve metagegevens**, en **SAML Single Sign-On Service-URL** naar [Form.com ondersteuningsteam](https://form.com/about/company/contact-us/). Ze stelt u deze optie om de SAML SSO-verbinding instellen goed aan beide zijden.
