...
3. **[Maak een testgebruiker Wizergos productiviteitssoftware](#create-a-wizergos-productivity-software-test-user)**  : als u wilt een equivalent van Britta Simon in Wizergos productiviteitssoftware die is gekoppeld aan de Azure AD-weergave van de gebruiker hebben.
...
3. Op de **Wizergos productiviteit Software domein en URL's** sectie, voert u de volgende stappen uit:
...
6. Op de **Wizergos productiviteit softwareconfiguratie** sectie, klikt u op **Wizergos productiviteitssoftware configureren** openen **aanmelding configureren** venster. Kopiëren de **afmelding-URL, SAML-entiteit-ID en Single Sign-On Service URL voor SAML-** uit de **Naslaggids sectie.**
...
7. In een ander browservenster aanmelden voor uw tenant Wizergos productiviteitssoftware als een beheerder.

8. Selecteer in het hamburgermenu **Admin**.
...
9. Selecteer in de beheerpagina in het menu links **verificatie** en klikt u op **Azure AD**.
