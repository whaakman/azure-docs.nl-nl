...
2. Op de **eenmalige aanmelding** dialoogvenster Selecteer **modus** als **op basis van SAML aanmelding** voor eenmalige aanmelding inschakelen.
    ...
    ![Dialoogvenster voor eenmalige aanmelding](./media/litmos-tutorial/tutorial_litmos_samlbase.png)

3. Op de **Litmos domein en de URL's** sectie, voert u de volgende stappen uit:

    ![URL's en Litmos domein eenmalige aanmelding informatie](./media/litmos-tutorial/tutorial_litmos_url.png)
...
6. Klik op **opslaan** knop.
    ...
    ![Knop Single Sign-On opslaan configureren](./media/litmos-tutorial/tutorial_general_400.png)
