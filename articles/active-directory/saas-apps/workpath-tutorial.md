...
3. **[Het maken van een testgebruiker Workpath](#creating-a-workpath-test-user)**  : als u wilt een equivalent van Britta Simon in Workpath die is gekoppeld aan de Azure AD-weergave van de gebruiker hebben.
...
3. Op de **Workpath domein en URL's** sectie, als u wilt configureren van de toepassing in **IDP** gestart modus de volgende stappen uitvoeren:
...
4. Controleer **geavanceerde URL-instellingen weergeven**. Als u wilt configureren van de toepassing in **SP** gestart modus, voert u de volgende stappen uit:
...
9. Op de **Workpath configuratie** sectie, klikt u op **configureren Workpath** openen **aanmelding configureren** venster. Kopiëren de **afmelding-URL, SAML-entiteit-ID en Single Sign-On Service URL voor SAML-** uit de **Naslaggids sectie.**

    ![Eenmalige aanmelding configureren](./media/workpath-tutorial/tutorial_workpath_configure.png) 

10. Het configureren van eenmalige aanmelding op **Workpath** zijde, moet u voor het verzenden van de gedownloade **Metadata XML**, **afmelding-URL, SAML-entiteit-ID en Single Sign-On Service URL voor SAML-** naar [Workpath ondersteuningsteam](https://help.workpath.com). 
