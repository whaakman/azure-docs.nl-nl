...
3. **[Maak een testgebruiker LoginRadius](#create-a-loginradius-test-user)**  : als u wilt een equivalent van Britta Simon in LoginRadius die is gekoppeld aan de Azure AD-weergave van de gebruiker hebben.
...
3. Op de **LoginRadius domein en URL's** sectie, voert u de volgende stappen uit:
...
7. Het configureren van eenmalige aanmelding op **LoginRadius** zijde, moet u voor het verzenden van de gedownloade **Metadata XML** naar [LoginRadius ondersteuningsteam](mailto:support@loginradius.com). Ze stelt u deze optie om de SAML SSO-verbinding instellen goed aan beide zijden.
