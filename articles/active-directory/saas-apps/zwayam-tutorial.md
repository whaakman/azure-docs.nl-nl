...
3. **[Maak een testgebruiker Zwayam](#create-a-zwayam-test-user)**  : als u wilt een equivalent van Britta Simon in Zwayam die is gekoppeld aan de Azure AD-weergave van de gebruiker hebben.
...
3. Op de **Zwayam domein en URL's** sectie, voert u de volgende stappen uit:
...
6. Op de **Zwayam configuratie** sectie, klikt u op **configureren Zwayam** openen **aanmelding configureren** venster. Kopiëren de **SAML entiteit-ID** uit de **Naslaggids sectie** en plak de **SAML entiteit-ID** waarde in de **aanmeldings-URL** -tekstvak in de  **Zwayam domein en URL's** sectie.

    ![Zwayam configuratie](./media/zwayam-tutorial/tutorial_Zwayam_configure.png) 

7. Het configureren van eenmalige aanmelding op **Zwayam** zijde, moet u voor het verzenden van de gedownloade **Metadata XML** naar [Zwayam ondersteuningsteam](mailto:opendoors@zwayam.com). Ze stelt u deze optie om de SAML SSO-verbinding instellen goed aan beide zijden.
