...
1. Op de **TonicDM domein en URL's** sectie, voert u de volgende stappen uit:
    ...
    a. Typ een URL in het tekstvak **Aanmeldings-URL**: `https://tonicdm.com/`

    b. In de **id** tekstvak, een URL typen: `https://tonicdm.com/saml/metadata`

1. Op de **SAML-handtekeningcertificaat** sectie, klikt u op **certificaat (Base64)** en slaat u het certificaatbestand op uw computer.

    ![De link om het certificaat te downloaden](./media/tonicdm-tutorial/tutorial_tonicdm_certificate.png) 

1. Klik op **opslaan** knop.

    ![De knop voor enkelvoudige aanmelding configureren](./media/tonicdm-tutorial/tutorial_general_400.png)
