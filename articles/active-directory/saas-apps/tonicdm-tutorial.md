...
3. **[Maak een testgebruiker TonicDM](#create-a-tonicdm-test-user)**  : als u wilt een equivalent van Britta Simon in TonicDM die is gekoppeld aan de Azure AD-weergave van de gebruiker hebben.
...
3. Op de **TonicDM domein en URL's** sectie, voert u de volgende stappen uit:
...
6. Op de **TonicDM configuratie** sectie, klikt u op **configureren TonicDM** openen **aanmelding configureren** venster. Kopiëren de **afmelding-URL, SAML-entiteit-ID en Single Sign-On Service URL voor SAML-** uit de **Naslaggids sectie.**
