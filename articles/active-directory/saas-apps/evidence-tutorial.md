...
2. Op de **eenmalige aanmelding** dialoogvenster Selecteer **modus** als **op basis van SAML aanmelding** voor eenmalige aanmelding inschakelen.
    ...
    ![Dialoogvenster voor eenmalige aanmelding](./media/evidence-tutorial/tutorial_evidence.com_samlbase.png)

3. Op de **Evidence.com domein en de URL's** sectie, voert u de volgende stappen uit:

    ![URL's en evidence.com domein eenmalige aanmelding informatie](./media/evidence-tutorial/tutorial_evidence.com_url.png)
...
5. Klik op **opslaan** knop.
    ...
    ![Knop Single Sign-On opslaan configureren](./media/evidence-tutorial/tutorial_general_400.png)
