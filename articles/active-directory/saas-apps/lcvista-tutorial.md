...
2. In de **SAML-Config** sectie, Controleer de **inschakelen SAML-aanmelding** en voer de details, zoals vermeld in onderstaande afbeelding. 
    ...
    d. In de **voornaam kenmerk** tekstvak, plak de waarde `https://schemas.xmlsoap.org/ws/2005/05/identity/claims/givenname`.

    e. In de **laatste naamkenmerk** tekstvak, plak de waarde `https://schemas.xmlsoap.org/ws/2005/05/identity/claims/surname`.

    f. In de **e kenmerk** tekstvak, plak de waarde `https://schemas.xmlsoap.org/ws/2005/05/identity/claims/emailaddress`.

    g. In de **kenmerk Username** tekstvak, plak de waarde `https://schemas.xmlsoap.org/ws/2005/05/identity/claims/name`.
...
In deze sectie maakt u een gebruiker met de naam van Britta Simon in LCVista. Werken met [LCVista Client ondersteuningsteam](https://lcvista.com/contact) om toe te voegen de gebruikers in het LCVista-platform. Gebruikers moeten worden gemaakt en worden geactiveerd voordat u eenmalige aanmelding gebruiken.
