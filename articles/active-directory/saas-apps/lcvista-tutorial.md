...
3. **[Het maken van een testgebruiker LCVista](#creating-a-lcvista-test-user)**  : als u wilt een equivalent van Britta Simon in LCVista die is gekoppeld aan de Azure AD-weergave van de gebruiker hebben.
...
3. Op de **LCVista domein en URL's** sectie, voert u de volgende stappen uit:
...
6. Op de **LCVista configuratie** sectie, klikt u op **configureren LCVista** openen **aanmelding configureren** venster. Kopiëren de **SAML entiteit-ID** en **Single Sign-On Service URL voor SAML** uit de **Naslaggids sectie.**

    ![Eenmalige aanmelding configureren](./media/lcvista-tutorial/tutorial_lcvista_configure.png) 

7.  Meld u aan bij uw toepassing LCVista als beheerder.

8. In de **SAML-Config** sectie, Controleer de **inschakelen SAML-aanmelding** en voer de details, zoals vermeld in onderstaande afbeelding. 
