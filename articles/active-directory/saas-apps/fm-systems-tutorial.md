...
3. **[Het maken van een testgebruiker FM:Systems](#creating-an-fmsystems-test-user)**  : als u wilt een equivalent van Britta Simon in FM:Systems die is gekoppeld aan de Azure AD-weergave van de gebruiker hebben.
...
3. Op de **FM:Systems domein en URL's** sectie, voert u de volgende stappen uit:
