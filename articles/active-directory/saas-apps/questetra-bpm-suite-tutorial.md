...
1. Op de **Questetra BPM Suite domein en URL's** sectie, voert u de volgende stappen uit:
    ...
    a. In de **aanmeldings-URL** tekstvak, een URL met behulp van het volgende patroon: `https://<subdomain>.questetra.net/saml/SSO/alias/bpm`

    b. In de **id** tekstvak, een URL met behulp van het volgende patroon: `https://<subdomain>.questetra.net/`
