...
2. Op de **eenmalige aanmelding** dialoogvenster Selecteer **modus** als **op basis van SAML aanmelding** voor eenmalige aanmelding inschakelen.
    ...
    ![Dialoogvenster voor eenmalige aanmelding](./media/voyance-tutorial/tutorial_voyance_samlbase.png)
...
3. Op de **Voyance domein en de URL's** sectie, voert u de volgende stappen uit als u wilt configureren, de toepassing in **IDP** modus gestart:
    ...
    ![Voyance domein en URL's eenmalige aanmelding-informatie voor IDP](./media/voyance-tutorial/tutorial_voyance_url1.png)
...
6. Klik op **opslaan** knop.
    ...
    ![Knop Single Sign-On opslaan configureren](./media/voyance-tutorial/tutorial_general_400.png)
...
9. Ga naar de rechterbovenhoek van de navigatiebalk en klik op de vervolgkeuzelijst met de tekst "**Top universiteit**'.
    ...
    ![Eenmalige aanmelding op App aan clientzijde Top universiteit configureren](./media/voyance-tutorial/tutorial_voyance_001.png) 

10. Klik op '**beheerdersinstellingen**'.

    ![Eenmalige aanmelding op App aan clientzijde beheerdersinstellingen configureren](./media/voyance-tutorial/tutorial_voyance_002.png)

11. Klik op '**gebruikerstoegang**' tabblad.

    ![Eenmalige aanmelding configureren voor toegang voor App-zijde van gebruiker](./media/voyance-tutorial/tutorial_voyance_003.png)

12. Klik op de '**SSO is uitgeschakeld**' om de Azure AD configureren als een IdP SAML 2.0 gebruikt.

    ![Configureren van eenmalige aanmelding op App aan clientzijde SSO is uitgeschakeld knop](./media/voyance-tutorial/tutorial_voyance_004.png)

13. Ga naar **SAML v2** sectie en Voer onderstaande stappen te volgen:

    ![Eenmalige aanmelding configureren op App aan clientzijde SAML v2](./media/voyance-tutorial/tutorial_voyance_005.png)
