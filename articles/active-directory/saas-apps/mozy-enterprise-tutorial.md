...
3. **[Het maken van een testgebruiker Mozy Enterprise](#creating-a-mozy-enterprise-test-user)**  : als u wilt een equivalent van Britta Simon in Mozy-onderneming die is gekoppeld aan de Azure AD-weergave van de gebruiker hebben.
...
3. Op de **Mozy Enterprise domein en URL's** sectie, voert u de volgende stappen uit:
...
6. Op de **Mozy Ondernemingsconfiguratie** sectie, klikt u op **configureren Mozy Enterprise** openen **aanmelding configureren** venster. Kopiëren de **SAML entiteit-ID en Single Sign-On Service URL voor SAML-** uit de **Naslaggids sectie.**

    ![Eenmalige aanmelding configureren](./media/mozy-enterprise-tutorial/tutorial_mozyenterprise_configure.png) 

7. Meld u in een ander browservenster in uw bedrijf Mozy Enterprise site als beheerder.
