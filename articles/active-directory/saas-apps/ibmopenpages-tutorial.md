...
3. **[Maak een testgebruiker IBM OpenPages](#create-an-ibm-openpages-test-user)**  : als u wilt een equivalent van Britta Simon in IBM OpenPages die is gekoppeld aan de Azure AD-weergave van de gebruiker hebben.
...
3. Op de **IBM OpenPages domein en URL's** sectie, voert u de volgende stappen uit:
...
7. Het configureren van eenmalige aanmelding op **IBM OpenPages** zijde, moet u voor het verzenden van de gedownloade **Metadata XML** naar [IBM OpenPages ondersteuningsteam](https://www.ibm.com/support/home/). Ze stelt u deze optie om de SAML SSO-verbinding instellen goed aan beide zijden.
