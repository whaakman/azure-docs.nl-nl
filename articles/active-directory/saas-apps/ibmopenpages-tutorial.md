...
1. Op de **IBM OpenPages domein en URL's** sectie, voert u de volgende stappen uit:
    ...
    a. In de **id** tekstvak, een URL met behulp van het volgende patroon: `http://<subdomain>.ibm.com:<ID>/openpages`

    b. In de **antwoord-URL** tekstvak, een URL met behulp van het volgende patroon: `https://<subdomain>.ibm.com:<ID>/samlsps/op`

    > [!NOTE] 
    > Deze waarden zijn niet echt. Werk deze waarden met de werkelijke id en de antwoord-URL. Neem contact op met [IBM OpenPages Client ondersteuningsteam](https://www.ibm.com/support/home/) om deze waarden te verkrijgen. 
...
1. Klik op **opslaan** knop.
    ...
    ![Configureren van eenmalige aanmelding opslaan](./media/ibmopenpages-tutorial/tutorial_general_400.png)

1. Het configureren van eenmalige aanmelding op **IBM OpenPages** zijde, moet u voor het verzenden van de gedownloade **Metadata XML** naar [IBM OpenPages ondersteuningsteam](https://www.ibm.com/support/home/). Ze stelt u deze optie om de SAML SSO-verbinding instellen goed aan beide zijden.
...
In deze sectie maakt u een gebruiker met de naam van Britta Simon in IBM OpenPages. Werken met [IBM OpenPages ondersteuningsteam](https://www.ibm.com/support/home/) om toe te voegen de gebruikers in het IBM OpenPages-platform. Gebruikers moeten worden gemaakt en worden geactiveerd voordat u eenmalige aanmelding gebruiken.
