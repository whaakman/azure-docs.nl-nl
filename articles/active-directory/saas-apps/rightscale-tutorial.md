...
In deze sectie maakt u een gebruiker met de naam van Britta Simon in Rightscale. Werken met [Rightscale Client ondersteuningsteam](mailto:support@rightscale.com) om toe te voegen de gebruikers in het Rightscale-platform. Gebruikers moeten worden gemaakt en worden geactiveerd voordat u eenmalige aanmelding gebruiken.
