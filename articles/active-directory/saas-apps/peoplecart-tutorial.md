...
3. **[Maak een testgebruiker Peoplecart](#create-a-peoplecart-test-user)**  : als u wilt een equivalent van Britta Simon in Peoplecart die is gekoppeld aan de Azure AD-weergave van de gebruiker hebben.
...
3. Op de **Peoplecart domein en URL's** sectie, voert u de volgende stappen uit:
...
6. Op de **Peoplecart configuratie** sectie, klikt u op **configureren Peoplecart** openen **aanmelding configureren** venster. Kopiëren de **Single Sign-On Service URL voor SAML** uit de **Naslaggids sectie.**
