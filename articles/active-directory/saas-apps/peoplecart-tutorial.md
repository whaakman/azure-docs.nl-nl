...
3. Op de **Peoplecart domein en de URL's** sectie, voert u de volgende stappen uit:
    ...
    ![URL's en Peoplecart domein eenmalige aanmelding informatie](./media/peoplecart-tutorial/tutorial_peoplecart_url.png)
...
5. Klik op **opslaan** knop.
    ...
    ![Knop Single Sign-On opslaan configureren](./media/peoplecart-tutorial/tutorial_general_400.png)
