...
1. Op de **Front domein en URL's** sectie, voert u de volgende stappen uit:
    ...
    a. In de **id** tekstvak, een URL met behulp van het volgende patroon: `https://<companyname>.frontapp.com`

    b. In de **antwoord-URL** tekstvak, een URL met behulp van het volgende patroon: `https://<companyname>.frontapp.com/sso/saml/callback`
     
    > [!NOTE] 
    > Deze waarden zijn niet echt. Deze waarden bijwerken met de werkelijke id en de antwoord-URL die worden beschreven later in de zelfstudie of neem contact op met [Front-Client-ondersteuningsteam](mailto:support@frontapp.com) om deze waarden te verkrijgen. 
...
In deze sectie maakt u een gebruiker met de naam Britta Simon op de voorgrond. Werken met [Front-Client-ondersteuningsteam](mailto:support@frontapp.com) om toe te voegen de gebruikers in de Front-platform. Gebruikers moeten worden gemaakt en worden geactiveerd voordat u eenmalige aanmelding gebruiken.
