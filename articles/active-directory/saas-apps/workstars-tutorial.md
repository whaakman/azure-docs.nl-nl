...
3. **[Maak een testgebruiker Workstars](#create-a-workstars-test-user)**  : als u wilt een equivalent van Britta Simon in Workstars die is gekoppeld aan de Azure AD-weergave van de gebruiker hebben.
...
3. Op de **Workstars domein en URL's** sectie, voert u de volgende stappen uit:
    ...
    b. In de **antwoord-URL** tekstvak, een URL met behulp van het volgende patroon: `https://<subdomain>.workstars.com/saml/login_check`
...
5. Klik op **opslaan** knop.
    ...
    ![Configureren van eenmalige aanmelding opslaan](./media/workstars-tutorial/tutorial_general_400.png)

6. Op de **Workstars configuratie** sectie, klikt u op **configureren Workstars** openen **aanmelding configureren** venster. Kopiëren de **afmelding-URL, SAML-entiteit-ID en Single Sign-On Service URL voor SAML-** uit de **Naslaggids sectie.**

    ![Workstars configuratie](./media/workstars-tutorial/tutorial_workstars_configure.png) 

7. In een ander browservenster, meld u aan bij uw bedrijf Workstars site als beheerder.

8. Klik in de belangrijkste werkbalk **instellingen**.

    ![Workstars TAKENL](./media/workstars-tutorial/tutorial_workstars_sett.png)

9. Ga naar **Meld u aan bij** > **instellingen**.
