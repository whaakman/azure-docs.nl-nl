...
4. Op de **SAML-certificaat voor ondertekening van** sectie, klikt u op **certificaat (Base64)** en sla het certificaatbestand op uw computer.
    ...
    ![Certificaat voor ondertekening van SAML-sectie](./media/work-com-tutorial/tutorial_work-com_certificate.png) 
...
13. Vouw de **beveiligingsmechanismen** menu en klik vervolgens op **instellingen voor eenmalige aanmelding**.
    ...
    ![Eenmalige aanmelding instellingen](./media/work-com-tutorial/ic794113.png "eenmalige aanmelding-instellingen")
...
15. In de **SAML Single Sign-On-instellingen** sectie, voert u de volgende stappen uit:
    ...
    ![Afzonderlijke SAML aanmelding instelling](./media/work-com-tutorial/ic794114.png "SAML Single Sign-On-instelling")
...
1. In de **Azure-portal**, klik op het navigatiedeelvenster links **Azure Active Directory** pictogram.
    ...
    ![Een Azure AD-testgebruiker maken](./media/work-com-tutorial/create_aaduser_01.png) 
...
2. Selecteer in de lijst met toepassingen **Work.com**.
    ...
    ![Work.com in de lijst van app](./media/work-com-tutorial/tutorial_work-com_app.png) 
