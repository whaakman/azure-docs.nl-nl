...
4. Typ in het zoekvak **Palo Alto Networks - opening**, selecteer **Palo Alto Networks - opening** van resultaat deelvenster klik vervolgens op **toevoegen** om toe te voegen van de toepassing.
    ...
    ![Netwerken Palo Alto - opening in de lijst met resultaten](./media/paloaltonetworks-aperture-tutorial/tutorial_paloaltonetwork_addfromgallery.png)
...
2. Op de **eenmalige aanmelding** dialoogvenster Selecteer **modus** als **op basis van SAML aanmelding** voor eenmalige aanmelding inschakelen.
    ...
    ![Dialoogvenster voor eenmalige aanmelding](./media/paloaltonetworks-aperture-tutorial/tutorial_paloaltonetwork_samlbase.png)
...
3. Op de **Palo Alto Networks - opening domein en de URL's** sectie, voert u de volgende stappen uit als u wilt configureren, de toepassing in **IDP** modus gestart:
    ...
    ![Palo Alto netwerken - URL's en opening domein eenmalige aanmelding informatie](./media/paloaltonetworks-aperture-tutorial/tutorial_paloaltonetwork_url.png)
...
4. Controleer **weergeven geavanceerde instellingen voor URL** en voer de volgende stap als u wilt configureren van de toepassing in **SP** modus gestart:
    ...
    ![Palo Alto netwerken - URL's en opening domein eenmalige aanmelding informatie](./media/paloaltonetworks-aperture-tutorial/tutorial_paloaltonetwork_url1.png)
...
6. Klik op **opslaan** knop.
    ...
    ![Knop Single Sign-On opslaan configureren](./media/paloaltonetworks-aperture-tutorial/tutorial_general_400.png)
...
2. Selecteer in de lijst met toepassingen **Palo Alto Networks - opening**.
    ...
    ![De netwerken Palo Alto - opening koppeling in de lijst met toepassingen](./media/paloaltonetworks-aperture-tutorial/tutorial_paloaltonetwork_app.png)  
