...
3. **[Het maken van een testgebruiker Showpad](#creating-a-showpad-test-user)**  : als u wilt een equivalent van Britta Simon in Showpad die is gekoppeld aan de Azure AD-weergave van de gebruiker hebben.
...
3. Op de **Showpad domein en URL's** sectie, voert u de volgende stappen uit:

    ![Eenmalige aanmelding configureren](./media/showpad-tutorial/tutorial_showpad_url.png)

    a. In de **aanmeldings-URL** tekstvak, een URL met behulp van het volgende patroon: `https://<comapany-name>.showpad.biz/login`

    b. In de **id** tekstvak, een URL met behulp van het volgende patroon: `https://<company-name>.showpad.biz`

    > [!NOTE] 
    > Deze waarden zijn niet echt. Werk deze waarden met de werkelijke aanmeldings-URL en -id. Neem contact op met [Showpad ondersteuningsteam](https://help.showpad.com) om deze waarden te verkrijgen. 
...
6. Aanmelding bij uw tenant Showpad als beheerder.

7. Klik in het menu bovenaan op de **instellingen**.
   
    ![Single Sign-On aan App configureren](./media/showpad-tutorial/tutorial_showpad_001.png) 

8. Navigeer naar "**Single Sign-On**'en klikt u op'**inschakelen**."
   
    ![Single Sign-On aan App configureren](./media/showpad-tutorial/tutorial_showpad_002.png)

9. Op de **toevoegen van een SAML 2.0-Service** dialoogvenster, voer de volgende stappen uit:
   
    ![Single Sign-On aan App configureren](./media/showpad-tutorial/tutorial_showpad_003.png) 
