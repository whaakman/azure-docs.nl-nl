...
1. Het configureren van eenmalige aanmelding op **organigram nu** zijde, moet u voor het verzenden van de gedownloade **Metadata XML** naar [organigram nu ondersteuningsteam](mailto:ocnsupport@officeworksoftware.com). Ze stelt u deze optie om de SAML SSO-verbinding instellen goed aan beide zijden.
...
1. Maken **Admin** gebruikers en **lezen/schrijven** gebruikers, moet u handmatig een gebruiker maken om te kunnen toegang krijgen tot hun niveau van bevoegdheden via eenmalige aanmelding. Voor het inrichten van een gebruikersaccount, moet u de volgende stappen uitvoeren:
