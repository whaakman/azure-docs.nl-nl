...
1. Typ in het zoekvak **Klue**.

    ![Het maken van een Azure AD-testgebruiker](./media/klue-tutorial/tutorial_klue_search.png)

1. Selecteer in het deelvenster resultaten **Klue**, en klik vervolgens op **toevoegen** om toe te voegen van de toepassing.
...
1. **[Het maken van een testgebruiker Klue](#creating-a-klue-test-user)**  : als u wilt een equivalent van Britta Simon in Klue die is gekoppeld aan de Azure AD-weergave van de gebruiker hebben.
...
1. Op de **Klue domein en URL's** sectie, als u wilt configureren van de toepassing in **IDP** modus gestart:
...
1. Op de **Klue configuratie** sectie, klikt u op **configureren Klue** openen **aanmelding configureren** venster. Kopiëren de **SAML entiteit-ID en Single Sign-On Service URL voor SAML-** uit de **Naslaggids sectie.**

    ![Eenmalige aanmelding configureren](./media/klue-tutorial/tutorial_klue_configure.png) 

1. Het configureren van eenmalige aanmelding op **Klue** zijde, moet u voor het verzenden van de gedownloade **Certificate(Base64), Single Sign-On Service URL voor SAML- en SAML entiteit-ID** naar [Klue ondersteuningsteam](mailto:support@klue.com).
...
1. Selecteer in de lijst met toepassingen, **Klue**.
