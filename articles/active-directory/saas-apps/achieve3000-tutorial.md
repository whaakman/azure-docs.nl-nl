...
2. Op de **eenmalige aanmelding** dialoogvenster Selecteer **modus** als **op basis van SAML aanmelding** voor eenmalige aanmelding inschakelen.
    ...
    ![Dialoogvenster voor eenmalige aanmelding](./media/achieve3000-tutorial/tutorial_achieve3000_samlbase.png)

3. Op de **Achieve3000 domein en de URL's** sectie, voert u de volgende stappen uit:

    ![URL's en Achieve3000 domein eenmalige aanmelding informatie](./media/achieve3000-tutorial/tutorial_achieve3000_url.png)
...
6. In de **gebruikerskenmerken** sectie op de **eenmalige aanmelding** dialoogvenster SAML-token kenmerk configureren zoals wordt weergegeven in de afbeelding en de volgende stappen uitvoeren:
    ...
    ![Eenmalige aanmelding configureren toevoegen](./media/achieve3000-tutorial/tutorial_officespace_04.png)

    ![Eenmalige aanmelding Addattb configureren](./media/achieve3000-tutorial/tutorial_attribute_05.png)
...
7. Klik op **opslaan** knop.
    ...
    ![Knop Single Sign-On opslaan configureren](./media/achieve3000-tutorial/tutorial_general_400.png)
