...
4. Typ in het zoekvak **SilkRoad levensduur Suite**, selecteer **SilkRoad levensduur Suite** van resultaat deelvenster klik vervolgens op **toevoegen** om toe te voegen van de toepassing.
    ...
    ![SilkRoad levensduur Suite in de lijst met resultaten](./media/silkroad-life-suite-tutorial/tutorial_silkroadlifesuite_addfromgallery.png)
...
2. Op de **eenmalige aanmelding** dialoogvenster Selecteer **modus** als **op basis van SAML aanmelding** voor eenmalige aanmelding inschakelen.
    ...
    ![Dialoogvenster voor eenmalige aanmelding](./media/silkroad-life-suite-tutorial/tutorial_silkroadlifesuite_samlbase.png)

3. Op de **SilkRoad levensduur Suite domein en de URL's** sectie, voert u de volgende stappen uit:

    ![URL's en SilkRoad levensduur Suite domein één aanmelding informatie](./media/silkroad-life-suite-tutorial/tutorial_silkroadlifesuite_url1.png)
...
5. Klik op **opslaan** knop.
    ...
    ![Knop Single Sign-On opslaan configureren](./media/silkroad-life-suite-tutorial/tutorial_general_400.png)
...
2. Selecteer in de lijst met toepassingen **SilkRoad levensduur Suite**.
    ...
    ![De koppeling SilkRoad levensduur Suite in de lijst met toepassingen](./media/silkroad-life-suite-tutorial/tutorial_silkroadlifesuite_app.png)  
