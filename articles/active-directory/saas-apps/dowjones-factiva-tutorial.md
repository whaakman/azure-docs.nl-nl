...
3. **[Het maken van een testgebruiker Derhoud Jones Factiva](#creating-a-dow-jones-factiva-test-user)**  : als u wilt een equivalent van Britta Simon in Derhoud Jones Factiva die is gekoppeld aan de Azure AD-weergave van de gebruiker hebben.
...
3. Op de **Derhoud Jones Factiva domein en URL's** sectie, de gebruiker beschikt niet over de stappen uitvoeren omdat de app is al vooraf geïntegreerd met Azure.
...
6. Het configureren van eenmalige aanmelding op **Derhoud Jones Factiva** zijde, moet u voor het verzenden van de gedownloade **Metadata XML** naar [Derhoud Jones Factiva ondersteuningsteam](https://www.dowjones.com/contact/). Ze stelt u deze optie om de SAML SSO-verbinding instellen goed aan beide zijden.
