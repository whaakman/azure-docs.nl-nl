...
2. Op de **eenmalige aanmelding** dialoogvenster Selecteer **modus** als **op basis van SAML aanmelding** voor eenmalige aanmelding inschakelen.
    ...
    ![Dialoogvenster voor eenmalige aanmelding](./media/predictixpricereporting-tutorial/tutorial_predictixpricereporting_samlbase.png)

3. Op de **Predictix prijs Reporting domein en de URL's** sectie, voert u de volgende stappen uit:

    ![URL's en Predictix prijs Reporting domein eenmalige aanmelding informatie](./media/predictixpricereporting-tutorial/tutorial_predictixpricereporting_url.png)
...
5. Klik op **opslaan** knop.
    ...
    ![Knop Single Sign-On opslaan configureren](./media/predictixpricereporting-tutorial/tutorial_general_400.png)
...
6. Op de **Predictix prijs Reporting configuratie** sectie, klikt u op **configureren Predictix prijs Reporting** openen **eenmalige aanmelding configureren** venster. Kopieer de **Sign-Out-URL, SAML entiteit-ID en SAML Single Sign-On Service-URL** van de **Naslaggids punt.**
    ...
    ![Configuratie van Predictix prijs Reporting](./media/predictixpricereporting-tutorial/tutorial_predictixpricereporting_configure.png) 
