...
3. **[Het maken van een testgebruiker Sciforma](#creating-a-sciforma-test-user)**  : als u wilt een equivalent van Britta Simon in Sciforma die is gekoppeld aan de Azure AD-weergave van de gebruiker hebben.
...
3. Op de **Sciforma domein en URL's** sectie, voert u de volgende stappen uit:
...
6. Het configureren van eenmalige aanmelding op **Sciforma** zijde, moet u voor het verzenden van de gedownloade **Metadata XML** naar [Sciforma ondersteuningsteam](http://www.sciforma.com/company/contact_us).
