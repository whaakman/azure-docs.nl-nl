...
1. Op de **Sciforma domein en URL's** sectie, voert u de volgende stappen uit:
    ...
    a. Typ in het tekstvak **Aanmeldings-URL** een URL met het volgende patroon: `https://<subdomain>.sciforma.net/sciforma/main.html`

    b. Typ in het tekstvak **Id** een URL met het volgende patroon: `https://<subdomain>.sciforma.net/sciforma/saml`

    > [!NOTE] 
    > Dit zijn geen echte waarden. Werk deze waarden bij met de daadwerkelijke aanmeldings-URL en id. Neem contact op met [Sciforma Client ondersteuningsteam](https://www.sciforma.com/about/contact) om deze waarden te verkrijgen. 
...
1. Het configureren van eenmalige aanmelding op **Sciforma** zijde, moet u voor het verzenden van de gedownloade **Metadata XML** naar [Sciforma ondersteuningsteam](https://www.sciforma.com/about/contact).
