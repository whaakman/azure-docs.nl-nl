...
1. Het configureren van eenmalige aanmelding op **Qumu Cloud** zijde, moet u voor het verzenden van de gedownloade **Metadata XML** naar [Qumu Cloud-ondersteuningsteam](mailto:support@qumu.com). Ze stelt u deze optie om de SAML SSO-verbinding instellen goed aan beide zijden.
