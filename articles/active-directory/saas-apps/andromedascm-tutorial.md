...
2. Op de **eenmalige aanmelding** dialoogvenster Selecteer **modus** als **op basis van SAML aanmelding** voor eenmalige aanmelding inschakelen.
    ...
    ![Dialoogvenster voor eenmalige aanmelding](./media/andromedascm-tutorial/tutorial_andromedascm_samlbase.png)
...
3. Op de **Andromeda domein en de URL's** sectie, voert u de volgende stappen uit als u wilt configureren, de toepassing in **IDP** modus gestart:
    ...
    ![URL's en Andromeda domein eenmalige aanmelding informatie](./media/andromedascm-tutorial/tutorial_andromedascm_url.png)
...
4. Controleer **weergeven geavanceerde instellingen voor URL** en voer de volgende stap als u wilt configureren van de toepassing in **SP** modus gestart:
    ...
    ![URL's en Andromeda domein eenmalige aanmelding informatie](./media/andromedascm-tutorial/tutorial_andromedascm_url1.png)
...
6. In de **gebruikerskenmerken** sectie op de **eenmalige aanmelding** dialoogvenster SAML-token kenmerk configureren zoals wordt weergegeven in de afbeelding en de volgende stappen uitvoeren:
    ...
    ![Eenmalige aanmelding configureren toevoegen](./media/andromedascm-tutorial/tutorial_attribute_04.png)

    ![Eenmalige aanmelding Addattb configureren](./media/andromedascm-tutorial/tutorial_attribute_05.png)
...
8. Klik op **opslaan** knop.
    ...
    ![Knop Single Sign-On opslaan configureren](./media/andromedascm-tutorial/tutorial_general_400.png)
