...
2. Op de **eenmalige aanmelding** dialoogvenster Selecteer **modus** als **op basis van SAML aanmelding** voor eenmalige aanmelding inschakelen.
    ...
    ![Dialoogvenster voor eenmalige aanmelding](./media/redbrickhealth-tutorial/tutorial_redbrickhealth_samlbase.png)

3. Op de **RedBrick Health domein en de URL's** sectie, voert u de volgende stappen uit:

    ![RedBrick Health domein en de URL's van eenmalige aanmelding informatie](./media/redbrickhealth-tutorial/tutorial_redbrickhealth_url.png)
    ...
    ![RedBrick Health domein en de URL's van eenmalige aanmelding informatie](./media/redbrickhealth-tutorial/tutorial_redbrickhealth_url1.png)
...
7. Klik op **opslaan** knop.
    ...
    ![Knop Single Sign-On opslaan configureren](./media/redbrickhealth-tutorial/tutorial_general_400.png)
...
2. Selecteer in de lijst met toepassingen **RedBrick Health**.
    ...
    ![De koppeling RedBrick Health in de lijst met toepassingen](./media/redbrickhealth-tutorial/tutorial_redbrickhealth_app.png)  
