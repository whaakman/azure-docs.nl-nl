...
3. **[Maak een testgebruiker RedBrick Health](#create-a-redbrick-health-test-user)**  : als u wilt een equivalent van Britta Simon in RedBrick status die is gekoppeld aan de Azure AD-weergave van de gebruiker hebben.
...
3. Op de **RedBrick Health domein en URL's** sectie, voert u de volgende stappen uit:
...
8. Op de **RedBrick Statusconfiguratie** sectie, klikt u op **RedBrick Health configureren** openen **aanmelding configureren** venster. Kopiëren de **SAML entiteit-ID** uit de **Naslaggids sectie.**
