...
3. **[Maak een testgebruiker OnTrack](#create-an-ontrack-test-user)**  : als u wilt een equivalent van Britta Simon in OnTrack die is gekoppeld aan de Azure AD-weergave van de gebruiker hebben.
...
3. Op de **OnTrack domein en URL's** sectie, voert u de volgende stappen uit:
...
7. Klik op **opslaan** knop.
    ...
    ![Configureren van eenmalige aanmelding opslaan](./media/ontrack-tutorial/tutorial_general_400.png)

8. Het configureren van eenmalige aanmelding op **OnTrack** zijde, moet u voor het verzenden van de gedownloade **Metadata XML** naar [OnTrack ondersteuningsteam](mailto:CustomerService@insigniagroup.com). Ze stelt u deze optie om de SAML SSO-verbinding instellen goed aan beide zijden.
...
In deze sectie maakt u een gebruiker met de naam van Britta Simon in OnTrack. Werken met [OnTrack ondersteuningsteam](mailto:CustomerService@insigniagroup.com) om toe te voegen de gebruikers in het OnTrack-platform. Gebruikers moeten worden gemaakt en worden geactiveerd voordat u eenmalige aanmelding gebruiken.
