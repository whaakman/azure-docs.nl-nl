...
2. Op de **eenmalige aanmelding** dialoogvenster Selecteer **modus** als **op basis van SAML aanmelding** voor eenmalige aanmelding inschakelen.
    ...
    ![Dialoogvenster voor eenmalige aanmelding](./media/ontrack-tutorial/tutorial_ontrack_samlbase.png)

3. Op de **OnTrack domein en de URL's** sectie, voert u de volgende stappen uit:

    ![URL's en OnTrack domein eenmalige aanmelding informatie](./media/ontrack-tutorial/tutorial_ontrack_url.png)
...
7. Klik op **opslaan** knop.
    ...
    ![Knop Single Sign-On opslaan configureren](./media/ontrack-tutorial/tutorial_general_400.png)
