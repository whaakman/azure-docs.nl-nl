...
3. **[Maak een testgebruiker INSTALLATIEKOPIE werkt](#create-a-image-works-test-user)**  : als u wilt een equivalent van Britta Simon in INSTALLATIEKOPIE werkt die is gekoppeld aan de Azure AD-weergave van de gebruiker hebben.
...
3. Op de **INSTALLATIEKOPIE werkt domein en URL's** sectie, voert u de volgende stappen uit:
...
6. Op de **configuratie van de INSTALLATIEKOPIE werkt** sectie, klikt u op **configureren INSTALLATIEKOPIE werkt** openen **aanmelding configureren** venster. Kopiëren de **URL van de afmelding, SAML-entiteit-ID en Single Sign-On Service URL voor SAML-** uit de **Naslaggids sectie.**
