...
1. Typ in het zoekvak **Nomadesk**.

    ![Het maken van een Azure AD-testgebruiker](./media/nomadesk-tutorial/tutorial_nomadesk_search.png)

1. Selecteer in het deelvenster resultaten **Nomadesk**, en klik vervolgens op **toevoegen** om toe te voegen van de toepassing.
...
1. **[Het maken van een testgebruiker Nomadesk](#creating-a-nomadesk-test-user)**  : als u wilt een equivalent van Britta Simon in Nomadesk die is gekoppeld aan de Azure AD-weergave van de gebruiker hebben.
...
1. Op de **Nomadesk domein en URL's** sectie, voert u de volgende stappen uit:

    ![Eenmalige aanmelding configureren](./media/nomadesk-tutorial/tutorial_nomadesk_url.png)

    a. Typ in het tekstvak **Aanmeldings-URL** een URL met het volgende patroon: `https://mynomadesk.com/logon/saml/<TENANTID>`

    b. Typ in het tekstvak **Id** een URL met het volgende patroon: `https://secure.nomadesk.com/saml/<instancename>`

    > [!NOTE] 
    > Dit zijn geen echte waarden. Werk deze waarden bij met de daadwerkelijke aanmeldings-URL en -id. Neem contact op met [Nomadesk Client ondersteuningsteam](mailto:support@nomadesk.com) om deze waarden te verkrijgen. 
...
1. Op de **Nomadesk configuratie** sectie, klikt u op **configureren Nomadesk** openen **aanmelding configureren** venster. Kopiëren de **afmelding-URL, SAML-entiteit-ID en Single Sign-On Service URL voor SAML-** uit de **Naslaggids sectie.**
...
1. Selecteer in de lijst met toepassingen, **Nomadesk**.
