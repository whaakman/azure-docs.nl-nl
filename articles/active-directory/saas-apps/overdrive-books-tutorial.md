...
1. Op de **Overdrive domein en URL's** sectie, voert u de volgende stappen uit:
    ...
    Typ in het tekstvak **Aanmeldings-URL** een URL met het volgende patroon: `http://<subdomain>.libraryreserve.com`
...
1. Het configureren van eenmalige aanmelding op **Overdrive** zijde, moet u voor het verzenden van de gedownloade **Metadata XML** naar [Overdrive ondersteuningsteam](https://help.overdrive.com/). Het team stelt de instellingen zo in dat de verbinding tussen SAML en eenmalige aanmelding aan beide zijden goed is ingesteld.
