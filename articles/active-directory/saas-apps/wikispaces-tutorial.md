...
1. Op de **Wikispaces domein en URL's** sectie, voert u de volgende stappen uit:
    ...
    a. Typ in het tekstvak **Aanmeldings-URL** een URL met het volgende patroon: `https://<companyname>.wikispaces.net`

    b. Typ in het tekstvak **Id** een URL met het volgende patroon: `https://session.wikispaces.net/<instancename>`

    > [!NOTE] 
    > Dit zijn geen echte waarden. Werk deze waarden bij met de daadwerkelijke aanmeldings-URL en id. Neem contact op met [Wikispaces Client ondersteuningsteam](https://www.wikispaces.com/site/help) om deze waarden te verkrijgen. 
