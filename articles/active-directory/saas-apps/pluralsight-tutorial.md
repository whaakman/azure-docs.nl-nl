...
2. Op de **eenmalige aanmelding** dialoogvenster Selecteer **modus** als **op basis van SAML aanmelding** voor eenmalige aanmelding inschakelen.
    ...
    ![Dialoogvenster voor eenmalige aanmelding](./media/pluralsight-tutorial/tutorial_pluralsight_samlbase.png)

3. Op de **Pluralsight domein en de URL's** sectie, voert u de volgende stappen uit:

    ![URL's en Pluralsight domein eenmalige aanmelding informatie](./media/pluralsight-tutorial/tutorial_pluralsight_url.png)
...
2. Selecteer in de lijst met toepassingen **Pluralsight**.
    ...
    ![De koppeling Pluralsight in de lijst met toepassingen](./media/pluralsight-tutorial/tutorial_pluralsight_app.png)  
