...
1. Op de **Soonr werkplek domein en URL's** sectie, voert u de volgende stappen uit:
    ...
    a. In de **id** tekstvak, een URL met behulp van het volgende patroon: `https://<servername>.soonr.com/singlesignon/saml/metadata`

    b. In de **antwoord-URL** tekstvak, een URL met behulp van het volgende patroon: `https://<servername>.soonr.com/singlesignon/saml/SSO`
...
1. Op de **Soonr werkplek domein en URL's** sectie, als u wilt configureren van de toepassing in **SP geïnitieerde modus**, voer de volgende stappen uit:
    ...
    > [!NOTE] 
    > Deze waarden zijn niet echt. Deze waarden bijwerken met de werkelijke-id en meld u aan bij de URL en antwoord-URL. Neem contact op met [Soonr werkplek ondersteuningsteam](https://awp.autotask.net/help/) om deze waarden te verkrijgen.
