...
1. Op de **Boxcryptor domein en URL's** sectie, voert u de volgende stappen uit:
    ...
    a. Typ een URL in het tekstvak **Aanmeldings-URL**: `https://www.boxcryptor.com/app`

    b. In de **id** tekstvak, een waarde: `boxcryptor`

1. Op de **SAML-handtekeningcertificaat** sectie, klikt u op **certificaat (Base64)** en slaat u het certificaatbestand op uw computer.

    ![De link om het certificaat te downloaden](./media/boxcryptor-tutorial/tutorial_boxcryptor_certificate.png) 

1. Klik op **opslaan** knop.

    ![De knop voor enkelvoudige aanmelding configureren](./media/boxcryptor-tutorial/tutorial_general_400.png)
...
In deze sectie maakt u een gebruiker met de naam van Britta Simon in Boxcryptor. Werken met [Boxcryptor ondersteuningsteam](mailto:support@boxcryptor.com) om toe te voegen de gebruikers of het domein dat nodig is om te worden opgenomen in de whitelist in het Boxcryptor-platform. Als het domein is toegevoegd door het team, krijgen automatisch gebruikers ingericht voor het Boxcryptor-platform. Er moeten gebruikers worden gemaakt en geactiveerd voordat u eenmalige aanmelding kunt gebruiken.
