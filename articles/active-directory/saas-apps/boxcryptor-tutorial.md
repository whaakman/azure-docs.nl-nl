...
3. **[Maak een testgebruiker Boxcryptor](#create-a-boxcryptor-test-user)**  : als u wilt een equivalent van Britta Simon in Boxcryptor die is gekoppeld aan de Azure AD-weergave van de gebruiker hebben.
...
3. Op de **Boxcryptor domein en URL's** sectie, voert u de volgende stappen uit:
...
6. Op de **Boxcryptor configuratie** sectie, klikt u op **configureren Boxcryptor** openen **aanmelding configureren** venster. Kopiëren de **Single Sign-On Service URL voor SAML** en **SAML entiteit-ID** uit de **Naslaggids sectie.**
