...
2. Op de **eenmalige aanmelding** dialoogvenster Selecteer **modus** als **op basis van SAML aanmelding** voor eenmalige aanmelding inschakelen.
    ...
    ![Dialoogvenster voor eenmalige aanmelding](./media/trello-tutorial/tutorial_trello_samlbase.png)
...
3. Op de **Trello domein en de URL's** sectie als u wilt configureren van de toepassing in **IDP geïnitieerd modus**, voer de volgende stappen uit:
    ...
    ![URL's en Trello domein eenmalige aanmelding informatie](./media/trello-tutorial/tutorial_trello_url.png)
...
4. Als u wilt configureren van de toepassing in **SP geïnitieerd modus**, voer de volgende stappen uit:
    ...
    ![URL's en Trello domein eenmalige aanmelding informatie](./media/trello-tutorial/tutorial_trello_url1.png)
...
8. Klik op **opslaan** knop.
    ...
    ![Knop Single Sign-On opslaan configureren](./media/trello-tutorial/tutorial_general_400.png)
...
2. Selecteer in de lijst met toepassingen **Trello**.
    ...
    ![De koppeling Trello in de lijst met toepassingen](./media/trello-tutorial/tutorial_trello_app.png)  
