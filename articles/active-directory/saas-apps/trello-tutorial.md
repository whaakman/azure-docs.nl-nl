...
3. **[Maak een testgebruiker Trello](#create-a-trello-test-user)**  : als u wilt een equivalent van Britta Simon in Trello die is gekoppeld aan de Azure AD-weergave van de gebruiker hebben.
...
3. Op de **Trello-domein en URL's** sectie, als u wilt configureren van de toepassing in **IDP gestart door modus**, voer de volgende stappen uit:
...
7. Op de **SAML-handtekeningcertificaat** sectie, klikt u op **certificaat (Base64)** en sla het bestand met metagegevens op uw computer.
...
9. Op de **Trello configuratie** sectie, klikt u op **configureren Trello** openen **aanmelding configureren** venster. Kopiëren de **Single Sign-On Service URL voor SAML** uit de **Naslaggids sectie.**
