...
1. Op de **halogeen Software domein en URL's** sectie, voert u de volgende stappen uit:
    ...
    a. In de **aanmeldings-URL** tekstvak, een URL met behulp van het volgende patroon: `https://global.hgncloud.com/<companyname>`
    ...
    > [!NOTE] 
    > Deze waarden zijn niet echt. Werk deze waarden met de werkelijke aanmeldings-URL en -id. Neem contact op met [halogeen softwareclient ondersteuningsteam](https://support.halogensoftware.com/) om deze waarden te verkrijgen. 
