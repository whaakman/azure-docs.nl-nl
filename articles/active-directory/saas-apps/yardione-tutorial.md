...
3. **[Maak een testgebruiker YardiOne](#create-a-yardione-test-user)**  : als u wilt een equivalent van Britta Simon in YardiOne die is gekoppeld aan de Azure AD-weergave van de gebruiker hebben.
...
3. Op de **YardiOne domein en URL's** sectie, voert u de volgende stappen uit:

    ![YardiOne domein en URL's, eenmalige aanmelding informatie](./media/yardione-tutorial/tutorial_yardione_url.png)

    a. In de **aanmeldings-URL** tekstvak, een URL met behulp van het volgende patroon: `https://<y1-subdomain>.yardione.com`

    b. In de **id** tekstvak, een URL met behulp van het volgende patroon: `http://<y1-subdomain>.yardione.com/yAuth2/trust`

    > [!NOTE] 
    > Deze waarden zijn niet echt. Werk deze waarden met de werkelijke aanmeldings-URL en -id. Neem contact op met [YardiOne Client ondersteuningsteam](https://clientcentral.yardi.com) om deze waarden te verkrijgen.
...
5. Klik op **opslaan** knop.
    ...
    ![Configureren van eenmalige aanmelding opslaan](./media/yardione-tutorial/tutorial_general_400.png)

6. Het configureren van eenmalige aanmelding op **YardiOne** zijde, moet u voor het verzenden van de **App-Url voor federatieve metagegevens** naar [YardiOne ondersteuningsteam](https://clientcentral.yardi.com). Ze stelt u deze optie om de SAML SSO-verbinding instellen goed aan beide zijden.
