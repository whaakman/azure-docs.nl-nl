...
In deze zelfstudie leert u hoe YardiOne integreren met Azure Active Directory (Azure AD).

YardiOne integreren met Azure AD biedt de volgende voordelen:

- U kunt beheren in Azure AD die toegang tot YardiOne heeft.
- U kunt uw gebruikers automatisch ophalen aangemeld bij YardiOne (Single Sign-On) met hun Azure AD-accounts kunt inschakelen.
...
1. YardiOne uit de galerie toevoegen
2. Configureren en testen van Azure AD eenmalige aanmelding

## <a name="adding-yardione-from-the-gallery"></a>YardiOne uit de galerie toevoegen
Voor het configureren van de integratie van YardiOne in Azure AD, moet u YardiOne uit de galerie toevoegen aan de lijst met beheerde SaaS-apps.
...
4. Typ in het zoekvak **YardiOne**, selecteer **YardiOne** van resultaat deelvenster klik vervolgens op **toevoegen** om toe te voegen van de toepassing.

    ![YardiOne in de lijst met resultaten](./media/yardione-tutorial/tutorial_yardione_addfromgallery.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Configureren en testen eenmalige aanmelding Azure AD

In deze sectie configureert en test eenmalige aanmelding Azure AD met YardiOne op basis van een testgebruiker 'Britta Simon' genoemd.

Voor eenmalige aanmelding werkt, moet Azure AD weten wat de gebruiker equivalent in YardiOne is voor een gebruiker in Azure AD. Met andere woorden, moet een koppeling relatie tussen een Azure AD-gebruiker en de betreffende gebruiker in YardiOne tot stand worden gebracht.
...
3. **[Maak een testgebruiker YardiOne](#create-a-yardione-test-user)**  - YardiOne die is gekoppeld aan de Azure AD-weergave van de gebruiker van een exemplaar van Britta Simon bevatten.
4. **[Toewijzen van de Azure AD-testgebruiker](#assign-the-azure-ad-test-user)**  - Britta Simon gebruik van Azure AD eenmalige aanmelding inschakelen.
5. **[Test eenmalige aanmelding](#test-single-sign-on)**  : om te controleren of de configuratie werkt.

### <a name="configure-azure-ad-single-sign-on"></a>Eenmalige aanmelding Azure AD configureren

In dit gedeelte Azure AD eenmalige aanmelding inschakelen in de Azure portal en eenmalige aanmelding in uw toepassing YardiOne configureren.

**Voor het configureren van Azure AD eenmalige aanmelding met YardiOne, moet u de volgende stappen uitvoeren:**

1. In de Azure-portal op de **YardiOne** toepassing Integratiepagina, klikt u op **eenmalige aanmelding**.

    ![Koppeling voor eenmalige aanmelding configureren][4]

2. Op de **eenmalige aanmelding** dialoogvenster Selecteer **modus** als **op basis van SAML aanmelding** voor eenmalige aanmelding inschakelen.
 
    ![Dialoogvenster voor eenmalige aanmelding](./media/yardione-tutorial/tutorial_yardione_samlbase.png)

3. Op de **YardiOne domein en de URL's** sectie, voert u de volgende stappen uit:

    ![URL's en YardiOne domein eenmalige aanmelding informatie](./media/yardione-tutorial/tutorial_yardione_url.png)

    a. In de **aanmeldings-URL** textbox, typ een URL met het volgende patroon volgen: `https://<y1-subdomain>.yardione.com`
...
4. Op de **SAML-certificaat voor ondertekening van** sectie, klikt u op de knop kopiëren om te kopiëren **App-Url voor federatieve metagegevens** en plak deze in Kladblok. 
    ...
    ![De downloadkoppeling certificaat](./media/yardione-tutorial/tutorial_yardione_certificate.png) 
 
5. Klik op **opslaan** knop.

    ![Knop Single Sign-On opslaan configureren](./media/yardione-tutorial/tutorial_general_400.png)
...
### <a name="create-a-yardione-test-user"></a>Een testgebruiker YardiOne maken

Het doel van deze sectie is het maken van een gebruiker Britta Simon in YardiOne genoemd. YardiOne ondersteunt just-in-time-inrichting, dit is standaard ingeschakeld. Er is geen actie-item voor u in deze sectie. Een nieuwe gebruiker is gemaakt tijdens een poging tot toegang tot YardiOne als deze nog niet bestaat.
...
In deze sectie schakelt u Britta Simon gebruikt Azure eenmalige aanmelding toegang verlenen aan YardiOne.

![Toewijzen van de gebruikersrol][200] 

**Britta Simon om aan te wijzen YardiOne, moet u de volgende stappen uitvoeren:**

1. Open de weergave toepassingen in de Azure-portal en gaat u naar de directoryweergave en gaat u naar **bedrijfstoepassingen** klikt u vervolgens op **alle toepassingen**.

    ![Gebruiker toewijzen][201] 

2. Selecteer in de lijst met toepassingen **YardiOne**.
...
Als u op de tegel YardiOne in het deelvenster toegang, u moet ophalen automatisch aangemeld bij uw toepassing YardiOne.
