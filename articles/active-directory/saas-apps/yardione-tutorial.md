...
* U kunt uw gebruikers worden automatisch aangemeld YardiOne (Single Sign-On) met hun Azure AD-accounts inschakelen.
...
* Eenmalige aanmelding YardiOne ingeschakeld abonnement

## <a name="scenario-description"></a>Scenariobeschrijving

In deze zelfstudie gaat u in een testomgeving eenmalige aanmelding van Azure AD configureren en testen.

* Biedt ondersteuning voor YardiOne **SP** gestart door SSO

* Biedt ondersteuning voor YardiOne **Just In Time** inrichten van gebruikers
...
In deze sectie kunt u configureren en testen Azure AD eenmalige aanmelding met YardiOne op basis van een testgebruiker met de naam **Britta Simon**.
Voor eenmalige aanmelding om te werken, moet een koppeling relatie tussen een Azure AD-gebruiker en de gerelateerde gebruiker in YardiOne tot stand worden gebracht.
...
2. **[Configureren van eenmalige aanmelding YardiOne](#configure-yardione-single-sign-on)**  : als u wilt de Single Sign-On-instellingen configureren op de toepassing aan clientzijde.
3. **[Een Azure AD-testgebruiker maken](#create-an-azure-ad-test-user)**: als u Azure AD-eenmalige aanmelding wil testen met Britta Simon.
4. **[De testgebruiker van Azure AD-toewijzen](#assign-the-azure-ad-test-user)**: als u wilt dat Britta Simon gebruik kan maken van Azure AD-eenmalige aanmelding.
5. **[Maken van de testgebruiker YardiOne](#create-yardione-test-user)**  : als u wilt een equivalent van Britta Simon in YardiOne die is gekoppeld aan de Azure AD-weergave van de gebruiker hebben.
...
1. In de [Azure-portal](https://portal.azure.com/)op de **YardiOne** toepassing integratie weergeeft, schakelt **eenmalige aanmelding**.
...
4. In de sectie **Standaard SAML-configuratie** voert u de volgende stappen uit:
    ...
    ![YardiOne domein en URL's, eenmalige aanmelding informatie](common/sp-identifier.png)
...
### <a name="configure-yardione-single-sign-on"></a>YardiOne voor eenmalige aanmelding configureren
...
1. Selecteer in de Azure portal, **bedrijfstoepassingen**, selecteer **alle toepassingen**en selecteer vervolgens **YardiOne**.
...
In deze sectie wordt een gebruiker met de naam Britta Simon gemaakt in YardiOne. YardiOne biedt ondersteuning voor just-in-time-gebruikersinrichting, dat standaard is ingeschakeld. Er is geen actie-item voor u in deze sectie. Als een gebruiker nog niet in YardiOne bestaat, wordt een nieuw gemaakt nadat verificatie.
...
Wanneer u op de tegel YardiOne in het toegangsvenster, moet u worden automatisch aangemeld bij de YardiOne waarvoor u eenmalige aanmelding hebt ingesteld. Zie [Introduction to the Access Panel](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction) (Inleiding tot het toegangsvenster) voor meer informatie over het toegangsvenster.
