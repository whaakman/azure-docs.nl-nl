...
4. Typ in het zoekvak **Tangoe opdracht Premium Mobile**, selecteer **Tangoe opdracht Premium Mobile** van resultaat deelvenster klik vervolgens op **toevoegen** om toe te voegen van de toepassing.
    ...
    ![Tangoe opdracht Premium Mobile uit de galerie toevoegen ](./media/tangoe-tutorial/tutorial_tangoe_addfromgallery.png)
...
3. Op de **Tangoe opdracht Premium Mobile domein en de URL's** sectie, voert u de volgende stappen uit:
    ...
    ![URL's en mobiele Tangoe opdracht Premium-domein](./media/tangoe-tutorial/tutorial_tangoe_url.png)
...
4. Op de **SAML-certificaat voor ondertekening van** sectie, klikt u op **Metadata XML** en sla het bestand met metagegevens op uw computer.
    ...
    ![Certificaat voor ondertekening van SAML-sectie](./media/tangoe-tutorial/tutorial_tangoe_certificate.png) 

5. Klik op **opslaan** knop.

    ![knop Opslaan](./media/tangoe-tutorial/tutorial_general_400.png)
...
1. In de **Azure-portal**, klik op het navigatiedeelvenster links **Azure Active Directory** pictogram.
    ...
    ![Een Azure AD-testgebruiker maken](./media/tangoe-tutorial/create_aaduser_01.png) 
...
2. Selecteer in de lijst met toepassingen **Tangoe opdracht Premium Mobile**.
    ...
    ![Tangoe opdracht Premium Mobile in lijst met Apps](./media/tangoe-tutorial/tutorial_tangoe_app.png) 
