...
4. Typ in het zoekvak **Druva**, selecteer **Druva** van resultaat deelvenster klik vervolgens op **toevoegen** om toe te voegen van de toepassing.
    ...
    ![Druva in de lijst met resultaten](./media/druva-tutorial/tutorial_druva_addfromgallery.png)
...
2. Op de **eenmalige aanmelding** dialoogvenster Selecteer **modus** als **op basis van SAML aanmelding** voor eenmalige aanmelding inschakelen.
    ...
    ![Dialoogvenster voor eenmalige aanmelding](./media/druva-tutorial/tutorial_druva_samlbase.png)
...
12. Voer de volgende stappen uit in het dialoogvenster Instellingen voor eenmalige aanmelding:
    ...
    ![Eenmalige aanmelding instellingen](./media/druva-tutorial/ic795092.png "eenmalige aanmelding-instellingen")
...
13. Op de **instellingen** pagina, klikt u op **SSO-Token genereren**.
    ...
    ![Instellingen](./media/druva-tutorial/ic795093.png "instellingen")
...
2. Selecteer in de lijst met toepassingen **Druva**.
    ...
    ![De koppeling Druva in de lijst met toepassingen](./media/druva-tutorial/tutorial_druva_app.png)  
