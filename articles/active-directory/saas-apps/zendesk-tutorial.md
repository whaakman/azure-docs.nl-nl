...
2. Op de **eenmalige aanmelding** dialoogvenster Selecteer **modus** als **op basis van SAML aanmelding** voor eenmalige aanmelding inschakelen.
    ...
    ![Dialoogvenster voor eenmalige aanmelding](./media/zendesk-tutorial/tutorial_zendesk_samlbase.png)

3. Op de **Zendesk-domein en de URL's** sectie, voert u de volgende stappen uit:

    ![Zendesk-domein en de URL's van eenmalige aanmelding informatie](./media/zendesk-tutorial/tutorial_zendesk_url.png)
...
5. De SAML-asserties verwacht Zendesk in een specifieke indeling. Er zijn geen verplichte SAML-kenmerken, maar u kunt desgewenst een kenmerk uit toevoegen **gebruikerskenmerken** sectie volgens de onderstaande stappen te volgen: 
    ...
    ![Eenmalige aanmelding configureren toevoegen](./media/zendesk-tutorial/tutorial_attribute_04.png)
...
6. Klik op **opslaan** knop.
    ...
    ![Knop Single Sign-On opslaan configureren](./media/zendesk-tutorial/tutorial_general_400.png)
...
Het doel van deze sectie is het maken van een gebruiker Britta Simon aangeroepen in de Zendesk. Zendesk ondersteunt automatisch gebruikers inrichten, dit is standaard ingeschakeld. U vindt meer informatie [hier](zendesk-provisioning-tutorial.md) over het configureren van automatische gebruikers inrichten.

**Als u handmatig maken van de gebruiker moet, neem voert u de volgende stappen:**

> [!NOTE]
> **Eindgebruikers** accounts automatisch worden ingericht als u zich aanmeldt. **Agent** en **Admin** accounts moeten handmatig worden ingericht **Zendesk** voordat u zich aanmeldt.
