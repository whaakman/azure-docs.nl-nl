...
5. Klik op **opslaan** knop.
    ...
    ![Configureren van eenmalige aanmelding opslaan](./media/zivver-tutorial/tutorial_general_400.png)

6. Het configureren van eenmalige aanmelding op **ZIVVER** zijde, moet u voor het verzenden van de gedownloade **Metadata XML** naar [ZIVVER ondersteuningsteam](https://support.zivver.com). Ze stelt u deze optie om de SAML SSO-verbinding instellen goed aan beide zijden.
