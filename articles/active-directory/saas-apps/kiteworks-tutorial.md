...
* U kunt uw gebruikers worden automatisch aangemeld Kiteworks (Single Sign-On) met hun Azure AD-accounts inschakelen.
...
* Kiteworks eenmalige aanmelding ingeschakeld abonnement
...
4. Typ in het zoekvak **Kiteworks**, selecteer **Kiteworks** van resultaat deelvenster klik vervolgens op **toevoegen** om toe te voegen van de toepassing.

     ![Kiteworks in de lijst met resultaten](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Azure AD-eenmalige aanmelding configureren en testen

In deze sectie kunt u configureren en testen Azure AD eenmalige aanmelding met kiteworks hebben op basis van een testgebruiker met de naam **Britta Simon**.
Voor eenmalige aanmelding om te werken, moet een koppeling relatie tussen een Azure AD-gebruiker en de gerelateerde gebruiker in Kiteworks tot stand worden gebracht.
...
2. **[Configureren van eenmalige aanmelding Kiteworks](#configure-kiteworks-single-sign-on)**  : als u wilt de Single Sign-On-instellingen configureren op de toepassing aan clientzijde.
...
1. In de [Azure-portal](https://portal.azure.com/)op de **Kiteworks** toepassing integratie weergeeft, schakelt **eenmalige aanmelding**.
...
4. In de sectie **Standaard SAML-configuratie** voert u de volgende stappen uit:
    ...
    ![Kiteworks domein en URL's, eenmalige aanmelding informatie](common/sp-identifier.png)

    a. In het tekstvak **Aanmeldings-URL** typt u een URL met de volgende notatie: `https://<subdomain>.kiteworks.com`

    b. In het tekstvak **Id (Entiteits-id)** typt u een URL met de volgende notatie: `https://<subdomain>.kiteworks.com/sp/module.php/saml/sp/saml2-acs.php/sp-sso`
...
6. Op de **Kiteworks instellen** sectie, kopieert u de juiste URL('s) volgens uw behoeften.
...
### <a name="configure-kiteworks-single-sign-on"></a>Kiteworks voor eenmalige aanmelding configureren
...
1. Selecteer in de Azure portal, **bedrijfstoepassingen**, selecteer **alle toepassingen**en selecteer vervolgens **Kiteworks**.

    ![De blade Bedrijfstoepassingen](common/enterprise-applications.png)

2. Selecteer in de lijst met toepassingen, **Kiteworks**.

    ![De koppeling Kiteworks in de lijst met toepassingen](common/all-applications.png)
