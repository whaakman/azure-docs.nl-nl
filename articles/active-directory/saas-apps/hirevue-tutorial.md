...
1. Op de **HireVue domein en URL's** sectie, voert u de volgende stappen uit:
    ...
    > [!NOTE] 
    > Deze waarden zijn niet echt. Werk deze waarden met de werkelijke aanmeldings-URL en -id. Neem contact op met [HireVue Client ondersteuningsteam](mailto:samlsupport@hirevue.com) om deze waarden te verkrijgen. 
