...
2. Op de **eenmalige aanmelding** dialoogvenster Selecteer **modus** als **op basis van SAML aanmelding** voor eenmalige aanmelding inschakelen.
    ...
    ![Dialoogvenster voor eenmalige aanmelding](./media/databasics-tutorial/tutorial_databasics_samlbase.png)

3. Op de **DATABASICS domein en de URL's** sectie, voert u de volgende stappen uit:

    ![URL's en DATABASICS domein eenmalige aanmelding informatie](./media/databasics-tutorial/tutorial_databasics_url.png)
...
5. Klik op **opslaan** knop.
    ...
    ![Knop Single Sign-On opslaan configureren](./media/databasics-tutorial/tutorial_general_400.png)
