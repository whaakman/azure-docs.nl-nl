...
3. Nieuwe toepassing toevoegen, klikt u op **toevoegen** knop boven aan het dialoogvenster.
...
3. **[Het maken van een BC in de Cloud testgebruiker](#creating-a-bc-in-the-cloud-test-user)**  : als u wilt een equivalent van Britta Simon in BC hebben in de Cloud die is gekoppeld aan de Azure AD-weergave van de gebruiker.
...
3. Op de **BC in de Cloud-domein en URL's** sectie, voert u de volgende stappen uit:
...
6. Het configureren van eenmalige aanmelding op **BC in de Cloud** zijde, moet u voor het verzenden van de gedownloade **Metadata XML** naar [BC in de Cloud ondersteuningsteam](https://www.bcinthecloud.com/supportcenter/).
