...
3. **[Het maken van een testgebruiker Chromeriver](#creating-a-chromeriver-test-user)**  : als u wilt een equivalent van Britta Simon in Chromeriver die is gekoppeld aan de Azure AD-weergave van de gebruiker hebben.
...
3. Op de **Chromeriver domein en URL's** sectie, voert u de volgende stappen uit:

    ![Eenmalige aanmelding configureren](./media/chromeriver-tutorial/tutorial_chromeriver_url.png)

    a. In de **id** tekstvak, een URL met behulp van het volgende patroon: `https://<subdomain>.chromeriver.com`

    b. In de **antwoord-URL** tekstvak, een URL met behulp van het volgende patroon: `https://<subdomain>.chromeriver.com/login/sso/saml/consume?customerId=<uniqueid>`

    > [!NOTE] 
    > Deze waarden zijn niet echt. Werk deze waarden met de werkelijke id en de antwoord-URL. Neem contact op met [Chromeriver ondersteuningsteam](https://www.chromeriver.com/services/support) om deze waarden te verkrijgen.
...
6. Het configureren van eenmalige aanmelding op **Chromeriver** zijde, moet u voor het verzenden van de gedownloade **Metadata XML** naar [Chromeriver ondersteuningsteam](https://www.chromeriver.com/services/support). U krijgt een melding wanneer SSO is ingeschakeld voor uw abonnement.
