...
1. Op de **perceptie Verenigde Staten (niet-UltiPro)-domein en URL's** sectie, voert u de volgende stappen uit:
    ...
    b. In het tekstvak **Antwoord-URL** typt u een URL met behulp van het volgende patroon: `https://perception.kanjoya.com/sso?idp=<entity_id>`

    > [!NOTE] 
    > De waarde is niet echt. U werkt de waarde bij met de werkelijke antwoord-URL, zoals later in de zelfstudie wordt uitgelegd.
...
1. Klik op **opslaan** knop.
    ...
    ![De knop voor enkelvoudige aanmelding configureren](./media/perceptionunitedstates-tutorial/tutorial_general_400.png)
