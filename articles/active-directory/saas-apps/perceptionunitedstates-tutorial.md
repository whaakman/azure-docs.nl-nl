...
3. Op de **perceptie Verenigde Staten (niet-UltiPro)-domein en URL's** sectie, voert u de volgende stappen uit:
...
6. Op de **perceptie Verenigde Staten (niet-UltiPro) configuratie** sectie, klikt u op **configureren perceptie Verenigde Staten (niet-UltiPro)** openen **aanmelding configureren** venster . Kopiëren de **SAML entiteit-ID** uit de **Naslaggids sectie.**
...
7. In een ander browservenster, meld u aan bij uw bedrijf perceptie Verenigde Staten (niet-UltiPro) site als beheerder.

8. Klik in de belangrijkste werkbalk **Accountinstellingen**.
