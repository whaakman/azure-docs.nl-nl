...
2. Op de **eenmalige aanmelding** dialoogvenster Selecteer **modus** als **op basis van SAML aanmelding** voor eenmalige aanmelding inschakelen.
    ...
    ![Dialoogvenster voor eenmalige aanmelding](./media/perceptionunitedstates-tutorial/tutorial_perceptionunitedstates_samlbase.png)

3. Op de **perceptie Verenigde Staten (niet-UltiPro)-domein en de URL's** sectie, voert u de volgende stappen uit:

    ![Perceptie Verenigde Staten (niet-UltiPro)-domein en de URL's van eenmalige aanmelding informatie](./media/perceptionunitedstates-tutorial/tutorial_perceptionunitedstates_url.png)
...
5. Klik op **opslaan** knop.
    ...
    ![Knop Single Sign-On opslaan configureren](./media/perceptionunitedstates-tutorial/tutorial_general_400.png)
