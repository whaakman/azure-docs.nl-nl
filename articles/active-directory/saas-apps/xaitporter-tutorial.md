...
2. Op de **eenmalige aanmelding** dialoogvenster Selecteer **modus** als **op basis van SAML aanmelding** voor eenmalige aanmelding inschakelen.
    ...
    ![Dialoogvenster voor eenmalige aanmelding](./media/xaitporter-tutorial/tutorial_xaitporter_samlbase.png)

3. Op de **XaitPorter domein en de URL's** sectie, voert u de volgende stappen uit:

    ![URL's en XaitPorter domein eenmalige aanmelding informatie](./media/xaitporter-tutorial/tutorial_xaitporter_url.png)
...
5. Klik op **opslaan** knop.
    ...
    ![Knop Single Sign-On opslaan configureren](./media/xaitporter-tutorial/tutorial_general_400.png)
