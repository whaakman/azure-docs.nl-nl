...
3. **[Het maken van een testgebruiker Tango Analytics](#creating-a-tango-analytics-test-user)**  : als u wilt een equivalent van Britta Simon in Tango Analytics die is gekoppeld aan de Azure AD-weergave van de gebruiker hebben.
...
3. Op de **Tango Analytics domein en URL's** sectie, voert u de volgende stappen uit:
...
6. Het configureren van eenmalige aanmelding op **Tango Analytics** zijde, moet u voor het verzenden van de gedownloade **Metadata XML** naar [Tango Analytics ondersteuningsteam](mailto:support@tangoanalytics.com). Ze stelt u deze optie om de SAML SSO-verbinding instellen goed aan beide zijden.
