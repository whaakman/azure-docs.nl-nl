...
1. Typ in het zoekvak **Mindflash**.

    ![Het maken van een Azure AD-testgebruiker](./media/mindflash-tutorial/tutorial_mindflash_search.png)

1. Selecteer in het deelvenster resultaten **Mindflash**, en klik vervolgens op **toevoegen** om toe te voegen van de toepassing.
...
1. **[Het maken van een testgebruiker Mindflash](#creating-a-mindflash-test-user)**  : als u wilt een equivalent van Britta Simon in Mindflash die is gekoppeld aan de Azure AD-weergave van de gebruiker hebben.
...
1. Op de **Mindflash domein en URL's** sectie, voert u de volgende stappen uit:

    ![Eenmalige aanmelding configureren](./media/mindflash-tutorial/tutorial_mindflash_url.png)

    a. Typ in het tekstvak **Aanmeldings-URL** een URL met het volgende patroon: `https://<companyname>.mindflash.com`

    b. Typ in het tekstvak **Id** een URL met het volgende patroon: `https://<companyname>.mindflash.com`

    > [!NOTE] 
    > Dit zijn geen echte waarden. Werk deze waarden bij met de daadwerkelijke aanmeldings-URL en id. Neem contact op met [Mindflash Client ondersteuningsteam](https://www.mindflash.com/contact/) om deze waarden te verkrijgen. 
...
1. Het configureren van eenmalige aanmelding op **Mindflash** zijde, moet u voor het verzenden van de gedownloade **Metadata XML** naar [Mindflash ondersteuningsteam](https://www.mindflash.com/contact/).
...
1. Selecteer in de lijst met toepassingen, **Mindflash**.
