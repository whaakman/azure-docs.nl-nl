...
3. **[Maak een testgebruiker FileCloud](#create-a-filecloud-test-user)**  : als u wilt een equivalent van Britta Simon in FileCloud die is gekoppeld aan de Azure AD-weergave van de gebruiker hebben.
...
3. Op de **FileCloud domein en URL's** sectie, voert u de volgende stappen uit:
...
6. Op de **FileCloud configuratie** sectie, klikt u op **configureren FileCloud** openen **aanmelding configureren** venster. Kopiëren de **SAML entiteit-ID** uit de **Naslaggids sectie.**

    ![FileCloud configuratie](./media/filecloud-tutorial/tutorial_filecloud_configure.png) 

7. In een ander browservenster aanmelden voor uw tenant FileCloud als beheerder.

8. Klik in het linkernavigatiedeelvenster op **instellingen**. 
   
    ![Configureren van eenmalige aanmelding op App-zijde](./media/filecloud-tutorial/tutorial_filecloud_000.png)

9. Klik op **SSO** tabblad in de sectie instellingen. 
   
    ![Configureren van eenmalige aanmelding op App-zijde](./media/filecloud-tutorial/tutorial_filecloud_001.png)

10. Selecteer **SAML** als **SSO standaardtype** op **instellingen voor eenmalige aanmelding (SSO)** deelvenster.
   
    ![Configureren van eenmalige aanmelding op App-zijde](./media/filecloud-tutorial/tutorial_filecloud_002.png)

11. In de **IdP eindpunt-URL** tekstvak, plak de waarde van **SAML entiteit-ID** die u hebt gekopieerd vanuit Azure portal.

    ![Configureren van eenmalige aanmelding op App-zijde](./media/filecloud-tutorial/tutorial_filecloud_003.png)

12. Open het gedownloade metagegevensbestand in Kladblok, Kopieer de inhoud ervan in het Klembord en plakt u deze naar de **IdP-metagegevens** tekstvak op **SAML-instellingen** deelvenster.
