...
1. Op de **FileCloud domein en URL's** sectie, voert u de volgende stappen uit:
    ...
    a. Typ in het tekstvak **Aanmeldings-URL** een URL met het volgende patroon: `https://<subdomain>.filecloudonline.com`

    b. Typ in het tekstvak **Id** een URL met het volgende patroon: `https://<subdomain>.filecloudonline.com/simplesaml/module.php/saml/sp/metadata.php/default-sp`

    > [!NOTE] 
    > Dit zijn geen echte waarden. Werk deze waarden bij met de daadwerkelijke aanmeldings-URL en id. Neem contact op met [FileCloud Client ondersteuningsteam](mailto:support@codelathe.com) om deze waarden te verkrijgen. 
...
1. Klik op **opslaan** knop.
    ...
    ![De knop voor enkelvoudige aanmelding configureren](./media/filecloud-tutorial/tutorial_general_400.png)
