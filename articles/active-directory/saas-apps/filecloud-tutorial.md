...
2. Op de **eenmalige aanmelding** dialoogvenster Selecteer **modus** als **op basis van SAML aanmelding** voor eenmalige aanmelding inschakelen.
    ...
    ![Dialoogvenster voor eenmalige aanmelding](./media/filecloud-tutorial/tutorial_filecloud_samlbase.png)

3. Op de **FileCloud domein en de URL's** sectie, voert u de volgende stappen uit:

    ![URL's en FileCloud domein eenmalige aanmelding informatie](./media/filecloud-tutorial/tutorial_filecloud_url.png)
...
5. Klik op **opslaan** knop.
    ...
    ![Knop Single Sign-On opslaan configureren](./media/filecloud-tutorial/tutorial_general_400.png)
...
8. Klik in het navigatiedeelvenster links op **instellingen**. 
    ...
    ![Eenmalige aanmelding op App aan clientzijde configureren](./media/filecloud-tutorial/tutorial_filecloud_000.png)

9. Klik op **SSO** tabblad op het gedeelte instellingen. 
   
    ![Eenmalige aanmelding op App aan clientzijde configureren](./media/filecloud-tutorial/tutorial_filecloud_001.png)

10. Selecteer **SAML** als **SSO standaardtype** op **instellingen voor eenmalige aanmelding op (SSO)** Configuratiescherm.
   
    ![Eenmalige aanmelding op App aan clientzijde configureren](./media/filecloud-tutorial/tutorial_filecloud_002.png)

11. In de **IdP eindpunt-URL** textbox, plak de waarde van **SAML entiteit-ID** die u hebt gekopieerd vanuit Azure-portal.

    ![Eenmalige aanmelding op App aan clientzijde configureren](./media/filecloud-tutorial/tutorial_filecloud_003.png)
...
12. Open de van het gedownloade metagegevensbestand in Kladblok, Kopieer de inhoud ervan naar het Klembord en plakt u deze naar de **IdP metagegevens** textbox op **SAML instellingen** Configuratiescherm.
    ...
    ![Eenmalige aanmelding op App aan clientzijde configureren](./media/filecloud-tutorial/tutorial_filecloud_004.png)
