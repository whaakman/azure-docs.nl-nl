...
5. Klik op **opslaan** knop.
    ...
    ![De knop voor enkelvoudige aanmelding configureren](./media/edcor-tutorial/tutorial_general_400.png)
...
7. Het configureren van eenmalige aanmelding op **Edcor** zijde, moet u voor het verzenden van de gedownloade **Metadata XML**, **afmelding URL** en **SAML entiteit-ID** naar [Edcor ondersteuningsteam](http://www.edcor.com/contact-us-2/). Het team stelt de instellingen zo in dat de verbinding tussen SAML en eenmalige aanmelding aan beide zijden goed is ingesteld.
...
In deze sectie maakt u een gebruiker met de naam van Britta Simon in Edcor. Werken met [Edcor ondersteuningsteam](http://www.edcor.com/contact-us-2/) om toe te voegen de gebruikers in het Edcor-platform. Er moeten gebruikers worden gemaakt en geactiveerd voordat u eenmalige aanmelding kunt gebruiken.  
