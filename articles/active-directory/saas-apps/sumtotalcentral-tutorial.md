...
2. Op de **eenmalige aanmelding** dialoogvenster Selecteer **modus** als **op basis van SAML aanmelding** voor eenmalige aanmelding inschakelen.
    ...
    ![Dialoogvenster voor eenmalige aanmelding](./media/sumtotalcentral-tutorial/tutorial_sumtotalcentral_samlbase.png)

3. Op de **SumTotalCentral domein en de URL's** sectie, voert u de volgende stappen uit:

    ![URL's en SumTotalCentral domein eenmalige aanmelding informatie](./media/sumtotalcentral-tutorial/tutorial_sumtotalcentral_url.png)
...
5. Klik op **opslaan** knop.
    ...
    ![Knop Single Sign-On opslaan configureren](./media/sumtotalcentral-tutorial/tutorial_general_400.png)
