...
3. **[Maak een testgebruiker SumTotalCentral](#create-a-sumtotalcentral-test-user)**  : als u wilt een equivalent van Britta Simon in SumTotalCentral die is gekoppeld aan de Azure AD-weergave van de gebruiker hebben.
...
3. Op de **SumTotalCentral domein en URL's** sectie, voert u de volgende stappen uit:
...
6. Het configureren van eenmalige aanmelding op **SumTotalCentral** zijde, moet u voor het verzenden van de gedownloade **Metadata XML** naar [SumTotalCentral ondersteuningsteam](http://www.sumtotalsystems.com/support/). Ze stelt u deze optie om de SAML SSO-verbinding instellen goed aan beide zijden.
