...
3. **[Het maken van een testgebruiker CompetencyIQ](#creating-a-competencyiq-test-user)**  : als u wilt een equivalent van Britta Simon in CompetencyIQ die is gekoppeld aan de Azure AD-weergave van de gebruiker hebben.
...
3. Op de **CompetencyIQ domein en URL's** sectie, voert u de volgende stappen uit:
...
6. Op de **CompetencyIQ configuratie** sectie, klikt u op **configureren CompetencyIQ** openen **aanmelding configureren** venster. Kopiëren de **SAML entiteit-ID**, en **Single Sign-On Service URL voor SAML** uit de **Naslaggids sectie.**
