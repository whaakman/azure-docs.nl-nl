...
4. In de sectie **Standaard SAML-configuratie** voert u de volgende stappen uit:
    ...
    a. In het tekstvak **Aanmeldings-URL** typt u een URL met het volgende patroon: `https://<tenant-name>.itrp.com`

    b. In het tekstvak **Id (Entiteits-id)** typt u een URL met het volgende patroon: `https://<tenant-name>.itrp.com`
