...
3. **[Maak een testgebruiker Skyhigh netwerken](#create-a-skyhigh-networks-test-user)**  : als u wilt een equivalent van Britta Simon hebt in Skyhigh-netwerken die is gekoppeld aan de Azure AD-weergave van de gebruiker.
...
3. Op de **Skyhigh netwerken domein en URL's** sectie, voert u de volgende stappen uit als u wilt configureren van de toepassing in **IDP** modus gestart:
...
7. Op de **Skyhigh netwerken configuratie** sectie, klikt u op **Skyhigh netwerken configureren** openen **aanmelding configureren** venster. Kopiëren de **afmelding-URL, SAML-entiteit-ID en Single Sign-On Service URL voor SAML-** uit de **Naslaggids sectie.**
