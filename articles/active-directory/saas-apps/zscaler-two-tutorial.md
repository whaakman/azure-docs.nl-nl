...
4. **[Het maken van een Zscaler twee testgebruiker](#creating-a-zscaler-two-test-user)**  : als u wilt een equivalent van Britta Simon in Zscaler twee die is gekoppeld aan de Azure AD-weergave van de gebruiker hebben.
...
3. Op de **Zscaler twee domein en URL's** sectie, voert u de volgende stappen uit:
...
6. Op de **Zscaler twee configuratie** sectie, klikt u op **Zscaler twee configureren** openen **aanmelding configureren** venster. Kopiëren de **Single Sign-On Service URL voor SAML** uit de **Naslaggids sectie.**

    ![Eenmalige aanmelding configureren](./media/zscaler-two-tutorial/tutorial_zscalertwo_configure.png) 

7. In een ander browservenster aanmelden bij uw ZScaler twee bedrijf site als beheerder.
