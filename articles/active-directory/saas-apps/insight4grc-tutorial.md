...
1. Typ in het zoekvak **Insight4GRC**, selecteer **Insight4GRC** van resultaat deelvenster klik vervolgens op **toevoegen** om toe te voegen van de toepassing.
...
1. **[Maak een testgebruiker Insight4GRC](#create-an-insight4grc-test-user)**  : als u wilt een equivalent van Britta Simon in Insight4GRC die is gekoppeld aan de Azure AD-weergave van de gebruiker hebben.
...
1. Op de **Insight4GRC domein en URL's** sectie, voert u de volgende stappen uit als u wilt configureren van de toepassing in **IDP** modus gestart:
    ...
    b. In het tekstvak **Antwoord-URL** typt u een URL met behulp van het volgende patroon: `https://<subdomain>.Insight4GRC.com/Public/SAML/ACS.aspx`
...
1. Controleer **geavanceerde URL-instellingen weergeven** en voer de volgende stap als u wilt configureren van de toepassing in **SP** modus gestart:
    ...
    Typ in het tekstvak **Aanmeldings-URL** een URL met het volgende patroon: `https://<subdomain>.Insight4GRC.com/Public/Login.aspx`
     
    > [!NOTE] 
    > Dit zijn geen echte waarden. Werk deze waarden bij met de werkelijke id, antwoord-URL en aanmeldings-URL. Neem contact op met [Insight4GRC Client ondersteuningsteam](mailto:support.ss@rsmuk.com) om deze waarden te verkrijgen. 
...
1. Op de **SAML-handtekeningcertificaat** sectie, klikt u op de knop kopiëren om te kopiëren **App-Url voor federatieve metagegevens** en plak deze in Kladblok.
    ...
    ![De link om het certificaat te downloaden](./media/insight4grc-tutorial/tutorial_insight_certificate.png) 

1. Klik op **opslaan** knop.

    ![De knop voor enkelvoudige aanmelding configureren](./media/insight4grc-tutorial/tutorial_general_400.png)
    
1. Het configureren van eenmalige aanmelding op **Insight4GRC** zijde, moet u voor het verzenden van de gekopieerde **App-Url voor federatieve metagegevens** naar [Insight4GRC ondersteuningsteam](mailto:support.ss@rsmuk.com). Het team stelt de instellingen zo in dat de verbinding tussen SAML en eenmalige aanmelding aan beide zijden goed is ingesteld.
...
1. Selecteer in de lijst met toepassingen, **Insight4GRC**.
