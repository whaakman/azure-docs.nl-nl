...
1. Het configureren van eenmalige aanmelding op **Insight4GRC** zijde, moet u voor het verzenden van de gekopieerde **App-Url voor federatieve metagegevens** naar [Insight4GRC ondersteuningsteam](mailto:support.ss@rsmuk.com). Ze stelt u deze optie om de SAML SSO-verbinding instellen goed aan beide zijden.
