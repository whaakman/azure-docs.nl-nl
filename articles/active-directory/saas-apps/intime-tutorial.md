...
2. Op de **eenmalige aanmelding** dialoogvenster Selecteer **modus** als **op basis van SAML aanmelding** voor eenmalige aanmelding inschakelen.
    ...
    ![Dialoogvenster voor eenmalige aanmelding](./media/intime-tutorial/tutorial_intime_samlbase.png)

3. Op de **InTime domein en de URL's** sectie, voert u de volgende stappen uit:

    ![InTime domein en de URL's van eenmalige aanmelding informatie](./media/intime-tutorial/tutorial_intime_url.png)
...
6. Klik op **opslaan** knop.
    ...
    ![Knop Single Sign-On opslaan configureren](./media/intime-tutorial/tutorial_general_400.png)
