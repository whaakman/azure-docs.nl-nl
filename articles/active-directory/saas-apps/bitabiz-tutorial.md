...
1. Op de **BitaBIZ domein en URL's** sectie, voert u de volgende stappen uit als u wilt configureren van de toepassing in de modus voor IDP gestart:
    ...
    Typ in het tekstvak **Id** een URL met het volgende patroon: `https://www.bitabiz.com/<instanceId>`
...
1. Op de **SAML-handtekeningcertificaat** sectie, klikt u op **Certificate(Base64)** en slaat u het certificaatbestand op uw computer.
    ...
    ![De link om het certificaat te downloaden](./media/bitabiz-tutorial/tutorial_bitabiz_certificate.png) 

1. Klik op **opslaan** knop.

    ![De knop voor enkelvoudige aanmelding configureren](./media/bitabiz-tutorial/tutorial_general_400.png)
