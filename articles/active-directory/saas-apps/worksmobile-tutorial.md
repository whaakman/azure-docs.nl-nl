...
3. Op de **regel werkt domein en URL's** sectie, voert u de volgende stappen uit:
...
6. Op de **regel werkt configuratie** sectie, klikt u op **configureren regel werkt** openen **aanmelding configureren** venster. Kopiëren de **afmelding-URL, SAML-entiteit-ID en Single Sign-On Service URL voor SAML-** uit de **Naslaggids sectie.**
