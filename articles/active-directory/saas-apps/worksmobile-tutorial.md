...
* U kunt uw gebruikers worden automatisch aangemeld bij regel WORKS (Single Sign-On) inschakelen met hun Azure AD-accounts.
...
* REGEL werkt eenmalige aanmelding ingeschakeld abonnement

## <a name="scenario-description"></a>Scenariobeschrijving

In deze zelfstudie gaat u in een testomgeving eenmalige aanmelding van Azure AD configureren en testen.

* Biedt ondersteuning voor regel werkt **SP** gestart door SSO
...
4. Typ in het zoekvak **regel werkt**, selecteer **regel werkt** van resultaat deelvenster klik vervolgens op **toevoegen** om toe te voegen van de toepassing.
    ...
    ![REGEL werkt in de lijst met resultaten](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Azure AD-eenmalige aanmelding configureren en testen

In deze sectie kunt u configureren en testen Azure AD eenmalige aanmelding met regel werkt op basis van een testgebruiker met de naam **Britta Simon**.
Voor eenmalige aanmelding om te werken, moet een koppeling relatie tussen een Azure AD-gebruiker en de gerelateerde gebruiker in regel werkt tot stand worden gebracht.
...
2. **[REGEL werkt eenmalige aanmelding configureren](#configure-line-works-single-sign-on)**  : als u wilt de Single Sign-On-instellingen configureren op de toepassing aan clientzijde.
3. **[Een Azure AD-testgebruiker maken](#create-an-azure-ad-test-user)**: als u Azure AD-eenmalige aanmelding wil testen met Britta Simon.
4. **[De testgebruiker van Azure AD-toewijzen](#assign-the-azure-ad-test-user)**: als u wilt dat Britta Simon gebruik kan maken van Azure AD-eenmalige aanmelding.
5. **[REGEL werkt testgebruiker maken](#create-line-works-test-user)**  : als u wilt een equivalent van Britta Simon in regel werkt die is gekoppeld aan de Azure AD-weergave van de gebruiker hebben.
...
4. In de sectie **Standaard SAML-configuratie** voert u de volgende stappen uit:
    ...
    ![REGEL werkt domein en URL's, eenmalige aanmelding informatie](common/sp-identifier.png)
...
6. Op de **instellen van de regel werkt** sectie, kopieert u de juiste URL('s) volgens uw behoeften.
...
### <a name="configure-line-works-single-sign-on"></a>REGEL werkt eenmalige aanmelding configureren

Het configureren van eenmalige aanmelding op **regel werkt** aan clientzijde, lees de [documenten regel werkt SSO](https://developers.worksmobile.com/jp/document/1001080101) en configureer de instelling van een regel werkt.
...
1. Selecteer in de Azure portal, **bedrijfstoepassingen**, selecteer **alle toepassingen**en selecteer vervolgens **regel werkt**.

    ![De blade Bedrijfstoepassingen](common/enterprise-applications.png)

2. Selecteer in de lijst met toepassingen, **regel werkt**.

    ![De koppeling van de regel werkt in de lijst met toepassingen](common/all-applications.png)
...
### <a name="create-line-works-test-user"></a>REGEL werkt testgebruiker maken
