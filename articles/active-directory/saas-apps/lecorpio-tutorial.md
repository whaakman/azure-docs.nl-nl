...
1. Op de **Lecorpio domein en URL's** sectie, voert u de volgende stappen uit:
    ...
    b. In de **id** tekstvak, een URL met behulp van het volgende patroon: `https://<instance name>.lecorpio.com/<customer name>`

    > [!NOTE] 
    > Deze waarden zijn niet de werkelijke. Werk deze waarden met de werkelijke aanmeldings-URL en -id. Hier stellen we voor u voor het gebruik van de unieke waarde van de tekenreeks in de id. Neem contact op met [Lecorpio Client ondersteuningsteam](mailto:info@lecorpio.com) om deze waarden te verkrijgen. 
