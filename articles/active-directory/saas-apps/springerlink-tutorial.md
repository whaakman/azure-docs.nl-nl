...
4. **[Eenmalige aanmelding testen](#test-single-sign-on)**  : als u wilt controleren of de configuratie werkt.
...
3. Op de **Springer koppeling domein en URL's** sectie, als u wilt configureren van de toepassing in **IDP** modus gestart:
...
7. Het configureren van eenmalige aanmelding op **Springer koppeling** zijde, moet u voor het verzenden van de **App-Url voor federatieve metagegevens** naar [Springer koppeling ondersteuningsteam](mailto:identity@springernature.com).
