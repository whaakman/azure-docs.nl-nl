...
2. Op de **eenmalige aanmelding** dialoogvenster Selecteer **modus** als **op basis van SAML aanmelding** voor eenmalige aanmelding inschakelen.
    ...
    ![Dialoogvenster voor eenmalige aanmelding](./media/springerlink-tutorial/tutorial_springerlink_samlbase.png)

3. Op de **Springer koppeling domein en de URL's** sectie als u wilt configureren van de toepassing in **IDP** modus gestart:

    ![URL's en Springer koppeling domein eenmalige aanmelding informatie](./media/springerlink-tutorial/tutorial_springerlink_url1.png)
...
4. Controleer **weergeven geavanceerde instellingen voor URL**. Als u wilt configureren van de toepassing in **SP** modus gestart:
    ...
    ![URL's en Springer koppeling domein eenmalige aanmelding informatie](./media/springerlink-tutorial/tutorial_springerlink_url.png)
...
6. Klik op **opslaan** knop.
    ...
    ![Knop Single Sign-On opslaan configureren](./media/springerlink-tutorial/tutorial_general_400.png)

7. Eenmalige aanmelding configureren op **Springer koppeling** kant die u wilt verzenden de **App-Url voor federatieve metagegevens** naar [Springer koppeling ondersteuningsteam](mailto:identity@springernature.com).
