...
1. Typ in het zoekvak **TextMagic**, selecteer **TextMagic** van resultaat deelvenster klik vervolgens op **toevoegen** om toe te voegen van de toepassing.
...
In TextMagic, wijs de waarde van de **gebruikersnaam** in Azure AD als de waarde van de **gebruikersnaam** de relatie van de koppeling tot stand brengen.
...
1. **[Maak een testgebruiker TextMagic](#create-a-textmagic-test-user)**  : als u wilt een equivalent van Britta Simon in TextMagic die is gekoppeld aan de Azure AD-weergave van de gebruiker hebben.
...
1. Op de **eenmalige aanmelding** dialoogvenster, selecteer **modus** als **SAML gebaseerde aanmelding** eenmalige aanmelding inschakelen.
    ...
    ![In het dialoogvenster voor eenmalige aanmelding](./media/textmagic-tutorial/tutorial_textmagic_samlbase.png)

1. Op de **TextMagic domein en URL's** sectie, voert u de volgende stappen uit als u wilt configureren van de toepassing in **IDP** modus gestart:
...
1. Controleer **geavanceerde URL-instellingen weergeven** en voer de volgende stap als u wilt configureren van de toepassing in **SP** modus gestart:
    ...
    ![TextMagic domein en URL's, eenmalige aanmelding informatie](./media/textmagic-tutorial/url1.png)

    In de **aanmeldings-URL** tekstvak, een URL typen: `https://my.textmagic.com/login/sso`
...
1. Klik op **opslaan** knop.
    ...
    ![Configureren van eenmalige aanmelding opslaan](./media/textmagic-tutorial/tutorial_general_400.png)
    
1. Op de **TextMagic configuratie** sectie, klikt u op **configureren TextMagic** openen **aanmelding configureren** venster. Kopiëren de **afmelding-URL, SAML-entiteit-ID en Single Sign-On Service URL voor SAML-** uit de **Naslaggids sectie.**

    ![TextMagic configuratie](./media/textmagic-tutorial/tutorial_textmagic_configure.png) 

1. In een ander browservenster aanmelden bij uw bedrijf TextMagic site als beheerder.

1. Selecteer **Accountinstellingen** onder de gebruikersnaam.

    ![TextMagic configuratie](./media/textmagic-tutorial/config1.png) 
1. Klik op het tabblad **"eenmalige aanmelding (SSO)"** en vult u de volgende velden:  
    
    ![TextMagic configuratie](./media/textmagic-tutorial/config2.png)

    a. In **id-provider entiteit-ID:** tekstvak, plak de waarde van **SAML entiteit-ID**, die u hebt gekopieerd vanuit Azure portal.

    b. In **id-provider voor eenmalige aanmelding-URL:** tekstvak, plak de waarde van **Single Sign-On Service URL**, die u hebt gekopieerd vanuit Azure portal.

    c. In **id-provider SLO-URL:** tekstvak, plak de waarde van **afmelding URL**, die u hebt gekopieerd vanuit Azure portal.
...
1. In de Azure portal, in het linkerdeelvenster klikt u op de **Azure Active Directory** knop.
    ...
    ![De Azure Active Directory-knop](./media/textmagic-tutorial/create_aaduser_01.png)

1. Als u wilt weergeven in de lijst met gebruikers, gaat u naar **gebruikers en groepen**, en klik vervolgens op **alle gebruikers**.

    !['Gebruikers en groepen' en 'Alle gebruikers' koppelingen](./media/textmagic-tutorial/create_aaduser_02.png)

1. Om te openen de **gebruiker** in het dialoogvenster, klikt u op **toevoegen** aan de bovenkant van de **alle gebruikers** in het dialoogvenster.

    ![De knop toevoegen](./media/textmagic-tutorial/create_aaduser_03.png)

1. In de **gebruiker** dialoogvenster vak, voer de volgende stappen uit:

    ![Het dialoogvenster gebruiker](./media/textmagic-tutorial/create_aaduser_04.png)
...
### <a name="create-a-textmagic-test-user"></a>Maak een testgebruiker TextMagic

Toepassing biedt ondersteuning voor Just in time gebruikersinrichting en na-verificatiegebruikers, in de toepassing automatisch worden gemaakt. U moet de gegevens eenmaal op de eerste aanmelding bij het activeren van de onderliggende account in het systeem in te vullen.
...
**Als u wilt Britta Simon aan TextMagic toewijst, moet u de volgende stappen uitvoeren:**

1. Open de weergave toepassingen in de Azure-portal en gaat u naar de mapweergave en Ga naar **bedrijfstoepassingen** klikt u vervolgens op **alle toepassingen**.

    ![Gebruiker toewijzen][201] 

1. Selecteer in de lijst met toepassingen, **TextMagic**.

    ![De koppeling TextMagic in de lijst met toepassingen](./media/textmagic-tutorial/tutorial_textmagic_app.png)  
