...
3. **[Maak een testgebruiker TextMagic](#create-a-textmagic-test-user)**  : als u wilt een equivalent van Britta Simon in TextMagic die is gekoppeld aan de Azure AD-weergave van de gebruiker hebben.
...
3. Op de **TextMagic domein en URL's** sectie, voert u de volgende stappen uit als u wilt configureren van de toepassing in **IDP** modus gestart:
...
7. Op de **TextMagic configuratie** sectie, klikt u op **configureren TextMagic** openen **aanmelding configureren** venster. Kopiëren de **afmelding-URL, SAML-entiteit-ID en Single Sign-On Service URL voor SAML-** uit de **Naslaggids sectie.**

    ![TextMagic configuratie](./media/textmagic-tutorial/tutorial_textmagic_configure.png) 

8. In een ander browservenster aanmelden bij uw bedrijf TextMagic site als beheerder.
