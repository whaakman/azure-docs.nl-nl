...
2. Op de **eenmalige aanmelding** dialoogvenster Selecteer **modus** als **op basis van SAML aanmelding** voor eenmalige aanmelding inschakelen.
    ...
    ![Dialoogvenster voor eenmalige aanmelding](./media/textmagic-tutorial/tutorial_textmagic_samlbase.png)
...
3. Op de **TextMagic domein en de URL's** sectie, voert u de volgende stappen uit als u wilt configureren, de toepassing in **IDP** modus gestart:
    ...
    ![URL's en TextMagic domein eenmalige aanmelding informatie](./media/textmagic-tutorial/tutorial_textmagic_url.png)

    In de **id** textbox, typ een URL: `https://my.textmagic.com/saml/metadata`

4. Controleer **weergeven geavanceerde instellingen voor URL** en voer de volgende stap als u wilt configureren van de toepassing in **SP** modus gestart:

    ![URL's en TextMagic domein eenmalige aanmelding informatie](./media/textmagic-tutorial/url1.png)
...
6. Klik op **opslaan** knop.
    ...
    ![Knop Single Sign-On opslaan configureren](./media/textmagic-tutorial/tutorial_general_400.png)
