...
Om te integreren met uw cloud-functionaliteit [software als een service (SaaS)](https://azure.microsoft.com/overview/what-is-saas/) toepassingen met Azure Active Directory, hebben we een reeks zelfstudies waarin wordt uitgelegd configuratie ontwikkeld.

Zie voor een lijst van alle SaaS-apps die vooraf geïntegreerd in Azure AD zijn, de [Active Directory Marketplace](https://azuremarketplace.microsoft.com/marketplace/apps/category/azure-active-directory-apps).
...
| :--- | :--- | :--- |
| ![logo](./media/tutorial-list/active-directory-saas-atlassian-cloud-tutorial.png)| [Atlassian Cloud](atlassian-cloud-tutorial.md)| [Atlassian Cloud - inrichten van gebruikers](atlassian-cloud-provisioning-tutorial.md)|
...
Ga voor meer zelfstudies, gebruikt u de inhoudsopgave aan de linkerkant.
...
| ![logo](./media/tutorial-list/active-directory-saas-sapboc-tutorial.png)| [SAP-Cloud-Identiteitsplatform](saphana-tutorial.md)| |

## <a name="oneclick-sso"></a>OneClick eenmalige aanmelding

| Logo | Zelfstudie voor eenmalige aanmelding |        |
| :--- | :--- | :--- |
...
| ![logo](./media/tutorial-list/active-directory-saas-knowlwdge-anywhere-lms-tutorial.png)| [Kennis overal LMS](knowledge-anywhere-lms-tutorial.md)|     |
...
Zie voor meer informatie over toepassingsbeheer, [wat is Toepassingsbeheer](../manage-apps/what-is-application-management.md).