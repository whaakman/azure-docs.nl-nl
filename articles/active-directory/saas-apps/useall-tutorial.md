...
* U kunt uw gebruikers worden automatisch aangemeld Useall (Single Sign-On) met hun Azure AD-accounts inschakelen.
...
* Eenmalige aanmelding Useall ingeschakeld abonnement

## <a name="scenario-description"></a>Scenariobeschrijving

In deze zelfstudie gaat u in een testomgeving eenmalige aanmelding van Azure AD configureren en testen.

* Biedt ondersteuning voor Useall **SP** gestart door SSO
...
In deze sectie kunt u configureren en testen Azure AD eenmalige aanmelding met Useall op basis van een testgebruiker met de naam **Britta Simon**.
Voor eenmalige aanmelding om te werken, moet een koppeling relatie tussen een Azure AD-gebruiker en de gerelateerde gebruiker in Useall tot stand worden gebracht.
...
2. **[Configureren van eenmalige aanmelding Useall](#configure-useall-single-sign-on)**  : als u wilt de Single Sign-On-instellingen configureren op de toepassing aan clientzijde.
3. **[Een Azure AD-testgebruiker maken](#create-an-azure-ad-test-user)**: als u Azure AD-eenmalige aanmelding wil testen met Britta Simon.
4. **[De testgebruiker van Azure AD-toewijzen](#assign-the-azure-ad-test-user)**: als u wilt dat Britta Simon gebruik kan maken van Azure AD-eenmalige aanmelding.
5. **[Maken van de testgebruiker Useall](#create-useall-test-user)**  : als u wilt een equivalent van Britta Simon in Useall die is gekoppeld aan de Azure AD-weergave van de gebruiker hebben.
...
1. In de [Azure-portal](https://portal.azure.com/)op de **Useall** toepassing integratie weergeeft, schakelt **eenmalige aanmelding**.
...
4. In de sectie **Standaard SAML-configuratie** voert u de volgende stappen uit:
    ...
    ![Useall domein en URL's, eenmalige aanmelding informatie](common/sp-identifier.png)

    a. In het tekstvak **Aanmeldings-URL** typt u een URL met het volgende patroon: `https://<SUBDOMAIN>.useall.com.br/tenant/useall`
...
### <a name="configure-useall-single-sign-on"></a>Useall voor eenmalige aanmelding configureren

Het configureren van eenmalige aanmelding op **Useall** zijde, moet u voor het verzenden van de **App-Url voor federatieve metagegevens** naar [Useall ondersteuningsteam](mailto:luizotavio@useall.com.br). Het team stelt de instellingen zo in dat de verbinding tussen SAML en eenmalige aanmelding aan beide zijden goed is ingesteld.
...
1. Selecteer in de Azure portal, **bedrijfstoepassingen**, selecteer **alle toepassingen**en selecteer vervolgens **Useall**.
...
Wanneer u op de tegel Useall in het toegangsvenster, moet u worden automatisch aangemeld bij de Useall waarvoor u eenmalige aanmelding hebt ingesteld. Zie [Introduction to the Access Panel](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction) (Inleiding tot het toegangsvenster) voor meer informatie over het toegangsvenster.
