...
2. Op de **eenmalige aanmelding** dialoogvenster Selecteer **modus** als **op basis van SAML aanmelding** voor eenmalige aanmelding inschakelen.
    ...
    ![Dialoogvenster voor eenmalige aanmelding](./media/youearnedit-tutorial/tutorial_youearnedit_samlbase.png)

3. Op de **YouEarnedIt domein en de URL's** sectie, voert u de volgende stappen uit:

    ![URL's en YouEarnedIt domein eenmalige aanmelding informatie](./media/youearnedit-tutorial/tutorial_youearnedit_url.png)
...
5. Klik op **opslaan** knop.
    ...
    ![Knop Single Sign-On opslaan configureren](./media/youearnedit-tutorial/tutorial_general_400.png)
