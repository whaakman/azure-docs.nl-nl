...
2. Op de **eenmalige aanmelding** dialoogvenster Selecteer **modus** als **op basis van SAML aanmelding** voor eenmalige aanmelding inschakelen.
    ...
    ![Dialoogvenster voor eenmalige aanmelding](./media/ceridiandayforcehcm-tutorial/tutorial_ceridiandayforcehcm_samlbase.png)
...
7. Klik op **opslaan** knop.
    ...
    ![Knop Single Sign-On opslaan configureren](./media/ceridiandayforcehcm-tutorial/tutorial_general_400.png)
...
2. Selecteer in de lijst met toepassingen **Ceridian Dayforce HCM**.
    ...
    ![De koppeling Ceridian Dayforce HCM in de lijst met toepassingen](./media/ceridiandayforcehcm-tutorial/tutorial_ceridiandayforcehcm_app.png)  
