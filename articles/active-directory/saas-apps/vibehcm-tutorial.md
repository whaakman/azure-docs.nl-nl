...
* U kunt uw gebruikers worden automatisch aangemeld Vibe HCM (Single Sign-On) inschakelen met hun Azure AD-accounts.
...
* Vibe HCM eenmalige aanmelding ingeschakeld abonnement

## <a name="scenario-description"></a>Scenariobeschrijving

In deze zelfstudie gaat u in een testomgeving eenmalige aanmelding van Azure AD configureren en testen.

* Vibe HCM ondersteunt **SP** en **IDP** gestart door SSO
...
In deze sectie kunt u configureren en testen Azure AD eenmalige aanmelding met Vibe HCM op basis van een testgebruiker met de naam **Britta Simon**.
Voor eenmalige aanmelding om te werken, moet een koppeling relatie tussen een Azure AD-gebruiker en de gerelateerde gebruiker in Vibe HCM tot stand worden gebracht.
...
2. **[Configureer Vibe HCM Single Sign-On](#configure-vibe-hcm-single-sign-on)**  : als u wilt de Single Sign-On-instellingen configureren op de toepassing aan clientzijde.
3. **[Een Azure AD-testgebruiker maken](#create-an-azure-ad-test-user)**: als u Azure AD-eenmalige aanmelding wil testen met Britta Simon.
4. **[De testgebruiker van Azure AD-toewijzen](#assign-the-azure-ad-test-user)**: als u wilt dat Britta Simon gebruik kan maken van Azure AD-eenmalige aanmelding.
5. **[Maak Vibe HCM testgebruiker](#create-vibe-hcm-test-user)**  : als u wilt een equivalent van Britta Simon in Vibe HCM die is gekoppeld aan de Azure AD-weergave van de gebruiker hebben.
...
1. In de [Azure-portal](https://portal.azure.com/)op de **Vibe HCM** toepassing integratie weergeeft, schakelt **eenmalige aanmelding**.
...
4. Op de **SAML-basisconfiguratie** sectie, als u wilt configureren van de toepassing in **IDP** gestart modus voor de gebruiker beschikt niet over een stap uitvoeren omdat de app is al vooraf geïntegreerd met Azure.
    ...
    ![Vibe HCM domein en URL's, eenmalige aanmelding informatie](common/preintegrated.png)

5. Klik op **Extra URL's instellen** en voer de volgende stap uit als u de toepassing in de door **SP** geïnitieerde modus wilt configureren:

    ![Vibe HCM domein en URL's, eenmalige aanmelding informatie](common/metadata-upload-additional-signon.png)

    In het tekstvak **Aanmeldings-URL** typt u een URL met de volgende notatie: `https://<companyName>.vibehcm.com/portal.jsp`

    > [!NOTE]
    > De waarde is niet echt. Werk de waarde bij met de werkelijke aanmeldings-URL. Neem contact op met [Vibe HCM Client ondersteuningsteam](mailto:support@vibehcm.com) om de waarde. U kunt ook verwijzen naar het patroon dat wordt weergegeven in de sectie **Standaard SAML-configuratie** in de Azure-portal.
...
### <a name="configure-vibe-hcm-single-sign-on"></a>Vibe HCM eenmalige aanmelding configureren

Het configureren van eenmalige aanmelding op **Vibe HCM** zijde, moet u voor het verzenden van de **App-Url voor federatieve metagegevens** naar [Vibe HCM-ondersteuningsteam](mailto:support@vibehcm.com). Het team stelt de instellingen zo in dat de verbinding tussen SAML en eenmalige aanmelding aan beide zijden goed is ingesteld.
...
1. Selecteer in de Azure portal, **bedrijfstoepassingen**, selecteer **alle toepassingen**en selecteer vervolgens **Vibe HCM**.
...
Wanneer u op de tegel Vibe HCM in het toegangsvenster, moet u worden automatisch aangemeld bij de Vibe HCM waarvoor u eenmalige aanmelding hebt ingesteld. Zie [Introduction to the Access Panel](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction) (Inleiding tot het toegangsvenster) voor meer informatie over het toegangsvenster.
