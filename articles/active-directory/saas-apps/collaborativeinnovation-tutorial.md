...
1. Het configureren van eenmalige aanmelding op **gezamenlijke innovatie** zijde, moet u voor het verzenden van de gedownloade **Metadata XML** naar [gezamenlijke innovatie ondersteuningsteam](https://www.unilever.com/contact/). Ze stelt u deze optie om de SAML SSO-verbinding instellen goed aan beide zijden.
