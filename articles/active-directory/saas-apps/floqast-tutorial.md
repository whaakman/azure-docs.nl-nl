...
2. Op de **eenmalige aanmelding** dialoogvenster Selecteer **modus** als **op basis van SAML aanmelding** voor eenmalige aanmelding inschakelen.
    ...
    ![Dialoogvenster voor eenmalige aanmelding](./media/floqast-tutorial/tutorial_floqast_samlbase.png)
...
3. Op de **FloQast domein en de URL's** sectie, voert u de volgende stappen uit als u wilt configureren, de toepassing in **IDP** modus gestart:
    ...
    ![URL's en FloQast domein eenmalige aanmelding informatie](./media/floqast-tutorial/tutorial_floqast_url.png)

     In de **id** textbox, typ een URL: `https://go.floqast.com/`

4. Controleer **weergeven geavanceerde instellingen voor URL** en voer de volgende stap als u wilt configureren van de toepassing in **SP** modus gestart:

    ![URL's en FloQast domein eenmalige aanmelding informatie](./media/floqast-tutorial/tutorial_floqast_url1.png)
...
6. In de **gebruikerskenmerken** sectie op de **eenmalige aanmelding** dialoogvenster SAML-token kenmerk configureren zoals wordt weergegeven in de afbeelding en de volgende stappen uitvoeren:
    ...
    ![Eenmalige aanmelding configureren toevoegen](./media/floqast-tutorial/tutorial_attribute_04.png)

    ![Eenmalige aanmelding Addattb configureren](./media/floqast-tutorial/tutorial_attribute_05.png)
...
7. Op de **SAML-certificaat voor ondertekening van** sectie, klikt u op **Metadata XML** en sla het metagegevensbestand op uw computer en voer de volgende stappen uit:
    ...
    ![De bevestiging van het certificaat](./media/floqast-tutorial/tutorial_floqast_certificateassertion.png)

    b. Selecteer **ondertekening optie** als **aanmelding SAML-reactie en assertion**.

8. Klik op **opslaan** knop.

    ![Knop Single Sign-On opslaan configureren](./media/floqast-tutorial/tutorial_general_400.png)
