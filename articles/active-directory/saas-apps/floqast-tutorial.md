...
1. Het configureren van eenmalige aanmelding op **FloQast** zijde, moet u voor het verzenden van de gedownloade **Metadata XML** naar [FloQast ondersteuningsteam](mailto:support@floqast.com). Ze stelt u deze optie om de SAML SSO-verbinding instellen goed aan beide zijden.
