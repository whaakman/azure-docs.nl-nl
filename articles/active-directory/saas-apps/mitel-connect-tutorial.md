...
4. In de sectie **Standaard SAML-configuratie** voert u de volgende stappen uit:
    ...
    a. In het tekstvak **Aanmeldings-URL** typt u een URL met het volgende patroon: `https://auth.mitel.io/authorize?client_id=<CLIENT ID>`

    b. In het tekstvak **Id (Entiteits-id)** typt u een URL met het volgende patroon: `https://authentication.api.mitel.io/2017-09-01/saml2/<account-uui>`

    > [!NOTE]
    > Dit zijn geen echte waarden. Werk deze waarden bij met de werkelijke aanmeldings-URL en id. Neem contact op met [Mitel verbinding maken met Client-ondersteuningsteam](https://www.mitel.com/support/mitel-technical-support) om deze waarden te verkrijgen. U kunt ook verwijzen naar het patroon dat wordt weergegeven in de sectie **Standaard SAML-configuratie** in de Azure-portal.
...
Het configureren van eenmalige aanmelding op **Mitel verbinding** zijde, moet u voor het verzenden van de gedownloade **federatieve metagegevens-XML** en toepassing van de gekopieerde URL's van Azure portal om te [ondersteuningsteam Mitel verbinding maken ](https://www.mitel.com/support/mitel-technical-support). Het team stelt de instellingen zo in dat de verbinding tussen SAML en eenmalige aanmelding aan beide zijden goed is ingesteld.
...
In deze sectie maakt u een gebruiker met de naam van Britta Simon in Mitel verbinding maken. Werken met [ondersteuningsteam Mitel verbinding](https://www.mitel.com/support/mitel-technical-support) om toe te voegen de gebruikers in het platform Mitel verbinding maken. Er moeten gebruikers worden gemaakt en geactiveerd voordat u eenmalige aanmelding kunt gebruiken.
