...
3. **[Het maken van een testgebruiker Novatus](#creating-a-novatus-test-user)**  : als u wilt een equivalent van Britta Simon in Novatus die is gekoppeld aan de Azure AD-weergave van de gebruiker hebben.
...
3. Op de **Novatus domein en URL's** sectie, voert u de volgende stappen uit:
