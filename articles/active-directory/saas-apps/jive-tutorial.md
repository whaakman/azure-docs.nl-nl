...
4. In de sectie **Standaard SAML-configuratie** voert u de volgende stappen uit:
    ...
    a. In het tekstvak **Aanmeldings-URL** typt u een URL met het volgende patroon: `https://<instance name>.jivecustom.com`

    b. In het tekstvak **Id (Entiteits-id)** typt u een URL met het volgende patroon: `https://<instance name>.jiveon.com`
