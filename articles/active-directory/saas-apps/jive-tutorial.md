...
4. Typ in het zoekvak **Jive**.
    ...
    ![Een Azure AD-testgebruiker maken](./media/jive-tutorial/tutorial_jive_search.png)

5. Selecteer in het deelvenster resultaten **Jive**, en klik vervolgens op **toevoegen** om toe te voegen van de toepassing.

    ![Een Azure AD-testgebruiker maken](./media/jive-tutorial/tutorial_jive_addfromgallery.png)
...
7. Klik in het menu bovenaan op '**Saml**. "
    ...
    ![App-zijde eenmalige aanmelding configureren](./media/jive-tutorial/tutorial_jive_002.png)
...
8. Navigeer naar de '**Idp metagegevens**' tabblad.
    ...
    ![App-zijde eenmalige aanmelding configureren](./media/jive-tutorial/tutorial_jive_003.png)
...
9. Ga naar de '**kenmerk Gebruikerskoppeling**' tabblad.
    ...
    ![App-zijde eenmalige aanmelding configureren](./media/jive-tutorial/tutorial_jive_004.png)
...
1. In de **Azure-portal**, klik op het navigatiedeelvenster links **Azure Active Directory** pictogram.
    ...
    ![Een Azure AD-testgebruiker maken](./media/jive-tutorial/create_aaduser_01.png) 

2. Als u wilt weergeven in de lijst met gebruikers, gaat u naar **gebruikers en groepen** en klik op **alle gebruikers**.

    ![Een Azure AD-testgebruiker maken](./media/jive-tutorial/create_aaduser_02.png)

3. Openen van de **gebruiker** dialoogvenster, klikt u op **toevoegen** boven aan het dialoogvenster.

    ![Een Azure AD-testgebruiker maken](./media/jive-tutorial/create_aaduser_03.png) 

4. Op de **gebruiker** dialoogvenster pagina, voert u de volgende stappen uit:

    ![Een Azure AD-testgebruiker maken](./media/jive-tutorial/create_aaduser_04.png)
...
Het doel van deze sectie is het maken van een gebruiker Britta Simon in Jive genoemd. Jive ondersteunt automatisch gebruikers inrichten, dit is standaard ingeschakeld. U vindt meer informatie [hier](jive-provisioning-tutorial.md) over het configureren van automatische gebruikers inrichten.
