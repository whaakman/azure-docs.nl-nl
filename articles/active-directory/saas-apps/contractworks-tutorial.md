...
2. Op de **eenmalige aanmelding** dialoogvenster Selecteer **modus** als **op basis van SAML aanmelding** voor eenmalige aanmelding inschakelen.
    ...
    ![Dialoogvenster voor eenmalige aanmelding](./media/contractworks-tutorial/tutorial_contractworks_samlbase.png)
...
3. Op de **ContractWorks domein en de URL's** sectie, voert u de volgende stappen uit als u wilt configureren, de toepassing in **IDP** modus gestart:
    ...
    ![URL's en ContractWorks domein eenmalige aanmelding informatie](./media/contractworks-tutorial/tutorial_contractworks_url.png)

    In de **id** textbox, typ een URL: `https://login.securedocs.com/saml/metadata`

4. Controleer **weergeven geavanceerde instellingen voor URL** en voer de volgende stap als u wilt configureren van de toepassing in **SP** modus gestart:

    ![URL's en ContractWorks domein eenmalige aanmelding informatie](./media/contractworks-tutorial/tutorial_contractworks_url1.png)
...
8. Klik op **opslaan** knop.
    ...
    ![Knop Single Sign-On opslaan configureren](./media/contractworks-tutorial/tutorial_general_400.png)
