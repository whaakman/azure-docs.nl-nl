...
2. Op de **eenmalige aanmelding** dialoogvenster Selecteer **modus** als **op basis van SAML aanmelding** voor eenmalige aanmelding inschakelen.
    ...
    ![Dialoogvenster voor eenmalige aanmelding](./media/communifire-tutorial/tutorial_communifire_samlbase.png)
...
3. Op de **Communifire domein en de URL's** sectie, voert u de volgende stappen uit als u wilt configureren van de toepassing in de IDP geïnitieerd modus:
    ...
    ![URL's en Communifire domein eenmalige aanmelding informatie](./media/communifire-tutorial/tutorial_communifire_url.png)
...
4. Controleer **weergeven geavanceerde instellingen voor URL** en voer de volgende stap als u wilt configureren van de toepassing in **SP** modus gestart:
    ...
    ![URL's en Communifire domein eenmalige aanmelding informatie](./media/communifire-tutorial/tutorial_communifire_url1.png)
...
6.  Controleer **weergeven geavanceerde instellingen voor het ondertekenen van certificaat** en selecteer **ondertekening optie** als **aanmelding SAML-reactie en assertion**.
    ...
    ![De optie certificaat](./media/communifire-tutorial/tutorial_communifire_certificateoption.png) 

7. Klik op **opslaan** knop.

    ![Knop Single Sign-On opslaan configureren](./media/communifire-tutorial/tutorial_general_400.png)
