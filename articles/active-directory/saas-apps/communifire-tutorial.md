...
3. **[Maak een testgebruiker Communifire](#create-a-communifire-test-user)**  : als u wilt een equivalent van Britta Simon in Communifire die is gekoppeld aan de Azure AD-weergave van de gebruiker hebben.
...
3. Op de **Communifire domein en URL's** sectie, voert u de volgende stappen uit als u wilt configureren van de toepassing in de modus voor IDP gestart:
...
6.  Controleer **geavanceerde instellingen voor ondertekening van certificaat weergeven** en selecteer **ondertekening optie** als **aanmelding SAML-antwoord en -bewering**.
