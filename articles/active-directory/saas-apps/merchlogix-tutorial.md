...
2. Op de **eenmalige aanmelding** dialoogvenster Selecteer **modus** als **op basis van SAML aanmelding** voor eenmalige aanmelding inschakelen.
    ...
    ![Dialoogvenster voor eenmalige aanmelding](./media/merchlogix-tutorial/tutorial_merchlogix_samlbase.png)

3. Op de **Merchlogix domein en de URL's** sectie, voert u de volgende stappen uit:

    ![URL's en Merchlogix domein eenmalige aanmelding informatie](./media/merchlogix-tutorial/tutorial_merchlogix_url.png)
...
5. Klik op **opslaan** knop.
    ...
    ![Knop Single Sign-On opslaan configureren](./media/merchlogix-tutorial/tutorial_general_400.png)
