...
2. Op de **eenmalige aanmelding** dialoogvenster Selecteer **modus** als **op basis van SAML aanmelding** voor eenmalige aanmelding inschakelen.
    ...
    ![Dialoogvenster voor eenmalige aanmelding](./media/boomi-tutorial/tutorial_boomi_samlbase.png)

3. Op de **Boomi domein en de URL's** sectie, voert u de volgende stappen uit:

    ![URL's en Boomi domein eenmalige aanmelding informatie](./media/boomi-tutorial/tutorial_boomi_url.png)
...
7. Klik op **opslaan** knop.
    ...
    ![Knop Single Sign-On opslaan configureren](./media/boomi-tutorial/tutorial_general_400.png)
...
11. Klik op de **SSO opties** tabblad en Voer onderstaande stappen te volgen.
    ...
    ![App-zijde eenmalige aanmelding configureren](./media/boomi-tutorial/tutorial_boomi_11.png)
