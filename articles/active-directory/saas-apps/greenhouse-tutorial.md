...
2. Op de **eenmalige aanmelding** dialoogvenster Selecteer **modus** als **op basis van SAML aanmelding** voor eenmalige aanmelding inschakelen.
    ...
    ![Dialoogvenster voor eenmalige aanmelding](./media/greenhouse-tutorial/tutorial_greenhouse_samlbase.png)

3. Op de **handel domein en de URL's** sectie, voert u de volgende stappen uit:

    ![Handel domein en de URL's van eenmalige aanmelding informatie](./media/greenhouse-tutorial/tutorial_greenhouse_url.png)
...
5. Klik op **opslaan** knop.
    ...
    ![Knop Single Sign-On opslaan configureren](./media/greenhouse-tutorial/tutorial_general_400.png)
