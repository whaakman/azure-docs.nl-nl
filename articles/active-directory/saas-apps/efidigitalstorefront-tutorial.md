...
4. Typ in het zoekvak **EFI digitale winkel**, selecteer **EFI digitale winkel** van resultaat deelvenster klik vervolgens op **toevoegen** om toe te voegen van de toepassing.
    ...
    ![Digitale winkel EFI in de lijst met resultaten](./media/efidigitalstorefront-tutorial/tutorial_efidigital_addfromgallery.png)
...
2. Op de **eenmalige aanmelding** dialoogvenster Selecteer **modus** als **op basis van SAML aanmelding** voor eenmalige aanmelding inschakelen.
    ...
    ![Dialoogvenster voor eenmalige aanmelding](./media/efidigitalstorefront-tutorial/tutorial_efidigital_samlbase.png)

3. Op de **EFI digitale winkel domein en de URL's** sectie, voert u de volgende stappen uit:

    ![URL's en EFI digitale winkel domein eenmalige aanmelding informatie](./media/efidigitalstorefront-tutorial/tutorial_efidigital_url.png)
...
5. Klik op **opslaan** knop.
    ...
    ![Knop Single Sign-On opslaan configureren](./media/efidigitalstorefront-tutorial/tutorial_general_400.png)
