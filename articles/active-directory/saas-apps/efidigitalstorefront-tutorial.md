...
3. **[Maak een testgebruiker EFI digitale winkel](#create-a-efi-digital-storefront-test-user)**  : als u wilt een equivalent van Britta Simon in EFI digitale winkel die is gekoppeld aan de Azure AD-weergave van de gebruiker hebben.
...
3. Op de **EFI digitale winkel domein en URL's** sectie, voert u de volgende stappen uit:
