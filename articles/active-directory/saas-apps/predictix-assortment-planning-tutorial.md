...
1. Op de **Predictix assortiment Planning domein en URL's** sectie, voert u de volgende stappen uit:
    ...
    > [!NOTE] 
    > Dit zijn geen echte waarden. Werk deze waarden bij met de daadwerkelijke aanmeldings-URL en id. Neem contact op met [Predictix assortiment Planning Client ondersteuningsteam](https://www.infor.com/support) om deze waarden te verkrijgen. 
 


1. Op de **SAML-handtekeningcertificaat** sectie, klikt u op **Certificate(Base64)** en slaat u het certificaatbestand op uw computer.

    ![De link om het certificaat te downloaden](./media/predictix-assortment-planning-tutorial/tutorial_predictixassortmentplanning_certificate.png) 

1. Klik op **opslaan** knop.

    ![De knop voor enkelvoudige aanmelding configureren](./media/predictix-assortment-planning-tutorial/tutorial_general_400.png)
