...
4. Typ in het zoekvak **Learning Seat LMS**.
    ...
    ![Een Azure AD-testgebruiker maken](./media/learningseatlms-tutorial/tutorial_learnconnect_search.png)
...
1. In de **Azure-portal**, klik op het navigatiedeelvenster links **Azure Active Directory** pictogram.
    ...
    ![Een Azure AD-testgebruiker maken](./media/learningseatlms-tutorial/create_aaduser_01.png) 

2. Als u wilt weergeven in de lijst met gebruikers, gaat u naar **gebruikers en groepen** en klik op **alle gebruikers**.
    
    ![Een Azure AD-testgebruiker maken](./media/learningseatlms-tutorial/create_aaduser_02.png) 

3. Openen van de **gebruiker** dialoogvenster, klikt u op **toevoegen** boven aan het dialoogvenster.
 
    ![Een Azure AD-testgebruiker maken](./media/learningseatlms-tutorial/create_aaduser_03.png) 

4. Op de **gebruiker** dialoogvenster pagina, voert u de volgende stappen uit:
 
    ![Een Azure AD-testgebruiker maken](./media/learningseatlms-tutorial/create_aaduser_04.png) 
...
Klik op de tegel Learning Seat LMS in het deelvenster toegang, u zal worden automatisch aangemeld bij uw toepassing Learning Seat LMS. Zie voor meer informatie over het toegangsvenster [Inleiding tot het toegangsvenster](../active-directory-saas-access-panel-introduction.md).
