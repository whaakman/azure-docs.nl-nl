...
4. Typ in het zoekvak **8 x 8 virtuele Office**.
    ...
    ![Een Azure AD-testgebruiker maken](./media/8x8virtualoffice-tutorial/tutorial_8x8virtualoffice_search.png)
...
5. Selecteer in het deelvenster resultaten **8 x 8 virtuele Office**, en klik vervolgens op **toevoegen** om toe te voegen van de toepassing.
    ...
    ![Een Azure AD-testgebruiker maken](./media/8x8virtualoffice-tutorial/tutorial_8x8virtualoffice_addfromgallery.png)
...
8. Selecteer **virtuele Office Account Mgr** in deelvenster van de toepassing.
    ...
    ![Zijde van de App configureren](./media/8x8virtualoffice-tutorial/tutorial_8x8virtualoffice_001.png)

9. Selecteer **Business** account te beheren en klikt u op **aanmelden** knop.
   
    ![Zijde van de App configureren](./media/8x8virtualoffice-tutorial/tutorial_8x8virtualoffice_002.png)

10. Klik op **Accounts** tabblad in de menulijst.
   
    ![Zijde van de App configureren](./media/8x8virtualoffice-tutorial/tutorial_8x8virtualoffice_003.png)

11. Klik op **eenmalige aanmelding** in de lijst van Accounts.
   
    ![Zijde van de App configureren](./media/8x8virtualoffice-tutorial/tutorial_8x8virtualoffice_004.png)

12. Selecteer **eenmalige aanmelding** onder verificatiemethode en op **SAML**.
    
    ![Zijde van de App configureren](./media/8x8virtualoffice-tutorial/tutorial_8x8virtualoffice_005.png)
...
13. Kopiëren **SAML SSO URL**, **Kana uit de URL van één** en **URL-verlener** van Azure AD **URL aanmelden**, **URL afmelden**  en **URL-verlener** in 8 x 8 virtuele Office. 
    ...
    ![Zijde van de App configureren](./media/8x8virtualoffice-tutorial/tutorial_8x8virtualoffice_006.png)
...
1. In de **Azure-portal**, klik op het navigatiedeelvenster links **Azure Active Directory** pictogram.
    ...
    ![Een Azure AD-testgebruiker maken](./media/8x8virtualoffice-tutorial/create_aaduser_01.png) 

2. Als u wilt weergeven in de lijst met gebruikers, gaat u naar **gebruikers en groepen** en klik op **alle gebruikers**.
    
    ![Een Azure AD-testgebruiker maken](./media/8x8virtualoffice-tutorial/create_aaduser_02.png) 

3. Openen van de **gebruiker** dialoogvenster, klikt u op **toevoegen** boven aan het dialoogvenster.
 
    ![Een Azure AD-testgebruiker maken](./media/8x8virtualoffice-tutorial/create_aaduser_03.png) 

4. Op de **gebruiker** dialoogvenster pagina, voert u de volgende stappen uit:
 
    ![Een Azure AD-testgebruiker maken](./media/8x8virtualoffice-tutorial/create_aaduser_04.png) 
