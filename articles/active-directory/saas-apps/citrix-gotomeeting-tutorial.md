...
2. Op de **eenmalige aanmelding** dialoogvenster Selecteer **modus** als **op basis van SAML aanmelding** voor eenmalige aanmelding inschakelen.
    ...
    ![Dialoogvenster voor eenmalige aanmelding](./media/citrix-gotomeeting-tutorial/tutorial_gotomeeting_samlbase.png)

3. Op de **GoToMeeting domein en de URL's** sectie, voert u de volgende stappen uit:

    ![URL's en GoToMeeting domein eenmalige aanmelding informatie](./media/citrix-gotomeeting-tutorial/tutorial_gotomeeting_url.png)
...
5. Klik op **opslaan** knop.
    ...
    ![Knop Single Sign-On opslaan configureren](./media/citrix-gotomeeting-tutorial/tutorial_general_400.png)
