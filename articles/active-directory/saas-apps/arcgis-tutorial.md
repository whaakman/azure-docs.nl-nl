...
3. **[Maak een testgebruiker ArcGIS Online](#create-a-arcgis-online-test-user)**  : als u wilt een equivalent van Britta Simon in ArcGIS Online die is gekoppeld aan de Azure AD-weergave van de gebruiker hebben.
...
3. Op de **ArcGIS Online domein en URL's** sectie, voert u de volgende stappen uit:
...
6. Meld u in een ander browservenster in uw bedrijf ArcGIS site als beheerder.

7. Klik op **instellingen bewerken**.
...
9. Onder **Enterprise aanmeldingen**, klikt u op **id-PROVIDER instellen**.

    ![Enterprise-aanmeldingen](./media/arcgis-tutorial/ic784744.png "Enterprise-aanmeldingen")

10. Op de **id-Provider instellen** configuratie pagina, voert u de volgende stappen uit:
