...
2. Op de **eenmalige aanmelding** dialoogvenster Selecteer **modus** als **op basis van SAML aanmelding** voor eenmalige aanmelding inschakelen.
    ...
    ![Dialoogvenster voor eenmalige aanmelding](./media/arcgis-tutorial/tutorial_arcgisonline_samlbase.png)

3. Op de **ArcGIS Online domein en de URL's** sectie, voert u de volgende stappen uit:

    ![URL's en ArcGIS Online domein eenmalige aanmelding informatie](./media/arcgis-tutorial/tutorial_arcgisonline_url.png)
...
5. Klik op **opslaan** knop.
    ...
    ![Knop Single Sign-On opslaan configureren](./media/arcgis-tutorial/tutorial_general_400.png)
...
10. Op de **identiteitsprovider ingesteld** configuratie pagina, voert u de volgende stappen uit:
    ...
    ![Instellen van de identiteitsprovider](./media/arcgis-tutorial/ic784745.png "identiteitsprovider instellen")
...
2. Klik op **leden UITNODIGEN**.
    ...
    ![Leden uitnodigen](./media/arcgis-tutorial/ic784747.png "leden uit te nodigen")

3. Selecteer **automatisch leden toevoegen zonder een e-mailbericht te verzenden**, en klik vervolgens op **volgende**.
   
    ![Automatisch toevoegen van leden](./media/arcgis-tutorial/ic784748.png "automatisch toevoegen van leden")
