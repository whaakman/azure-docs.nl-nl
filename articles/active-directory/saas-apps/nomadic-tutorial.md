...
2. Op de **eenmalige aanmelding** dialoogvenster Selecteer **modus** als **op basis van SAML aanmelding** voor eenmalige aanmelding inschakelen.
    ...
    ![Dialoogvenster voor eenmalige aanmelding](./media/nomadic-tutorial/tutorial_nomadic_samlbase.png)

3. Op de **Nomadic domein en de URL's** sectie, voert u de volgende stappen uit:

    ![Nomadic domein en de URL's van eenmalige aanmelding informatie](./media/nomadic-tutorial/tutorial_nomadic_url.png)
...
5. Klik op **opslaan** knop.
    ...
    ![Knop Single Sign-On opslaan configureren](./media/nomadic-tutorial/tutorial_general_400.png)
