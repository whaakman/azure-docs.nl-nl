...
1. Op de **namelijk domein en URL's** sectie, voert u de volgende stappen uit:
    ...
    a. Typ in het tekstvak **Aanmeldings-URL** een URL met het volgende patroon: `https://<subdomain>.namely.com`

    b. Typ in het tekstvak **Id** een URL met het volgende patroon: `https://<subdomain>.namely.com/saml/metadata`

    > [!NOTE] 
    > Dit zijn geen echte waarden. Werk deze waarden bij met de daadwerkelijke aanmeldings-URL en id. Neem contact op met [namelijk Client ondersteuningsteam](https://www.namely.com/contact/) om deze waarden te verkrijgen. 
