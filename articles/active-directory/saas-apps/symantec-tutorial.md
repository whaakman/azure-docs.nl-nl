...
2. Op de **eenmalige aanmelding** dialoogvenster Selecteer **modus** als **op basis van SAML aanmelding** voor eenmalige aanmelding inschakelen.
    ...
    ![Dialoogvenster voor eenmalige aanmelding](./media/symantec-tutorial/tutorial_symantecwebsecurityservicewss_samlbase.png)

3. Op de **Symantec Web Service (WSS) beveiligingsdomein en URL's** sectie, voert u de volgende stappen uit:

    ![Symantec Web Security Service (WSS)-domein en de URL's van eenmalige aanmelding informatie](./media/symantec-tutorial/tutorial_symantecwebsecurityservicewss_url.png)
...
5. Klik op **opslaan** knop.
    ...
    ![Knop Single Sign-On opslaan configureren](./media/symantec-tutorial/tutorial_general_400.png)
