...
g. Hierna moet u de bovenstaande procedure, blijven de methode als **PATCH** en plak de inhoud in de resterende rol de **aanvraagtekst** en klik op **Query uitvoeren**.
