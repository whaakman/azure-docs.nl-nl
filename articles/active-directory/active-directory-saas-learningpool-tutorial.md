...
In deze zelfstudie leert u hoe Learningpool Act integreren met Azure Active Directory (Azure AD).

Learningpool Act integreren met Azure AD biedt de volgende voordelen:
...
1. Learningpool Act uit de galerie toevoegen
2. Configureren en testen van Azure AD eenmalige aanmelding

## <a name="adding-learningpool-act-from-the-gallery"></a>Learningpool Act uit de galerie toevoegen
Voor het configureren van de integratie van Learningpool Act in Azure AD, moet u Learningpool Act uit de galerie toevoegen aan de lijst met beheerde SaaS-apps.
...
4. Typ in het zoekvak **Learningpool Act**.

    ![Een Azure AD-testgebruiker maken](./media/active-directory-saas-Learningpool-tutorial/tutorial_Learningpoolact_search.png)

5. Selecteer in het deelvenster resultaten **Learningpool Act**, en klik vervolgens op **toevoegen** om toe te voegen van de toepassing.
...
Voor eenmalige aanmelding werkt, moet Azure AD weten wat de gebruiker equivalent in Learningpool Act is aan een gebruiker in Azure AD. Met andere woorden, moet een koppeling relatie tussen een Azure AD-gebruiker en de verwante Learningpool Act-gebruiker worden gemaakt.
...
Om te configureren en testen van Azure AD eenmalige aanmelding met Learningpool Act, moet u de volgende bouwstenen voltooien:

1. **[Configureren van Azure AD Single Sign-On](#configuring-azure-ad-single-sign-on)**  : als u wilt dat uw gebruikers kunnen deze functie gebruiken.
2. **[Maken van een Azure AD-testgebruiker](#creating-an-azure-ad-test-user)**  - voor het testen van Azure AD eenmalige aanmelding met Britta Simon.
3. **[Maken van een testgebruiker Learningpool Act](#creating-a-learningpool-act-test-user)**  - Learningpool Act die is gekoppeld aan de Azure AD-weergave van de gebruiker van een exemplaar van Britta Simon bevatten.
4. **[Toewijzen van de Azure AD-testgebruiker](#assigning-the-azure-ad-test-user)**  - Britta Simon gebruik van Azure AD eenmalige aanmelding inschakelen.
5. **[Testen van eenmalige aanmelding](#testing-single-sign-on)**  : om te controleren of de configuratie werkt.

### <a name="configuring-azure-ad-single-sign-on"></a>Eenmalige aanmelding Azure AD configureren

In dit gedeelte Azure AD eenmalige aanmelding inschakelen in de Azure portal en eenmalige aanmelding in uw toepassing Learningpool Act configureren.

**Voor het configureren van Azure AD eenmalige aanmelding met Learningpool Act, moet u de volgende stappen uitvoeren:**

1. In de Azure-portal op de **Learningpool Act** toepassing Integratiepagina, klikt u op **eenmalige aanmelding**.
...
3. Op de **Learningpool Act-domein en de URL's** sectie, voert u de volgende stappen uit:

    ![Eenmalige aanmelding configureren](./media/active-directory-saas-Learningpool-tutorial/tutorial_Learningpoolact_url.png)

    a. In de **aanmeldings-URL** textbox, typ de URL: `https://parliament.preview.Learningpool.com/auth/shibboleth/index.php`
    ...
    > [!NOTE] 
    > Deze waarden zijn niet echt. Deze waarden bijwerken met het werkelijke aanmeldings-URL en de id. Neem contact op met [Learningpool Act Client ondersteuningsteam](https://www.Learningpool.com/support) ophalen van deze waarden. 
...
5. De SAML-asserties verwacht Learningpool Act toepassing in een specifieke indeling. Configureer de volgende claims voor deze toepassing. U kunt de waarden van deze kenmerken van beheren de **'Atrribute'** tabblad van de toepassing. De volgende Schermafbeelding toont een voorbeeld voor deze. 
...
8. Eenmalige aanmelding configureren op **Learningpool Act** zijde, moet u de gedownloade verzenden **Metadata XML** naar [Learningpool Act-ondersteuningsteam](https://www.Learningpool.com/support). Ze deze instelling zodat de SAML SSO-verbinding juist is ingesteld op beide zijden ingesteld.
...
Om Azure AD-gebruikers zich aanmelden bij Learningpool Act, moeten ze worden ingericht in Learningpool Act.

Er is geen actie-item voor configuratie van gebruikers inrichten met Learningpool functioneren.  
Gebruikers moeten worden gemaakt door uw [Learningpool Act-ondersteuningsteam](https://www.Learningpool.com/support).

>[!NOTE]
>U kunt andere Learningpool Act gebruiker account hulpmiddelen voor het maken of API's die is geleverd door Learningpool Act aan inrichten AAD-gebruikersaccounts. 

### <a name="assigning-the-azure-ad-test-user"></a>Toewijzen van de testgebruiker Azure AD

In deze sectie schakelt u Britta Simon gebruikt Azure eenmalige aanmelding toegang verlenen aan Learningpool Act.

![Gebruiker toewijzen][200] 

**Als u wilt toewijzen Britta Simon met Learningpool functioneren, moet u de volgende stappen uitvoeren:**

1. Open de weergave toepassingen in de Azure-portal en gaat u naar de directoryweergave en gaat u naar **bedrijfstoepassingen** klikt u vervolgens op **alle toepassingen**.

    ![Gebruiker toewijzen][201] 

2. Selecteer in de lijst met toepassingen **Learningpool Act**.
...
Als u op de tegel Learningpool Act in het deelvenster toegang, u moet ophalen automatisch aangemeld bij uw Learningpool Act-toepassing.
