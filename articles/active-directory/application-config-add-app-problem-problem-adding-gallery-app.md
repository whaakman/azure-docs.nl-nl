---
title: Probleem met het toevoegen van een galerie van Azure AD-toepassing | Microsoft Docs
description: Inzicht in het algemene problemen mensen vlak bij het toevoegen van de galerie van Azure AD-toepassingen en wat u kunt doen om deze kunt oplossen
...
ms.locfileid: "36334982"
---
# <a name="problem-adding-an-azure-ad-gallery-application"></a>Probleem met een galerie van Azure AD-toepassing toevoegen

In dit artikel helpt u begrijpen van het algemene problemen mensen vlak bij het toevoegen van de galerie van Azure AD-toepassingen en wat u kunt doen om deze kunt oplossen.
...
Als u wilt leren over toepassingen, de [lijst zelfstudies over het integreren van SaaS-Apps met Azure Active Directory](https://docs.microsoft.com/azure/active-directory/active-directory-saas-tutorial-list) artikel is een goede plaats om te starten.

Daarnaast de [Azure AD-toepassingen-documentbibliotheek](https://docs.microsoft.com/azure/active-directory/active-directory-apps-index) kunt u meer informatie over eenmalige aanmelding met Azure AD en hoe het werkt.
...
6.  Klik op de **kopie** **pictogram** rechts van de **Kopieerfout** tekstvak voor het kopiëren van de Meldingsdetails te delen met een groep engineer van ondersteuning of productupdates
