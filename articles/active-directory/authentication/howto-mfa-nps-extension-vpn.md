...
description: Uw VPN-infrastructuur worden geïntegreerd met Azure MFA met behulp van de Network Policy Server-uitbreiding voor Microsoft Azure.
...
De Network Policy Server (NPS)-extensie voor Azure, waarmee organisaties beschermen Remote Authentication Dial-In User Service (RADIUS)-clientauthenticatie met behulp van cloud-gebaseerde [Azure multi-factor Authentication (MFA)](howto-mfaserver-nps-rdg.md), waarmee u verificatie in twee stappen.
...
Zie voor meer informatie over Azure AD Connect [uw on-premises adreslijsten integreren met Azure Active Directory](../connect/active-directory-aadconnect.md). 
...
13. In de **nieuwe voltooien inbel- of VPN-verbindingen en RADIUS-clients** Selecteer **voltooien**.
    ...
    ![Het venster 'voltooien nieuwe inbel- of de verbindingen van virtueel particulier netwerk en de RADIUS-clients'](./media/howto-mfa-nps-extension-vpn/image10.png)
...
5. Onder **beleid**, selecteer **netwerkbeleid**. Hier ziet u een beleid met virtuele particuliere netwerk (VPN)-verbindingen dat lijkt op het beleid wordt weergegeven in de volgende afbeelding:
    ...
    ![Netwerkbeleid](./media/howto-mfa-nps-extension-vpn/image13.png)
...
3. In de **Routing and Remote Access** venster met de rechtermuisknop op  **\<servernaam > (lokaal)**, en selecteer vervolgens **eigenschappen**.
    ...
    ![Het venster Routering en RAS](./media/howto-mfa-nps-extension-vpn/image14.png)
...
8. Met de rechtermuisknop op de netwerkverbinding van de VPN- en selecteer vervolgens **eigenschappen**. 
    ...
    ![Eigenschappen van VPN-netwerk](./media/howto-mfa-nps-extension-vpn/image19.png)
...
5. In de **NPS-extensie voor Azure MFA Setup** Selecteer **sluiten**.  
    ...
    ![Het 'Setup geslaagd' bevestigingsvenster](./media/howto-mfa-nps-extension-vpn/image37.png) 
...
4. Voer uw Azure AD-beheerdersreferenties en het wachtwoord en selecteer vervolgens **aanmelden**. 
    ...
    ![Het venster PowerShell aanmelden](./media/howto-mfa-nps-extension-vpn/image39.png)
...
![Het venster Windows-VPN-instellingen](./media/howto-mfa-nps-extension-vpn/image42.png)
...
![Het account verifiëren](./media/howto-mfa-nps-extension-vpn/image43.png)
...
![PowerShell beveiliging Logboeken](./media/howto-mfa-nps-extension-vpn/image44.png)
...
![Met een mislukte gebeurtenis aanmelden beveiligingslogboek](./media/howto-mfa-nps-extension-vpn/image47.png)
...
![Shareware toepassing](./media/howto-mfa-nps-extension-vpn/image49.png)
...
[Ophalen van Azure multi-factor Authentication](concept-mfa-licensing.md)
