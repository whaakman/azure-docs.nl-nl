...
- Probeer de [Microsoft Authenticator-app](../../../../multi-factor-authentication/end-user/microsoft-authenticator-app-how-to.md) om te controleren of uw aanmeldingen met app-meldingen in plaats van de ontvangen tekst of aanroepen.
