...
* **Ondersteunt het instellen van wachtwoorden voor gebruikers die gebruikmaken van** [synchronisatie van wachtwoordhash](./../connect/active-directory-aadconnectsync-implement-password-hash-synchronization.md): als het wachtwoord opnieuw instellen van service detecteert dat een gesynchroniseerde gebruiker-account voor synchronisatie van wachtwoordhash is ingeschakeld, wordt dit opnieuw instellen van het account van on-premises en cloud wachtwoord tegelijkertijd. Wachtwoord terugschrijven is niet afhankelijk van synchronisatie van wachtwoordhash.
...
Zie voor meer informatie over licentieverlening [licenties nodig zijn voor write-back van wachtwoord](concept-sspr-licensing.md) of de volgende sites:
...
[Writeback]: ./media/howto-sspr-writeback/enablepasswordwriteback.png "Wachtwoord terugschrijven in Azure AD Connect inschakelen"
