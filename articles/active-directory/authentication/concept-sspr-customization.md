...
* Als de gebruiker toegang heeft tot de aangepaste URL:
    * Door de *w /* -parameter voor het wachtwoord opnieuw instellen pagina, zoals 'https://login.microsoftonline.com/?whr=contoso.com'
...
[Contact]: ./media/concept-sspr-customization/sspr-contact-admin.png "Neem contact op met uw beheerder voor hulp bij het opnieuw instellen van uw wachtwoord e-voorbeeld"
