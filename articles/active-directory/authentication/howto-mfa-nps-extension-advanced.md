...
Voor het oplossen van problemen met alternatieve aanmeldings-id's, kunt u de aanbevolen stappen voor [alternatieve aanmeldings-ID fouten](howto-mfa-nps-extension-errors.md#alternate-login-id-errors).
