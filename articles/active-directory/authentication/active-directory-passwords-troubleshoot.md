---
title: Self-service voor wachtwoord opnieuw instellen oplossen van problemen met Azure Active Directory
...
| Ik zie niet de **On-premises integratie** tabblad. | Deze optie wordt alleen weergegeven als u Azure AD Connect hebt gedownload en het terugschrijven van wachtwoorden hebt geconfigureerd. Zie voor meer informatie, [aan de slag met Azure AD Connect met behulp van de express-instellingen](./../connect/active-directory-aadconnect-get-started-express.md). |
...
Voor meer informatie, Controleer de vereisten van de verbinding in de [vereisten voor Azure AD Connect](./../connect/active-directory-aadconnect-prerequisites.md) artikel.
...
* **Pagina**: welke pagina u op wanneer u opgemerkt dat de fout zijn? De URL als kunt u of een schermafbeelding van de pagina bevatten.
* **Ondersteuningscode**: Wat is de van ondersteuningscode die is gegenereerd toen de gebruiker zag de fout?
...
* **Gebruikers-ID**: wie is de gebruiker die de fout hebt gezien? Een voorbeeld is *user@contoso.com*.
