...
| De map voor het wachtwoord opnieuw instellen is ingeschakeld, maar de gebruiker heeft een ontbrekend of onjuist gevormd verificatiegegevens. | Voordat u doorgaat, zorg ervoor dat de dat gebruiker heeft contact op met gegevens in het bestand in de map goed gevormd. Zie voor meer informatie [gegevens die worden gebruikt door Azure AD zelf uw wachtwoord opnieuw instellen](howto-sspr-authenticationdata.md). |
...
Verwijst naar de bijgewerkte lijst met meer granulatie [Microsoft Azure Datacenter IP-adresbereiken](https://www.microsoft.com/download/details.aspx?id=41653) elke woensdag bijgewerkt en de volgende maandag tot stand is gebracht.
