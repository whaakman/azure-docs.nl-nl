...
4. Typ in het zoekvak **koppel**, selecteer **koppel** van resultaat deelvenster klik vervolgens op **toevoegen** om toe te voegen van de toepassing.
    ...
    ![Koppel in de lijst met resultaten](./media/active-directory-saas-flock-tutorial/tutorial_flock_addfromgallery.png)
...
2. Op de **eenmalige aanmelding** dialoogvenster Selecteer **modus** als **op basis van SAML aanmelding** voor eenmalige aanmelding inschakelen.
    ...
    ![Dialoogvenster voor eenmalige aanmelding](./media/active-directory-saas-flock-tutorial/tutorial_flock_samlbase.png)

3. Op de **koppel domein en de URL's** sectie, voert u de volgende stappen uit:

    ![Koppel domein en de URL's van eenmalige aanmelding informatie](./media/active-directory-saas-flock-tutorial/tutorial_flock_url.png)
...
4. Op de **SAML-certificaat voor ondertekening van** sectie, klikt u op **Certificate(Base64)** en sla het certificaatbestand op uw computer.
    ...
    ![De downloadkoppeling certificaat](./media/active-directory-saas-flock-tutorial/tutorial_flock_certificate.png)

5. Klik op **opslaan** knop.

    ![Knop Single Sign-On opslaan configureren](./media/active-directory-saas-flock-tutorial/tutorial_general_400.png)
...
6. Op de **koppel configuratie** sectie, klikt u op **koppel configureren** openen **eenmalige aanmelding configureren** venster. Kopieer de **SAML entiteit-ID en SAML Single Sign-On Service-URL** van de **Naslaggids punt.**
    ...
    ![Koppel-configuratie](./media/active-directory-saas-flock-tutorial/tutorial_flock_configure.png) 
...
8. Selecteer **verificatie** tabblad van het navigatievenster van de linkerkant en selecteer vervolgens **SAML-verificatie**.
    ...
    ![Koppel-configuratie](./media/active-directory-saas-flock-tutorial/configure1.png)

9. In de **SAML-verificatie** sectie, voert u de volgende stappen uit:

    ![Koppel-configuratie](./media/active-directory-saas-flock-tutorial/configure2.png)
...
1. Klik in de Azure-portal in het linkerdeelvenster op het **Azure Active Directory** knop.
    ...
    ![De Azure Active Directory-knop](./media/active-directory-saas-flock-tutorial/create_aaduser_01.png)

2. Als u wilt weergeven in de lijst met gebruikers, gaat u naar **gebruikers en groepen**, en klik vervolgens op **alle gebruikers**.

    !['Gebruikers en groepen' en 'Alle gebruikers' koppelingen](./media/active-directory-saas-flock-tutorial/create_aaduser_02.png)

3. Openen van de **gebruiker** in het dialoogvenster klikt u op **toevoegen** boven aan de **alle gebruikers** in het dialoogvenster.

    ![De knop toevoegen](./media/active-directory-saas-flock-tutorial/create_aaduser_03.png)

4. In de **gebruiker** dialoogvenster vak, voert u de volgende stappen uit:

    ![Het dialoogvenster gebruiker](./media/active-directory-saas-flock-tutorial/create_aaduser_04.png)
...
2. Klik op **Team beheren** in het linkernavigatievenster.
    ...
    ![Werknemer toevoegen](./media/active-directory-saas-flock-tutorial/user1.png)

3. Klik op **lid toevoegen** tabblad en selecteer vervolgens **teamleden**.

    ![Werknemer toevoegen](./media/active-directory-saas-flock-tutorial/user2.png)

4. Voer het e-mailadres van de gebruiker zoals **Brittasimon@contoso.com** en selecteer vervolgens **gebruikers toevoegen**.

    ![Werknemer toevoegen](./media/active-directory-saas-flock-tutorial/user3.png)
...
2. Selecteer in de lijst met toepassingen **koppel**.
    ...
    ![De koppeling Koppel in de lijst met toepassingen](./media/active-directory-saas-flock-tutorial/tutorial_flock_app.png)
