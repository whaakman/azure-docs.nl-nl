...
3. Op de **Atlassian Cloud-domein en de URL's** sectie, voert u de volgende stappen uit als u wilt configureren, de toepassing in **IDP** modus gestart:
    ...
    ![URL's en Atlassian Cloud domein eenmalige aanmelding informatie](./media/active-directory-saas-atlassian-cloud-tutorial/tutorial_atlassiancloud_url_new.png)
    
    a. In de **id** textbox, typ de URL:`https://id.atlassian.com/login`
    
    b. In de **antwoord-URL** textbox, typ de URL:`https://id.atlassian.com/login/saml/acs`
...
4. Controleer **weergeven geavanceerde instellingen voor URL** en voer de volgende stap als u wilt configureren van de toepassing in **SP** modus gestart:
    ...
    > [!NOTE] 
    > Deze waarden zijn niet echt. U kunt deze waarden ophalen van SAML-configuratie van Atlassian Cloud scherm, die verderop in de zelfstudie wordt beschreven.
...
7. Op de **Atlassian Cloudconfiguratie** sectie, klikt u op **Atlassian Cloud configureren** openen **eenmalige aanmelding configureren** venster. Kopieer de **SAML entiteit-ID en SAML Single Sign-On Service-URL** van de **Naslaggids punt.**

    ![Atlassian Cloudconfiguratie](./media/active-directory-saas-atlassian-cloud-tutorial/tutorial_atlassiancloud_configure.png) 

8. Ophalen van eenmalige aanmelding die zijn geconfigureerd voor uw toepassing, meld u aan bij de Atlassian-Portal met behulp van de administrator-rechten.

9. Navigeer naar **Atlassian Sitebeheer** > **organisaties & beveiliging**. Als u dat nog niet gedaan hebt, maken en de naam van uw organisatie. Klik in het linkernavigatievenster **domeinen**.

    ![Eenmalige aanmelding configureren](./media/active-directory-saas-atlassian-cloud-tutorial/tutorial_atlassiancloud_06.png)

10. Selecteer de manier waarop dat u wilt controleren of uw domein - **DNS** of **HTTPS**.

    ![Eenmalige aanmelding configureren](./media/active-directory-saas-atlassian-cloud-tutorial/tutorial_atlassiancloud_17.png)

11. Voor DNS-verificatie, selecteer de **DNS** tabblad op de **domeinen** pagina en voer dit stappen uit:
    ...
    b. Zoek in uw DNS de instellingenpagina voor het toevoegen van een nieuwe record
...
12. Ga terug naar de **pagina domeinen** Organisatiebeheer en klik op de **domein controleren** knop. Voer uw domeinnaam in het pop-upvenster en klik op de **domein controleren** knop.
...
13. Voor HTTPS-verificatie, selecteer de **HTTPS** tabblad op de **domeinen** pagina en voert u de volgende stappen:
...
14. Ga terug naar de **domeinen** pagina in Organisatiebeheer en klik op de **domein controleren** knop. Voer uw **domeinnaam** in het pop-upvenster en klik op de **domein controleren** knop.

    ![Eenmalige aanmelding configureren](./media/active-directory-saas-atlassian-cloud-tutorial/tutorial_atlassiancloud_22.png)

15. Als het verificatieproces in de hoofdmap geüploade bestand vinden kunt, de status van het domein werkt bij **geverifieerde**.

    ![Eenmalige aanmelding configureren](./media/active-directory-saas-atlassian-cloud-tutorial/tutorial_atlassiancloud_23.png)

    > [!NOTE]
    > Raadpleeg voor meer informatie [Atlassian van domein verificatie documentatie](https://confluence.atlassian.com/cloud/domain-verification-873871234.html)

16. Klik in de linkernavigatiebalk op **eenmalige aanmelding SAML**. Als u nog niet gedaan hebt, zich abonneren op Atlassian van Identity Manager.

    ![Eenmalige aanmelding configureren](./media/active-directory-saas-atlassian-cloud-tutorial/tutorial_atlassiancloud_11.png)

17. In **toevoegen de SAML-configuratie** dialoogvenster hosteigenschappen toevoegen de Providerinstellingen identiteit als volgt:
    ...
    c. Het gedownloade certificaat openen in Kladblok en kopieer de waarden zonder het Begin en einde regels en plak deze in de **openbare X509 certificaat** vak.
    
    d. Klik op **configuratie opslaan** de instellingen op te slaan.
     
18. Werk de instellingen van Azure AD om ervoor te zorgen dat u setup de juiste URL's hebben.
...
19. Klik in de Azure-portal op **opslaan** knop.
...
1. Klik in de sectie Site beheer van Atlassian Portal op de **gebruikers** knop
