...
De volgende zelfstudie begeleidt u bij het maken van een hybride identiteit-omgeving met behulp van Pass through-verificatie.  Deze omgeving kan vervolgens worden gebruikt voor het testen of voor het ophalen van meer wilt weten over de werking van een hybride identiteit.
...
![Aangepaste](media/tutorial-federation/custom1.png)</br>
...
![Aangepaste](media/tutorial-federation/custom2.png)</br>
6. Om ervoor te zorgen dat deze is geverifieerd, klikt u op verifiëren klikt.</br>
![Aangepaste](media/tutorial-federation/custom3.png)</br>
...
6. Selecteer op het scherm aanmelden van gebruikers **Pass through-verificatie** en **eenmalige aanmelding inschakelen** en klikt u op **volgende**.</br>
...
9. Voer op de pagina van de referenties voor eenmalige aanmelding-n inschakelen contoso\Administrator gebruikersnaam en wachtwoord in en klikt u op **volgende.**
...
12. Nadat de installatie is voltooid, meldt u zich af en opnieuw aanmelden voordat u de Synchronization Service Manager of Synchronization Rule Editor gebruiken.
