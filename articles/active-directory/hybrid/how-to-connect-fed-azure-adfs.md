...
![Implementatie-ontwerp](./media/how-to-connect-fed-azure-adfs/deployment.png)
...
![Virtueel netwerk maken](./media/how-to-connect-fed-azure-adfs/deploynetwork1.png)
...
![NSG’s maken](./media/how-to-connect-fed-azure-adfs/creatensg1.png)
...
![NSG’s initialiseren](./media/how-to-connect-fed-azure-adfs/nsgint1.png)
...
![NPS configureren](./media/how-to-connect-fed-azure-adfs/nsgconfigure1.png)
...
![Subnetten na NSG](./media/how-to-connect-fed-azure-adfs/nsgconfigure2.png)
...
![Opslagaccount maken](./media/how-to-connect-fed-azure-adfs/storageaccount1.png)
...
![Beschikbaarheidssets](./media/how-to-connect-fed-azure-adfs/availabilityset1.png)
...
![Virtuele machines geïmplementeerd](./media/how-to-connect-fed-azure-adfs/virtualmachinesdeployed_noadfs.png)
...
![Bladeren naar load balancer](./media/how-to-connect-fed-azure-adfs/browseloadbalancer.png)
...
![Interne load balancer](./media/how-to-connect-fed-azure-adfs/ilbdeployment1.png)

Wanneer u op Maken klikt en de ILB is geïmplementeerd, wordt deze weergegeven in de lijst met load balancers:

![Load balancers na ILB](./media/how-to-connect-fed-azure-adfs/ilbdeployment2.png)
...
![ILB-back-endpool configureren](./media/how-to-connect-fed-azure-adfs/ilbdeployment3.png)
...
![Test ILB configureren](./media/how-to-connect-fed-azure-adfs/ilbdeployment4.png)
...
![ILB-taakverdelingsregels configureren](./media/how-to-connect-fed-azure-adfs/ilbdeployment5.png)
...
![Internetgerichte load balancer](./media/how-to-connect-fed-azure-adfs/elbdeployment1.png)

Na implementatie wordt de load balancer weergegeven in de lijst met load balancers.

![Lijst met load balancers](./media/how-to-connect-fed-azure-adfs/elbdeployment2.png)
...
![Internetgerichte load balancer configureren](./media/how-to-connect-fed-azure-adfs/elbdeployment3.png) 

![Internetgerichte load balancer (DNS) configureren](./media/how-to-connect-fed-azure-adfs/elbdeployment4.png)
...
![Back-endpool voor internetgerichte (openbare) load balancer configureren](./media/how-to-connect-fed-azure-adfs/elbdeployment5.png)
...
![Test voor internetgerichte load balancer configureren](./media/how-to-connect-fed-azure-adfs/elbdeployment6.png)

**8.5. Taakverdelingsregel(s) maken**

Volg dezelfde stappen als in ILB om de taakverdelingsregel voor TCP 443 te configureren.

![Taakverdelingsregels van internetgerichte load balancer configureren](./media/how-to-connect-fed-azure-adfs/elbdeployment7.png)
...
![INT-toegangsregels (inkomend)](./media/how-to-connect-fed-azure-adfs/nsg_int.png)
...
![EXT-toegangsregels (inkomend)](./media/how-to-connect-fed-azure-adfs/nsg_dmz.png)
...
![Aanmeldingspagina testen](./media/how-to-connect-fed-azure-adfs/test1.png)

Bij een geslaagde aanmelding wordt een soortgelijk positief bericht weergegeven:

![Test geslaagd](./media/how-to-connect-fed-azure-adfs/test2.png)
...
* [De AD FS configureren en beheren met Azure AD Connect](how-to-connect-fed-whatis.md)
