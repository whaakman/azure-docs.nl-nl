...
- Zie voor het inschakelen van MSI op een Azure VM [configureren van een Azure VM beheerde Service identiteit (MSI) met behulp van PowerShell](qs-configure-powershell-windows-vm.md).
