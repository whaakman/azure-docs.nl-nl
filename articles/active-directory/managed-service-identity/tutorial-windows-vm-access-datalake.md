---
title: Toegang krijgen tot Azure Data Lake Storage met een Managed Service Identity voor een Windows-VM
description: Deze zelfstudie laat zien hoe u toegang krijgt tot Azure Data Lake Storage met een Managed Service Identity voor een Windows-VM.
...
Maak een nieuwe map in uw Data Lake Storage, en verleen de Managed Service Identity van uw VM toestemming voor het lezen, schrijven en uitvoeren van bestanden in die map:
...
In deze zelfstudie gebruikt u PowerShell voor het maken van REST-aanvragen om te verifiëren bij de REST-API van het Data Lake Storage-bestandssysteem. Als u de Managed Service Identity van de virtuele machine wilt gebruiken voor verificatie, moet u de aanvragen verzenden vanaf de virtuele machine.
...
Gefeliciteerd!  U hebt geverifieerd bij het Data Lake Storage-bestandssysteem met behulp van een Managed Service Identity voor een virtuele machine.
