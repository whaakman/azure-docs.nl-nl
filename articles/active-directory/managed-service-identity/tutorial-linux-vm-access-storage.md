---
title: Toegang krijgen tot Azure Storage met de beheerde entiteit van een Linux-VM
description: Een zelfstudie die u helpt bij het gebruiken van een door het systeem toegewezen Managed Service Identity op een Linux-VM voor toegang tot Azure Storage.
...
In deze zelfstudie hebt u geleerd een beheerde identiteit van een virtuele Linux-machine in te schakelen om toegang tot Azure Storage te krijgen.  Zie voor meer informatie over Azure Storage:
