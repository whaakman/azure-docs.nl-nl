...
In deze zelfstudie leert u hoe Abintegro integreren met Azure Active Directory (Azure AD).

Abintegro integreren met Azure AD biedt de volgende voordelen:
...
1. Abintegro uit de galerie toevoegen
2. Configureren en testen van Azure AD eenmalige aanmelding

## <a name="adding-abintegro-from-the-gallery"></a>Abintegro uit de galerie toevoegen
Voor het configureren van de integratie van Abintegro in Azure AD, moet u Abintegro uit de galerie toevoegen aan de lijst met beheerde SaaS-apps.
...
In deze sectie kunt u configureren en testen eenmalige aanmelding Azure AD met Abintegro op basis van een testgebruiker genaamd "Britta Simon."

Voor eenmalige aanmelding werkt, moet Azure AD weten wat de gebruiker equivalent in Abintegro is voor een gebruiker in Azure AD. Met andere woorden, moet een koppeling relatie tussen een Azure AD-gebruiker en de betreffende gebruiker in Abintegro tot stand worden gebracht.

Wijs in Abintegro, de waarde van de **gebruikersnaam** in Azure AD als de waarde van de **gebruikersnaam** de relatie van de koppeling tot stand brengen.
...
3. **[Maken van een testgebruiker Abintegro](#creating-an-abintegro-test-user)**  - Abintegro die is gekoppeld aan de Azure AD-weergave van de gebruiker van een exemplaar van Britta Simon bevatten.
4. **[Toewijzen van de Azure AD-testgebruiker](#assigning-the-azure-ad-test-user)**  - Britta Simon gebruik van Azure AD eenmalige aanmelding inschakelen.
5. **[Testen van eenmalige aanmelding](#testing-single-sign-on)**  : om te controleren of de configuratie werkt.

### <a name="configuring-azure-ad-single-sign-on"></a>Eenmalige aanmelding Azure AD configureren

In dit gedeelte Azure AD eenmalige aanmelding inschakelen in de Azure portal en eenmalige aanmelding in uw toepassing Abintegro configureren.

**Voor het configureren van Azure AD eenmalige aanmelding met Abintegro, moet u de volgende stappen uitvoeren:**

1. In de Azure-portal op de **Abintegro** toepassing Integratiepagina, klikt u op **eenmalige aanmelding**.
...
3. Op de **Abintegro domein en de URL's** sectie, voert u de volgende stappen uit:

    ![Eenmalige aanmelding configureren](./media/active-directory-saas-abintegro-tutorial/tutorial_abintegro_url.png)

    In de **aanmeldings-URL** textbox, typ een URL met het volgende patroon volgen: `https://dev.abintegro.com/Shibboleth.sso/Login?entityID=<Issuer>&target=https://dev.abintegro.com/secure/`

    > [!NOTE] 
    > Deze waarde is geen echte. Deze waarde bijwerken met de werkelijke URL voor eenmalige aanmelding. Neem contact op met [Abintegro Client ondersteuningsteam](mailto:support@abintegro.com) deze waarde op te halen. 
...
6. Eenmalige aanmelding configureren op **Abintegro** zijde, moet u de gedownloade verzenden **Metadata XML** naar [Abintegro ondersteuningsteam](mailto:support@abintegro.com). Ze deze instelling zodat de SAML SSO-verbinding juist is ingesteld op beide zijden ingesteld.
...
### <a name="creating-an-abintegro-test-user"></a>Een testgebruiker Abintegro maken

Er is geen actie-item voor gebruikers inrichten voor Abintegro configuratie. Wanneer een toegewezen gebruiker probeert aan te melden bij met het toegangsvenster Abintegro, Abintegro u controleert of de gebruiker bestaat.
  
Als er nog geen gebruikersaccount beschikbaar is, wordt het automatisch gemaakt door Abintegro.

### <a name="assigning-the-azure-ad-test-user"></a>Toewijzen van de testgebruiker Azure AD

In deze sectie schakelt u Britta Simon gebruikt Azure eenmalige aanmelding toegang verlenen aan Abintegro.

![Gebruiker toewijzen][200] 

**Britta Simon om aan te wijzen Abintegro, moet u de volgende stappen uitvoeren:**
...
Als u op de tegel Abintegro in het deelvenster toegang, krijgt u de aanmeldingspagina van Abintegro toepassing.
