...
4. Typ in het zoekvak **SAML SSO voor Bitbucket door resolutie GmbH**, selecteer **SAML SSO voor Bitbucket door resolutie GmbH** van resultaat deelvenster klik vervolgens op **toevoegen** om toe te voegen de de toepassing.
    ...
    ![SAML SSO voor Bitbucket door oplossing GmbH in de lijst met resultaten](./media/active-directory-saas-bitbucket-tutorial/tutorial_bitbucket_addfromgallery.png)
...
2. Op de **eenmalige aanmelding** dialoogvenster Selecteer **modus** als **op basis van SAML aanmelding** voor eenmalige aanmelding inschakelen.
    ...
    ![Dialoogvenster voor eenmalige aanmelding](./media/active-directory-saas-bitbucket-tutorial/tutorial_bitbucket_samlbase.png)
...
3. Op de **SAML SSO voor Bitbucket door resolutie GmbH domein en URL's** sectie, voert u de volgende stappen uit als u wilt configureren van de toepassing in de IDP geïnitieerd modus:
    ...
    ![SAML SSO voor Bitbucket door resolutie GmbH domein en één URL's aanmelding informatie](./media/active-directory-saas-bitbucket-tutorial/tutorial_bitbucket_url.png)
...
4. Controleer **weergeven geavanceerde instellingen voor URL** en voer de volgende stap als u wilt configureren van de toepassing in **SP** modus gestart:
    ...
    ![SAML SSO voor Bitbucket door resolutie GmbH domein en één URL's aanmelding informatie](./media/active-directory-saas-bitbucket-tutorial/tutorial_bitbucket_url1.png)
...
5. Op de **SAML-certificaat voor ondertekening van** sectie, klikt u op **Metadata XML** en sla het bestand met metagegevens op uw computer.
    ...
    ![De downloadkoppeling certificaat](./media/active-directory-saas-bitbucket-tutorial/tutorial_bitbucket_certificate.png) 

6. Klik op **opslaan** knop.

    ![Knop Single Sign-On opslaan configureren](./media/active-directory-saas-bitbucket-tutorial/tutorial_general_400.png)
...
9. Ga naar het gedeelte ACCOUNTS, klikt u op **SAML SingleSignOn** op de menubalk.
    ...
    ![De Samlsingle](./media/active-directory-saas-bitbucket-tutorial/tutorial_bitbucket_samlsingle.png)

10. Op de **SAML SIngleSignOn invoegtoepassing configuratiepagina**, klikt u op **idp toevoegen**. 

    ![De idp toevoegen](./media/active-directory-saas-bitbucket-tutorial/tutorial_bitbucket_addidp.png)

11. Op de **Kies uw SAML-identiteitsprovider** pagina de volgende stappen uitvoeren:

    ![De id-provider](./media/active-directory-saas-bitbucket-tutorial/tutorial_bitbucket_identityprovider.png)
...
12. Op de **identiteit provider configuratiepagina**, klikt u op **volgende**.
    ...
    ![De configuratie van de identiteit](./media/active-directory-saas-bitbucket-tutorial/tutorial_bitbucket_identityconfig.png)
...
13.  Op de **SAML Idp-metagegevens importeren** pagina, klikt u op **bestand laden** voor het uploaden van de **METADATA XML** -bestand dat u hebt gedownload vanuit Azure-portal.
    ...
    ![De idpmetadata](./media/active-directory-saas-bitbucket-tutorial/tutorial_bitbucket_idpmetadata.png)
    
14. Klik op **Volgende**.

15. Klik op **instellingen opslaan**.

    ![Het opslaan](./media/active-directory-saas-bitbucket-tutorial/tutorial_bitbucket_save.png)
...
1. Klik in de Azure-portal in het linkerdeelvenster op het **Azure Active Directory** knop.
    ...
    ![De Azure Active Directory-knop](./media/active-directory-saas-bitbucket-tutorial/create_aaduser_01.png)

2. Als u wilt weergeven in de lijst met gebruikers, gaat u naar **gebruikers en groepen**, en klik vervolgens op **alle gebruikers**.

    !['Gebruikers en groepen' en 'Alle gebruikers' koppelingen](./media/active-directory-saas-bitbucket-tutorial/create_aaduser_02.png)

3. Openen van de **gebruiker** in het dialoogvenster klikt u op **toevoegen** boven aan de **alle gebruikers** in het dialoogvenster.

    ![De knop toevoegen](./media/active-directory-saas-bitbucket-tutorial/create_aaduser_03.png)

4. In de **gebruiker** dialoogvenster vak, voert u de volgende stappen uit:

    ![Het dialoogvenster gebruiker](./media/active-directory-saas-bitbucket-tutorial/create_aaduser_04.png)
...
2. Selecteer in de lijst met toepassingen **SAML SSO voor Bitbucket door resolutie GmbH**.
    ...
    ![De SAML SSO voor Bitbucket door resolutie GmbH koppeling in de lijst met toepassingen](./media/active-directory-saas-bitbucket-tutorial/tutorial_bitbucket_app.png)  
