...
-   Als een toepassing van een gebruiker of groep die de gebruiker lid van is is verwijderd, probeert aan te melden en afmelden opnieuw naar de gebruiker toegang deelvenster na een paar minuten om te zien als de toepassing wordt verwijderd.

-   Als u een licentie is verwijderd uit een gebruiker of groep is de gebruiker dat lid is van dit kan lang duren, afhankelijk van de omvang en complexiteit van de groep voor wijzigingen worden aangebracht. Voor extra tijd voordat u zich in het deelvenster toegang toestaan.
...
Een gebruiker mogelijk ziet u een toepassing op hun Toegangsvenster omdat ze eerder waren is toegewezen aan deze. Hier volgen een aantal manieren om te controleren:
...
Als u wilt controleren of een gebruiker is toegewezen aan de toepassing, de volgende stappen uit:
...
7.  Klik op **licenties** om te zien die verleent aan de gebruiker momenteel is toegewezen.
   ...
   * Als de gebruiker een Office-licentie is toegewezen, kunnen hierdoor eerste partij Office-toepassingen worden weergegeven op het toegangsvenster van de gebruiker.
...
Een gebruiker mogelijk ziet u een toepassing op hun Toegangsvenster omdat ze deel uitmaken van een groep die de toepassing is toegewezen. Hier volgen een aantal manieren om te controleren:
