...
![de rol globale beheerder](./media/add-guest-to-role/global-admin-role.png)

## <a name="limited-administrator-role"></a>Beperkte Administrator-rol

![beperkte Administrator-rol](./media/add-guest-to-role/limited-admin-role.png)
