...
![Voordat de aanbieding inwisseling](media/user-properties/before-redemption.png)

### <a name="after-invitation-redemption"></a>Na een uitnodiging voor inwisseling

![Na de aanbieding inwisseling](media/user-properties/after-redemption.png)
...
![Gastgebruikers filteren](media/user-properties/filter-guest-users.png)
