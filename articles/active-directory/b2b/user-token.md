---
title: 'Inzicht in gebruikerstokens in B2B-samenwerking: Azure Active Directory | Microsoft Docs'
...
ms.locfileid: "56675378"
---
# <a name="understand-user-tokens-in-azure-ad-b2b-collaboration"></a>Inzicht in gebruikerstokens in Azure AD B2B-samenwerking

Als u weten hoe het token voor een gebruiker B2B-samenwerking eruitziet wilt, hier worden de details van bearer-token en token-inhoud voor een gastbesturingssysteem van de Azure Active Directory (Azure AD) en een Microsoft-account Gast in de resource-tenant (voor tenant-id 04dcc6ab-388a-4559-b527-fbec656300ea). Als de inhoud van JSON Web Token (JWT) wilt weergeven, gebruikt [ https://jwt.io/ ](https://jwt.io/) of [ https://jwt.ms/ ](https://jwt.ms/).
