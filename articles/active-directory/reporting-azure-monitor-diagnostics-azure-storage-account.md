...
4. In het deelvenster **Diagnostische instellingen** voert u een van de volgende handelingen uit:
    ...
    * Selecteer **Diagnostische instelling toevoegen** als u nieuwe instellingen wilt toevoegen.  
    ...
    ![Exportinstellingen](./media/reporting-azure-monitor-diagnostics-azure-storage-account/ExportSettings.png)
...
11. Selecteer **Opslaan** om de instelling op te slaan.
    ...
    ![Diagnostische instellingen](./media/reporting-azure-monitor-diagnostics-azure-storage-account/DiagnosticSettings.png)
...
13. Voor **Auditlogboeken** selecteert u **insights-log-audit**. Voor **Aanmeldingslogboeken** selecteert u **insights-log-signin**.
    ![Opslagaccount](./media/reporting-azure-monitor-diagnostics-azure-storage-account/StorageAccount.png)
