...
In deze zelfstudie leert u hoe EthicsPoint Incident Management (EPIM) integreren met Azure Active Directory (Azure AD).

EthicsPoint Incident Management (EPIM) integreren met Azure AD biedt de volgende voordelen:

- U kunt beheren in Azure AD met toegang op EthicsPoint Incident Management (EPIM)
- U kunt uw gebruikers automatisch ophalen aangemelde naar EthicsPoint Incident Management (EPIM) (Single Sign-On) inschakelen met hun Azure AD-accounts
...
1. EthicsPoint Incident Management (EPIM) uit de galerie toevoegen
2. Configureren en testen van Azure AD eenmalige aanmelding

## <a name="adding-ethicspoint-incident-management-epim-from-the-gallery"></a>EthicsPoint Incident Management (EPIM) uit de galerie toevoegen
Voor het configureren van de integratie van EthicsPoint Incident Management (EPIM) in Azure AD, moet u EthicsPoint Incident Management (EPIM) uit de galerie toevoegen aan de lijst met beheerde SaaS-apps.
...
4. Typ in het zoekvak **EthicsPoint Incident Management (EPIM)**.
...
5. Selecteer in het deelvenster resultaten **EthicsPoint Incident Management (EPIM)**, en klik vervolgens op **toevoegen** om toe te voegen van de toepassing.
...
Voor eenmalige aanmelding werkt, moet Azure AD weten wat de gebruiker equivalent in EthicsPoint Incident Management (EPIM) is aan een gebruiker in Azure AD. Met andere woorden, moet een koppeling relatie tussen een Azure AD-gebruiker en de betreffende gebruiker in EthicsPoint Incident Management (EPIM) tot stand worden gebracht.

EthicsPoint Incident Management (EPIM), wijs de waarde van de **gebruikersnaam** in Azure AD als de waarde van de **gebruikersnaam** de relatie van de koppeling tot stand brengen.
...
3. **[Maken van een testgebruiker EthicsPoint Incident Management (EPIM)](#creating-a-ethicspoint-incident-management-epim-test-user)**  - hebben een equivalent van Britta Simon in EthicsPoint Incident Management (EPIM) die is gekoppeld aan de Azure AD-weergave van de gebruiker.
4. **[Toewijzen van de Azure AD-testgebruiker](#assigning-the-azure-ad-test-user)**  - Britta Simon gebruik van Azure AD eenmalige aanmelding inschakelen.
5. **[Testen van eenmalige aanmelding](#testing-single-sign-on)**  : om te controleren of de configuratie werkt.

### <a name="configuring-azure-ad-single-sign-on"></a>Eenmalige aanmelding Azure AD configureren

In deze sectie maakt u Azure AD eenmalige aanmelding inschakelen in de Azure portal en eenmalige aanmelding configureren in uw toepassing EthicsPoint Incident Management (EPIM).
...
1. In de Azure-portal op de **EthicsPoint Incident Management (EPIM)** toepassing Integratiepagina, klikt u op **eenmalige aanmelding**.
...
3. Op de **EthicsPoint Incident Management (EPIM)-domein en de URL's** sectie, voert u de volgende stappen uit:
    ...
    b. In de **id** textbox, typ een URL met het volgende patroon volgen: `https://<companyname>.navexglobal.com/adfs/services/trust`

    c. In de **antwoord-URL** textbox, typ een URL met het volgende patroon volgen: `https://<servername>.navexglobal.com/adfs/ls/`

    > [!NOTE] 
    > Deze waarden zijn niet echt. Deze waarden bijwerken met de werkelijke antwoord-URL, -id en aanmeldings-URL. Neem contact op met [EthicsPoint Incident Management (EPIM) Client ondersteuningsteam](http://www.navexglobal.com/company/contact-us) ophalen van deze waarden. 
...
6. Eenmalige aanmelding configureren op **EthicsPoint Incident Management (EPIM)** zijde, moet u de gedownloade verzenden **Metadata XML** naar [ondersteuningsteam EthicsPoint Incident Management (EPIM) ](http://www.navexglobal.com/company/contact-us).
...
In deze sectie maakt u een gebruiker met de naam Britta Simon in EthicsPoint Incident Management (EPIM). Neem contact op met [EthicsPoint Incident Management (EPIM) ondersteuningsteam](http://www.navexglobal.com/company/contact-us) om toe te voegen de gebruikers van het platform EthicsPoint Incident Management (EPIM).

### <a name="assigning-the-azure-ad-test-user"></a>Toewijzen van de testgebruiker Azure AD

In deze sectie schakelt u Britta Simon Azure eenmalige aanmelding toegang verleent aan EthicsPoint Incident Management (EPIM) gebruiken.
...
2. Selecteer in de lijst met toepassingen **EthicsPoint Incident Management (EPIM)**.
...
Als u op de tegel EthicsPoint Incident Management (EPIM) in het deelvenster toegang, u moet ophalen automatisch aangemeld bij uw toepassing EthicsPoint Incident Management (EPIM).
