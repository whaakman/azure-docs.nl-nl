...
- Zie [Referentie voor auditactiviteiten van Azure AD](active-directory-reporting-activity-audit-reference.md) voor een volledige lijst van alle auditactiviteiten.
