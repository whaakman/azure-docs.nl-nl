...
---
# <a name="using-azure-ad-connect-health-with-ad-fs"></a>Azure AD Connect Health gebruiken met AD FS
...
Om aanvullende gegevens te selecteren geeft u een tijdsperiode op, of klikt u met de rechtermuisknop op de grafiek met gebruiksanalyses en selecteert u Grafiek bewerken om de groepering te wijzigen. Vervolgens kunt u de tijdsperiode opgeven, andere gegevens selecteren en de groepering wijzigen. U kunt de distributie van het verificatieverkeer op basis van verschillende "gegevens" weergeven en alle gegevens groeperen met behulp van de relevante 'groeperen op'-parameters die in de volgende tabel worden beschreven:
