...
![Algemeen scenario voor synchronisatie fout vaststellen](./media/active-directory-aadconnect-health-sync-iidfix/IIdFixCommonCase.png)
...
![Fout-zwevende object synchronisatiescenario vaststellen](./media/active-directory-aadconnect-health-sync-iidfix/IIdFixOrphanedCase.png)
...
![Zwevende synchronisatieobject fout diagnosticeren * gebruiker bestaat * scenario](./media/active-directory-aadconnect-health-sync-iidfix/IIdFixOrphanedCase.png)
...
![Zwevende synchronisatieobject fout diagnosticeren * dezelfde gebruiker * scenario](./media/active-directory-aadconnect-health-sync-iidfix/IIdFixOrphanedCase.png)
...
![Synchronisatiefout nadat het probleem vaststellen](./media/active-directory-aadconnect-health-sync-iidfix/IIdFixAfterFix.png)
