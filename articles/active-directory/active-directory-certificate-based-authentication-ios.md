...
iOS-apparaten kunnen u certificaten gebaseerde verificatie (CBA) gebruiken om te verifiëren met Azure Active Directory met een clientcertificaat op hun apparaat bij het verbinden met:
