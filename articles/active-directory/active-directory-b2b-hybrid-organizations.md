...
- U kunt Microsoft Identity Manager (MIM) 2016 SP1 en de MIM-beheeragent gebruiken voor Microsoft Graph. (Hiervoor is een Azure AD Premium 1-abonnement vereist.)
- U kunt een PowerShell-script gebruiken. (Deze oplossing vereist geen MIM of AD Premium.)

Zie voor meer informatie over het implementeren van deze oplossingen [Grant B2B-gebruikers in Azure AD toegang tot uw on-premises toepassingen](active-directory-b2b-hybrid-cloud-to-on-premises.md).
...
We nu aanbieding methoden waar u Azure AD Connect gebruiken kunt voor het synchroniseren van deze lokale accounts naar de cloud als 'gastgebruikers', waar de accounts zich gedragen net zoals Azure AD B2B-gebruikers. Deze oplossing werkt ook als u een on-premises identity-systeem waarmee uw partners die hun eigen externe e-mailadressen gebruiken als hun naam hebt.
...
Zie voor meer informatie implementatie [Grant partner lokaal beheerde accounts toegang krijgen tot bronnen in de cloud met Azure AD B2B-samenwerking](active-directory-b2b-hybrid-on-premises-to-cloud.md).
...
- [Verleen partner lokaal beheerde accounts toegang krijgen tot bronnen in de cloud met Azure AD B2B-samenwerking](active-directory-b2b-hybrid-on-premises-to-cloud.md).
