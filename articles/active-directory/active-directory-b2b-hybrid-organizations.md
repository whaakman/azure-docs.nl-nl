...
- [Verleen partner lokaal beheerde serviceaccounts toegang bronnen in de cloud met Azure AD B2B-samenwerking](active-directory-b2b-hybrid-on-premises-to-cloud.md)
