...
4. Typ in het zoekvak **Proxyclick**, selecteer **Proxyclick** van resultaat deelvenster klik vervolgens op **toevoegen** om toe te voegen van de toepassing.
    ...
    ![Proxyclick in de lijst met resultaten](./media/active-directory-saas-proxyclick-tutorial/tutorial_proxyclick_addfromgallery.png)
...
2. Op de **eenmalige aanmelding** dialoogvenster Selecteer **modus** als **op basis van SAML aanmelding** voor eenmalige aanmelding inschakelen.
    ...
    ![Dialoogvenster voor eenmalige aanmelding](./media/active-directory-saas-proxyclick-tutorial/tutorial_proxyclick_samlbase.png)
...
3. Op de **Proxyclick domein en de URL's** sectie, voert u de volgende stappen uit als u wilt configureren, de toepassing in **IDP** modus gestart:
    ...
    ![URL's en Proxyclick domein eenmalige aanmelding informatie](./media/active-directory-saas-proxyclick-tutorial/tutorial_proxyclick_url2.png)
...
4. Controleer **weergeven geavanceerde instellingen voor URL** en voer de volgende stap als u wilt configureren van de toepassing in **SP** modus gestart:
    ...
    ![URL's en Proxyclick domein eenmalige aanmelding informatie](./media/active-directory-saas-proxyclick-tutorial/tutorial_proxyclick_url1.png)
...
5. Op de **SAML-certificaat voor ondertekening van** sectie, klikt u op **Certificate(Base64)** en sla het certificaatbestand op uw computer.
    ...
    ![De downloadkoppeling certificaat](./media/active-directory-saas-proxyclick-tutorial/tutorial_proxyclick_certificate.png) 

6. Klik op **opslaan** knop.

    ![Knop Single Sign-On opslaan configureren](./media/active-directory-saas-proxyclick-tutorial/tutorial_general_400.png)
...
7. Op de **Proxyclick configuratie** sectie, klikt u op **configureren Proxyclick** openen **eenmalige aanmelding configureren** venster. Kopieer de **SAML entiteit-ID en SAML Single Sign-On Service-URL** van de **Naslaggids punt.**
    ...
    ![Proxyclick configuratie](./media/active-directory-saas-proxyclick-tutorial/tutorial_proxyclick_configure.png)

8. In een ander browservenster, meld u aan bij uw bedrijf Proxyclick site als beheerder.

9. Selecteer **& Accountinstellingen**.

    ![Proxyclick configuratie](./media/active-directory-saas-proxyclick-tutorial/configure1.png)

10. Schuif omlaag naar de **INTEGRATIES** en selecteer **SAML**.

    ![Proxyclick configuratie](./media/active-directory-saas-proxyclick-tutorial/configure2.png)

11. In de **SAML** sectie, voert u de volgende stappen uit:

    ![Proxyclick configuratie](./media/active-directory-saas-proxyclick-tutorial/configure3.png)
...
1. Klik in de Azure-portal in het linkerdeelvenster op het **Azure Active Directory** knop.
    ...
    ![De Azure Active Directory-knop](./media/active-directory-saas-proxyclick-tutorial/create_aaduser_01.png)

2. Als u wilt weergeven in de lijst met gebruikers, gaat u naar **gebruikers en groepen**, en klik vervolgens op **alle gebruikers**.

    !['Gebruikers en groepen' en 'Alle gebruikers' koppelingen](./media/active-directory-saas-proxyclick-tutorial/create_aaduser_02.png)

3. Openen van de **gebruiker** in het dialoogvenster klikt u op **toevoegen** boven aan de **alle gebruikers** in het dialoogvenster.

    ![De knop toevoegen](./media/active-directory-saas-proxyclick-tutorial/create_aaduser_03.png)

4. In de **gebruiker** dialoogvenster vak, voert u de volgende stappen uit:

    ![Het dialoogvenster gebruiker](./media/active-directory-saas-proxyclick-tutorial/create_aaduser_04.png)
...
2. Klik op **collega's** van de bovenste navigatiebalk.
    ...
    ![Werknemer toevoegen](./media/active-directory-saas-proxyclick-tutorial/user1.png)

3. Klik op **collega toevoegen**

    ![Werknemer toevoegen](./media/active-directory-saas-proxyclick-tutorial/user2.png)

4. In de **toevoegen van een collega** sectie, voert u de volgende stappen uit:

    ![Werknemer toevoegen](./media/active-directory-saas-proxyclick-tutorial/user3.png)
...
2. Selecteer in de lijst met toepassingen **Proxyclick**.
    ...
    ![De koppeling Proxyclick in de lijst met toepassingen](./media/active-directory-saas-proxyclick-tutorial/tutorial_proxyclick_app.png)  
