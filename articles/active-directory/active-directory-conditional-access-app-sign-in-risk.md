...
![Beleid maken](./media/active-directory-conditional-access-app-sign-in-risk/1000.png)
...
3. Op de **Azure Active Directory** pagina, in de **beheren** sectie, klikt u op **voorwaardelijke toegang**.
    ...
    ![Voorwaardelijke toegang](./media/active-directory-conditional-access-app-sign-in-risk/03.png)
 
4. Op de **voorwaardelijke toegang** in de werkbalk bovenaan op de pagina, klikt u op **toevoegen**.

    ![Naam](./media/active-directory-conditional-access-app-sign-in-risk/108.png)

5. Op de **nieuw** pagina, in de **naam** tekstvak, type **toegang blokkeren voor middelgrote risiconiveau**.

    ![Naam](./media/active-directory-conditional-access-app-sign-in-risk/104.png)

6. In de **toewijzing** sectie, klikt u op **gebruikers en groepen**.

    ![Gebruikers en groepen](./media/active-directory-conditional-access-app-sign-in-risk/06.png)

7. Op de **gebruikers en groepen** pagina:

    ![Voorwaardelijke toegang](./media/active-directory-conditional-access-app-sign-in-risk/107.png)
...
9. Op de **Cloud-apps** pagina:
    ...
    ![Voorwaardelijke toegang](./media/active-directory-conditional-access-app-sign-in-risk/109.png)
...
10. In de **besturingselementen voor toegang** sectie, klikt u op **verlenen**.
    ...
    ![Besturingselementen voor toegang](./media/active-directory-conditional-access-app-sign-in-risk/10.png)

11. Op de **verlenen** pagina:

    ![Voorwaardelijke toegang](./media/active-directory-conditional-access-app-sign-in-risk/105.png)
...
12. In de **beleid inschakelen** sectie, klikt u op **op**.
    ...
    ![Beleid inschakelen](./media/active-directory-conditional-access-app-sign-in-risk/18.png)
...
![Gebruiker](./media/active-directory-conditional-access-app-sign-in-risk/117.png)
...
2. Klik op **gebruiker**, selecteer **Alan Charon** op de **gebruikers** pagina en klik vervolgens op **Selecteer**.
    ...
    ![Gebruiker](./media/active-directory-conditional-access-app-sign-in-risk/116.png)

3. Als **aanmeldingsrisico**, selecteer **gemiddeld**.

    ![Gebruiker](./media/active-directory-conditional-access-app-sign-in-risk/119.png)
...
> [Vereisen dat de gebruiksrechtovereenkomst moet zijn geaccepteerd](./active-directory-conditional-access-tou.md)
