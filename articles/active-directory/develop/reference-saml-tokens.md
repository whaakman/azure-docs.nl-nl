...
| Naam | Gelijkwaardige JWT-Claim | Beschrijving | Voorbeeld |
| --- | --- | --- | ------------|
...
| Instant verificatie | |Registreert de datum en tijd waarop de verificatie heeft plaatsgevonden. | `<AuthnStatement AuthnInstant="2011-12-29T05:35:22.000Z">` | 
