...
|`unique_name` |  Reeks | Biedt een mens leesbaar waarde die het onderwerp van het token identificeert. Deze waarde is niet noodzakelijkerwijs uniek zijn binnen een tenant en mag alleen worden gebruikt voor weer te geven. Alleen uitgegeven met v1.0 `id_tokens`. |
...
## <a name="validating-idtokens"></a>Valideren `id_tokens`
