...
> [!TIP]
> Probeer deze aanvraag wordt uitgevoerd in Postman. (Vergeet niet om te vervangen de `refresh_token`) [ ![uitvoeren in Postman](./media/v2-oauth2-auth-code-flow/runInPostman.png)](https://app.getpostman.com/run-collection/f77994d794bab767596d)
> 
