...
Zie voor meer informatie over het protocol op-andere gebruikers-of [identiteitsplatform van Microsoft en OAuth 2.0 namens-stroom](https://docs.microsoft.com/en-us/azure/active-directory/develop/v2-oauth2-on-behalf-of-flow)
