...
| --- | --- | --- |
| tenant |Vereist |De directory-tenant die u wilt machtiging van aanvragen. Kan worden opgegeven in de beschrijvende naam van de indeling of GUID of algemeen waarnaar wordt verwezen met 'algemene' zoals te zien is in het voorbeeld. |
