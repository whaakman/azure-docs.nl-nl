...
* Zie voor meer informatie over de relatie tussen de toepassing en Service-Principal objecten van een toepassing [toepassing en service-principalobjecten in Azure AD][AAD-APP-OBJECTS].
* Zie de [woordenlijst voor ontwikkelaars van Azure AD] [ AAD-DEVELOPER-GLOSSARY] voor definities van de basisconcepten voor de ontwikkelaars van Azure Active Directory (AD).
