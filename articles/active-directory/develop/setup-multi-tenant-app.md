...
- Algemene inzicht te krijgen [het configureren van een toepassing met meerdere tenants](https://docs.microsoft.com/azure/active-directory/develop/active-directory-integrating-applications#configuring-multi-tenant-applications)
- Een stapsgewijze overzicht van [hoe het toestemmingsframework Azure AD wordt gebruikt voor het implementeren van toestemming](https://docs.microsoft.com/azure/active-directory/develop/active-directory-integrating-applications#overview-of-the-consent-framework), die is vereist voor toepassingen met meerdere tenants
