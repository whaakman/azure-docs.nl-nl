...
![OpenID Connect-banen](./media/v2-oauth2-implicit-grant-flow/convergence-scenarios-implicit.svg)
...
* Ga via de [MSAL JS voorbeelden](sample-v2-code.md#single-page-applications-spa) aan de slag coderen.
