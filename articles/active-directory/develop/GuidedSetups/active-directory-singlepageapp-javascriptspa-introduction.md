---
title: Azure AD v2 JS SPA begeleide Setup - Inleiding | Microsoft Docs
...
![De werking van de voorbeeld-app die is gegenereerd door deze handleiding](media/active-directory-singlepageapp-javascriptspa-introduction/javascriptspa-intro.png)
...
> [!NOTE]
> *msal.js* doelen de *Azure Active Directory-v2-eindpunt* -waardoor privé, school- als accounts aanmelden en tokens verkrijgen. De *Azure Active Directory-v2-eindpunt* heeft [enkele beperkingen](..\active-directory-v2-limitations.md). Als u alleen geïnteresseerd in school- als accounts, gebruikt *adal.js* en de *V1 eindpunt*. Verschillen tussen de v1- en v2-eindpunten lezen leert de [v1-v2 vergelijking](..\active-directory-v2-compare.md).
