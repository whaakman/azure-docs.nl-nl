...
9. Op de **Cloud-apps** pagina, voert u de volgende stappen uit:
    ...
    ![Cloud-apps selecteren](./media/active-directory-conditional-access-app-based-mfa/26.png)
...
![Wat gebeurt er als hulpprogramma voor beleid](./media/active-directory-conditional-access-app-based-mfa/23.png)
