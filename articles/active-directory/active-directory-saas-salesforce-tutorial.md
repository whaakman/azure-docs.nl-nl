...
5. Klik op **opslaan** knop ![configureren eenmalige aanmelding](./media/active-directory-saas-salesforce-tutorial/tutorial_general_400.png)
...
12. Op de **SAML Single Sign-On instelling bewerken** maken de volgende configuraties:
    ...
    b. Plakken **SAML entiteit-ID** waarde in de **verlener** veld in Salesforce.
