...
> [!NOTE]
> Nu hoeft gastgebruikers niet langer de uitnodiging voor e-mail, behalve in sommige gevallen speciale. Zie voor meer informatie [B2B-samenwerking uitnodiging inwisseling](active-directory-b2b-redemption-experience.md).  
...
2. De beheerder in de organisatie van de host [beleid heeft ingesteld](active-directory-b2b-delegate-invitations.md) waardoor Sam om te bepalen en andere gebruikers van de partnerorganisatie (Litware) toevoegen.
...
- [Gemachtigde uitnodigingen voor Azure Active Directory B2B-samenwerking](active-directory-b2b-delegate-invitations.md)
