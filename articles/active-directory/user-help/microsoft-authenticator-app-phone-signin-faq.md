...
ms.locfileid: "44717043"
---
# <a name="sign-in-with-your-phone-not-your-password"></a>Meld u aan met uw telefoon, niet met uw wachtwoord
De Microsoft Authenticator-app kunt u uw accounts beveiligen door verificatie in twee stappen uitvoeren nadat u uw wachtwoord hebt ingevoerd. Maar wist u ook dat dit het wachtwoord voor uw persoonlijke Microsoft-account kan vervangen?
...
2. De meeste pagina's waar normaal gesproken u het wachtwoord van uw Microsoft-account voert hebben een koppeling met de melding dat **gebruik van een app in plaats daarvan**. Selecteer deze koppeling naar aanmelden met uw telefoon.
 
3. Microsoft stuurt een melding naar uw telefoon. De melding om aan te melden bij uw account goed te keuren.   
