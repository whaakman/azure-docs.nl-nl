...
1. In de **wachtwoord opgeven** scherm, selecteer **ben mijn wachtwoord vergeten**.
...
Als de beheerder de functie ingeschakeld, ziet u een koppeling naar **wachtwoord opnieuw instellen** op uw Windows 7, Windows 8, Windows 8.1 of Windows 10-aanmeldingsscherm.

1. Selecteer de **wachtwoord opnieuw instellen** koppelen aan het begin van het wachtwoord opnieuw instellen van proces zonder gebruik te maken van de normale web gebaseerde ervaring.

2. Controleer of uw gebruikers-ID en selecteer **volgende**.

3. Selecteer en controleer of een contactmethode voor verificatie. Indien nodig, kiest u een tweede verificatieoptie die verschilt van uw vorige versie, de benodigde informatie invullen.

4. Op de **een nieuw wachtwoord maken** pagina, typ en Bevestig uw nieuwe wachtwoord en selecteer vervolgens **volgende**.

    Sterke wachtwoorden hebben doorgaans 8 tot 16 tekens, inclusief hoofdletters en kleine letters, ten minste één cijfer en ten minste één speciaal teken.

5. Nadat u het bericht dat uw wachtwoord is opnieuw ingesteld, kunt u selecteren **voltooien**.
