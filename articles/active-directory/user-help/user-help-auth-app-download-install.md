...
- Na het downloaden en installeren van de app, moet u uw verschillende accounts toevoegen. Zie voor meer informatie, [uw accounts toevoegen](user-help-auth-app-add-account-overview.md).
