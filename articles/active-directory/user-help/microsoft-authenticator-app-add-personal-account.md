...
2. Aan de onderkant van de **basisprincipes van beveiliging** pagina, kies de **meer beveiligingsopties** koppeling.
    ...
    ![Basisprincipes van beveiligingspagina met de koppeling 'meer security options' is gemarkeerd](./media/microsoft-authenticator-app-add-personal-account/more-security-options-link.png)
...
2. Selecteer **account toevoegen** uit de **aanpassen en controle** pictogram in de rechterbovenhoek.
    ...
    ![De pagina accounts, met het pictogram aanpassen en de controle van gemarkeerd](./media/microsoft-authenticator-app-add-personal-account/customize-and-control-icon.png)
