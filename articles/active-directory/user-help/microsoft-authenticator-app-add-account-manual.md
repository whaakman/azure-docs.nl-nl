...
ms.locfileid: "55478097"
---
# <a name="manually-add-an-account-to-the-app"></a>Handmatig een account toevoegen aan de app.
Als uw camera niet kan om vast te leggen van de QR-code, kunt u gegevens over uw account handmatig toevoegen aan de Microsoft Authenticator-app voor tweeledige verificatie. Dit werkt voor werk- of schoolaccounts en persoonlijke niet-Microsoft-accounts.
...
1. Op uw PC, houd er rekening mee de **Code** en **Url** informatie over de **mobiele app configureren** pagina. Houd deze pagina geopend zodat u de code en URL kunt zien.
    ...
    ![Scherm waarmee de QR-code](./media/microsoft-authenticator-app-add-account-manual/auth-app-barcode.png)
...
3. Selecteer **of Voer de CODE handmatig**.
    ...
    ![Scherm voor het scannen van een QR-code](./media/microsoft-authenticator-app-add-account-manual/auth-app-manual-code.png)
   
4. Voer de **Code** en **URL** uit stap 1 en selecteer vervolgens **voltooien**.

    ![Scherm voor het invoeren van code en URL in](./media/microsoft-authenticator-app-add-account-manual/auth-app-code-url.png)
...
- Nadat u uw accounts aan de app toevoegen, kunt u zich bij het gebruik van de Microsoft Authenticator-app op uw apparaat. Zie voor meer informatie, [Meld u aan met behulp van de app](microsoft-authenticator-app-phone-signin-faq.md).
