...
4. Typ in het zoekvak **SharePoint lokale**, selecteer **SharePoint lokale** van resultaat deelvenster klik vervolgens op **toevoegen** om toe te voegen van de toepassing.
    ...
    ![SharePoint lokaal in de lijst met resultaten](./media\active-directory-saas-sharepoint-on-premises-tutorial/tutorial_sharepointonpremises_addfromgallery.png)
...
2. Op de **eenmalige aanmelding** dialoogvenster Selecteer **modus** als **op basis van SAML aanmelding** voor eenmalige aanmelding inschakelen.
    ...
    ![Dialoogvenster voor eenmalige aanmelding](./media\active-directory-saas-sharepoint-on-premises-tutorial/tutorial_sharepointonpremises_samlbase.png)

3. Op de **SharePoint on-premises domein en URL's** sectie, voert u de volgende stappen uit:

    ![Lokale domein en de URL's eenmalige aanmelding gegevens voor SharePoint](./media\active-directory-saas-sharepoint-on-premises-tutorial/tutorial_sharepointonpremises_url1.png)
...
4. Op de **SAML-certificaat voor ondertekening van** sectie, klikt u op **Metadata XML** en sla het bestand met metagegevens op de computer met de extensie .cer. Kopieer en plak het volledige pad van het metagegevensbestand van de gedownloade in Kladblok.
    ...
    ![De downloadkoppeling certificaat](./media\active-directory-saas-sharepoint-on-premises-tutorial/tutorial_sharepointonpremises_certificate.png)

5. Klik op **opslaan** knop.

    ![Knop Single Sign-On opslaan configureren](./media\active-directory-saas-sharepoint-on-premises-tutorial/tutorial_general_400.png)
...
6. Op de **SharePoint lokale configuratie** sectie, klikt u op **SharePoint configureren lokale** openen **eenmalige aanmelding configureren** venster. Kopieer de **Single Sign-On Service-URL** van de **Naslaggids punt.**
    ...
    ![Configuratie van SharePoint on-premises](./media\active-directory-saas-sharepoint-on-premises-tutorial/tutorial_sharepointonpremises_configure.png)
...
8. **Een nieuwe vertrouwde id-provider configureren in SharePoint Server 2016**
    ...
    ![Uw provider voor verificatie configureren](./media\active-directory-saas-sharepoint-on-premises-tutorial/fig10-configauthprovider.png)
...
1. Klik in de Azure-portal in het linkerdeelvenster op het **Azure Active Directory** knop.
    ...
    ![De Azure Active Directory-knop](./media\active-directory-saas-sharepoint-on-premises-tutorial/create_aaduser_01.png)

2. Als u wilt weergeven in de lijst met gebruikers, gaat u naar **gebruikers en groepen**, en klik vervolgens op **alle gebruikers**.

    !['Gebruikers en groepen' en 'Alle gebruikers' koppelingen](./media\active-directory-saas-sharepoint-on-premises-tutorial/create_aaduser_02.png)

3. Openen van de **gebruiker** in het dialoogvenster klikt u op **toevoegen** boven aan de **alle gebruikers** in het dialoogvenster.

    ![De knop toevoegen](./media\active-directory-saas-sharepoint-on-premises-tutorial/create_aaduser_03.png)

4. In de **gebruiker** dialoogvenster vak, voert u de volgende stappen uit:

    ![Het dialoogvenster gebruiker](./media\active-directory-saas-sharepoint-on-premises-tutorial/create_aaduser_04.png)
...
4. Klik in het beleid voor webtoepassing **gebruikers toevoegen**.
    ...
    ![Zoeken naar een gebruiker door hun naamclaim](./media\active-directory-saas-sharepoint-on-premises-tutorial/fig11-searchbynameclaim.png)
...
9. Klik in machtigingen op **volledig beheer**.
    ...
    ![Volledig beheer verlenen aan een claimgebruiker](./media\active-directory-saas-sharepoint-on-premises-tutorial/fig12-grantfullcontrol.png)
...
![Claims zoekresultaten](./media\active-directory-saas-sharepoint-on-premises-tutorial/fig16-claimssearchresults.png)
...
2. Selecteer in de lijst met toepassingen **SharePoint lokale**.
    ...
    ![De SharePoint-koppeling in de lijst met toepassingen](./media\active-directory-saas-sharepoint-on-premises-tutorial/tutorial_sharepointonpremises_app.png)
