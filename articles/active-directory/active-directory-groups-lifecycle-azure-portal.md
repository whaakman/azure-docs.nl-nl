...
De volgende cmdlets kunnen worden gebruikt voor het beleid configureren in meer detail. Zie voor meer informatie [PowerShell documentatie](https://docs.microsoft.com/en-us/powershell/module/azuread/?view=azureadps-2.0-preview&branch=master#groups).
