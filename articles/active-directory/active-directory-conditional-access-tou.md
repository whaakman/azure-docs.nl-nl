...
![Beleid maken](./media/active-directory-conditional-access-tou/5555.png)
...
5. Op de **Azure Active Directory** pagina, in de **beheren** sectie, klikt u op **voorwaardelijke toegang**.
    ...
    ![Voorwaardelijke toegang](./media/active-directory-conditional-access-tou/03.png) 

6. In de **beheren** sectie, klikt u op **gebruiksvoorwaarden**.

    ![Gebruiksvoorwaarden](./media/active-directory-conditional-access-tou/04.png) 

7. Klik in het menu aan de bovenkant op **nieuwe voorwaarden**.

    ![Gebruiksvoorwaarden](./media/active-directory-conditional-access-tou/05.png) 

8. Op de **nieuwe gebruiksvoorwaarden** pagina:

    ![Gebruiksvoorwaarden](./media/active-directory-conditional-access-tou/112.png) 
...
![Beleid maken](./media/active-directory-conditional-access-tou/1234.png)
...
1. Op de **nieuw** pagina, in de **naam** tekstvak, type **vereisen gebruiksvoorwaarden voor Isabella**.
    ...
    ![Naam](./media/active-directory-conditional-access-tou/71.png)

2. In de **toewijzing** sectie, klikt u op **gebruikers en groepen**.

    ![Gebruikers en groepen](./media/active-directory-conditional-access-tou/06.png)

3. Op de **gebruikers en groepen** pagina:

    ![Gebruikers en groepen](./media/active-directory-conditional-access-tou/24.png)
...
5. Op de **Cloud-apps** pagina:
    ...
    ![Cloud-apps selecteren](./media/active-directory-conditional-access-tou/26.png)
...
6. In de **besturingselementen voor toegang** sectie, klikt u op **verlenen**.
    ...
    ![Besturingselementen voor toegang](./media/active-directory-conditional-access-tou/10.png)

7. Op de **verlenen** pagina:

    ![Verlenen](./media/active-directory-conditional-access-tou/111.png)
...
8. In de **beleid inschakelen** sectie, klikt u op **op**.
    ...
    ![Beleid inschakelen](./media/active-directory-conditional-access-tou/18.png)
...
![Wat gebeurt er als hulpprogramma voor beleid](./media/active-directory-conditional-access-tou/79.png)
...
2. Klik op **gebruikers**, selecteer **Isabella Simonsen**, en klik vervolgens op **Selecteer**.
    ...
    ![Gebruiker](./media/active-directory-conditional-access-tou/15.png)
...
![Gebruiksvoorwaarden](./media/active-directory-conditional-access-tou/57.png)
...
> [MFA vereisen voor specifieke apps](./active-directory-conditional-access-app-based-mfa.md)
> [toegang blokkeren als er een risico voor de sessie wordt gedetecteerd](./active-directory-conditional-access-app-sign-in-risk.md)
