...
* [Ophalen van gegevens met behulp van de Azure Active Directory reporting API met certificaten](active-directory-reporting-api-with-certificates.md)
