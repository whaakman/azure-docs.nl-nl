...
4. Typ in het zoekvak **BlueJeans**.
    ...
    ![BlueJeans inrichten](./media/active-directory-saas-bluejeans-provisioning-tutorial/BluejeansAppSearch.png)
...
5. Selecteer in het deelvenster resultaten **BlueJeans**, en klik vervolgens op de **toevoegen** knop BlueJeans toevoegen aan de lijst met SaaS-toepassingen.
    ...
    ![BlueJeans inrichten](./media/active-directory-saas-bluejeans-provisioning-tutorial/BluejeansAppSearchResults.png)

    ![BlueJeans inrichten](./media/active-directory-saas-bluejeans-provisioning-tutorial/BluejeansAppCreate.png)
...
2. Selecteer BlueJeans uit de lijst met SaaS-toepassingen.
    ...
    ![BlueJeans inrichten](./media/active-directory-saas-bluejeans-provisioning-tutorial/Bluejeans2.png)

3. Selecteer de **inrichten** tabblad.

    ![BlueJeans inrichten](./media/active-directory-saas-bluejeans-provisioning-tutorial/BluejeansProvisioningTab.png)

4. Stel de **Inrichtingsmodus** naar **automatische**.

    ![BlueJeans inrichten](./media/active-directory-saas-bluejeans-provisioning-tutorial/Bluejeans1.png)
...
9. Onder de **toewijzingen** sectie **synchroniseren Azure Active Directory-gebruikers BlueJeans**.
    ...
    ![BlueJeans inrichten](./media/active-directory-saas-bluejeans-provisioning-tutorial/BluejeansMapping.png)
...
10. Controleer de kenmerken van de gebruiker die gesynchroniseerd zijn van Azure AD naar BlueJeans in de **kenmerk toewijzing** sectie. De kenmerken die zijn geselecteerd als **overeenkomend** eigenschappen overeenkomen met de gebruikersaccounts in BlueJeans voor update-bewerkingen worden gebruikt. Selecteer de **opslaan** knop eventuele wijzigingen doorvoeren.
    ...
    ![BlueJeans inrichten](./media/active-directory-saas-bluejeans-provisioning-tutorial/BluejeansUserMappingAtrributes.png)
...
12. Om de Azure AD-service voor BlueJeans inricht, wijzigen de **inrichting Status** naar **op** in de **instellingen** sectie.
    ...
    ![BlueJeans inrichten](./media/active-directory-saas-bluejeans-provisioning-tutorial/BluejeansProvisioningStatus.png)
...
13. De gebruikers en/of groepen die u wilt definiëren om in te richten voor BlueJeans door het kiezen van de gewenste waarden in **bereik** in de **instellingen** sectie.
    ...
    ![BlueJeans inrichten](./media/active-directory-saas-bluejeans-provisioning-tutorial/UserGroupSelection.png)

14. Wanneer u klaar om in te richten bent, klikt u op **opslaan**.

    ![BlueJeans inrichten](./media/active-directory-saas-bluejeans-provisioning-tutorial/SaveProvisioning.png)
