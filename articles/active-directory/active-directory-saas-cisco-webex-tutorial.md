...
- U kunt uw gebruikers automatisch ophalen aangemeld bij Cisco Webex (Single Sign-On) inschakelen met hun Azure AD-accounts.
...
- Een Cisco-Webex eenmalige aanmelding ingeschakeld abonnement
...
4. Typ in het zoekvak **Cisco Webex**, selecteer **Cisco Webex** van resultaat deelvenster klik vervolgens op **toevoegen** om toe te voegen van de toepassing.
...
In deze sectie configureert en test eenmalige aanmelding Azure AD met Cisco Webex op basis van een testgebruiker 'Britta Simon' genoemd.

Voor eenmalige aanmelding werkt, moet Azure AD weten wat de gebruiker equivalent in Cisco Webex is aan een gebruiker in Azure AD. Met andere woorden, moet een koppeling relatie tussen een Azure AD-gebruiker en de betreffende gebruiker in Cisco Webex tot stand worden gebracht.

Wijs in Cisco Webex, de waarde van de **gebruikersnaam** in Azure AD als de waarde van de **gebruikersnaam** de relatie van de koppeling tot stand brengen.

Om te configureren en testen van Azure AD eenmalige aanmelding met Cisco Webex, moet u de volgende bouwstenen voltooien:
...
1. In de Azure-portal op de **Cisco Webex** toepassing Integratiepagina, klikt u op **eenmalige aanmelding**.
...
3. Op de **Cisco Webex domein en de URL's** sectie, voert u de volgende stappen uit:
    ...
    a. In de **aanmeldings-URL** textbox, typ een URL met het volgende patroon volgen:`https://<subdomain>.webex.com`

    b. In de **id** textbox, typ de URL:`http://www.webex.com`

    c. In de **antwoord-URL** textbox, typ een URL met het volgende patroon volgen:`https://company.webex.com/dispatcher/SAML2AuthService?siteurl=company`
     
    > [!NOTE] 
    > Deze waarden zijn niet echt. Deze waarden bijwerken met de werkelijke antwoord-URL en de aanmeldings-URL. Neem contact op met [Cisco Webex Client ondersteuningsteam](https://www.webex.co.in/support/support-overview.html) ophalen van deze waarden. 
...
6. Klik op **opslaan** knop.
    ...
    ![Knop Single Sign-On opslaan configureren](./media/active-directory-saas-cisco-webex-tutorial/tutorial_general_400.png)
    
6. Op de **Cisco Webex configuratie** sectie, klikt u op **configureren Cisco Webex** openen **eenmalige aanmelding configureren** venster. Kopieer de **Sign-Out-URL, SAML entiteit-ID en SAML Single Sign-On Service-URL** van de **Naslaggids punt.**

    ![Eenmalige aanmelding configureren](./media/active-directory-saas-cisco-webex-tutorial/tutorial_ciscowebex_configure.png) 

7. In een ander browservenster, meld u aan bij uw bedrijf Cisco Webex site als beheerder.

8. Klik in het menu bovenaan op **Sitebeheer**.

    ![Sitebeheer](./media/active-directory-saas-cisco-webex-tutorial/ic777621.png "Sitebeheer")

9. In de **-Site beheren** sectie, klikt u op **SSO configuratie**.
   
    ![Configuratie van de SSO-](./media/active-directory-saas-cisco-webex-tutorial/ic777622.png "SSO-configuratie")

10. In de **federatieve Web-SSO configuratie** sectie, voert u de volgende stappen uit:
   
    ![Federatieve SSO configuratie](./media/active-directory-saas-cisco-webex-tutorial/ic777623.png "federatieve SSO-configuratie")  

    a. Van de **Protocol Federation** selecteert **SAML 2.0**.

    b. Als **SSO profiel**, selecteer **SP Intiated**.

    c. Open uw gedownloade certificaat in Kladblok en kopieer de inhoud ervan.

    d. Klik op **SAML-metagegevens importeren**, en plak de gekopieerde inhoud van het certificaat.

    e. In de **verlener voor SAML (IdP-ID)** textbox, plak de waarde van **SAML entiteit-ID** die u hebt gekopieerd vanuit Azure-portal.

    f. In de **aanmeldings-URL van de klant SSO Service** textbox plakken **SAML Single Sign-On Service-URL** die u hebt gekopieerd vanuit Azure-portal.

    g. Van de **NameID indeling** selecteert **e-mailadres**.

    h. In de **AuthnContextClassRef** textbox type **urn: oasis: namen: tc: SAML:2.0:ac:classes:Password**.

    ik. In de **klant SSO-Service-URL voor afmelden** textbox plakken **Sign-Out URL** die u hebt gekopieerd vanuit Azure-portal.
...
Om Azure AD-gebruikers zich aanmelden bij Cisco Webex, moeten ze worden ingericht in Cisco Webex. In het geval van een Cisco-Webex is inrichting een handmatige taak.
...
3. Voer de volgende stappen uit in de sectie gebruiker toevoegen:
    ...
    a. Als **accounttype**, selecteer **Host**.
    ...
    d. In de **gebruikersnaam** textbox, typ het e-mailadres van gebruiker, zoals Brittasimon@contoso.com.

    e. In de **e** textbox, typ het e-mailadres van gebruiker, zoals Brittasimon@contoso.com.

    f. In de **wachtwoord** textbox, typt u het wachtwoord van gebruiker.

    g. In de **bevestigen** wachtwoordtekstvak, voer het wachtwoord van gebruiker opnieuw in.
...
In deze sectie maakt inschakelen u Britta Simon gebruikt Azure eenmalige aanmelding toegang verlenen aan Cisco Webex.
...
2. Selecteer in de lijst met toepassingen **Cisco Webex**.
...
Als u op de tegel Cisco Webex in het deelvenster toegang, u moet ophalen automatisch aangemeld bij uw toepassing Cisco Webex.
