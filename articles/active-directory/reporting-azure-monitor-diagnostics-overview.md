...
* **Aanmeldingslogboeken**: met het [activiteitenrapport voor aanmeldingen](active-directory-reporting-activity-sign-ins.md) kunt u bepalen wie de taken heeft uitgevoerd die in het auditlogboek zijn gerapporteerd.
...
* Een [licentie](https://azure.microsoft.com/pricing/details/active-directory/) voor Azure AD Free, Basic, Premium 1 of Premium 2 voor toegang tot de Azure AD-logboeken in de Azure-portal. 
...
**A:** zowel de aanmeldings- als de auditlogboeken zijn beschikbaar om via deze functie doorgestuurd te worden. Gebeurtenissen met betrekking tot B2C worden momenteel niet ondersteund. Raadpleeg het [auditlogboekschema](reporting-azure-monitor-diagnostics-audit-log-schema.md) en het [aanmeldingslogboekschema](reporting-azure-monitor-diagnostics-sign-in-log-schema.md) om uit te vinden welke typen logboeken en welke op functie gebaseerde logboeken momenteel worden ondersteund. 
...
**A:** de opslagkosten zijn afhankelijk van de grootte van uw logboeken en de door u gekozen bewaarperiode. Raadpleeg de sectie [Opslaggrootte voor activiteitenlogboeken](https://review.docs.microsoft.com/en-us/azure/active-directory/reporting-azure-monitor-diagnostics-overview?branch=pr-en-us-47660#storage-size-for-activity-logs) voor een lijst van de geschatte kosten voor tenants. De kosten zijn afhankelijk van het aantal logboeken dat wordt gegenereerd.
...
* [Activiteitenlogboeken doorsturen naar een Event Hub](reporting-azure-monitor-diagnostics-azure-event-hub.md)
