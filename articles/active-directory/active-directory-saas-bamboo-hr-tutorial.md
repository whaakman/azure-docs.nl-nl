...
2. In de **eenmalige aanmelding** venster in de **modus** vervolgkeuzelijst, selecteer **op basis van SAML aanmelding**.
    ...
    ![Venster voor eenmalige aanmelding](./media/active-directory-saas-bamboo-hr-tutorial/tutorial_bamboohr_samlbase.png)

3. Onder **BambooHR domein en de URL's**, het volgende doen:

    ![De sectie BambooHR domein en de URL 's](./media/active-directory-saas-bamboo-hr-tutorial/tutorial_bamboohr_url.png)
...
5. Selecteer **Opslaan**.
    ...
    ![De knop Opslaan](./media/active-directory-saas-bamboo-hr-tutorial/tutorial_general_400.png)
...
8. Ga als volgt te werk op de startpagina:
    ...
    ![De pagina BambooHR Single Sign-On](./media/active-directory-saas-bamboo-hr-tutorial/ic796691.png "eenmalige aanmelding")   
...
9. In de **SAML Single Sign-On** deelvenster de volgende handelingen uit:
    ...
    ![Het deelvenster SAML Single Sign-On](./media/active-directory-saas-bamboo-hr-tutorial/IC796692.png "SAML Single Sign-On")
...
4. In de **gebruiker** venster de volgende handelingen uit:
    ...
    ![Het venster gebruiker](./media/active-directory-saas-bamboo-hr-tutorial/create_aaduser_04.png)
...
2. In de **bedrijfstoepassingen** selecteert **BambooHR**.
    ...
    ![De koppeling BambooHR in de lijst met Enterprise-toepassingen](./media/active-directory-saas-bamboo-hr-tutorial/tutorial_bamboohr_app.png)  
