...
Microsoft Azure Active Directory-toegangsbeheer (ook wel bekend als Access Control Service of ACS) wordt buiten gebruik gesteld in November 2018.  Meer informatie, inclusief een gedetailleerde planning en een hoog niveau migratie-instructies vindt u [op deze pagina](./develop/active-directory-acs-migration.md).
