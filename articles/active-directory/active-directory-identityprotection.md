...
Azure Active Directory Identity Protection analyseert uw configuratie en beveiligingsproblemen die invloed op van uw gebruikers-id's hebben kunnen detecteert. Zie voor meer informatie, [beveiligingsproblemen die worden gedetecteerd door Azure Active Directory Identity Protection](identity-protection/vulnerabilities.md).
...
U kunt uw onderzoeksactiviteiten om te verbinden, de [meldingen](identity-protection/notifications.md) Azure Active Directory Protection per e-mail verzendt.
...
* [Riskante aanmelding herstel](identity-protection/flows.md#risky-sign-in-recovery)
* [Riskante aanmelding geblokkeerd](identity-protection/flows.md#risky-sign-in-blocked)  
* [Aanmelden-ervaringen met Azure AD Identity Protection](identity-protection/flows.md)  
...
* [Aangetast account recovery stroom](identity-protection/flows.md#compromised-account-recovery).  
* [Aangetast account geblokkeerd stroom](identity-protection/flows.md#compromised-account-blocked).  
...
* [Multi-factor authentication-registratie stroom](identity-protection/flows.md#multi-factor-authentication-registration).  
* [Aanmelden-ervaringen met Azure AD Identity Protection](identity-protection/flows.md).  
...
* [Beveiligingsproblemen die worden gedetecteerd door Azure Active Directory Identity Protection](identity-protection/vulnerabilities.md)

* [Azure Active Directory-risicogebeurtenissen](active-directory-identity-protection-risk-events.md)

* [Azure Active Directory Identity Protection-meldingen](identity-protection/notifications.md)

* [Playbook voor Azure Active Directory Identity Protection](identity-protection/playbook.md)

* [Azure Active Directory Identity Protection-woordenlijst](identity-protection/glossary.md)

* [Aanmelden-ervaringen met Azure AD Identity Protection](identity-protection/flows.md)

* [Azure Active Directory Identity Protection - blokkering opheffen van gebruikers](identity-protection/howto-unblock-user.md)

* [Aan de slag met Azure Active Directory Identity Protection en Microsoft Graph](identity-protection/graph-get-started.md)
