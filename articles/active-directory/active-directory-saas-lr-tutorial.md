...
4. Typ in het zoekvak **LoginRadius**, selecteer **LoginRadius** van resultaat deelvenster klik vervolgens op **toevoegen** om toe te voegen van de toepassing.
    ...
    ![LoginRadius in de lijst met resultaten](./media/active-directory-saas-lr-tutorial/tutorial_LoginRadius_addfromgallery.png)
...
2. Op de **eenmalige aanmelding** dialoogvenster Selecteer **modus** als **op basis van SAML aanmelding** voor eenmalige aanmelding inschakelen.
    ...
    ![Dialoogvenster voor eenmalige aanmelding](./media/active-directory-saas-lr-tutorial/tutorial_LoginRadius_samlbase.png)

3. Op de **LoginRadius domein en de URL's** sectie, voert u de volgende stappen uit:

    ![URL's en LoginRadius domein eenmalige aanmelding informatie](./media/active-directory-saas-lr-tutorial/tutorial_LoginRadius_url.png)
...
5. Op de **SAML-certificaat voor ondertekening van** sectie, klikt u op **Metadata XML** en sla het bestand met metagegevens op uw computer.
    ...
    ![De downloadkoppeling certificaat](./media/active-directory-saas-lr-tutorial/tutorial_LoginRadius_certificate.png) 
...
2. Selecteer in de lijst met toepassingen **LoginRadius**.
    ...
    ![De koppeling LoginRadius in de lijst met toepassingen](./media/active-directory-saas-lr-tutorial/tutorial_LoginRadius_app.png)  
