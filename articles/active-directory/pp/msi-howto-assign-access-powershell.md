...
Nadat u MSI-bestand hebt ingeschakeld op een Azure-resource, [, zoals een Azure-VM](msi-qs-configure-powershell-windows-vm.md):
...
- Zie voor het inschakelen van MSI-bestand op een Azure VM [configureren van een Azure VM Managed Service Identity (MSI) met behulp van PowerShell](msi-qs-configure-powershell-windows-vm.md).
