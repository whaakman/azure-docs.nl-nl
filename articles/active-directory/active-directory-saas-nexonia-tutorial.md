...
4. Typ in het zoekvak **Nexonia**.

    ![Een Azure AD-testgebruiker maken](./media/active-directory-saas-nexonia-tutorial/tutorial_nexonia_search.png)

5. Selecteer in het deelvenster resultaten **Nexonia**, en klik vervolgens op **toevoegen** om toe te voegen van de toepassing.
...
In deze sectie kunt u configureren en testen eenmalige aanmelding Azure AD met Nexonia op basis van een testgebruiker genaamd "Britta Simon."
...
3. **[Maken van een testgebruiker Nexonia](#creating-a-nexonia-test-user)**  - Nexonia die is gekoppeld aan de Azure AD-weergave van de gebruiker van een exemplaar van Britta Simon bevatten.
...
3. Op de **Nexonia domein en de URL's** sectie, voert u de volgende stappen uit:
    ...
    In de **antwoord-URL** textbox, typ een URL met het volgende patroon volgen:`https://system.nexonia.com/assistant/saml.do?orgCode=<organizationcode>`

    > [!NOTE] 
    > Deze waarde is geen echte. Deze waarde bijwerken met de werkelijke antwoord-URL. Neem contact op met [Nexonia ondersteuningsteam](https://nexonia.zendesk.com/hc/requests/new) deze waarde op te halen. 
...
7. Als u eenmalige aanmelding die zijn geconfigureerd voor uw toepassing, neem contact op met [Nexonia ondersteuningsteam](https://nexonia.zendesk.com/hc/requests/new) en geeft u het volgende:
...
### <a name="creating-a-nexonia-test-user"></a>Een testgebruiker Nexonia maken
