...
| Deze zakelijke app momenteel niet toegankelijk. Probeer het later opnieuw... Er is een time-out opgetreden voor de connector. | Uw gebruikers foutmelding deze wanneer u probeert toegang tot de app die u als ze zijn niet correct gedefinieerd voor deze toepassing aan de lokale op gepubliceerd. Zorg ervoor dat uw gebruikers de juiste machtigingen hebben, zoals gedefinieerd voor deze back van endtoepassing op de on-premises-machine. |
