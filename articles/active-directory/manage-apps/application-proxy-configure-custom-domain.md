...
- Een [gecontroleerde domein is toegevoegd aan Azure Active Directory](../add-custom-domain.md).
...
Alle geverifieerde domeinen worden weergegeven in de vervolgkeuzelijst van de externe URL voor uw toepassing. Om te wijzigen van het domein, moet u zojuist hebt dat veld voor de toepassing bijwerken. Als het domein dat u wilt dat niet in de lijst [toevoegen als een geverifieerde domeinnaam](../add-custom-domain.md). Als u een domein dat niet heeft een bijbehorende certificaat nog stap 5-7 het certificaat toevoegen Volg selecteert. Controleer vervolgens of dat u de DNS-record om te leiden van de nieuwe externe URL bijwerken. 
