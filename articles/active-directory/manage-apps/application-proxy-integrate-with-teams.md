...
- Meer informatie over hoe [lokale SharePoint-sites publiceren](application-proxy-integrate-with-sharepoint-server.md) met toepassingsproxy.
- Configureren van uw apps te gebruiken [aangepaste domeinen](application-proxy-configure-custom-domain.md) voor de externe URL. 
