...
![Tenant-netwerkverkeer beperkingen - diagram](./media/tenant-restrictions/traffic-flow.png)
...
![Toegang geweigerd-pagina voor gebruikers in tenants niet toegestaan](./media/tenant-restrictions/end-user-denied.png)
...
![De Azure portal gebruiken om beperkte aanmeldpogingen weer te geven](./media/tenant-restrictions/portal-report.png)
