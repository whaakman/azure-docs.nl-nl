---
title: Problemen met het configureren van voorwaardelijke toegang tot een van mijn toepassingen'
description: Problemen met het configureren van voorwaardelijke toegang tot een van mijn toepassingen'
...
## <a name="ive-set-up-conditional-access-but-something-isnt-working"></a>Ik voorwaardelijke toegang hebt ingesteld, maar er iets niet werkt
  De onderstaande documenten helpt u bij het oplossen van enkele van de meest voorkomende problemen in deze categorie.
  * [Voorwaardelijke toegang werkt niet omdat de klant niet voldoet aan de vereisten vooraf voor apparaatregistratie](https://docs.microsoft.com/azure/active-directory/active-directory-conditional-access/?/?WT.mc_id=DMC_AAD_Manage_Apps_Troubleshooting_Nav)
  * [De tenant wordt geblokkeerd vanwege verkeerd ingestelde beleidsregels voor voorwaardelijke toegang](https://docs.microsoft.com/azure/active-directory/active-directory-conditional-access-device-remediation/?/?WT.mc_id=DMC_AAD_Manage_Apps_Troubleshooting_Nav)
