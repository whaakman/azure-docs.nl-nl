...
- **[Azure AD die lid zijn van de apparaten](device-management-introduction.md#azure-ad-joined-devices)**  : ophalen van een organisatie Windows 10-apparaten die niet is gekoppeld aan een on-premises Azure AD geregistreerd bij Azure AD geregistreerd. 
