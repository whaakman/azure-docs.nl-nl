...
In deze zelfstudie leert u hoe Anaplan integreren met Azure Active Directory (Azure AD).
...
1. Anaplan uit de galerie toevoegen
2. Configureren en testen van Azure AD eenmalige aanmelding

## <a name="adding-anaplan-from-the-gallery"></a>Anaplan uit de galerie toevoegen
Voor het configureren van de integratie van Anaplan in Azure AD, moet u Anaplan uit de galerie toevoegen aan de lijst met beheerde SaaS-apps.
...
Voor eenmalige aanmelding werkt, moet Azure AD weten wat de gebruiker equivalent in Anaplan is voor een gebruiker in Azure AD. Met andere woorden, moet een koppeling relatie tussen een Azure AD-gebruiker en de betreffende gebruiker in Anaplan tot stand worden gebracht.

Wijs in Anaplan, de waarde van de **gebruikersnaam** in Azure AD als de waarde van de **gebruikersnaam** de relatie van de koppeling tot stand brengen.
...
3. **[Maken van een testgebruiker Anaplan](#creating-an-anaplan-test-user)**  - Anaplan die is gekoppeld aan de Azure AD-weergave van de gebruiker van een exemplaar van Britta Simon bevatten.
4. **[Toewijzen van de Azure AD-testgebruiker](#assigning-the-azure-ad-test-user)**  - Britta Simon gebruik van Azure AD eenmalige aanmelding inschakelen.
5. **[Testen van eenmalige aanmelding](#testing-single-sign-on)**  : om te controleren of de configuratie werkt.

### <a name="configuring-azure-ad-single-sign-on"></a>Eenmalige aanmelding Azure AD configureren

In dit gedeelte Azure AD eenmalige aanmelding inschakelen in de Azure portal en eenmalige aanmelding in uw toepassing Anaplan configureren.

**Voor het configureren van Azure AD eenmalige aanmelding met Anaplan, moet u de volgende stappen uitvoeren:**

1. In de Azure-portal op de **Anaplan** toepassing Integratiepagina, klikt u op **eenmalige aanmelding**.
...
3. Op de **Anaplan domein en de URL's** sectie, voert u de volgende stappen uit:

    ![Eenmalige aanmelding configureren](./media/active-directory-saas-anaplan-tutorial/tutorial_anaplan_url.png)

    a. In de **aanmeldings-URL** textbox, typ een URL met het volgende patroon volgen: `https://sdp.anaplan.com/frontdoor/saml/<tenant name>`

    b. In de **id** textbox, typ een URL met het volgende patroon volgen: `https://<subdomain>.anaplan.com`

    > [!NOTE] 
    > Deze waarden zijn niet echt. Deze waarden bijwerken met het werkelijke aanmeldings-URL en de id. Neem contact op met [Anaplan Client ondersteuningsteam](mailto:support@anaplan.com) ophalen van deze waarden. 
...
### <a name="creating-an-anaplan-test-user"></a>Een testgebruiker Anaplan maken

In deze sectie kunt u een gebruiker Britta Simon aangeroepen in Anaplan maken. Neem contact op met [Anaplan ondersteuningsteam](mailto:support@anaplan.com) de gebruikers van het platform Anaplan toevoegen.

### <a name="assigning-the-azure-ad-test-user"></a>Toewijzen van de testgebruiker Azure AD

In deze sectie schakelt u Britta Simon gebruikt Azure eenmalige aanmelding toegang verlenen aan Anaplan.

![Gebruiker toewijzen][200] 

**Britta Simon om aan te wijzen Anaplan, moet u de volgende stappen uitvoeren:**
...
Als u op de tegel Anaplan in het deelvenster toegang, u moet ophalen automatisch aangemeld bij uw toepassing Anaplan.
