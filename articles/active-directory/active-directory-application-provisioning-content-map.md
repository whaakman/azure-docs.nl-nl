---
title: Problemen met het configureren en inrichten van gebruikers van een toepassing'
description: Problemen met het configureren en inrichten van gebruikers van een toepassing'
...
## <a name="i-want-to-know-when-provisioning-will-finish"></a>Ik wil weten wanneer de inrichting wordt voltooid
  De volgende documenten kunnen u helpen een aantal van de meest voorkomende problemen in deze categorie op te lossen.
  * [Ik weet niet hoe ik kan zien wanneer een specifieke gebruiker toegang heeft tot een toepassing](https://docs.microsoft.com/azure/active-directory/application-provisioning-when-will-provisioning-finish-specific-user/?/?WT.mc_id=DMC_AAD_Manage_Apps_Troubleshooting_Nav)
  * [Het inrichten naar mijn toepassing in de Azure AD-galerie werkt, maar het inrichtingsproces duurt uren of nog langer](https://docs.microsoft.com/azure/active-directory/application-provisioning-when-will-provisioning-finish/?/?WT.mc_id=DMC_AAD_Manage_Apps_Troubleshooting_Nav)

## <a name="im-having-problems-configuring-user-provisioning-to-an-application"></a>Ik ondervind problemen met het configureren van gebruikers inrichten tot een toepassing
  De volgende documenten kunnen u helpen een aantal van de meest voorkomende problemen in deze categorie op te lossen.
