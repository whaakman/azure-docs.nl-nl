...
Vervolgens maken we een bestand met de naam test.txt. Gebruik vervolgens de SAS-referenties om te verifiëren met de `New-AzStorageContent` cmdlet, upload het bestand naar de blob-container en vervolgens het bestand te downloaden.
