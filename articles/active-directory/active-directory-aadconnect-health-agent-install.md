...
> [!NOTE]
> Als u Azure AD Connect Health wilt gebruiken, is Azure AD Premium vereist. Als u niet over Azure AD Premium beschikt, kunt u de configuratie in de Azure Portal niet voltooien. Voor meer informatie raadpleegt u de [pagina met vereisten](active-directory-aadconnect-health-agent-install.md#requirements).
> 
> 
