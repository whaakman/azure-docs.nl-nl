...
- Uw app moet gebruikmaken van versie **1.5** van de SDK ARCore voor Unity (ondersteuning voor ARCore 1.6 + beschikbaar zal zijn een later tijdstip).
