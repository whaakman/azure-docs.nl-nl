...
## [Controlepunt en herhaling](stream-analytics-concepts-checkpoint-replay.md)
...
## Schalen
### [Schaal aanpassen met streaming-eenheden](stream-analytics-streaming-unit-consumption.md)
### [Schaal aanpassen met query-parallellisatie](stream-analytics-parallelization.md)
#### [Doorvoer vergroten](stream-analytics-scale-jobs.md)
### [Schaal aanpassen met ML-functies](stream-analytics-scale-with-machine-learning-functions.md)

## Automatiseren
### [.NET-SDK gebruiken](stream-analytics-dotnet-management-sdk.md)
### [Azure PowerShell gebruiken](https://github.com/Azure/azure-stream-analytics/tree/master/Samples/ASAOneClick)
...
## Problemen oplossen
### [Stappen voor probleemoplossing](stream-analytics-troubleshooting-guide.md)
### [Algemene problemen](stream-analytics-common-troubleshooting-issues.md)
### [Taakdiagram](stream-analytics-job-diagram-with-metrics.md)
### [Diagnostische logboeken](stream-analytics-job-diagnostic-logs.md)
### [Status van resources controleren](stream-analytics-resource-health.md)
### [SELECT INTO-instructie](stream-analytics-select-into.md)
### [Event Hub-ontvangers](stream-analytics-event-hub-consumer-groups.md)

## Integreren met machine learning
### [Sentimentanalyse met ML-modellen](stream-analytics-machine-learning-integration-tutorial.md)
...
## [Video's](https://azure.microsoft.com/resources/videos/index/?services=stream-analytics&sort=newest)
