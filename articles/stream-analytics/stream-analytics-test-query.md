---
title: Testen van query's in Azure Stream Analytics
description: Dit artikel wordt beschreven hoe u kunt testen van query's op basis van bestanden met voorbeeldgegevens in Stream Analytics-taken.
