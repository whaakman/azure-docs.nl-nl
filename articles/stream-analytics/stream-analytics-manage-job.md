---
title: 'Zelfstudie: Een Stream Analytics-taak maken en beheren met behulp van de Azure-portal | Microsoft Docs'
...
2. Selecteer **Een resource maken** > **Internet of Things** > **Event Hubs**.  
   ...
   ![Een Azure Event Hub maken](media/stream-analytics-manage-job/find-eh.png)
...
4. U moet de query **Opslaan**.  
   ...
   ![Stream Analytics-query definiëren](media/stream-analytics-manage-job/define-query.png)
