---
title: Een interne load balancer van het type Basic maken - Azure CLI | Microsoft Docs
description: Leer hoe u een interne load balancer maakt met behulp van Azure CLI
