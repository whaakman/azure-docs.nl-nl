...
1. If you have never used Azure CLI, see [Install and configure the Azure CLI](../../articles/xplat-cli-install.md). Follow the instructions up to the point where you select your Azure account and subscription.
...
1. Create an internal load balancer
    ...
    >[AZURE.NOTE] All resources for an internal load balancers, such as virtual networks and virtual network subnets, must be in the same resource group and in the same region.
