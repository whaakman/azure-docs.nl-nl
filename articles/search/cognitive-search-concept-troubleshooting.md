---
title: Tips voor cognitief zoeken in Azure Search | Microsoft Docs
...
## <a name="tip-1-start-with-a-small-dataset"></a>Tip 1: Start met een kleine gegevensset
...
## <a name="tip-3-see-what-works-even-if-there-are-some-failures"></a>Tip 3: Zien wat werkt, zelfs als er fouten opgetreden zijn
...
## <a name="tip-6-extend-processing-beyond-maximum-run-time-24-hour-window"></a>Tip 6: Verwerking voorbij de maximale uitvoeringstijd (24-uurs tijdvenster) uitbreiden
...
## <a name="tip-7-increase-indexing-throughput"></a>Tip 7: De doorvoer voor indexering verhogen
...
+ [Snelstartgids: Een pijplijn cognitief zoeken in de portal maken](cognitive-search-quickstart-blob.md)
