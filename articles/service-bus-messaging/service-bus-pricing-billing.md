...
Service Bus in de standaardmodus wordt aangeboden en [Premium](service-bus-premium-messaging.md) lagen. U kunt een servicelaag voor elke Service Bus-Servicenaamruimte die u maakt en deze selectie laag kan toepassen op alle entiteiten in die naamruimte gemaakt.
...
Als onderdeel van het nieuwe prijsmodel wordt facturering voor wachtrijen en onderwerpen/abonnementen gewijzigd. Deze entiteiten worden overstappen van facturering per bericht naar facturering per bewerking. Een 'bewerking"verwijst naar een API-aanroep ten opzichte van een wachtrij of onderwerp/abonnement service-eindpunt. Het gaat hierbij om bewerkingen voor beheer, verzenden/ontvangen en sessie-status.
