...
## [Handtekeningen voor gedeelde toegang genereren](service-bus-sas-overview.md)
...
### [AMQP gebruiken met de .NET API](service-bus-dotnet-advanced-message-queuing.md)
