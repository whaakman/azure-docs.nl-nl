...
ms.locfileid: "48856918"
---
# <a name="message-expiration-time-to-live"></a>Verlopen van berichten (Time to Live)

De nettolading binnen een bericht of een opdracht of een query die door een bericht met een ontvanger weergegeven is bijna altijd onderhevig aan een vorm van de deadline op toepassingsniveau verlopen. De inhoud niet meer wordt geleverd of de aangevraagde bewerking is niet meer uitgevoerd na een deadline.
...
De functie is ingeschakeld met behulp van de [autoDeleteOnIdle](/azure/templates/microsoft.servicebus/namespaces/queues) eigenschap, die is ingesteld op de periode waarvoor u een entiteit moet actieve (niet-gebruikte) voordat deze automatisch wordt verwijderd. De minimale duur is vijf minuten.
