...
Where `[namespace]` and `SharedAccessKey` are obtained from the [Azure portal][Azure portal]. For more information, see [How to use Service Bus queues][How to use Service Bus queues].
