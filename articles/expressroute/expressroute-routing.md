...
## IP-adressen die worden gebruikt voor peerings
...
### IP-adressen die worden gebruikt voor openbare Azure-peering en Microsoft-peering
...
### Ondersteuning voor BGP-community's in nationale clouds (preview)
