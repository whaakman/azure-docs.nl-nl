...
>[!NOTE]
>Microsoft-peering, is de beste manier toegang krijgen tot alle services die worden gehost op Azure.
>
...
Het openbare IP-adres wordt gebruikt voor interne management alleen en geen vormt een beveiligingsrisico van het virtuele netwerk.
