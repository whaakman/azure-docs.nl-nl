...
| **pfx** | Ja | <*base64-encoded-pfx-file*> | De met base64 gecodeerde inhoud uit een Personal Information Exchange (PFX)-bestand |
...
| **pfx** | Ja, alleen voor het referentietype 'Certificaat' | <*base64-encoded-pfx-file*> | De met base64 gecodeerde inhoud uit een Personal Information Exchange (PFX)-bestand |
| **secret** | Ja, alleen voor het "Geheim" referentietype | <*secret-for-authentication*> | Het geheim base64-gecodeerd, die de client voor de aanvragende autorisatie gebruikt |
|||||
