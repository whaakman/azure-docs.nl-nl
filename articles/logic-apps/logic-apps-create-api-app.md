...
>
> Voor voorbeelden van API-App die is gebouwd voor logische apps, gaat u naar de [Azure Logic Apps-GitHub-opslagplaats](http://github.com/logicappsio) of [blog](http://aka.ms/logicappsblog).
