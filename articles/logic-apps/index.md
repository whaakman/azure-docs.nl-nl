        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>Schema 's</h3>
                        <p><a href="/azure/logic-apps/logic-apps-workflow-definition-language">Definitietaal van werkstroom</a></p>
                        <p><a href="/azure/logic-apps/logic-apps-workflow-actions-triggers">Werkstroomacties en -triggers</a></p>
                   </div>
                </div>
            </div>
        </div>
