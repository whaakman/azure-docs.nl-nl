...
description: Maken en beheren van logische apps in Visual Studio Code (VS-Code)
services: logic-apps
...
* Basiskennis over logische app [werkstroomdefinities](../logic-apps/logic-apps-workflow-definition-language.md) en de structuur, waarbij JavaScript Object Notation (JSON)
