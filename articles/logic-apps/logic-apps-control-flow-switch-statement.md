...
* Als u wilt indienen of hierop stemmen op de functies of suggesties, gaat u naar de [site voor gebruikersfeedback van Azure Logic Apps](http://aka.ms/logicapps-wish).
