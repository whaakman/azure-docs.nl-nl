...
1. Selecteer of Voer de volgende waarden:
   ...
   | Resourcegroep | Selecteer **nieuw**, Geef een naam en selecteer vervolgens **OK**. In de schermopname is de naam van de resourcegroep is *mypolicyquickstart\<datum in MMDD > rg*. |
