...
![Schermafbeelding van de aangepaste rol geïmporteerd in de Azure portal](./media/role-assignments-external-users/18.png)

![schermopname van het aangepaste geïmporteerde rol toewijzen aan gebruiker in dezelfde map](./media/role-assignments-external-users/19.png)

![schermopname van machtigingen voor aangepaste geïmporteerde beveiligingsrol](./media/role-assignments-external-users/20.png)

Gebruikers met deze aangepaste rol kunnen nu nieuwe ondersteuningsaanvragen maken.

![Schermafbeelding van de aangepaste rol ondersteuningsaanvragen maken](./media/role-assignments-external-users/21.png)
...
![Schermafbeelding van de aangepaste rol kan niet worden gemaakt van virtuele machines](./media/role-assignments-external-users/22.png)

![Schermafbeelding van de aangepaste rol kan niet worden gemaakt van nieuwe RGs](./media/role-assignments-external-users/23.png)
...
![Azure portal schermafbeelding van de aangepaste rol die zijn gemaakt met behulp van de CLI 1.0](./media/role-assignments-external-users/26.png)
