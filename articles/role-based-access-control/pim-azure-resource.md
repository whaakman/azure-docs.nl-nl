...
U kunt nu PIM met gebaseerd toegangsbeheer (RBAC) gebruiken, beheren en controleren van toegang tot Azure-resources. PIM kan het lidmaatschap van de ingebouwde en aangepaste rollen om u te helpen beheren: 
...
Zie voor meer informatie [Overview of Role-Based toegangsbeheer in Azure PIM](../active-directory/privileged-identity-management/azure-pim-resource-rbac.md).