...
> | | |
> | --- | --- |
> | **Beschrijving** | Kan beheer van de storage-accounts. Biedt toegang tot de accountsleutel, die kan worden gebruikt voor toegang tot gegevens via gedeelde sleutel autorisatie. |
