...
Zie ook [Rekenresources onderbreken][Rekenresources onderbreken], [Rekenresources berekenen][Rekenresources berekenen], [Rekenresources vergroten/verkleinen][Rekenresources vergroten/verkleinen]
...
Zie ook [Inzicht krijgen in transacties][Inzicht krijgen in transacties], [Transacties optimaliseren][Transacties optimaliseren]
...
Zie ook [Tabelstatistieken beheren][Tabelstatistieken beheren], [CREATE STATISTICS][CREATE STATISTICS], [UPDATE STATISTICS][UPDATE STATISTICS]
...
Zie ook [Gegevens laden][Gegevens laden], [Gids voor gebruik van PolyBase][Gids voor gebruik van PolyBase], [Patronen en strategieën voor Azure SQL Data Warehouse laden][Patronen en strategieën voor Azure SQL Data Warehouse laden], [Gegevens laden met Azure Data Factory][Gegevens laden met Azure Data Factory], [Gegevens verplaatsen met Azure Data Factory][Gegevens verplaatsen met Azure Data Factory], [CREATE EXTERNAL FILE FORMAT][CREATE EXTERNAL FILE FORMAT], [Create table as select (CTAS)][Create table as select (CTAS)]
...
Zie ook [Gids voor gebruik van PolyBase][Gids voor gebruik van PolyBase]
...
Zie ook [Inzicht krijgen in transacties][Inzicht krijgen in transacties], [Transacties optimaliseren][Transacties optimaliseren], [Tabellen partitioneren][Tabellen partitioneren], [TRUNCATE TABLE][TRUNCATE TABLE], [ALTER TABLE][ALTER TABLE], [Create table as select (CTAS)][Create table as select (CTAS)]
...
Zie ook [Tabeloverzicht][Tabeloverzicht], [Gegevenstypes tabel][Gegevenstypes tabel], [CREATE TABLE][CREATE TABLE]
...
Zie ook [Tabelindexen][Tabelindexen], [Gids columnstore-indexen][Gids columnstore-indexen], [Columnstore-indexen herbouwen][Columnstore-indexen herbouwen]
...
Zie ook [Gelijktijdigheid en werklastbeheer][Gelijktijdigheid en werklastbeheer]
...
Zie ook [Gelijktijdigheid en werklastbeheer][Gelijktijdigheid en werklastbeheer], [sys.dm_pdw_waits][sys.dm_pdw_waits]
...
Zie ook [Uw workload controleren met DMV's][Uw workload controleren met DMV's], [LABEL][LABEL], [OPTION][OPTION], [sys.dm_exec_sessions][sys.dm_exec_sessions], [sys.dm_pdw_exec_requests][sys.dm_pdw_exec_requests], [sys.dm_pdw_request_steps][sys.dm_pdw_request_steps], [sys.dm_pdw_sql_requests][sys.dm_pdw_sql_requests], [sys.dm_pdw_dms_workers], [DBCC PDW_SHOWEXECUTIONPLAN][DBCC PDW_SHOWEXECUTIONPLAN], [sys.dm_pdw_waits][sys.dm_pdw_waits]

## <a name="other-resources"></a>Meer informatie
Zie ook ons artikel [Problemen oplossen][Problemen oplossen] voor veelvoorkomende problemen en oplossingen.

Als u in dit artikel niet hebt gevonden waarnaar u zocht, kunt u "Zoeken naar documenten" aan de linkerzijde van deze pagina gebruiken om alle Azure SQL Data Warehouse-documenten te doorzoeken.  Het [MSDN-forum Azure SQL Data Warehouse][MSDN-forum Azure SQL Data Warehouse] is een plek waar u vragen kunt stellen aan andere gebruikers en de SQL Data Warehouse-productgroep.  We controleren het forum regelmatig om er zeker van te zijn dat uw vragen worden beantwoord door een andere gebruiker of een van ons.  We hebben ook een [Stack Overflow-forum Azure SQL Data Warehouse][Stack Overflow-forum Azure SQL Data Warehouse] voor als u uw vragen liever in Stack Overflow stelt.
...
[Gelijktijdigheid en werklastbeheer]: ./sql-data-warehouse-develop-concurrency.md
[Create table as select (CTAS)]: ./sql-data-warehouse-develop-ctas.md
[Tabeloverzicht]: ./sql-data-warehouse-tables-overview.md
[Gegevenstypes tabel]: ./sql-data-warehouse-tables-data-types.md
[Tabeldistributie]: ./sql-data-warehouse-tables-distribute.md
[Tabelindexen]: ./sql-data-warehouse-tables-index.md
[Oorzaken van slechte kwaliteit voor columnstore-indexen]: ./sql-data-warehouse-tables-index.md#causes-of-poor-columnstore-index-quality
[Columnstore-indexen herbouwen]: ./sql-data-warehouse-tables-index.md#rebuilding-indexes-to-improve-segment-quality
[Tabellen partitioneren]: ./sql-data-warehouse-tables-partition.md
[Tabelstatistieken beheren]: ./sql-data-warehouse-tables-statistics.md
[Tijdelijke tabellen]: ./sql-data-warehouse-tables-temporary.md
[Gids voor gebruik van PolyBase]: ./sql-data-warehouse-load-polybase-guide.md
[Gegevens laden]: ./sql-data-warehouse-overview-load.md
[Gegevens verplaatsen met Azure Data Factory]: ../data-factory/data-factory-azure-sql-data-warehouse-connector.md
[Gegevens laden met Azure Data Factory]: ./sql-data-warehouse-get-started-load-with-azure-data-factory.md
...
[Uw workload controleren met DMV's]: ./sql-data-warehouse-manage-monitor.md
[Rekenresources onderbreken]: ./sql-data-warehouse-manage-compute-overview.md#pause-compute-bk
[Rekenresources berekenen]: ./sql-data-warehouse-manage-compute-overview.md#resume-compute-bk
[Rekenresources vergroten/verkleinen]: ./sql-data-warehouse-manage-compute-overview.md#scale-performance-bk
[Inzicht krijgen in transacties]: ./sql-data-warehouse-develop-transactions.md
[Transacties optimaliseren]: ./sql-data-warehouse-develop-best-practices-transactions.md
...
[Tabeldistributie selecteren]: https://blogs.msdn.microsoft.com/sqlcat/2015/08/11/choosing-hash-distributed-table-vs-round-robin-distributed-table-in-azure-sql-dw-service/
[Azure SQL Data Warehouse Feedback]: https://feedback.azure.com/forums/307516-sql-data-warehouse
[MSDN-forum Azure SQL Data Warehouse]: https://social.msdn.microsoft.com/Forums/sqlserver/home?forum=AzureSQLDataWarehouse
[Stack Overflow-forum Azure SQL Data Warehouse]:  http://stackoverflow.com/questions/tagged/azure-sqldw
[Patronen en strategieën voor Azure SQL Data Warehouse laden]: https://blogs.msdn.microsoft.com/sqlcat/2016/02/06/azure-sql-data-warehouse-loading-patterns-and-strategies
