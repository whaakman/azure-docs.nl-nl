...
### <a name="gen1"></a>Gen1
De volgende tabel ziet u het maximum aantal gelijktijdige query's en gelijktijdigheid sleuven voor elk [dynamische bronklasse](resource-classes-for-workload-management.md).  Deze van toepassing op Gen1.
...
**Statische resource klassen** in de volgende tabel ziet u de maximum aantal gelijktijdige query's en gelijktijdigheid sleuven voor elk [statische bronklasse](resource-classes-for-workload-management.md).  Deze van toepassing op Gen1.
