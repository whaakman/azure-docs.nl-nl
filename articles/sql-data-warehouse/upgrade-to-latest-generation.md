...
3. Zorg ervoor dat uw workload vóór de upgrade wordt uitgevoerd en stilgelegd is voltooid. U wordt uitvaltijd moeten ervaren over een paar minuten voordat uw datawarehouse weer online is als een datawarehouse geoptimaliseerd Gen2 Compute-laag is. **Klik op upgraden**. De prijs van de prestatielaag geoptimaliseerd Gen2 Compute-laag is momenteel half-uitgeschakeld tijdens de preview-periode:
