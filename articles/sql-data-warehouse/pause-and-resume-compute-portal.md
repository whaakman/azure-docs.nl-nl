...
description: De Azure portal gebruiken om de rekencapaciteit onderbreken in Azure SQL Data Warehouse om kosten te besparen. Berekeningen hervatten wanneer u klaar bent voor gebruik van het datawarehouse.
...
De Azure portal gebruiken om de rekencapaciteit onderbreken in Azure SQL Data Warehouse om kosten te besparen. [Compute hervatten](sql-data-warehouse-manage-compute-overview.md) wanneer u bent klaar voor gebruik van het datawarehouse.
