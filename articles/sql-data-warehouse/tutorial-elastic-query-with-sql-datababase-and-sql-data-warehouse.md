...
4. Verzenden van de volgende query uit voor het maken van een definitie van de externe tabel die naar verwijst de **OrdersInformation** tabel in de datawarehouse-exemplaar.
