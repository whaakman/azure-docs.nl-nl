...
## Next steps
For more information on Dynamic Management Views (DMVs), see [System views][System views].  
For tips on managing your SQL Data Warehouse, see [Manage overview][Manage overview].  
For best practices, see [SQL Data Warehouse best practices][SQL Data Warehouse best practices].
