...
* [ALTER MATERIALIZED weergave](/sql/t-sql/statements/alter-materialized-view-transact-sql?view=azure-sqldw-latest) (Preview) 
...
* [MATERIALIZED weergeven als SELECT maken](/sql/t-sql/statements/create-materialized-view-as-select-transact-sql?view=azure-sqldw-latest) (Preview) 
...
* [WORKLOAD CLASSIFICATIE MAKEN](/sql/t-sql/statements/create-workload-classifier-transact-sql)
...
* [WORKLOAD-CLASSIFICATIE VERWIJDEREN](/sql/t-sql/statements/drop-workload-classifier-transact-sql)
