---
title: SQL Data Warehouse Transact-SQL-verwijzing | Microsoft Docs
description: Koppelingen naar referentie-inhoud voor de Transact-SQL-onderwerpen die worden gebruikt door SQL Data Warehouse.
...
Zie voor meer TSQL-verwijzing, [elementen van de SQL Data Warehouse T-SQL-taal](sql-data-warehouse-reference-tsql-language-elements.md).
