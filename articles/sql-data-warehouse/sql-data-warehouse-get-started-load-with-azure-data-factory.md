...
Voordat u met deze zelfstudie begint, moet u beschikken over de volgende resources:
   ...
   + **Azure Data Factory**: Azure Data Factory voltooit de werkelijke belasting. U hebt er dus een nodig die u kunt gebruiken voor het bouwen van de pijplijn voor het verplaatsen van gegevens. Als u er nog geen hebt, krijgt u informatie om er een te maken in Stap 1 van [Aan de slag met Azure Data Factory (Data Factory-editor)][].
