...
* **Azure SQL Server**: zie [Een logische Azure SQL-databaseserver met de Azure-portal][Een logische Azure SQL-databaseserver met de Azure-portal] of [Een logische Azure SQL-databaseserver maken met PowerShell][Een logische Azure SQL-databaseserver maken met PowerShell] voor meer informatie.
...
## Volgende stappen
Wanneer de inrichting van uw SQL Data Warehouse is voltooid, kunt u proberen om [voorbeeldgegevens te laden][voorbeeldgegevens te laden] of meer informatie te zoeken over [ontwikkelen][ontwikkelen], [laden][laden] of [migreren][migreren].

Als u wilt weten hoe u SQL Data Warehouse programmatisch kunt beheren, lees dan het artikel over het gebruik van [PowerShell cmdlets and REST APIs][PowerShell cmdlets and REST APIs] (PowerShell-cmdlets en REST-API's).
