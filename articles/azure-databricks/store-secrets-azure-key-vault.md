...
Meld u aan bij [Azure Portal](https://portal.azure.com/). Deze zelf studie kan niet worden uitgevoerd met het gratis proef abonnement voor Azure. Voordat u het cluster maakt, gaat u naar uw profiel en wijzigt u uw abonnement in **betalen per gebruik**. Zie [Gratis Azure-account](https://azure.microsoft.com/free/) voor meer informatie.
