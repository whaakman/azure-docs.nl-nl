...
<!-- 2332636 - IS -->  
- Wanneer u AD FS voor uw Azure Stack-identiteitssysteem bij te werken naar deze versie van Azure Stack, de standaardeigenaar van het standaardabonnement provider opnieuw wordt ingesteld in de ingebouwde **CloudAdmin** gebruiker.  
...
<!-- 2096388 IS --> 
- U kunt de beheerportal niet gebruiken voor het bijwerken van regels voor een netwerkbeveiligingsgroep.
...
<!-- IS, ASDK --> 
- Speciale tekens, inclusief spaties en perioden, worden niet ondersteund in de **familie** of **laag** namen wanneer u een SKU voor de SQL- en MySQL-resourceproviders.
