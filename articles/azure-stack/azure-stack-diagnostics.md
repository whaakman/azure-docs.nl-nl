...
Azure-Stack is een grote verzameling onderdelen samenwerken en interactie met elkaar. Al deze onderdelen genereren hun eigen unieke Logboeken. Dit kunt vaststellen van problemen met een uitdaging, met name voor fouten die afkomstig zijn van meerdere Azure-Stack componenten maken. 
...
![Meld u verzameling hulpprogramma 's](media/azure-stack-diagnostics/image01.png)
...
* **MaxDaysOfFiles**
    ...
    Deze parameter bepaalt de leeftijd van de bestanden moeten worden bewaard. Oude logboekbestanden worden verwijderd.
* **MaxSizeInMB**

    Deze parameter bepaalt de drempelwaarde voor één bestand. Als de grootte is bereikt, wordt een nieuwe etl-bestand gemaakt.
* **TotalSizeInMB**

    Deze parameter bepaalt de totale grootte van de etl-bestanden dat is gegenereerd op basis van een event-sessie. Als de totale bestandsgrootte groter dan de parameterwaarde van deze is, oudere bestanden verwijderd.
...
*   **Panther Logboeken**
   ...
   Problemen met virtuele machine maken:
*   **Cluster-Logboeken**
...
**Voor het uitvoeren van Get-AzureStackLog op een systeem Azure Stack Development Kit (ASDK)**
1.  Meld u aan als AzureStack\AzureStackAdmin op de host.
2.  Open een PowerShell-venster als beheerder.
3.  Voer `Get-AzureStackLog` uit.  
...
**Geïntegreerd systeem voor het uitvoeren van Get-AzureStackLog op een Azure-Stack:**
...
- Wanneer u de logboeken van de PEP verzameld, geeft u de `OutputPath` parameter moet een locatie op de machine HLH. Zorg er ook voor dat de locatie is versleuteld.
...
**De parameter-overwegingen voor zowel ASDK en geïntegreerde systemen:**
...
- Op dit moment kunt u de `FilterByRole` -parameter voor filter logboekgegevens verzameld door de volgende rollen:
...
Een aantal extra zaken te weten:
