...
|Grootte     |vCPU     |Geheugen (GiB) | Tijdelijke opslag (GiB)  | Besturingssysteem van de maximale schijfdoorvoer (IOPS) | Maximale tijdelijke opslagdoorvoer (IOPS) | Max. aantal gegevensschijven / doorvoer (IOPS) | Max. aantal NIC's |    
|----------------|--|------|----|----|----|-------|---------|
