...
|Size - Size\Name |vCPU     |Geheugen | Maximumgrootte van tijdelijke schijf | Max OS schijfdoorvoer: (IOPS) | Maximum aantal tijdelijke opslagdoorvoer (IOPS) | Maximale schijf gegevensdoorvoer (IOPS) | Max. aantal NIC's |    
|-----------------|-----|---------|---------|-----|------|-----------|----|
