...
De voorbeelden in deze zelfstudie gebruikt de volgende waarden. U kunt deze waarden gebruiken voor het maken van een testomgeving of ze raadplegen voor een beter begrip van de voorbeelden. Zie [Over instellingen voor VPN Gateway](https://docs.microsoft.com/azure/vpn-gateway/vpn-gateway-about-vpn-gateway-settings) voor meer informatie over instellingen voor VPN-gateways in het algemeen.
