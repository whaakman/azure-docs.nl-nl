...
ms.locfileid: "42889686"
---
# <a name="prepare-for-extension-host-for-azure-stack"></a>Voorbereiden voor de host van de extensie voor Azure Stack

De host van de extensie kunt u helpen bij het beveiligde Azure Stack door het aantal vereiste TCP/IP-poorten te verminderen. In dit artikel wordt behandeld Azure Stack voorbereiden voor de extensie-host, die automatisch wordt ingeschakeld via een Azure Stack-Update-pakket na de 1808 update.
...
> [!Note]  
> U kunt deze stap overslaan, afhankelijk van uw aanvraag uw SSL-certificaten.
...
5. Importeer het certificaat voor de beheerder die als host fungeert eindpunt.
