...
Gebruik is op dit moment is gerapporteerd voor de netwerk-, opslag- en resourceproviders voor compute.

| **Resourceprovider** | **ID van de meter** | **De naam van de meter** | **Eenheid** | **Aanvullende informatie** |
| --- | --- | --- | --- | --- | 
| **Netwerk** |F271A8A388C44D93956A063E1D2FA80B |Gebruik van statische IP-adres |IP-adressen|Telling van IP-adressen gebruikt | 
| |9E2739BA86744796B465F64674B822BA |Gebruik van dynamische IP-adres |IP-adressen|Telling van IP-adressen gebruikt | 
...
| | B9FF3CD0-28AA-4762-84BB-FF8FBAEA6A90 |TableTransactions |Telling van 10.000 aanvragen |Aanvragen van de tabel-service (per 10.000) |
| | 50A1AEAF-8ECA-48A0-8973-A5B3077FEE0D |TableDataTransIn |Inkomende gegevens in GB |Tabel-service gegevens inkomend in GB |
| | 1B8C1DEC-EE42-414B-AA36-6229CF199370 |TableDataTransOut |Outgress GB |Uitgaande van een tabel-service-gegevens, in GB |
| | 43DAF82B-4618-444A-B994-40C23F7CD438 |BlobTransactions |Aanvragen tellen in 10.000 |Serviceaanvragen BLOB (per 10.000) |
| | 9764F92C-E44A-498E-8DC1-AAD66587A810 |BlobDataTransIn |Inkomende gegevens in GB |BLOB-service gegevens inkomend in GB |
| | 3023FEF4-ECA5-4D7B-87B3-CFBC061931E8 |BlobDataTransOut |Outgress GB |Uitgaande van BLOB-service gegevens in GB |
| | EB43DD12-1AA6-4C4B-872C-FAF15A6785EA |QueueTransactions |Aanvragen tellen in 10.000 |Wachtrij-serviceaanvragen (per 10.000) |
| | E518E809-E369-4A45-9274-2017B29FFF25 |QueueDataTransIn |Inkomende gegevens in GB |Wachtrij-service gegevens inkomend in GB | 
| | DD0A10BA-A5D6-4CB6-88C0-7D585CEF9FC2 |QueueDataTransOut |Outgress GB |Uitgaande van Queue-service gegevens in GB |
| **Compute** |FAB6EB84-500B-4A09-A8CA-7358F8BBAEA5 |Basis VM-grootte-uren |Virtuele core minuten | Dit is het aantal vcores keren minuten die de virtuele machine is uitgevoerd |
| |9CD92D4C-BAFD-4492-B278-BEDC2DE8232A |Uren Windows VM-grootte |Virtuele core minuten | Dit is het aantal vcores keren minuten die de virtuele machine is uitgevoerd |
| |6DAB500F-A4FD-49C4-956D-229BB9C8C793 |Uren voor VM-grootte |VM-uren |Basis- en Windows VM bevat. Komt niet voor vcores aanpassen |
| **Key Vault** | EBF13B9F-B3EA-46FE-BF54-396E93D48AB4 |Sleutelkluis-transacties | Aantal verzoeken in groepen van 10000| Aantal ontvangen door de Sleutelkluis gegevens vlak REST-API-aanvragen |
...
Op dit moment kunt u een query *alleen door gerapporteerd tijd*.
...
| 400/onjuiste aanvraag |*SubscriberIdIsNotDirectTenant* |Een serviceprovider-API-aanroep gebruikt een abonnements-ID is niet een geldige tenant van de aanroepfunctie. |
