...
Het is niet raadzaam om uit te schakelen telemetrie in uw organisatie zoals telemetrie bevat gegevens die de functionaliteit van het verbeterde product en stabiliteit stations. We echter erkennen dat in sommige scenario's dit kan nodig zijn. 
...
- ** Compatibiliteit met gegevens die zorgt voor een goed begrip over welke Resourceproviders zijn geïnstalleerd op een systeem en de virtuele machine en mogelijke compatibiliteitsproblemen identificeert.
