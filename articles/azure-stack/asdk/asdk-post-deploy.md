...
Na [installeren van de Azure Stack Development Kit (ASDK)](asdk-install.md), moet u een aantal aanbevolen na de installatie configuratiewijzigingen terwijl u aangemeld als AzureStack\AzureStackAdmin op de hostcomputer ASDK. 
