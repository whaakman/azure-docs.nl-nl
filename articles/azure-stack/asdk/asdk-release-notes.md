...
- MAC-adressen verwerkt interne Load Balancing (ILB) niet goed voor back-end virtuele machines die pakketten naar de back-endnetwerk verwijderen wanneer u Linux, alle exemplaren.
