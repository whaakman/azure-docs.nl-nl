...
## <a name="prerequisites"></a>Vereisten
 ...
 - U moet de toolkit worden uitgevoerd op de host van de Azure Stack of [VPN](azure-stack-connect-azure-stack.md#connect-to-azure-stack-with-vpn) connectiviteit van de machine waarop u het hulpprogramma uitvoert.
