...
- [Gebruik en facturering voor Azure Stack beheren als een cloudserviceprovider](azure-stack-add-manage-billing-as-a-csp.md)
- [Tenant voor gebruik en facturering toevoegen in Azure Stack](azure-stack-csp-howto-register-tenants.md)
