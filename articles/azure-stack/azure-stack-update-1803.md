...
- **Vaste** : wanneer u een virtuele machine, het bericht maakt *kan niet worden weergegeven prijzen* niet langer weergegeven bij het kiezen van een grootte voor de VM-grootte.
...
*Er zijn geen bekende problemen voor de installatie van update 1803.*
