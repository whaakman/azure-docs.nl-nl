...
### <a name="powershell-language-mode"></a>PowerShell taal-modus

Als u wilt registreren met succes Azure Stack, de PowerShell-taalmodus moet worden ingesteld op **FullLanguageMode**.  Controleren of de huidige taalmodus is ingesteld op full, opent u een PowerShell-venster met verhoogde bevoegdheid en voer de volgende PowerShell-opdrachten:
