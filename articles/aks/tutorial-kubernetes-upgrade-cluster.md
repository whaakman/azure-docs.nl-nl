...
Hier kunt u zien dat de versie van het huidige knooppunt is `1.7.7` en die versie `1.8.1` is beschikbaar.
...
Gebruik de `az aks upgrade` opdracht voor upgrade de clusterknooppunten. De volgende voorbeelden bijwerken naar versie van het cluster `1.8.1`.
