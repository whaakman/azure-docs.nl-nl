...
ms.locfileid: "60537885"
---
# <a name="quotas-and-limits-for-azure-container-instances"></a>Quota en limieten voor Azure Container Instances

Alle Azure-services bevatten bepaalde standaardlimieten en -quota voor resources en functies. Dit artikel worden de standaardquota en limieten voor Azure Container Instances.

Zie voor de beschikbaarheid van Azure Container Instances-functies en resources in Azure-regio's, [de beschikbaarheid van Azure Container Instances](container-instances-region-availability.md).
