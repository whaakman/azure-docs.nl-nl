...
---
# <a name="create-network-security-groups-using-the-azure-cli-10"></a>Netwerk met behulp van de Azure CLI 1.0 beveiligingsgroepen maken
...
- [Azure CLI 1.0](#how-to-create-the-nsg-for-the-front-end-subnet) – onze CLI voor het klassieke en resource management-implementatiemodel (in dit artikel)
- [Azure CLI 2.0](virtual-networks-create-nsg-arm-cli.md) -onze CLI volgende generatie voor de resource management-implementatiemodel 

[!INCLUDE [virtual-networks-create-nsg-intro-include](../../includes/virtual-networks-create-nsg-intro-include.md)]

[!INCLUDE [azure-arm-classic-important-include](../../includes/azure-arm-classic-important-include.md)]

Dit artikel is van toepassing op het Resource Manager-implementatiemodel. U kunt ook [nsg's maken in het klassieke implementatiemodel](virtual-networks-create-nsg-classic-cli.md).

[!INCLUDE [virtual-networks-create-nsg-scenario-include](../../includes/virtual-networks-create-nsg-scenario-include.md)]

De Azure CLI Voorbeeldopdrachten onderstaande verwacht een eenvoudige omgeving al gemaakt op basis van het bovenstaande scenario. 
...
3. Voer de **nsg azure-netwerk maken** opdracht voor het maken van een NSG.
   ...
   * **-g (of --resourcegroep)**. Naam van de resourcegroep waar de NSG wordt gemaakt. In ons scenario *TestRG*.
...
4. Voer de **azure-netwerk nsg regel maken** opdracht maakt u een regel waarmee toegang tot poort 3389 (RDP) van het Internet.
...
5. Voer de **azure-netwerk nsg regel maken** opdracht voor het maken van een regel die toegang tot poort 80 (HTTP) van het Internet is.
    ...
    Verwachte putput:
        ...
        data:    Priority                        : 200
        info:    network nsg rule create command OK
6. Voer de **azure network vnet subnet set** opdracht het NSG koppelen aan de front-end-subnet.
...
1. Voer de **nsg azure-netwerk maken** opdracht voor het maken van een NSG.
    ...
    Verwachte uitvoer:
        ...
        data:    DenyAllOutBound                *                  *            *               *                 *         Outbound   Deny    65500   
        info:    network nsg create command OK
2. Voer de **azure-netwerk nsg regel maken** opdracht maakt u een regel waarmee toegang tot poort 1433 (SQL) van de front-end-subnet.
    ...
    Verwachte uitvoer:
        ...
        data:    Priority                        : 100
        info:    network nsg rule create command OK
3. Voer de **azure-netwerk nsg regel maken** opdracht voor het maken van een regel die op het Internet van de toegang weigert.
    ...
    Verwachte putput:
        ...
        data:    Priority                        : 200
        info:    network nsg rule create command OK
4. Voer de **azure network vnet subnet set** opdracht het NSG koppelen aan het subnet voor back-end.
