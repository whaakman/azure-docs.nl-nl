...
4. <a name = "security-rule-settings"></a>Selecteer **+ toevoegen**.  Selecteer of waarden toevoegen voor de volgende instellingen en selecteer vervolgens **OK**:
    ...
    |Poortbereik van doel     | Geef een enkele waarde of een door komma's gescheiden lijst met waarden. | Net als bij **bron poortbereiken**, kunt u één of meerdere poorten en adresbereiken opgeven en er gelden beperkingen aan het getal dat u kunt opgeven. |
