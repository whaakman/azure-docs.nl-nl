...
2. Meld u aan bij uw account met de `Connect-AzureRmAccount` opdracht.
...
8. De NIC maken en koppelen van de drie IP-configuraties:
    ...
    >[!NOTE]
    >Hoewel alle configuraties zijn toegewezen aan één NIC in dit artikel, kunt u meerdere IP-configuraties kunt toewijzen aan elke NIC die is gekoppeld aan de virtuele machine. Lees voor meer informatie over het maken van een virtuele machine met meerdere NIC's, de [een virtuele machine maken met meerdere NIC's](../virtual-machines/windows/multiple-nics.md) artikel.
