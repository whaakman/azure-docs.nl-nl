...
* **Gebieden:** de mogelijkheid is beschikbaar in vele Azure-regio's en blijft uitbreiden. Zie voor een volledige lijst [Azure virtuele netwerken Updates](https://azure.microsoft.com/updates/accelerated-networking-in-expanded-preview) blog.   
* **Ondersteunde besturingssystemen:** Ubuntu Server 16.04 TNS met kernel 4.4.0-77 of hoger, SLES 12 SP2 RHEL 7.4 en CentOS 7.4 (gepubliceerd door Rogue Wave Software).
* **VM-grootte:** algemeen en de grootte van de compute-geoptimaliseerde exemplaar met acht of meer cores. Zie voor meer informatie [Linux VM-grootten](../virtual-machines/linux/sizes.md?toc=%2fazure%2fvirtual-network%2ftoc.json). De set ondersteunde VM-grootten voor exemplaar blijft om uit te vouwen.
