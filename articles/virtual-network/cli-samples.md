...
|[Configureer IPv4 + IPv6 dual stack-virtueel netwerk met Basic Load Balancer](./scripts/virtual-network-cli-sample-ipv6-dual-stack.md)|Virtueel netwerk met twee virtuele machines en een Azure Basic Load Balancer met openbare IP-adressen van IPv4 en IPv6 dual stack (IPv4 + IPv6) implementeert. |
|[Configureer IPv4 + IPv6 dual stack-virtueel netwerk met de standaardversie van Load Balancer](./scripts/virtual-network-cli-sample-ipv6-dual-stack-standard-load-balancer.md)|Virtueel netwerk met twee virtuele machines en een Azure Standard Load Balancer met openbare IP-adressen van IPv4 en IPv6 dual stack (IPv4 + IPv6) implementeert. |