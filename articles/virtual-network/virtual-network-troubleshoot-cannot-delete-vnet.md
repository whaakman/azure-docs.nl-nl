...
ms.locfileid: "66235014"
---
# <a name="troubleshooting-failed-to-delete-a-virtual-network-in-azure"></a>Probleemoplossing: Kan niet verwijderen van een virtueel netwerk in Azure
...
Zie voor het uitschakelen van de service [uitschakelen Azure Active Directory Domain Services met behulp van de Azure-portal](../active-directory-domain-services/delete-aadds.md).
