...
5. <a name="add-peering"></a>Typ of Selecteer waarden voor de volgende instellingen:
    ...
    Maar voor één peer voor dit virtuele netwerk, kan deze instelling is ingeschakeld hebben.
        ...
        U kunt geen externe gateways gebruiken als u al een gateway hebt geconfigureerd in uw virtuele netwerk. Zie voor meer informatie over het gebruik van een gateway voor de doorvoer, [een VPN-gateway voor de doorvoer in een virtueel netwerk-peering configureren](../vpn-gateway/vpn-gateway-peering-gateway-transit.md?toc=%2fazure%2fvirtual-network%2ftoc.json)
...
- U kunt externe gateways gebruiken of toestaan van gateway-doorvoer in wereldwijd gekoppelde virtuele netwerken en lokaal gekoppelde virtuele netwerken.
