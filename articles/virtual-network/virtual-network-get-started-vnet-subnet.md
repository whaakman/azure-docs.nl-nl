...
2. Klik op **Een resource maken** > **Netwerken** > **Virtueel netwerk**.
...
1. In [Azure Portal](https://portal.azure.com) klikt u op **Een resource maken** > **Compute** > **Windows Server 2016 Datacenter**.
2. Klik op **Create**.
...
1. Klik in [Azure Portal](https://portal.azure.com) op **Alle services**.
2. Typ *Resourcegroep* in het vak waarin het woord *Filter* staat. Klik op **Resourcegroepen** wanneer deze optie wordt weergegeven in de gefilterde lijst.
