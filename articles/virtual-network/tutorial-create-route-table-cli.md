...
Maak een routetabel met [az network route-table maken](/cli/azure/network/route#az_network_route_table_create). Het volgende voorbeeld wordt een routetabel met de naam *myRouteTablePublic*. 
...
Een route maken in de routetabel, met [az network route-table route maken](/cli/azure/network/route-table/route#az_network_route_table_route_create). 
