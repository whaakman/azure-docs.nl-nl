...
- Is er een toeslag voor gereserveerde IP-adressen?
    Soms. Zie voor details over de prijzen, de [gereserveerde IP-adres prijsinformatie over](http://go.microsoft.com/fwlink/?LinkID=398482) pagina.
