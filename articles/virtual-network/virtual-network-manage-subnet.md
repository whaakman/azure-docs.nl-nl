---
title: Toevoegen, wijzigen of verwijderen van het subnet van een virtueel Azure-netwerk | Microsoft Docs
...
5. Voer waarden in voor de volgende parameters:
    ...
    - **Subnet delegering:** een subnet nul op meerdere overdrachten zijn ingeschakeld voor het kan zijn. Subnet delegering biedt expliciete machtigingen voor de service servicespecifieke om resources te maken in het subnet met behulp van een unieke id bij het implementeren van de service. Voor het overdragen van een service, selecteert u de service die u overdragen wilt aan van de **Services** lijst. 
