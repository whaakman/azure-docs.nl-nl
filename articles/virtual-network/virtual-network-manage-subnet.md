...
|---|---|
|Azure-CLI|[AZ network vnet subnet maken](/cli/azure/network/vnet/subnet?toc=%2fazure%2fvirtual-network%2ftoc.json#az_network_vnet_subnet_create)|
...
|Hulpprogramma|Opdracht|
|---|---|
|Azure-CLI|[AZ network vnet subnet bijwerken](/cli/azure/network/vnet?toc=%2fazure%2fvirtual-network%2ftoc.json#az_network_vnet_update)|
...
|Hulpprogramma|Opdracht|
|---|---|
|Azure-CLI|[vnet-AZ netwerk het verwijderen](/cli/azure/network/vnet?toc=%2fazure%2fvirtual-network%2ftoc.json#az_network_vnet_delete)|
