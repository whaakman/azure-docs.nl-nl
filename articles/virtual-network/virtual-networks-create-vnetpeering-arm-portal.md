---
title: VNet-peering maken met behulp van Azure Portal | Microsoft Docs
...
---
# <a name="create-a-virtual-network-peering-using-the-azure-portal"></a>Een gelijkwaardig virtueel netwerk maken met Azure Portal
...
Volg de onderstaande stappen om VNet-peering te maken met behulp van Azure Portal op basis van het bovenstaande scenario.
...
5. Vervolgens meld u zich aan bij Azure Portal met UserB, die de bevoegde gebruiker is voor SubscriptionB. Volg de bovenstaande stappen om UserA toe te voegen als Network Contributor.
...
3. Kies op de blade Virtuele netwerken **VNET1**. Klik op **Peerings** en klik vervolgens op **Toevoegen**.
4. Geef uw koppeling een naam op de blade Peering toevoegen. Hier wordt deze **LinkToVNet2** genoemd. Selecteer **Klassiek** onder Peerdetails.
