...
Niet-domein Windows-clients proberen onbeveiligde dynamische DNS-(DDNS) updates wanneer ze worden opgestart of wanneer hun IP-adres verandert. De DNS-naam is de hostnaam plus het primaire DNS-achtervoegsel. Azure worden de primaire DNS-achtervoegsel leeg gelaten, maar u kunt dit instellen in de virtuele machine de [gebruikersinterface](https://technet.microsoft.com/library/cc794784.aspx) of [PowerShell](/powershell/module/dnsclient/set-dnsclient).
