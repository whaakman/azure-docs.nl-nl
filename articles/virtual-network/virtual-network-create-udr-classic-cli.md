...
Dit artikel is van toepassing op het klassieke implementatiemodel. U kunt ook [beheren Routering en het gebruik van virtuele apparaten in het Resource Manager-implementatiemodel](tutorial-create-route-table-cli.md).
