...
* **Opmerking**: Zie voor het oplossen van validatiefouten voor SSL-certificaat [http://readthedocs.org/docs/twilio-php/en/latest/usage/rest.html][ssl_validation] 
