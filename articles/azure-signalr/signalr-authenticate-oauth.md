---
title: Zelfstudie voor het verifiëren van Azure SignalR-clients | Microsoft Docs
...
3. Gebruik de volgende instellingen voor de nieuwe OAuth-app en klik vervolgens op **Register application**:
    ...
    | ------------ | --------------- | ----------- |
    | De naam van de toepassing | *Azure SignalR Chat* | De GitHub-gebruiker moet de app waarbij ze worden geverifieerd kunnen herkennen en vertrouwen.   |
    | Homepage URL | *http://localhost:5000/home* | |
    | Application description | *Een voorbeeld van een chatruimte die de Azure-SignalR-service gebruikt met GitHub-verificatie* | Een zinvolle beschrijving van de toepassing zodat de gebruikers van uw toepassing de context begrijpen waarin de verificatie wordt gebruikt. |
