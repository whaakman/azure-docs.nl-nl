...
Dit onderwerp leest u hoe u aan de slag met Azure-functies die gebruikmaken van Media Services maken. De Azure-functie die is gedefinieerd in dit onderwerp wordt een storage-account-container met de naam bewaakt **invoer** voor nieuwe MP4-bestanden. Wanneer een bestand in de storage-container is verbroken, kan de blob-trigger de functie wordt uitgevoerd. Azure functions Zie [overzicht](../azure-functions/functions-overview.md) en andere onderwerpen in de **Azure functions** sectie.
