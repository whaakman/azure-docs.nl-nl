...
> [!NOTE]
> If you also want to encrypt your HLS content with PlayReady, you need to create a common key and associate it with your asset. You also need to configure the content key’s authorization policy, as described in [Using PlayReady dynamic common encryption](media-services-protect-with-drm.md) topic.
> 
> 
