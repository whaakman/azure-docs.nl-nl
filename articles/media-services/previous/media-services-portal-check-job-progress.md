---
title: Voortgang codering taak met de Azure-portal
description: Deze zelfstudie leert u de stappen van de bewaking van de voortgang van de taak met de Azure portal.
...
ms.locfileid: "33788289"
---
# <a name="monitor-encoding-job-progress-with-the-azure-portal"></a>Voortgang codering taak met de Azure-portal
...
Wanneer u taken uitvoert, moet u vaak een manier om de voortgang van de taak volgen. 
...
Nadat uw coderingstaak is, kunt u publiceren en afspelen van uw assets, zoals wordt beschreven [hier](media-services-portal-publish.md).
