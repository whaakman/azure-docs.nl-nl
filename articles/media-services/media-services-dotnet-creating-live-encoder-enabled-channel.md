...
> [!NOTE]
> Om de waarden voor Naam en Sleutel te vinden, gaat u naar Azure Portal en selecteert u uw account. Het venster Instellingen wordt aan de rechterkant weergegeven. Selecteer Sleutels in het venster Instellingen. Door op het pictogram naast elk tekstvak te klikken, wordt de waarde gekopieerd naar het systeemklembord.
> 
> 
