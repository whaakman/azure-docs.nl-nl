---
title: Snelstartgids - Een Azure Media Services-account maken met CLI 2.0 | Microsoft Docs
...
In deze snelstartgids worden de stappen beschreven voor het maken van een nieuw Azure Media Services-account met behulp van CLI 2.0.  
