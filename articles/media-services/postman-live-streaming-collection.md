---
title: Importeren van de verzameling Postman voor Azure Live Streaming REST-aanroepen
...
ms.locfileid: "32178444"
---
# <a name="import-a-postman-collection-with-live-streaming-operations"></a>Een verzameling Postman met Live Streaming bewerkingen importeren

In dit artikel bevat een definitie van de **Postman** verzameling met gegroepeerde HTTP-aanvragen die aanroep **Live Streaming** Azure Media Services REST API's. Voor informatie over het configureren van **Postman** zodat deze kan worden gebruikt voor het aanroepen van Media Services REST-API's, Zie [Postman configureren voor Media Services REST-API-aanroepen](media-rest-apis-with-postman.md) zelfstudie.
