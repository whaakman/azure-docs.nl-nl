...
##Een Azure-Account instellen voor Media Services

Als u een Media Services-account wilt maken, gebruikt u de klassieke Azure-portal. Zie het onderwerp [Een Media Services-account maken](media-services-create-account.md) voor meer informatie. Nadat u uw account in de klassieke Azure-portal hebt gemaakt, bent u klaar om uw computer te configureren voor het ontwikkelen van toepassingen met Media Services.

##Configureren voor het ontwikkelen van toepassingen met Media Services

Deze sectie bevat algemene vereisten voor het ontwikkelen van Media Services met de Media Services SDK voor Java.

###Vereisten

-   Een Media Services-account in een nieuw of bestaand Azure-abonnement. Zie het onderwerp [Een Media Services-account maken](media-services-create-account.md) voor meer informatie.
-   De Azure-beheerbibliotheken voor Java, die u kunt installeren vanuit het [Azure Java Developer Center][].
...
Zie [Azure-bibliotheken voor Java-documentatie][] voor Javadoc-documentatie voor Media Services.
