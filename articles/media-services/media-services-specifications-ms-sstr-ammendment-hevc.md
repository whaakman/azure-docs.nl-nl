---
title: Azure mediaservices - Smooth Streaming-Protocol (MS-SSTR) Ammendment voor HEVC | Microsoft Docs
description: Deze specificatie beschrijft het protocol en de indeling voor gefragmenteerde MP4 gebaseerde live streamen met HEVC in Azure Media Services. Dit is een ammendment Smooth Streaming protocol documentaiton (MS-SSTR) voor onder meer ondersteuning voor HEVC opnemen en streaming. Alleen de wijzigingen die zijn vereist voor het leveren van HEVC zijn opgegeven in dit artikel, behalve zijn '(geen wijzigen)' geeft aan tekst voor alleen informatie wordt gekopieerd.
...
---
# <a name="smooth-streaming-protocol-ms-sstr-ammendment-for-hevc"></a>Smooth Streaming Protocol (MS-SSTR) Ammendment voor HEVC
...
>   [MPEG4 RA] De MP4 Statusregistratie-instanties, 'MP4REG' [http://www.mp4ra.org   ](http://go.microsoft.com/fwlink/?LinkId=327787)
