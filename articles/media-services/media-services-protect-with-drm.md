...
2. Codeer de asset met het bestand naar de Adaptive Bitrate MP4-set.
...
2. Gebruik NuGet om Azure Media Services .NET SDK te installeren en toe te voegen.
3. Voeg aanvullende verwijzingen toe: System.Configuration.
4. Voeg een configuratiebestand toe dat de accountnaam en sleutelgegevens bevat:
...
5. Haal ten minste één streaming-eenheid op voor het streaming-eindpunt van waaruit u uw inhoud wilt leveren. Zie [Streaming-eindpunten configureren](media-services-dotnet-get-started.md#configure-streaming-endpoint-using-the-portal) voor meer informatie.
