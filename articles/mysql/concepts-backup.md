---
title: Back-up en herstel in de Azure-Database voor MySQL
description: Meer informatie over automatische back-ups en terugzetten van uw Azure-Database voor de MySQL-server.
services: mysql
author: kamathsun
ms.author: sukamat
manager: kfile
...
Azure MySQL-Database biedt tot wel 100% van uw serveropslag ingerichte als back-upopslag zonder extra kosten. Dit is meestal geschikt is voor een back-up bewaren van zeven dagen. Alle aanvullende back-opslag is in rekening gebracht per GB maand.
...
In de Azure-Database voor MySQL maakt uitvoeren van een herstelpunt een nieuwe server vanaf de oorspronkelijke server back-ups.
