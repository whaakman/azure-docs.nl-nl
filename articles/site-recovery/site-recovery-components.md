...
**Primaire site** | **Processerver**: stel het processerveronderdeel in op uw primaire site om caching, compressie en optimalisatie van gegevens af te handelen. Hier wordt ook de push-installatie van de Unified Agent afgehandeld naar computers die u wilt beveiligen.<br/><br/> **VMware ESX/ESXi en vCenter**: u hebt een VMware EXS/ESXi -hypervisor nodig en optioneel ook een VMware vCenter-server.<br/><br/> **VM's** | Tijdens de implementatie wordt de Unified Agent geïnstalleerd op computers die u wilt beveiligen. De agent fungeert als communicatieprovider tussen alle onderdelen.
