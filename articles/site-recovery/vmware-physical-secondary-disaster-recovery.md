...
- Zorg ervoor dat de machines die u wilt repliceren voldoen [gerepliceerde machine ondersteuning](vmware-physical-secondary-support-matrix.md#replicated-vm-support).
