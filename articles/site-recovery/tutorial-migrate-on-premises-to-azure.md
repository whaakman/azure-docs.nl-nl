...
2. On-premises [VMware](tutorial-prepare-on-premises-vmware.md) of Hyper-V-servers voorbereiden.

Voordat u begint, is het handig om de architectuur voor noodherstel van [VMware](concepts-vmware-to-azure-architecture.md) of [Hyper-V](concepts-hyper-v-to-azure-architecture.md) te bekijken.
...
- De bronomgeving [instellen](tutorial-vmware-to-azure.md#set-up-the-source-environment) voor VMware-VM's.
- De bronomgeving [instellen](tutorial-physical-to-azure.md#set-up-the-source-environment) voor fysieke servers.
...
- [Beleid voor replicatie](tutorial-vmware-to-azure.md#create-a-replication-policy) voor VMware-VM's instellen.
- [Beleid voor replicatie](tutorial-physical-to-azure.md#create-a-replication-policy) voor fysieke servers instellen.
- [Beleid voor replicatie](hyper-v-azure-tutorial.md#set-up-a-replication-policy) voor Hyper-V-VM's instellen.


## <a name="enable-replication"></a>Replicatie inschakelen

- [Replicatie inschakelen](tutorial-vmware-to-azure.md#enable-replication) voor VMware VM's.
- [Replicatie inschakelen](tutorial-physical-to-azure.md#enable-replication) voor fysieke servers.
- [Replicatie inschakelen](hyper-v-azure-tutorial.md#enable-replication) voor Hyper-V-VM's.
...
6. Klik in **Gerepliceerde items** met de rechtermuisknop op de virtuele machine > **Migratie voltooien**. Hiermee wordt het migratieproces voltooid, de replicatie voor de VM gestopt en Site Recovery-facturering voor de virtuele machine gestopt.
    ...
    ![Migratie voltooien](./media/tutorial-migrate-on-premises-to-azure/complete-migration.png)
...
> [Stel herstel na noodgeval in](site-recovery-azure-to-azure-after-migration.md) voor Azure-VM's na de migratie van een on-premises locatie.
