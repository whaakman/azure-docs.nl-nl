...
1. Klik in het linkernavigatiegedeelte in [Azure Portal](https://portal.azure.com) op **Alle services**, en zoek en selecteer **Recovery Services-kluizen**.
...
1. Klik in [Azure Portal](https://portal.azure.com) op **Een resource maken** > **Netwerken** >
   **Virtueel netwerk**.
