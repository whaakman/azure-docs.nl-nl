...
---
# <a name="step-5-prepare-azure-resources-for-hyper-v-replication-to-azure"></a>Stap 5: Azure-resources voorbereiden voor Hyper-V-replicatie naar Azure

Volg de instructies in dit artikel voor het voorbereiden van Azure-resources, zodat u kunt lokale Hyper-V-machines (zonder de System Center VMM) repliceren voor het gebruik van Azure de [Azure Site Recovery](site-recovery-overview.md) service.
...
Zorg ervoor dat u hebt gelezen de [vereisten](hyper-v-site-walkthrough-prerequisites.md)
...
Ga naar [stap 6: Hyper-V voorbereiden resources](hyper-v-site-walkthrough-prepare-hyper-v.md)
