...
- Kunt Site Recovery downloaden en installeren wanneer de configuratiewizard voor Server Management wordt uitgevoerd. U hoeft niet geen specifieke actie te ondernemen.
