...
Deze fout treedt op wanneer de service Azure Site Recovery VSS Provider [gemarkeerd voor verwijdering](https://msdn.microsoft.com/library/ms838153.aspx). Probeer VSS om handmatig te installeren op de broncomputer door het uitvoeren van de volgende opdrachtregel
...
Deze fout treedt op wanneer de database van de service Azure Site Recovery VSS Provider [vergrendeld](https://msdn.microsoft.com/library/ms833798.aspx). Probeer VSS om handmatig te installeren op de broncomputer door het uitvoeren van de volgende opdrachtregel
