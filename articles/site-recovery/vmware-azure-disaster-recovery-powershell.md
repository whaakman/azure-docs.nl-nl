...
> [!TIP]
> Als alternatief voor de cmdlet Set-ASRVaultContext kunt een ook de cmdlet Import-AzureRmRecoveryServicesAsrVaultSettingsFile gebruiken om in te stellen de context van de kluis. Geef het pad waar de kluis registratiesleutelbestand zich bevindt als de parameter - path aan de cmdlet Import-AzureRmRecoveryServicesAsrVaultSettingsFile.
>
>Bijvoorbeeld:
>
>```azurepowershell
