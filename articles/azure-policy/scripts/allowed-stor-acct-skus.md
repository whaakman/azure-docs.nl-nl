---
title: Azure beleid json-voorbeeld - opslagaccount SKU's toegestaan | Microsoft Docs
description: Dit beleid json-voorbeeld moet storage-accounts gebruiken een goedgekeurde SKU.
...
---
# <a name="allowed-storage-account-skus"></a>Storage-account SKU's toegestaan

Dit beleid vereist dat storage-accounts een goedgekeurde SKU gebruiken. U opgeven een matrix van goedgekeurde SKU's.
