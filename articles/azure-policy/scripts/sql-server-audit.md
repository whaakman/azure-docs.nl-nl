---
title: Json-voorbeeld Azure Policy - auditinstellingen SQL Server controleren| Microsoft Docs
description: Dit json-voorbeeldbeleid controleert SQL server auditinstellingen.
