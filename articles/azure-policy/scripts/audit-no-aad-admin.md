---
title: Json-voorbeeld Azure-Policy - op een Azure AD-beheerder controleren | Microsoft Docs
description: Dit json-voorbeeldbeleid controleert of er een Azure Active Directory-beheerder is toegewezen aan de SQL Server.
