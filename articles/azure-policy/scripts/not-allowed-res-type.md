---
title: Azure beleid json-voorbeeld - niet toegestaan brontypen | Microsoft Docs
description: Dit beleid json-voorbeeld voorkomt dat de implementatie van de opgegeven brontypen.
...
---
# <a name="not-allowed-resource-types"></a>Brontypen die toegestaan niet

Dit beleid voorkomt dat de implementatie van de opgegeven brontypen. U een matrix van de volgende resourcetypen moeten worden geblokkeerd.
