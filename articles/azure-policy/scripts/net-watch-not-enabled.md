---
title: Json-voorbeeld Azure beleid - Audit als netwerk-Watcher niet is ingeschakeld voor de regio | Microsoft Docs
description: Dit beleid json-voorbeeld audits als netwerk-watcher niet is ingeschakeld voor een bepaald gebied
...
---
# <a name="audit-if-network-watcher-is-not-enabled-for-region"></a>Audit als netwerk-Watcher niet is ingeschakeld voor de regio

Dit beleid kunnen worden opgeslagen als netwerk-Watcher niet is ingeschakeld voor een opgegeven regio. U de naam van de regio waarin u wilt controleren of de netwerk-Watcher is ingeschakeld.
