---
title: Azure beleid json steekproef - versleuteling voor opslag-bestand | Microsoft Docs
description: Dit json-voorbeeld-beleid vereist dat versleuteling is ingeschakeld voor de storage-accounts.
...
---
# <a name="ensure-storage-file-encryption"></a>Zorg ervoor dat de bestandscodering voor opslag

Dit beleid vereist dat versleuteling is ingeschakeld voor de storage-accounts.
