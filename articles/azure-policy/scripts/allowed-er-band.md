---
title: Json-voorbeeld Azure Policy - toegestane Express Route-bandbreedte | Microsoft Docs
description: Dit json-voorbeeldbeleid vereist dat Express Routes een goedgekeurde set bandbreedten gebruiken.
...
ms.locfileid: "34600864"
---
# <a name="allowed-express-route-bandwidth"></a>Toegestane Express Route-bandbreedten

Dit beleid vereist dat Express Routes een goedgekeurde set bandbreedten gebruiken. U geeft een matrix op van bandbreedten die kunnen worden opgegeven voor Express Route.
