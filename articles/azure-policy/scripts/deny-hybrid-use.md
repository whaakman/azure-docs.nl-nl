---
title: Json-voorbeeld Azure Policy - hybrid use benefit weigeren| Microsoft Docs
description: Dit json-voorbeeldbeleid verbiedt gebruik van Azure Hybrid Use Benefit (AHUB).
