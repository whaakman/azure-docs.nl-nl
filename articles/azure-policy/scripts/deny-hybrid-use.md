---
title: Azure beleid json steekproef - weigeren hybride gebruik voordeel | Microsoft Docs
description: Dit beleid json-voorbeeld verbiedt gebruik van Azure hybride gebruiken voordeel (AHUB).
...
---
# <a name="deny-hybrid-use-benefit"></a>Hybride gebruik voordeel weigeren

Verbiedt gebruik van Azure hybride gebruiken voordeel (AHUB). Gebruik deze optie wanneer u niet wilt toestaan van gebruik van lokale licenties.
