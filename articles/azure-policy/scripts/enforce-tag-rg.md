---
title: Json-voorbeeld Azure Policy - tag en de waarde ervan afdwingen in brongroepen| Microsoft Docs
description: Dit json-voorbeeldbeleid vereist een tag en waarde in een brongroep.
