---
title: Json-voorbeeld Azure Policy - toegestane application gateway-SKU’s | Microsoft Docs
description: Dit json-voorbeeldbeleid vereist dat application gateways een goedgekeurde SKU gebruiken.
