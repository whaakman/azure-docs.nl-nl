---
title: Json-voorbeeld Azure Policy - toegestane gateway-SKU’s van virtueel netwerk | Microsoft Docs
description: Dit json-voorbeeldbeleid vereist dat gateways van virtuele netwerken een goedgekeurde SKU en gateway-type gebruiken.
...
ms.locfileid: "34602047"
---
# <a name="allowed-virtual-network-gateway-skus"></a>Toegestane gateway-SKU’s van virtueel netwerk

Dit beleid vereist dat gateways van virtuele netwerken een goedgekeurde SKU en gateway-type gebruiken. U geeft een matrix op van goedgekeurde SKU's en een matrix van goedgekeurde gateway-typen.
