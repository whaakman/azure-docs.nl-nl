---
title: Json-voorbeeld Azure Policy - NSG x in elk subnet | Microsoft Docs
description: Dit json-voorbeeldbeleid vereist dat een specifieke netwerkbeveiligingsgroep wordt gebruikt met elk virtueel subnet.
