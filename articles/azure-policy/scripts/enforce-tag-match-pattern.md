---
title: Azure beleid json steekproef - tag-matchpatroon afdwingen | Microsoft Docs
description: Dit beleid json-voorbeeld vereist dat de match-patroon voor de labelwaarde voldoen aan de resources.
...
---
# <a name="enforce-tag-match-pattern-for-tag-values"></a>Tag-matchpatroon voor labelwaarden afdwingen

Vereisen dat een tagwaarde voldoet aan een patroon overeen. Geef de toegestane patroon in de beleidsregel.
