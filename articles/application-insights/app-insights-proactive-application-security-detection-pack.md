...
Dit onderdeel vereist geen speciale instellingen, anders dan [configureren van uw app om het verzenden van telemetrie](https://docs.microsoft.com/en-us/azure/application-insights/app-insights-usage-overview).
