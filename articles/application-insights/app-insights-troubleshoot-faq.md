...
* Als u wilt een aangemelde gebruiker identificeren over machines en browsers, Voeg een aanroep naar [setAuthenticatedUserContect()](app-insights-api-custom-events-metrics.md#authenticated-users).
...
Elk item dat is transmmitted uitvoert een `itemCount` eigenschap die laat hoeveel oorspronkelijke gebeurtenissen dat het item zien vertegenwoordigt. Als u wilt nagaan steekproeven bij bewerking, kunt u deze query uitvoeren in Analytics:
