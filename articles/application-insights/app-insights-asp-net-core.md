...
2. Selecteer **bestand** > **nieuwe** > **Project** (Ctrl + Shift + N).
   ...
   ![Schermopname van Visual Studio-nieuw project-menu](./media/app-insights-asp-net-core/001-new-project.png)
...
3. Vouw **Visual C#** uit. Selecteer **.NET Core** > **ASP.NET Core-webtoepassing**. Voer een naam van het project en de naam van een oplossing en selecteer vervolgens **maken nieuwe Git-opslagplaats**.
   ...
   ![Schermopname van Visual Studio-wizard voor nieuw project](./media/app-insights-asp-net-core/002-asp-net-core-web-application.png)

4. Selecteer **.NET Core** > **ASP.NET Core 2.0** **webtoepassing** > **OK**.

    ![Schermopname van Visual Studio nieuwe project sjabloon selecteren](./media/app-insights-asp-net-core/003-web-application.png)
...
1. Uw app uitvoeren. Als u wilt uitvoeren van uw app, selecteer de **IIS Express** pictogram (![schermopname van Visual Studio IIS Express pictogram](./media/app-insights-asp-net-core/004-iis-express.png)).

2. Selecteer **weergave** > **andere Windows** > **Application Insights-zoekopdracht**.

   ![Schermopname van Visual Studio diagnostische hulpprogramma's voor selectie](./media/app-insights-asp-net-core/005-view-other-windows-search.png)
...
1. Selecteer **Project** > **Application Insights Telemetry toevoegen**. (Of u kunt met de rechtermuisknop op **Connected Services**, en selecteer vervolgens **Add Connected Service**.)
    ...
    ![Schermopname van Visual Studio-menu voor het selecteren van nieuw project](./media/app-insights-asp-net-core/007-project-add-telemetry.png)
...
2. Selecteer **aan de slag**. (Afhankelijk van uw versie van Visual Studio, de tekst kan verschillen. Sommige oudere versies hebben een **gratis starten** knop in plaats daarvan.)
    ...
    ![Schermopname van Application Insights knop aan de slag](./media/app-insights-asp-net-core/008-get-started.png)
...
1. Als u wilt uitvoeren van uw app, selecteer de ![Schermopname van Visual Studio IIS Express-pictogram](./media/app-insights-asp-net-core/004-iis-express.png) pictogram.

2. Kopieer de URL van de adresbalk van de browser. De URL heeft de indeling `http://localhost:<port number>`.

   ![Schermafbeelding van browser-URL in de adresbalk](./media/app-insights-asp-net-core/0013-copy-url.png)
...
1. Uw app uitvoeren. Als u wilt uitvoeren van uw app, selecteer de ![Schermopname van Visual Studio IIS Express-pictogram](./media/app-insights-asp-net-core/004-iis-express.png) pictogram.
...
4. Als de **overzicht** pagina in Applications Insights nog niet is geopend, zich in het menu van Visual Studio, selecteer **Project** > **Application Insights**  >  **Application Insights-Portal openen**. 
   ...
   ![Schermopname van het overzichtsvenster voor de](./media/app-insights-asp-net-core/0019-overview-updated.png)
...
![Schermafbeelding van NuGet afhankelijkheidsgrafiek voor Microsoft.AspNETCore.all](./media/app-insights-asp-net-core/013-dependency.png)
...
* [Verken Gebruikersstromen](app-insights-usage-flows.md) om te begrijpen hoe gebruikers navigeren via uw app.
...
* Gebruik [beschikbaarheidstests](app-insights-monitor-web-app-availability.md) om te controleren of uw app continu van over de hele wereld.
