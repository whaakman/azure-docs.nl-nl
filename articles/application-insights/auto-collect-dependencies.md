...
- Instellen van aangepaste afhankelijkheid bijhouden voor [.NET](app-insights-asp-net-dependencies.md).
- Instellen van aangepaste afhankelijkheid bijhouden voor [Java](app-insights-java-agent.md).
