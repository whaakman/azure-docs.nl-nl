...
[Azure PowerShell voor Sleutelkluis](https://docs.microsoft.com/powershell/module/azurerm.keyvault)
...
- [Aan de slag met Sleutelkluis in Node.js](https://azure.microsoft.com/resources/samples/key-vault-node-getting-started/)
