...
|----------|--------|--------|
|DataEncipherment|versleutelen, ontsleutelen| NB |
|DecipherOnly|ontsleutelen| NB  |
...
|EncipherOnly|encrypt| NB |
|KeyCertSign|Meld u aan, controleert u of|NB|
...
|Niet-afwijzing|Meld u aan, controleert u of| NB |
|crlsign|Meld u aan, controleert u of| NB |
