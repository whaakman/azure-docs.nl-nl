...
## [Lezen uit Key Vault - Node.js](quick-create-node.md)
# Zelfstudies
...
## Node.js
### [Key Vault-beheer](https://docs.microsoft.com/javascript/api/azure-arm-keyvault/)
### [Key Vault-clientbibliotheek](https://docs.microsoft.com/javascript/api/azure-keyvault/)
## Ontwikkelen
