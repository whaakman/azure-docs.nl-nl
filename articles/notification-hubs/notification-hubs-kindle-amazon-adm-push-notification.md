...
* Download de Android-SDK (als u Eclipse gebruikt) van de [Android-ontwikkelaarsportal](https://go.microsoft.com/fwlink/?LinkId=389797).
...
1. Maak in Eclipse een nieuw bestand met de naam `api_key.txt` in de mapassets van uw project.
