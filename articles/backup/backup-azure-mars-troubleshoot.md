...
| Foutdetails | Mogelijke oorzaken | Aanbevolen acties |
| ---     | ---     | ---    |      
| **Error** </br>*Instellen van de versleutelingssleutel voor veilige back-ups is mislukt. De huidige bewerking is mislukt vanwege een interne fout 'ongeldig invoer servicefout'. Probeer de bewerking na enige tijd opnieuw. Als het probleem zich blijft voordoen, neem contact op met Microsoft ondersteuning*. |Server is al geregistreerd met een andere kluis.| Hef de registratie van de server uit de kluis en Registreer het opnieuw.
