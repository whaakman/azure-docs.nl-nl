---
title: Azure Backup - Offline back-ups voor DPM en Azure Backup-Server | Microsoft Docs
...
---
# <a name="offline-backup-workflow-for-dpm-and-azure-backup-server"></a>Offline back-up-werkstroom voor DPM en de Azure Backup-Server
