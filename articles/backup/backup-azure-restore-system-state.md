...
13. Gebruik de volgende sectie op voor het voltooien van het herstelproces, [toepassen van de herstelde systeemstatus bestanden op een Windows-Server](#apply-restored-system-state-on-a-windows-server).
