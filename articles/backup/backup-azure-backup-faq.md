...
# Vragen over de Azure Backup-service
...
### Ik heb in een Backup-kluis een back-up gemaakt van mijn klassieke virtuele machines. Kan ik mijn virtuele machines migreren van de klassieke modus naar de Resource Manager-modus en ze beschermen in een Recovery Services-kluis?
...
### Van welke typen stations kan ik back-ups van bestanden en mappen maken? <br/>
...
### Wat is de maximale lengte voor een bestandspad dat met de Azure Backup-agent kan worden opgegeven als onderdeel van het Backup-beleid? <br/>
...
## Azure Backup-server en System Center Data Protection Manager
...
### Kan ik mijn DPM-server registreren voor meerdere kluizen? <br/>
...
### Welke versie van System Center Data Protection Manager wordt ondersteund? <br/>
...
### Ik heb de Azure Backup-agent geïnstalleerd om bestanden en mappen te beveiligen. Kan ik System Center DPM nu installeren voor samenwerking met de Azure Backup-agent om workloads van on-premises toepassingen of virtuele machines naar Azure te beveiligen? <br/>
...
### Werkt de Azure Backup-agent op een server die gegevensontdubbeling van Windows Server 2012 gebruikt? <br/>
...
### Kan ik de Backup-service zo configureren dat er een mail wordt verzonden als de back-uptaak mislukt? <br/>
...
### Gelden er limieten voor het moment waarop een back-uptaak kan worden gepland en voor het aantal keren?<br/>
...
### Waarom is de omvang van de gegevens die worden overgebracht naar de Recovery Services-kluis, kleiner dan de hoeveelheid gegevens waarvan ik een back-up heb gemaakt?<br/>
...
## Waar kan ik een back-up van maken?

<a id="which-operating-systems-do-azure-backup-support-br" class="xliff"></a>

### Welke besturingssystemen worden ondersteund door Azure Backup? <br/>
...
## Retentiebeleid en herstelpunten
...
### Is er een verschil tussen het retentie- of bewaarbeleid voor DPM en Windows Server of de Windows-client (dat wil zeggen op Windows Server zonder DPM)?<br/>
...
### Kan ik 'een back-up plannen' om 18:00 uur en voor het retentiebeleid een ander tijdstip opgeven?<br/>
...
### Als ik gegevens ga herstellen, betaal ik dan voor het uitgaande verkeer van Azure? <br/>
...
### Ik krijg een waarschuwing dat er geen Azure-back-ups zijn geconfigureerd voor deze server, terwijl ik wel een back-upbeleid heb geconfigureerd. <br/>
