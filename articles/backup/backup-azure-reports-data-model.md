...
| AlertStatus |Text |De status van de waarschuwing. Bijvoorbeeld: Active |
| AlertType |Text |Het type van de gegenereerde waarschuwing. Bijvoorbeeld back-up |
...
| EntityState |Text |Huidige status van het object met het back-upitem. Bijvoorbeeld actief, verwijderd |
| LastBackupDateTime |Date/Time |Tijdstip van laatste back-up voor geselecteerd back-upitem |
| LastBackupState |Text |Status van de laatste back-up voor het geselecteerde back-upitem. Bijvoorbeeld geslaagd, mislukt |
...
| BackupStorageDestination |Text |Doel van back-upopslag. Bijvoorbeeld Cloud, schijf  |
...
| JobStatus |Text |De status van de voltooide taak. Bijvoorbeeld voltooid, mislukt |
...
| BackupFrequency |Text |De frequentie waarmee back-ups worden uitgevoerd. Bijvoorbeeld dagelijks, wekelijks |
...
| MonthlyRetentionFormat |Text |Type configuratie voor maandelijkse retentie. Bijvoorbeeld dagelijks voor dag, wekelijks op basis van een week |
| MonthlyRetentionTimes |Text |De datum en tijd waarop de maandelijkse retentie is geconfigureerd |
| MonthlyRetentionWeeksOfTheMonth |Text |Weken van de maand waarin de maandelijkse retentie is geconfigureerd. Bijvoorbeeld eerste, laatste enz. |
...
| RetentionType |Text |Type Bewaar beleid. Bijvoorbeeld dagelijks, wekelijks, maandelijks, jaarlijks |
...
| YearlyRetentionFormat |Text |Type configuratie voor jaarlijkse retentie. Bijvoorbeeld dagelijks voor dag, wekelijks op basis van een week |
...
| YearlyRetentionWeeksOfTheMonth |Text |Weken van de maand waarin jaarlijks retentie is geconfigureerd. Bijvoorbeeld eerste, laatste enz. |
...
| PeriodOfTheDay |Text |De tijd periode van de dag. Bijvoorbeeld 12-3 AM |
