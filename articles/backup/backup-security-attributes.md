...
| Toegangsbeheer - autorisatie| Ja | Klanten die zijn gemaakt en ingebouwde RBAC-rollen worden gebruikt. Zie [Use Role-Based toegangsbeheer voor het beheren van Azure Backup-herstelpunten](/azure/backup/backup-rbac-rs-vault) voor meer informatie. |
