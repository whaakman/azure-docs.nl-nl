...
## <a name="error-the-agent-operation-failed-because-of-a-communication-error-with-the-dpm-agent-coordinator-service-on-server"></a>Fout: De agentbewerking is mislukt vanwege een communicatiefout met de service DPM Agent Coordinator op Server 

Volg deze [stappen voor probleemoplossing] (https://docs.microsoft.com/en-us/azure/backup/backup-azure-mabs-troubleshoot#registration-and-agent-related-issues) om dit probleem te verhelpen.

## <a name="error-setup-could-not-update-registry-metadata"></a>Fout: Setup kan de metagegevens van het register niet bijwerken
