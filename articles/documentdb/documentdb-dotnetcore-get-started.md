...
Wilt u een Xamarin iOS-, Android- of Forms-toepassing bouwen met de DocumentDB .NET Core-SDK? Zie [Mobiele Xamarin-toepassingen ontwikkelen met DocumentDB](documentdb-mobile-apps-with-xamarin.md).
