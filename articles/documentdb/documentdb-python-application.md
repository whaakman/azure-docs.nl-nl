...
> [!IMPORTANT]
> Als u Python 2.7 voor het eerst installeert, moet u in het scherm Customize Python 2.7.11 (Python 2.7.11 aanpassen) de optie **Add python.exe to Path** (Python.exe aan het pad toevoegen) selecteren.
> 
...
6. Over een paar seconden zal Visual Studio de publicatie van uw webtoepassing voltooien en een browser starten waarin u kunt zien hoe uw werk in Azure wordt uitgevoerd.
