...
![Diagram voor end-to-end](media/iot-hub-get-started-e2e-diagram/5.png)
...
2. Voer een unieke Taaknaam, Controleer of het abonnement, geeft u een resourcegroep en een locatie op, selecteer **vastmaken aan dashboard**, en klik vervolgens op **maken**.
   ...
   Het is raadzaam dat u de dezelfde locatie als die van uw resourcegroep selecteren. In dat geval helpt bij het verwerken van snelheid en worden de kosten van gegevensoverdracht.
...
2. Klik op **toepassingsinstellingen**, en klik vervolgens onder **App-instellingen**, voeg de volgende sleutel/waarde-paren toe:
   ...
   | Sleutel                                   | Waarde                                                        |
   |---------------------------------------|--------------------------------------------------------------|
   | Azure.IoT.IoTHub.ConnectionString     | Ontleend aan het iothub-explorer                                |
   | Azure.IoT.IoTHub.ConsumerGroup        | De naam van de consumergroep die u aan uw IoT-hub toevoegt  |

   ![Instellingen toevoegen aan uw web-app met sleutel/waarde-paren](media/iot-hub-live-data-visualization-in-web-apps/4_web-app-settings-key-value-azure.png)
...
3. Klik op **toepassingsinstellingen**onder **algemene instellingen**, in-/ uitschakelen de **Web sockets** optie en klik vervolgens op **opslaan**.
   ...
   ![Stel de Web sockets-optie](media/iot-hub-live-data-visualization-in-web-apps/10_toggle_web_sockets.png)
...
![De URL van uw web-app ophalen](media/iot-hub-live-data-visualization-in-web-apps/8_web-app-url-azure.png)
