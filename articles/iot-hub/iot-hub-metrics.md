...
|---|---|---|---|---|
|d2c.telemetry.ingress.allProtocol|Telemetrie-bericht verzenden pogingen|Aantal|Totaal|Aantal voor apparaat-naar-cloud-telemetrieberichten worden verzonden naar uw IoT-hub geprobeerd|
...
|c2d.Commands.egress.complete.Success|Opdrachten voltooid|Aantal|Totaal|Aantal opdrachten voor cloud-naar-apparaat is voltooid door het apparaat|
...
|d2c.telemetry.egress.Invalid|Ongeldige-berichten|Aantal|Totaal|Het aantal berichten niet worden bezorgd omdat ze niet compatibel met het eindpunt|
...
|d2c.endpoints.egress.eventHubs|Berichten in de Event Hub-eindpunten|Aantal|Totaal|Aantal keren dat berichten zijn geschreven naar de Event Hub-eindpunten|
...
|d2c.Twin.Read.failure|Twin leesbewerkingen van apparaten is mislukt|Aantal|Totaal|De telling van alle apparaat geïnitieerde twin leesbewerkingen mislukt.|
...
|d2c.Twin.update.Success|Geslaagde twin updates van apparaten|Aantal|Totaal|Het aantal updates van alle geslaagde twin apparaat gestart.|
|d2c.Twin.update.failure|Twin updates van apparaten is mislukt|Aantal|Totaal|De telling van alle apparaat geïnitieerde twin updates mislukt.|
...
|c2d.Twin.Read.Success|Geslaagde twin leest uit back-end|Aantal|Totaal|De telling van alle geslaagde back-end-geïnitieerde twin leest.|
...
|jobs.createTwinUpdateJob.failure|Mislukte bewerkingen voor het maken van twin taken bijwerken|Aantal|Totaal|De telling van alle mislukte twin update taken worden gemaakt.|
...
|jobs.cancelJob.success|Geslaagde taakannuleringen|Aantal|Totaal|De telling van alle geslaagde aanroepen naar een taak annuleren.|
|jobs.cancelJob.failure|Mislukte taakannuleringen|Aantal|Totaal|De telling van alle mislukte aanroepen voor een taak annuleren.|
