...
* **Plan**: Operatoren voor het maken van een schema voor de metagegevens van apparaten waarmee ze eenvoudig kunt inschakelen en nauwkeurig zoeken naar en richten op een groep apparaten voor bulksgewijze beheerbewerkingen. U kunt de apparaatdubbel gebruiken om de metagegevens van dit apparaat op te slaan in de vorm van tags en eigenschappen.
...
* **Configureren**: Vergemakkelijken bulksgewijze configuratiewijzigingen en firmware-updates op apparaten terwijl de status en beveiliging. Voer deze apparaatbeheerbewerkingen bulksgewijs uit met behulp van de gewenste eigenschappen of met rechtstreekse methoden en broadcast-taken.
...
* **Voortgang en status rapporteren**: De oplossing back-end wordt uitgevoerd apparaatdubbel-query's, in een set apparaten om te rapporteren over de status en voortgang van de acties die worden uitgevoerd op de apparaten.
