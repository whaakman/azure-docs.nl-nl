...
description: Instructiehandleiding voor Azure IoT Hub met C#. Gebruik Azure IoT Hub en C# in combinatie met de Azure IoT-SDK&quot;s voor het implementeren van een IoT-oplossing (Internet of Things).
services: iot-hub
