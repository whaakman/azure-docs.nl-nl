...
### <a name="method-invocation-for-iot-edge-modules"></a>De methodeaanroep voor rand van de IoT-modules
Preview aanroepen rechtstreekse methoden met een module-ID wordt ondersteund in de C#-SDK (beschikbaar [hier](https://www.nuget.org/packages/Microsoft.Azure.Devices/1.16.0-preview-004)).

Voor dit doel gebruiken de `ServiceClient.InvokeDeviceMethodAsync()` methode en geeft u de `deviceId` en `moduleId` als parameters.
