...
Aanroepen van directe methoden met een module-ID wordt ondersteund in de SDK voor C# (beschikbaar [hier](https://www.nuget.org/packages/Microsoft.Azure.Devices/)).
