...
2. Maak met een teksteditor een nieuw **AddTagsAndQuery.py** bestand.
...
4. Voeg de volgende code, vervang de tijdelijke aanduiding voor `[IoTHub Connection String]` en `[Device Id]` door de verbindingsreeks voor de IoT-hub en de apparaat-ID die u hebt gemaakt in de vorige secties.
...
5. Voeg de volgende code aan de **AddTagsAndQuery.py** bestand:
...
6. Voeg de volgende code toe aan het einde van **AddTagsAndQuery.py** voor het implementeren van de **iothub_service_sample_run** functie:
...
7. Voer de toepassing met:
    ...
    ![eerste query alle apparaten weergegeven in Redmond](./media/iot-hub-python-twin-getstarted/1-device-twins-python-service-sample.png)
...
4. Voeg de volgende code, vervang de tijdelijke aanduiding voor `[IoTHub Device Connection String]` door de verbindingsreeks voor de IoT hub-apparaat die u hebt gemaakt in de vorige secties.
...
5. Voeg de volgende code aan de **ReportConnectivity.py** bestand voor het implementeren van het apparaat dubbels functionaliteit:
...
6. Voeg de volgende code toe aan het einde van **ReportConnectivity.py** voor het implementeren van de **iothub_client_sample_run** functie:
...
7. Voer de apparaat-app:
    ...
    ![dubbele bijwerken](./media/iot-hub-python-twin-getstarted/2-python-client-sample.png)

8. Nu dat het apparaat heeft gemeld dat de gegevens over de connectiviteit, wordt deze weergegeven in beide query's. Ga terug en voer de query opnieuw uit:
