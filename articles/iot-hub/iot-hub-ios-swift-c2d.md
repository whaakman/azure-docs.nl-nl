...
* **voorbeeld-apparaat**, gemaakt in dezelfde app [Telemetrie verzenden vanaf een apparaat naar een IoT hub], die verbinding maakt met uw IoT-hub en cloud-naar-apparaat-berichten worden ontvangen.
...
Dit is de voorbeeld-apparaat die u in het artikel maakt [Telemetrie verzenden vanaf een apparaat naar een IoT hub]. Als u al dat deze worden uitgevoerd, kunt u deze sectie overslaan.
...
1. Haal de verbindingsreeks voor uw apparaat. U kunt deze tekenreeks kopiëren vanuit de Azure portal in de blade Apparaatdetails of ophalen met de volgende CLI-opdracht: 
...
1. Haal de serviceverbindingsreeks voor uw IoT-hub. U kunt deze tekenreeks van de Azure-portal kopiëren de **iothubowner** beleid in de **beleid voor gedeelde toegang** blade, haalt u deze met de volgende CLI-opdracht:  
...
2. In de **IoTHub-Service-clientvoorbeeld** app die wordt uitgevoerd op het gesimuleerde apparaat, geef de ID voor de IoT-apparaat dat u wilt een een bericht te verzenden. 
...
<!-- Links -->
[Telemetrie verzenden vanaf een apparaat naar een IoT hub]: quickstart-send-telemetry-ios.md
