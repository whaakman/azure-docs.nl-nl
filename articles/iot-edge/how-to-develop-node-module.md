...
1. In VS Code, gaat u naar de `deployment.template.json` bestand. Vervang de Node.js-module createOptions in **deployment.template.json** met onderstaande inhoud en sla dit bestand: 
    ```json
