...
Uw apparaat voorbereiden voor de IoT-Edge runtime-installatie, vervangen ```<release>``` met **16.04** of **18.04** die geschikt zijn voor uw versie van Ubuntu.
