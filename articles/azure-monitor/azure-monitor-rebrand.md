...
## <a name="consolidation-of-monitoring-services-into-azure-monitor"></a>Consolidatie van het bewaken van services in Azure Monitor
...
## <a name="log-analytics-redefinition"></a>Log Analytics herdefinitie
Log Analytics heeft een centrale rol gespeeld in het Azure management door het verzamelen van Telemetrie en andere gegevens uit een groot aantal bronnen en het leveren van een query taal en analytics-engine waarmee u inzicht in de werking van uw toepassingen en resources. Deze blijft in te vullen deze cruciale rol als een functie van Azure Monitor. Andere functies die werden beschouwd als onderdeel van Log Analytics, zoals agents en oplossingen wordt als functies van Azure Monitor worden verplaatst. De functionaliteit is niet veranderd dan potentiële verbeteringen hun ervaring in Azure portal.

## <a name="retirement-of-operations-management-suite-brand"></a>Buiten gebruik stellen van Operations Management Suite merk
