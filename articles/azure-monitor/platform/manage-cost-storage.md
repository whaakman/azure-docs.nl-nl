...
2. Klik in Azure Portal op **Alle services**. Typ in de lijst met resources **Log Analytics**. Als u begint te typen, wordt de lijst gefilterd op basis van uw invoer. Selecteer **Log Analytics**.<br><br> ![Azure Portal](media/manage-cost-storage/azure-portal-01.png)<br><br>  
3. In het deelvenster voor abonnementen van Log Analytics, selecteert u uw werkruimte en klik vervolgens op **gebruik en geraamde kosten** in het linkerdeelvenster.<br><br> ![Pagina gebruik en geschatte kosten](media/manage-cost-storage/usage-estimated-cost-dashboard-01.png)<br>
