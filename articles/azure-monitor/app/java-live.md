...
Als u een webtoepassing die al wordt uitgevoerd op uw Java EE-server hebt, kun u bewaking met [Application Insights](../../azure-monitor/app/app-insights-overview.md) zonder codewijzigingen of compileer uw project. Met deze optie krijgt u informatie over HTTP-aanvragen verzonden naar uw server, niet-verwerkte uitzonderingen en prestatiemeteritems.
