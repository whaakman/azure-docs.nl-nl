...
**ASP.NET-apps: Initialisatieprogramma, zodat de actieve TelemetryConfiguration laden**
...
**ASP.NET Core-apps: Initialisatieprogramma, zodat de TelemetryConfiguration laden**
