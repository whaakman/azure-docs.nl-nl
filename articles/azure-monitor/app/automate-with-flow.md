...
1. In de **frequentie** Schakel **dag**, en klik in de **Interval** Voer **1**.
    ...
    ![In het dialoogvenster van Microsoft Flow-trigger](./media/automate-with-flow/flow1.png)
...
1. Klik op **Preview query uitvoeren op Azure Application Insights - Analytics visualiseren**.
    ...
    ![Analytics-query-venster worden uitgevoerd](./media/automate-with-flow/flow2.png)
...
![Toepassings-ID in de Azure-portal](./media/automate-with-flow/appid.png) 

- Geef een naam voor de verbinding, samen met de toepassing-ID en API-sleutel.

    ![Venster van de verbinding met Microsoft Flow](./media/automate-with-flow/flow3.png)
...
- De volgende analytische query toevoegen en selecteer vervolgens het grafiektype voor HTML-tabel. 
    ...
    ![Analytics-queryvenster configuratie](./media/automate-with-flow/flow4.png)
...
1. Klik op **Office 365 Outlook - een e-mail verzenden**.
    ...
    ![Selectievenster voor Office 365 Outlook](./media/automate-with-flow/flow2b.png)
...
1. In de **een e-mailbericht verzenden** venster de volgende handelingen uit:
   ...
   d. Klik op **geavanceerde opties weergeven**.
    ...
    ![Office 365 Outlook-configuratie](./media/automate-with-flow/flow5.png)
...
1. Op het menu voor dynamische inhoud het volgende doen:
    ...
    ![Venster voor Office 365 e-configuratie](./media/automate-with-flow/flow7.png)
...
- In de **Stroomnaam** vak, een naam voor uw stroom toevoegen en klik vervolgens op **stroom maken**.
    ...
    ![Venster stromen maken](./media/automate-with-flow/flow8.png)
