...
- U bent lid van de **[eigenaar](https://docs.microsoft.com/en-us/azure/role-based-access-control/built-in-role.md#owner)** -rol op de AKS-cluster-bron. 
