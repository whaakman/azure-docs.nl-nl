...
2. Op de **functie-App** blade, voer de volgende waarden en selecteer vervolgens **OK** om de app te maken:
    ...
    |**Hosting-Plan**|Verbruiksabonnement| Het type plan uw app functie gebruikt. Opties zijn verbruik of Azure App Service-abonnement. |
    |**Locatie**|VS - midden| De regio waarin u de functie-app maken.|
    |**Storage-Account**|{autogenerated}| Het opslagaccount waarvoor Azure Functions voor opslagaccounts voor algemeen gebruik.|
