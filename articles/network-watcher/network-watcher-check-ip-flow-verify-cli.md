...
Voer de `az network watcher test-ip-flow` cmdlet voor het testen van het verkeer. In dit voorbeeld is het eerste IP-adres van de eerste NIC wordt gebruikt.
