# [Documentatie voor Azure Network Watcher](index.md)
...
## Pakketopname
### [Afwijkingen vinden](network-watcher-deep-packet-inspection.md)
### [Proactieve netwerkbewaking met Azure Functions](network-watcher-alert-triggered-packet-capture.md)
...
### [Grafana gebruiken](network-watcher-nsg-grafana.md)
### [Graylog gebruiken](network-watcher-analyze-nsg-flow-logs-graylog.md)
## [De relatieve latentie tussen een locatie en een Azure-regio bepalen](view-relative-latencies.md)
