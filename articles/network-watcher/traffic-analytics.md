...
U kunt traffic analytics gebruiken voor nsg's in een van de volgende regio's: West-Centraal VS, VS-Oost, VS-Oost 2, Noord-centraal VS, Zuid-centraal VS, VS-midden, VS West, VS-West 2, West-Europa, Noord-Europa, West VK, VK Zuid, Australië-Oost, Australië-Zuidoost, en Zuidoost-Azië. De log analytics-werkruimte moet bestaan in de West-Centraal VS, VS-Oost, West-Europa, VK Zuid, Australië-Zuidoost of de regio Zuidoost-Azië.
