...
![Overzicht van methoden voor toegang tot Azure Monitor voor containers](./media/monitoring-container-insights-overview/azmon-containers-views.png)
...
Om te beginnen met controleren van uw AKS-cluster, Bekijk [hoe zorgen voor onboarding Azure controleren voor containers](monitoring-container-insights-onboard.md) om te begrijpen van de vereisten en de beschikbare methoden bewaking wilt inschakelen.  