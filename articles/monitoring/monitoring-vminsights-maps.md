...
![Eigenschappen van de computer](./media/monitoring-vminsights-maps/properties-pane-01.png)
...
![Lijst met zoeken in het deelvenster met eigenschappen](./media/monitoring-vminsights-maps/properties-pane-logs-01.png)
...
![Machine-waarschuwingen in het deelvenster met eigenschappen](./media/monitoring-vminsights-maps/properties-pane-alerts-01.png)
...
Zie voor meer informatie over Azure-waarschuwingen en het maken van het waarschuwingsregels [Unified waarschuwingen in Azure Monitor](../monitoring-and-diagnostics/monitoring-overview-unified-alerts.md)
...
![Network connectivity grafieken deelvenster Voorbeeld](./media/monitoring-vminsights-maps/map-group-network-conn-pane-01.png)  
...
![Voorbeeld van een mislukte verbinding op de kaart](./media/monitoring-vminsights-maps/map-group-failed-connection-01.png)
...
![Voorbeeld van de client-groepen op de kaart](./media/monitoring-vminsights-maps/map-group-client-groups-01.png)
...
![Client groep IP-adres lijst voorbeeld op de kaart](./media/monitoring-vminsights-maps/map-group-client-group-iplist-01.png)
...
![Voorbeeld van de server-poort-groep op de kaart](./media/monitoring-vminsights-maps/map-group-server-port-groups-01.png)  
...
![Direct overzicht van de toewijzing van VM](./media/monitoring-vminsights-maps/map-direct-vm-01.png)
