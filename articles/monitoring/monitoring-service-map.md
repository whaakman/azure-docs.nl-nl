...
![Deelvenster van de prestaties van de computer](media/monitoring-service-map/machine-performance.png)
...
Serviceoverzicht computer- en inventarisgegevens is beschikbaar voor [zoeken](../log-analytics/log-analytics-log-searches.md) in Log Analytics. U kunt deze gegevens toepassen op scenario's met migratieplanning, analyse, detectie en het oplossen van prestaties op aanvraag.
...
Meer informatie over [zoekopdrachten](../log-analytics/log-analytics-log-searches.md) in Log Analytics om gegevens die worden verzameld door Serviceoverzicht te halen.
