...
![Machinegroep](media/monitoring-service-map/machine-group.png) de machines die deel uitmaken van de groep worden beschreven in wit in de kaart.
...
![Filter-groep](media/monitoring-service-map/machine-groups-filter.png)

Wanneer **alle processen** is geselecteerd, de kaart bevat alle processen en verbindingen op elk van de machines in de groep.

![Alle Machinegroep verwerkt](media/monitoring-service-map/machine-groups-all.png)
...
![Machinegroep gefilterd processen](media/monitoring-service-map/machine-groups-filtered.png)
...
![Machine uit groep verwijderen](media/monitoring-service-map/machine-groups-remove.png)
...
| ![Appserver](media/monitoring-service-map/role-application-server.png) | Toepassingsserver |
...
![Rolpictogrammen](media/monitoring-service-map/role-icons.png)
...
![Serverpoort groepen](media/monitoring-service-map/server-port-groups.png)
...
![Samenvattingsvenster machine](media/monitoring-service-map/machine-summary.png)
...
![Deelvenster machine-eigenschappen](media/monitoring-service-map/machine-properties.png)
...
![Deelvenster Eigenschappen verwerken](media/monitoring-service-map/process-properties.png)
...
![Machine servicedesk deelvenster](media/monitoring-service-map/service-desk.png)
...
![Machine prestaties deelvenster](media/monitoring-service-map/machine-performance.png)
...
Zie de [probleemoplossing sectie van het document Serviceoverzicht configureren]( monitoring-service-map-configure.md#troubleshooting).
