...
- Oplossingstargeting geldt alleen voor oplossingen die worden geleverd door Microsoft.  Dit geldt niet voor oplossingen [die zijn gemaakt door uzelf of partners](monitoring-solutions-creating.md).
...
- Meer informatie over oplossingen voor beheer, inclusief de oplossingen die kunnen worden geïnstalleerd in uw omgeving op [oplossingen voor Azure Log Analytics toevoegen aan uw werkruimte](monitoring-solutions.md).
