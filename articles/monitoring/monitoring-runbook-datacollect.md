...
- [Log Analytics-werkruimte](../log-analytics/log-analytics-get-started.md).
...
![Runbook bewerken](media/monitoring-runbook-datacollect/edit-runbook.png)
...
![Runbook-test](media/monitoring-runbook-datacollect/test-runbook.png)
...
4. Zorg ervoor dat de uitvoer naar Log Analytics eventuele fouten niet wordt weergegeven in de post-opdracht.  U hebt een bericht dat lijkt op het volgende.
    ...
    ![Post-uitvoer](media/monitoring-runbook-datacollect/post-output.png)

## <a name="5-verify-records-in-log-analytics"></a>5. Controleer de records in Log Analytics
Zodra het runbook in de test is voltooid en u gecontroleerd dat de uitvoer is ontvangen, kunt u controleren dat de records zijn gemaakt met behulp van een [zoeken in Logboeken in Log Analytics](../log-analytics/log-analytics-log-searches.md).

![De uitvoer van](media/monitoring-runbook-datacollect/log-output.png)
...
![Runbook publiceren](media/monitoring-runbook-datacollect/publish-runbook.png)
...
![Logboekregistratie en tracering](media/monitoring-runbook-datacollect/logging.png)
...
![Runbook plannen](media/monitoring-runbook-datacollect/schedule-runbook.png)
...
Wanneer een runbook wordt gestart, [wordt een taak gemaakt](../automation/automation-runbook-execution.md) en eventuele uitvoer in het logboek geregistreerd.  Dit zijn in feite dezelfde taken die het runbook worden verzameld.  U kunt controleren of dat het runbook wordt gestart zoals verwacht door het controleren van de taken voor het runbook nadat de begintijd voor de planning is verstreken.

![Taken](media/monitoring-runbook-datacollect/jobs.png)
...
5. Ga naar de onderkant vinden een vermelding die vergelijkbaar is met de onderstaande afbeelding.<br>![Uitgebreid](media/monitoring-runbook-datacollect/verbose.png)
