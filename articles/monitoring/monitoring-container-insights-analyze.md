...
Zie voor meer informatie over het inschakelen van Azure Monitor voor containers [ingebouwde Azure-Monitor voor containers](monitoring-container-insights-onboard.md).
...
![Voorbeeld van een cluster met meerdere dashboard Azure Monitor](./media/monitoring-container-insights-analyze/azmon-containers-multiview.png)
...
![Voorbeeld van de prestatiegrafieken weergegeven op het tabblad Cluster](./media/monitoring-container-insights-analyze/containers-cluster-perfview.png)
...
![Voorbeeld van Kubernetes perspectieven het deelvenster met eigenschappen](./media/monitoring-container-insights-analyze/perspectives-preview-pane-01.png)
...
![Voorbeeld met behulp van het filter verfijnen resultaten](./media/monitoring-container-insights-analyze/add-filter-option-01.png)
...
![Percentiel selectie voor het filteren van gegevens](./media/monitoring-container-insights-analyze/containers-metric-percentile-filter.png)
...
![Totaliseren van containers per knooppunt voorbeeld](./media/monitoring-container-insights-analyze/containers-nodes-containerstotal.png)
...
![Selecteer controllers weergeven](./media/monitoring-container-insights-analyze/containers-controllers-tab.png)
...
| Pictogram | Status | 
|--------|-------------|
| ![Pictogram voor actieve status gereed](./media/monitoring-container-insights-analyze/containers-ready-icon.png) | Wordt uitgevoerd (klaar)|
| ![In afwachting van ' of ' onderbroken statuspictogram](./media/monitoring-container-insights-analyze/containers-waiting-icon.png) | In afwachting van ' of ' onderbroken|
| ![De laatste keer doorgegeven met statuspictogram](./media/monitoring-container-insights-analyze/containers-grey-icon.png) | Laatst gerapporteerd uitgevoerd maar meer dan 30 minuten nog niet is gereageerd|
| ![Geslaagde statuspictogram](./media/monitoring-container-insights-analyze/containers-green-icon.png) | Is gestopt of niet stoppen|
...
![Selecteer containers weergeven](./media/monitoring-container-insights-analyze/containers-containers-tab.png)
...
| ![Pictogram voor actieve status gereed](./media/monitoring-container-insights-analyze/containers-ready-icon.png) | Wordt uitgevoerd (klaar)|  
| ![In afwachting van ' of ' onderbroken statuspictogram](./media/monitoring-container-insights-analyze/containers-waiting-icon.png) | In afwachting van ' of ' onderbroken|  
| ![De laatste keer doorgegeven met statuspictogram](./media/monitoring-container-insights-analyze/containers-grey-icon.png) | Laatst uitgevoerd gemeld, maar nog niet is gereageerd in meer dan 30 minuten|  
| ![Beëindigde statuspictogram](./media/monitoring-container-insights-analyze/containers-terminated-icon.png) | Is gestopt of niet stoppen|  
| ![Pictogram van de status mislukt](./media/monitoring-container-insights-analyze/containers-failed-icon.png) | Status mislukt |  
...
![Gegevens analyseren in Log Analytics](./media/monitoring-container-insights-analyze/container-health-log-search-example.png)   
