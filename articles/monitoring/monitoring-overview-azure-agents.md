...
Gegevens kunnen ook worden doorgestuurd naar [Application Insights](../application-insights/app-insights-cloudservices.md), [Log Analytics](../log-analytics/log-analytics-queries.md), of op niet-Azure-services met behulp van [Event Hub](../event-hubs/event-hubs-about.md). 
