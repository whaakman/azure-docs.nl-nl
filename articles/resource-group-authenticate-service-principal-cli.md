...
1. Sign in to your account.
        ...
        azure login
2. Create a service principal for your application. Provide a display name, the URI to a page that describes your application, the URIs that identify your application, and the password for your application identity. This command creates both the AD application and the service principal.
...
3. Grant the service principal permissions on your subscription. In this example, you add the service principal to the **Reader** role, which grants permission to read all resources in the subscription. For other roles, see [RBAC: Built-in roles](active-directory/role-based-access-built-in-roles.md). For the **ServicePrincipalName** parameter, provide the **ObjectId** that you used when creating the application. 
...
2. Log in as the service principal.
...
4. Sign in to your account.
        ...
        azure config mode arm
        azure login
5. Create a service principal for your application. Provide a display name, the URI to a page that describes your application, the URIs that identify your application, and the certificate data you copied. This command creates both the AD application and the service principal.
     ...
     The new service principal is returned. The Object Id is needed when granting permissions.
        ...
        data:                      https://www.contoso.org/example
        info:    ad sp create command OK
6. Grant the service principal permissions on your subscription. In this example, you add the service principal to the **Reader** role, which grants permission to read all resources in the subscription. For other roles, see [RBAC: Built-in roles](active-directory/role-based-access-built-in-roles.md). For the **ServicePrincipalName** parameter, provide the **ObjectId** that you used when creating the application. 
