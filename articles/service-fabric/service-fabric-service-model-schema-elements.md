...
Gebruikt om te bepalen welke knooppunten in het cluster een service kunt uitvoeren op. Een sleutel-waardepaar waarin de naam van de eigenschap knooppunt en de vereisten voor de waarde voor services worden beschreven. Afzonderlijke instructies kunnen worden gegroepeerd samen met eenvoudige Booleaanse logica voor het maken van de benodigde beperking. Bijvoorbeeld ' (FirmwareVersion > 12 & & InDMZ == True) '.
