...
Installeer zo nodig [Azure CLI 2.0](/en-us/cli/azure/install-azure-cli?view=azure-cli-latest).
...
|---|---|
| [az sf cluster create](https://docs.microsoft.com/cli/azure/sf/cluster?view=azure-cli-latest#az_sf_cluster_create) | Hiermee wordt een nieuw Service Fabric-cluster gemaakt.  |
