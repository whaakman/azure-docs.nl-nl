...
> [!Note]
> Clusters die worden uitgevoerd op een betrouwbaarheidslaag Brons kunnen u alleen testwerkbelastingen uitvoeren. Als u problemen met een cluster waarop Brons betrouwbaarheid ondervindt, wordt het ondersteuningsteam van Microsoft helpt u bij het oplossen van het probleem, maar wordt niet een analyses van hoofdoorzaken uitvoeren. Raadpleeg [de betrouwbaarheidskenmerken van de van het cluster](https://docs.microsoft.com/azure/service-fabric/service-fabric-cluster-capacity#the-reliability-characteristics-of-the-cluster) voor meer informatie.
>
> Raadpleeg voor meer informatie over wat vereist voor een productieklaar-cluster is, de [productie gereedheid controlelijst](https://docs.microsoft.com/azure/service-fabric/service-fabric-production-readiness-checklist).
