...
| list | Namen van alle waarden van de de opgegeven geheime resource. |
| Show | De waarde van een opgegeven versie van een geheime resource ophalen. |
