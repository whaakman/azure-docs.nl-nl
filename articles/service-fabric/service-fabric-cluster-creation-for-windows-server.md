...
> [!NOTE]
> The deployment logs are available locally on the VM/Machine that you ran the CreateServiceFabricCluster Powershell on. They are in a subfolder called "DeploymentTraces" under the folder where you ran the Powershell command. Also to see whether Service Fabric was deployed correctly to a machine, you can find the installed files in the C:\ProgramData directory and the FabricHost.exe and Fabric.exe processes can be seen running in Task Manager.
> 
> 
...
2. Number of ServiceTypes
3. Number of Applications
4. Number of ApplicationUpgrades
5. Number of FailoverUnits
6. Number of InBuildFailoverUnits
7. Number of UnhealthyFailoverUnits
8. Number of Replicas
9. Number of InBuildReplicas
10. Number of StandByReplicas
11. Number of OfflineReplicas
12. CommonQueueLength
13. QueryQueueLength
14. FailoverUnitQueueLength
15. CommitQueueLength
16. Number of Nodes
17. IsContextComplete: True/False
18. ClusterId: This is a GUID randomly generated for each cluster
19. ServiceFabricVersion
20. IP address of the VM/Machine from which the telemetry is uploaded
