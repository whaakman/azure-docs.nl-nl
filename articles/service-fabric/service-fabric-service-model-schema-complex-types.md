...
Een standaardgebruikersaccount opgeven voor alle pakketten van de service-code dat foutenrapporten beschikt over een specifieke RunAsPolicy is gedefinieerd in de sectie ServiceManifestImport.
|Kenmerk|Waarde|
|---|---|
...
|Kenmerk|Waarde|
|---|---|
|content|element(en) 3, 1 of meer kenmerken|
|gedefinieerd|wereldwijd|
...
|Kenmerk|Waarde|
|---|---|
|content|element(en) 9, 5 kenmerken|
|gedefinieerd|wereldwijd|
...
De isolatiemodus voor de container. Geldige waarden zijn standaard, verwerken of Hyper-v (alleen ondersteund voor Windows-containers) op Windows 10-hosts, alleen Hyper-V-isolatiemodus wordt ondersteund, zodat de container wordt uitgevoerd in Hyper-V-isolatiemodus, ongeacht de instelling voor de isolatie-modus.
|Kenmerk|Waarde|
|---|---|
|naam|Isolatie|
|Gebruik|optioneel|
...
NetworkType. Momenteel wordt alleen ondersteund type is 'Geopend'.
|Kenmerk|Waarde|
|---|---|
|naam|NetworkType|
|Gebruik|vereist|
...
|Kenmerk|Waarde|
|---|---|
|content|3 element(en), 10 kenmerken|
|gedefinieerd|wereldwijd|
...
#### <a name="port"></a>Poort
De poort zal worden overschreven in de Service Manifest
|Kenmerk|Waarde|
|---|---|
|naam|Poort|
|type|xs:String|
...
Het protocol voor het eindpunt. HTTPS-eindpunten moeten ook beschikken over een EndpointCertificate en een EndpointBindingPolicy gedeclareerd in het toepassingsmanifest. Het protocol kan niet worden gewijzigd verderop in de upgrade van een toepassing. 
|Kenmerk|Waarde|
|---|---|
|naam|Protocol|
|type|xs:String|
...
|Kenmerk|Waarde|
|---|---|
|content|18 element(en), 0 of meer kenmerken|
|gedefinieerd|wereldwijd|
...
|Kenmerk|Waarde|
|---|---|
|content|element(en) van 0, 9 kenmerken|
|gedefinieerd|wereldwijd|
...
De rechten te verlenen, standaard-lezen is.
|Kenmerk|Waarde|
|---|---|
|naam|GrantRights|
...
Het type resource, gedefinieerd in het servicemanifest eindpunt of certificaat.
|Kenmerk|Waarde|
|---|---|
|naam|ResourceType|
|Gebruik|optioneel|
...
|Kenmerk|Waarde|
|---|---|
|content|element(en) van 7, 0 of meer kenmerken|
|gedefinieerd|wereldwijd|
...
|Kenmerk|Waarde|
|---|---|
|content|8 element(en), 4 of meer kenmerken|
|gedefinieerd|wereldwijd|
...
Hiermee geeft u het maximumpercentage verdragen van beschadigde services voordat de toepassing als slecht beschouwd. Percentage standaard: 0.
|Kenmerk|Waarde|
|---|---|
...
Hiermee geeft u het maximumpercentage verdragen van beschadigde partities voordat een service als slecht beschouwd. Percentage standaard: 0.
|Kenmerk|Waarde|
|---|---|
...
Hiermee geeft u het maximumpercentage verdragen van replica's beschadigd voordat een partitie als slecht beschouwd. Percentage standaard: 0.
|Kenmerk|Waarde|
|---|---|
