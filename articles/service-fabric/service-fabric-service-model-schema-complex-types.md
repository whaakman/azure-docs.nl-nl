...
Voer een container met interactieve vlag is ingeschakeld. Geldige waarden zijn waar/onwaar. ONWAAR standaard.
|Kenmerk|Waarde|
|---|---|
|naam|RunInteractive|
|Gebruik|optioneel|
...
#### <a name="name"></a>Naam
Een unieke id voor de metriek binnen het cluster uit het perspectief van de Cluster Resource Manager.
|Kenmerk|Waarde|
|---|---|
|naam|Naam|
|Gebruik|vereist|
