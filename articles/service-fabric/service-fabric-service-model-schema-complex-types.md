...
#### <a name="name"></a>Naam
De naam van de toepassing moet worden gemaakt.
|Kenmerk|Waarde|
|---|---|
|naam|Naam|
|type|xs:String|
...
Hiermee geeft u op of op dezelfde manier behandelen waarschuwing health als fouten tijdens de statusevaluatie. Standaard: false.
|Kenmerk|Waarde|
|---|---|
...
Hiermee geeft u het maximale percentage verdragen geïmplementeerde toepassingen die beschadigd worden kunnen voordat de toepassing wordt beschouwd als fout. Dit wordt berekend door het aantal beschadigde geïmplementeerde toepassingen delen via het aantal knooppunten dat de toepassingen die momenteel zijn geïmplementeerd op in het cluster. De berekening rondt af naar boven op een storing op een klein aantal knooppunten tolereren. Percentage standaard: 0.
|Kenmerk|Waarde|
|---|---|
...
|Kenmerk|Waarde|
|---|---|
|content|4-elementen, kenmerken 1|
|gedefinieerd|Globaal|
...
De versie van het document ApplicationInstance.
|Kenmerk|Waarde|
|---|---|
|naam|Versie|
|type|xs:int|
...
|Kenmerk|Waarde|
|---|---|
|content|9-elementen, kenmerken 0|
|gedefinieerd|Globaal|
...
Waarde van deze inhoud ApplicationPackage
|Kenmerk|Waarde|
|---|---|
...
|Kenmerk|Waarde|
|---|---|
|content|4-elementen, kenmerken 3|
|gedefinieerd|Globaal|
...
#### <a name="version"></a>Versie
gebruiker gedefinieerde versietekenreeks voor het cluster manifest-document.
|Kenmerk|Waarde|
|---|---|
|naam|Versie|
|Gebruik|vereist|
...
|Kenmerk|Waarde|
|---|---|
|content|3-elementen, kenmerken 1|
|gedefinieerd|Globaal|
...
Hiermee wordt aangegeven als de inhoud van dit codepakket worden gedeeld door andere code-pakketten. Indien waar, voor een upgrade van dit codepakket, worden alle pakketten van de code wordt opnieuw gestart. Dit kenmerk wordt momenteel niet ondersteund en de waarde wordt genegeerd.
|Kenmerk|Waarde|
|---|---|
|naam|IsShared|
|type|xs:Boolean|
...
#### <a name="name"></a>Naam
De naam van het configuratiepakket in de service manifest waarin de instelling(en) moet worden overschreven.
|Kenmerk|Waarde|
|---|---|
|naam|Naam|
|Gebruik|vereist|
...
|Kenmerk|Waarde|
|---|---|
|content|0-elementen, kenmerken 8|
|gedefinieerd|Globaal|
...
De naam van het archief voor de X509 certificaat.
|Kenmerk|Waarde|
|---|---|
|naam|X509StoreName|
|type|xs:String|
...
De naam van de gegevenspakket met het certificaatbestand.
|Kenmerk|Waarde|
|---|---|
|naam|DataPackageRef|
|type|xs:String|
...
De versie van gegevenspakket met het certificaatbestand.
|Kenmerk|Waarde|
|---|---|
...
Wachtwoord en persoonlijke sleutel voor het certificaat.
|Kenmerk|Waarde|
|---|---|
|naam|Wachtwoord|
|type|xs:String|
...
#### <a name="name"></a>Naam
ID voor de specifieke certificaatgegevens. Deze naam wordt gebruikt voor het instellen van de omgevingsvariabele in de container.
|Kenmerk|Waarde|
|---|---|
|naam|Naam|
|type|xs:String|
...
Als de container heeft statuscontrole ingeschakeld en docker rapporten health_status gebeurtenis voor deze container, Service Fabric worden opgenomen als onderdeel van system health gerapporteerd. Wanneer health_status slecht is rapporteert Service Fabric een waarschuwing. Deze waarde is standaard ingesteld op true.
|Kenmerk|Waarde|
|---|---|
...
Als de container heeft statuscontrole ingeschakeld en docker rapporten health_status gebeurtenis voor deze container, opnieuw Service Fabric de container wanneer health_status gemeld door docker beschadigd is.
...
|Kenmerk|Waarde|
|---|---|
|content|9-elementen, kenmerken 5|
|gedefinieerd|Globaal|
...
De isolatiemodus voor de container. Geldige waarden zijn standaard, proces of Hyper-v (alleen ondersteund voor Windows-containers) op Windows 10-hosts, alleen isolatiemodus van Hyper-V wordt ondersteund, zodat de container wordt uitgevoerd in de isolatiemodus Hyper-V ongeacht de instelling van de isolatie-modus.
|Kenmerk|Waarde|
|---|---|
|naam|Isolatie|
|Gebruik|optioneel|
...
Het aantal containers achterlaat container herhaaldelijk matrijzen. Dit is standaard ingesteld op 0 dus geen containers worden achtergelaten.
|Kenmerk|Waarde|
|---|---|
...
Voer een container met interactieve vlag is ingeschakeld. Geldige waarden zijn waar/onwaar. Standaard False.
|Kenmerk|Waarde|
|---|---|
|naam|RunInteractive|
|Gebruik|optioneel|
...
NetworkType. Momenteel wordt alleen ondersteund type is 'Open'.
|Kenmerk|Waarde|
|---|---|
|naam|NetworkType|
|Gebruik|vereist|
...
De locatie die de bron is toegewezen aan in de actieve container. De bestemming kan dus een locatie die al in de container bestaat niet.
|Kenmerk|Waarde|
|---|---|
|naam|Doel|
|Gebruik|vereist|
...
#### <a name="driver"></a>Stuurprogramma
De naam van het stuurprogramma voor de volume-invoegtoepassing voor Azure Files is 'sfazurefile'.
|Kenmerk|Waarde|
|---|---|
|naam|Stuurprogramma|
|Gebruik|optioneel|
...
|Kenmerk|Waarde|
|---|---|
|content|3-elementen, kenmerken 10|
|gedefinieerd|Globaal|
...
Niet-ondersteund, niet gebruikt. Hiermee definieert u de isolatie-beleid voor de niet-beheerde dll's en beheerde assembly's in de DllHost geladen. 
|Kenmerk|Waarde|
|---|---|
...
Stuurprogramma-opties worden doorgegeven aan het stuurprogramma. De volume-invoegtoepassing van Azure-bestanden ondersteunt de volgende stuurprogrammaopties: sharenaam (de Azure-bestanden bestandsshare met het volume voor de container), storageAccountName (de Azure storage-account dat de bestandsshare Azure-bestanden bevat), () storageAccountKey Toegangssleutel voor de Azure storage-account met de bestandsshare Azure-bestanden).
...
#### <a name="name"></a>Naam
De naam van de optie stuurprogramma. 
|Kenmerk|Waarde|
|---|---|
|naam|Naam|
|type|xs:String|
...
De waarde van de optie stuurprogramma. 
|Kenmerk|Waarde|
|---|---|
|naam|Waarde|
|type|xs:String|
...
De naam van het eindpunt, moet worden gedeclareerd in de bronnensectie van het servicemanifest.  Wanneer u HTTPS gebruikt, gebruik niet dezelfde poort en certificaat voor andere service-exemplaren (onafhankelijk van de toepassing) geïmplementeerd op hetzelfde knooppunt. Upgraden van twee verschillende services met behulp van dezelfde poort in verschillende toepassingsexemplaren leidt tot een upgrade mislukt.
|Kenmerk|Waarde|
|---|---|
|naam|EndpointRef|

#### <a name="certificateref"></a>CertificateRef
De naam van het certificaat van het eindpunt is gedeclareerd in de sectie certificaten om terug te keren naar de client. 
|Kenmerk|Waarde|
|---|---|
|naam|CertificateRef|
|Gebruik|vereist|
...
Het protocol voor het eindpunt. HTTPS-eindpunten moeten ook beschikken over een EndpointCertificate en een EndpointBindingPolicy gedeclareerd in het toepassingsmanifest. Het protocol kan niet worden gewijzigd later in een upgrade van de toepassing. 
|Kenmerk|Waarde|
|---|---|
|naam|Protocol|
|type|xs:String|
...
#### <a name="type"></a>Type
Het type van het eindpunt.  Invoereindpunten worden gebruikt voor de poort voor de buitenwereld interne eindpunten worden gebruikt voor communicatie binnen een toepassing.
|Kenmerk|Waarde|
|---|---|
|naam|Type|
|type|xs:String|
...
Het achtervoegsel pad.  Bijvoorbeeld: "/ myapp1 '.
|Kenmerk|Waarde|
|---|---|
|naam|PathSuffix|
|Gebruik|optioneel|
...
#### <a name="codepackageref"></a>CodePackageRef
De naam van de code pakket die door dit eindpunt wordt gebruikt.
|Kenmerk|Waarde|
|---|---|
|naam|CodePackageRef|
|Gebruik|optioneel|
...
#### <a name="port"></a>Poort
De poort wordt vervangen door een bepaald door de Microsoft Azure Service Fabric na de registratie met Http.sys of BFE poort.
|Kenmerk|Waarde|
|---|---|
|naam|Poort|
...
True als het uitvoerbare bestand buiten het toepassingspakket is. Controle van programma's bestaan in het toepassingspakket is overgeslagen.
|Kenmerk|Waarde|
|---|---|
...
|Kenmerk|Waarde|
|---|---|
|content|0-elementen, kenmerken 5|
|gedefinieerd|Globaal|
...
Dit wordt alleen gebruikt als referentie X509 gebruikt. Hiermee geeft u het certificaat door de naam of de vingerafdruk van het zoeken 
|Kenmerk|Waarde|
|---|---|
|naam|X509FindType|
...
#### <a name="x509findvalue"></a>X509FindValue
Dit wordt alleen gebruikt als referentie X509 gebruikt. Dit is de daadwerkelijke naam of de vingerafdruk van het certificaat.
|Kenmerk|Waarde|
|---|---|
|naam|X509FindValue|
|Gebruik|vereist|
...
|Kenmerk|Waarde|
|---|---|
|content|18-elementen, kenmerken 0|
|gedefinieerd|Globaal|
...
Het IP-adres of de FQDN van de computer waarop u dit knooppunt plaatsen.
|Kenmerk|Waarde|
|---|---|
...
#### <a name="nodetyperef"></a>nodeTypeRef
Naam van de gedefinieerd in de sectie NodeTypes nodetype. 
|Kenmerk|Waarde|
|---|---|
|naam|nodeTypeRef|
|type|xs:String|
...
Hiermee geeft u op of het wachtwoord versleuteld of niet-tekst is.
|Kenmerk|Waarde|
|---|---|
...
#### <a name="name"></a>Naam
Naam van de installatiekopie van de container.
|Kenmerk|Waarde|
|---|---|
|naam|Naam|
|type|xs:String|
...
Versie van het besturingssysteem maken. Bijvoorbeeld, is de build-versie van Windows Server versie 1709 16299.
|Kenmerk|Waarde|
|---|---|
...
Naam van de rol die is gekoppeld aan knooppunt type ref die is gedefinieerd in de sectie NodeTypes.
|Kenmerk|Waarde|
|---|---|
|naam|RoleOrTierName|
|type|xs:String|
...
#### <a name="nodetyperef"></a>nodeTypeRef
Naam van het knooppunttype die is gedefinieerd in de sectie NodeTypes.
|Kenmerk|Waarde|
|---|---|
|naam|nodeTypeRef|
|type|xs:String|
...
#### <a name="isseednode"></a>IsSeedNode
Hiermee wordt aangegeven of het knooppunt een seed-knooppunt.
|Kenmerk|Waarde|
|---|---|
|naam|IsSeedNode|
|type|xs:Boolean|
...
#### <a name="name"></a>Naam
Een unieke id voor de metriek binnen het cluster vanuit het perspectief van de Cluster Resource Manager s.
|Kenmerk|Waarde|
|---|---|
|naam|Naam|
|Gebruik|vereist|
...
De standaardhoeveelheid load dat deze staatloze service voor deze metriek wordt gemaakt.
|Kenmerk|Waarde|
|---|---|
|naam|DefaultLoad|
|type|xs:Long|
...
De standaardhoeveelheid belasting dat deze service voor deze metriek heeft wordt als het een primaire replica.
|Kenmerk|Waarde|
|---|---|
...
De standaardhoeveelheid belasting dat deze service voor deze metriek heeft wordt wanneer deze een secundaire replica.
|Kenmerk|Waarde|
|---|---|
...
Bepaalt de metrische gewicht ten opzichte van de andere metrische gegevens die zijn geconfigureerd voor deze service. Als twee metrische gegevens uiteindelijk conflict optreedt, verkiest de Cluster Resource Manager tijdens runtime, de metrische waarde met de hogere gewicht. Nul wordt uitgeschakeld voor de load balancer voor deze metrische gegevens.
|Kenmerk|Waarde|
|---|---|
|naam|Gewicht|
...
De naam van het pakket code, configuratie, of gegevens worden gedeeld. Moet overeenkomen met de naam van het pakket dat is gedefinieerd in het servicemanifest.
|Kenmerk|Waarde|
|---|---|
|naam|PackageRef|
...
#### <a name="isencrypted"></a>isEncrypted
Indien waar, is de waarde van deze parameter gecodeerd
|Kenmerk|Waarde|
|---|---|
|naam|isEncrypted|
|type|xs:String|
...
Hiermee beperkt u de resources die kunnen worden gebruikt op de host en limieten voor servicepakket code declareert.

|Kenmerk|Waarde|
|---|---|
|content|0-elementen, 9 kenmerken|
|gedefinieerd|Globaal|
...
De zachte limiet (in MB) voor geheugen toezicht die alleen wanneer er conflicten geheugen wordt gedetecteerd op het knooppunt wordt afgedwongen. Moet een positief geheel getal zijn.
|Kenmerk|Waarde|
|---|---|
...
Relatieve gewicht van de CPU. Moet een positief geheel getal zijn.
|Kenmerk|Waarde|
|---|---|
|naam|CpuShares|
|type|xs:String|
...
De maximale i/o (in bytes per seconde) die kan worden gebruikt (lezen en schrijven). Moet een positief geheel getal zijn.
|Kenmerk|Waarde|
|---|---|
...
I/o tekstblok gewicht ten opzichte van andere pakketten code. Moet een positief geheel getal tussen 10 en 1000.
|Kenmerk|Waarde|
|---|---|
|naam|BlockIOWeight|
|type|xs:String|
...
Het gebruikersaccount dat het servicepakket code wordt uitgevoerd.  Het gebruikersaccount moet worden gedeclareerd in de sectie Principals. Vaak is het raadzaam om uit te voeren van het setup-toegangspunt met een lokale systeemaccount in plaats van een account administrators.
|Kenmerk|Waarde|
|---|---|
|naam|UserRef|
|Gebruik|vereist|
...
#### <a name="entrypointtype"></a>EntryPointType
Setup is het entrypoint gedefinieerd in het servicemanifest, de bevoorrechte ingangspunt gebruikt dat wordt uitgevoerd voordat er andere toegangspunt.  Main is gedefinieerd in het servicemanifest, meestal de ServiceHost langlopende EntryPoint. Alle toegangspunten is.
|Kenmerk|Waarde|
|---|---|
|naam|EntryPointType|
|Gebruik|optioneel|
...
De gebruiker of groep rechten aan een resource wordt toegewezen, moet worden gedeclareerd in de sectie Principals.
|Kenmerk|Waarde|
|---|---|
|naam|PrincipalRef|
|Gebruik|vereist|
...
Het type resource, gedefinieerd in het servicemanifest van de, eindpunt of certificaat.
|Kenmerk|Waarde|
|---|---|
|naam|ResourceType|
|Gebruik|optioneel|
...
#### <a name="name"></a>Naam
Naam van het lid van de service ten opzichte van de naam van de servicegroep.
|Kenmerk|Waarde|
|---|---|
|naam|Naam|
|Gebruik|vereist|
...
|Kenmerk|Waarde|
|---|---|
|content|4-elementen, kenmerken 2|
|gedefinieerd|Globaal|
...
de gebruiker gedefinieerd type-id voor een servicegroep, bijvoorbeeld 'ActorQueueSGType'. Deze waarde wordt gebruikt in het bestand ApplicationManifest.xml om de servicegroep te identificeren.
|Kenmerk|Waarde|
|---|---|
...
Hiermee geeft u op of de service-instantie wordt gemaakt door de impliciete factory. Als false (standaard), een van de pakketten code moet de service-factory groep registreren
|Kenmerk|Waarde|
|---|---|
...
|Kenmerk|Waarde|
|---|---|
|content|7-elementen, kenmerken 0|
|gedefinieerd|Globaal|
...
|Kenmerk|Waarde|
|---|---|
|content|8-elementen, kenmerken 4|
|gedefinieerd|Globaal|
...
De controlesomwaarde van het bestand ServiceManifest.
|Kenmerk|Waarde|
|---|---|
...
#### <a name="servicetypename"></a>ServiceTypeName
Naam van het type van de service gedefinieerd in het servicemanifest, die zal worden geïnstantieerd.
|Kenmerk|Waarde|
|---|---|
|naam|ServiceTypeName|
|Gebruik|vereist|
...
Geeft standaard verplaatsen kosten voor deze service.
|Kenmerk|Waarde|
|---|---|
...
Hiermee geeft u het maximale percentage verdragen slecht services voordat de toepassing is in orde beschouwd. Percentage standaard: 0.
|Kenmerk|Waarde|
|---|---|
...
Hiermee geeft u het maximale percentage verdragen slecht partities voordat een service wordt beschouwd als niet in orde. Percentage standaard: 0.
|Kenmerk|Waarde|
|---|---|
...
Hiermee geeft u het maximale percentage verdragen slecht replica's voordat u een partitie is in orde beschouwd. Percentage standaard: 0.
|Kenmerk|Waarde|
|---|---|
...
#### <a name="servicetypename"></a>ServiceTypeName
de gebruiker gedefinieerd type-id voor een service. Bijvoorbeeld 'QueueType' of 'CalculatorType'. Deze waarde wordt gebruikt in het bestand ApplicationManifest.xml om de service te identificeren.
|Kenmerk|Waarde|
|---|---|
|naam|ServiceTypeName|
|Gebruik|vereist|
...
Beschrijft de gebruiker gedefinieerde instellingen voor een ServiceComponent of een toepassing. Bestaat uit een of meer secties van sleutel-waardeparen.
...
|Kenmerk|Waarde|
|---|---|
|content|0-elementen, kenmerken 11|
|gedefinieerd|Globaal|
...
Dit is het volledige pad naar de locatie van MSI.
|Kenmerk|Waarde|
|---|---|
|naam|MSILocation|
|type|xs:String|
...
Dit is het volledige pad naar de locatie Cluster Manifest.
|Kenmerk|Waarde|
|---|---|
...
De locatie van het manifest infrastructuur die intern zijn gegenereerd.
|Kenmerk|Waarde|
|---|---|
...
#### <a name="nodename"></a>nodeName
Dit is de naam van het knooppunt waaraan de Fabric-Upgrade happe wordt
|Kenmerk|Waarde|
|---|---|
|naam|nodeName|
|type|xs:String|
...
Een vlag die aangeeft als RemoveNodeState Api moet worden aangeroepen na de knooppuntconfiguratie van het verwijderd.
|Kenmerk|Waarde|
|---|---|
...
Naam van het exe-bestand gebruikt door de installer-service bijwerken 
|Kenmerk|Waarde|
|---|---|
...
Naam van het exe-bestand gebruikt door de installer-service ongedaan maken van de upgrade
|Kenmerk|Waarde|
|---|---|
