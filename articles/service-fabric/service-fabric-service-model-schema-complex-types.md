...
#### <a name="version"></a>Versie
De gebruiker gedefinieerde versietekenreeks voor het cluster manifest-document.
|Kenmerk|Waarde|
|---|---|
|naam|Versie|
|Gebruik|vereist|
...
De naam van het eindpunt, moet worden gedeclareerd in de bronnensectie van het servicemanifest.
|Kenmerk|Waarde|
|---|---|
|naam|EndpointRef|
...
Versie van het besturingssysteem maken. voor ex: 1809 voor RS1
|Kenmerk|Waarde|
|---|---|
|type|xs:String|
...
De limieten van de totale hoeveelheid geheugen (geheugen + swap) in MB.
|Kenmerk|Waarde|
|---|---|
|type|xs:String|
|naam|MemorySwapInMB|
...
Voorlopig geheugenlimieten in MB. Moet een positief geheel getal zijn.
|Kenmerk|Waarde|
|---|---|
|type|xs:String|
...
Bruikbare percentage van de beschikbare CPU's (alleen windows). Moet een positief geheel getal zijn.
|Kenmerk|Waarde|
|---|---|
|type|xs:String|
|naam|CpuPercent|
...
Maximale i/o-snelheid in termen van IOps. Moet een positief geheel getal zijn.
|Kenmerk|Waarde|
|---|---|
|type|xs:String|
|naam|MaximumIOps|
...
Maximale i/o-bandbreedte. Moet een positief geheel getal zijn.
|Kenmerk|Waarde|
|---|---|
|type|xs:String|
...
Relatieve blok i/o-gewicht. Moet een positief geheel getal tussen 10 en 1000.
|Kenmerk|Waarde|
|---|---|
|type|xs:String|
|naam|BlockIOWeight|
...
De gebruiker gedefinieerd type-id voor de groep van een service, bijvoorbeeld 'ActorQueueSGType'. Deze waarde wordt gebruikt in het bestand ApplicationManifest.xml om de servicegroep te identificeren.
|Kenmerk|Waarde|
|---|---|
...
Waarde van het bestand ServiceManifest
|Kenmerk|Waarde|
|---|---|
|type|xs:String|
...
#### <a name="contentchecksum"></a>ContentChecksum
Waarde van deze inhoud ServicePackage
|Kenmerk|Waarde|
|---|---|
|type|xs:String|
|naam|ContentChecksum|
