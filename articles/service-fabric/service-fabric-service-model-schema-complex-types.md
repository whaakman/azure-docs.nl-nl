...
#### <a name="mountpoint"></a>Koppelpunt
|Kenmerk|Waarde|
|---|---|
|naam|Koppelpunt|
|type|xs:String|
...
#### <a name="nodename"></a>Knooppuntnaam
...
Beschrijving van netwerkbeleid, met inbegrip van container netwerk policie voor het servicepakket.
...
#### <a name="nodename"></a>Knooppuntnaam
Dit is de naam van het knooppunt waarop de infrastructuur van de Upgrade happe wordt
|Kenmerk|Waarde|
|---|---|
|naam|Knooppuntnaam|
|type|xs:String|
