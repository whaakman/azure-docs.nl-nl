...
| UpgradeHealthCheckInterval | The frequency that the health status is checked. This parameter is specified in the ClusterManager section of the _cluster_ _manifest_, and is not specified as part of the upgrade cmdlet. The default value is 60 seconds.  |
