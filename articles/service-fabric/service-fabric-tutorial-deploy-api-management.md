...
* Installeer de [Azure Powershell, moduleversie 4.1 of hoger](https://docs.microsoft.com/powershell/azure/install-azurerm-ps) of [Azure CLI](/cli/azure/install-azure-cli).
