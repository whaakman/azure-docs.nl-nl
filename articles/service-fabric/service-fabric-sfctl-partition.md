...
| quorum-verlies-status | Hiermee haalt u de voortgang van een quorum-verlies-bewerking op een partitie die aan de slag met de API StartQuorumLoss. |
| herstellen | Geeft aan dat de Service Fabric-cluster dat het proberen moet te herstellen van een specifieke partitie die momenteel sprake van quorumverlies is vastgelopen. |
