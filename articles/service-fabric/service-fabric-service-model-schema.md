...
# <a name="service-model-xml-schema-documentation"></a>Documentatie voor service model XML-schema
Dit artikel wordt het schemabestand ServiceFabricServiceModel.xsd is geïnstalleerd met de Service Fabric SDK.  Standaard wordt het schemabestand geïnstalleerd naar *C:\Program Files\Microsoft SDKs\Service Fabric\schemas\ServiceFabricServiceModel.xsd*.

## <a name="namespace-bindings"></a>Namespace-bindingen
|Voorvoegsel|Namespace-URI|
|---|---|
|Xs|http://www.w3.org/2001/XMLSchema|
|Geen|http://schemas.microsoft.com/2011/01/fabric|

## <a name="component-summary"></a>Overzicht van onderdelen 
De volgende onderdelen zijn gedefinieerd in de http://schemas.microsoft.com/2011/01/fabric naamruimte in ServiceFabricServiceModel.xsd:
- [293 elementen](service-fabric-service-model-schema-elements.md)
