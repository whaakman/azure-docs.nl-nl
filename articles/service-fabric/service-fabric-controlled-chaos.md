...
* **TimeToRun**: totale tijd dat Chaos uitgevoerd voordat het met succes is voltooid. U kunt Chaos stoppen voordat deze via de API StopChaos voor de periode TimeToRun uitgevoerd.
...
* **MaxConcurrentFaults**: het maximum aantal gelijktijdige fouten die zijn die in elke iteratie. De hogere Chaos van het getal, hoe meer agressief is en de failovers en de status overgang combinaties dat het cluster wordt verstuurd via zijn ook complexere. 
