...
In de **sfctl** code hieronder, de volgende opdracht wordt gebruikt om op te halen de **knooppuntnaam** waarde van de laatst gemaakte knooppunt: `sfctl node list --query "sort_by(items[*], &name)[-1].name"`
