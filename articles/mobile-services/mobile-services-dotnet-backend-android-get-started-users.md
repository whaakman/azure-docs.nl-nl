---
title: Get started with authentication (Android) | Microsoft Docs
...
1. Open the project that you created when you completed the tutorial [Get started with Mobile Services].
