---
title: Een DNS-zone maken met Azure CLI 1.0 | Microsoft Docs
description: Informatie over het maken van DNS-zones in Azure DNS. Dit is een stapsgewijze handleiding voor het maken en beheren van uw eerste DNS-zone met behulp van de Azure-CLI 1.0.
services: dns
...
# <a name="create-an-azure-dns-zone-using-azure-cli-10"></a>Een Azure DNS-zone maken met Azure CLI 1.0
