...
De **[branches](https://gallery.azure.ai/industries)** sectie van de galerie samenbrengt verschillende bronnen die specifiek voor sectoren, zoals zijn

* [Detailhandel](https://gallery.azure.ai/industries/retail) -retail-oplossingen zoals verkopen prognose, voorspellen van de klant verloop en ontwikkelen prijsmodellen zoeken.
* [Productie](https://gallery.azure.ai/industries/manufacturing) - zoeken naar productie-oplossingen zoals anticiperen op apparatuur onderhoud en prognose energieprijzen.
* [Banking](https://gallery.azure.ai/industries/banking) - zoeken naar oplossingen zoals het voorspellen van tegoed banking risico en bewaking voor on line fraude.
* [Gezondheidszorg](https://gallery.azure.ai/industries/healthcare) -gezondheidszorg oplossingen zoals ziekte detecteren en ziekenhuis readmissions voorspellen.
