...
Standaard elke gepubliceerde Web-service is geconfigureerd voor ondersteuning van 20 gelijktijdige aanvragen en mag maximaal 200 gelijktijdige aanvragen. Terwijl de klassieke Azure portal een manier biedt om deze waarde instelt, Azure Machine Learning optimaliseert automatisch de instelling voor de beste prestaties voor uw webservice en de portal waarde wordt genegeerd. 
...
De schaal van een webservice is een algemene taak. Enkele redenen om te schalen zijn voor ondersteuning van meer dan 200 gelijktijdige aanvragen, beschikbaarheid dankzij meerdere eindpunten te verhogen of afzonderlijke eindpunten voor de webservice leveren. U kunt de schaal verhogen door toe te voegen extra eindpunten voor dezelfde webservice via [klassieke Azure-portal](https://manage.windowsazure.com/) of de [Azure Machine Learning-webservice](https://services.azureml.net/) portal.
