...
| Feed-gegevensprovider |Leest de gegevens van een ondersteunde provider van de feed. Op dit moment alleen de Open Data Protocol (OData)-indeling wordt ondersteund. |<b>Gegevens inhoudstype</b>: Hiermee geeft u de OData-indeling.<br/><br/><b>Bron-URL</b>: Hiermee geeft u de volledige URL voor de gegevensfeed. <br/>Bijvoorbeeld, worden de volgende URL van de voorbeelddatabase Northwind gelezen: http://services.odata.org/northwind/northwind.svc/ |
