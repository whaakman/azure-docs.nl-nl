...
Voor geautomatiseerde ML moet u maken een `Experiment` object, dat een benoemd exemplaar van het object in een `Workspace` gebruikt voor het uitvoeren van experimenten.
