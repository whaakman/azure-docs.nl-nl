...
2. Een geïnstalleerde kopie van [Azure Machine Learning Workbench](../service/overview-what-is-azure-ml.md) volgende de [installatie snelstartgids](../service/quickstart-installation.md) het programma te installeren en het maken van een werkruimte.
