...
* Azure Machine Learning-Workbench. Zie [installatiehandleiding](../service/quickstart-installation.md). De Azure Machine Learning-Workbench kan op dit moment worden geïnstalleerd op alleen de volgende besturingssystemen: 
