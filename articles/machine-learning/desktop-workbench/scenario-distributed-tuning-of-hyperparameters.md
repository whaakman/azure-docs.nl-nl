...
* Een geïnstalleerde kopie van [Azure Machine Learning Workbench](../service/overview-what-is-azure-ml.md) volgende de [installeren en het maken van de Quick Start](../service/quickstart-installation.md) voor het installeren van de Workbench en maken van accounts.
