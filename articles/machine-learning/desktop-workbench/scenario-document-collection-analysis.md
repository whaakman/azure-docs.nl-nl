...
* Zorg ervoor dat u goed hebt geïnstalleerd [Azure Machine Learning Workbench](../service/overview-what-is-azure-ml.md) volgens de [installeren en maak Quick Start](../service/quickstart-installation.md).
