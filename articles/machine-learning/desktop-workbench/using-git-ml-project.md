...
Een Machine Learning-experimenten-account maken en installeer de app Azure Machine Learning-Workbench. Zie voor meer informatie [installeren en maak Quick Start](../service/quickstart-installation.md).
