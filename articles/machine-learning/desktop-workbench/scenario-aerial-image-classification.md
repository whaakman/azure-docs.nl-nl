...
- [Azure Machine Learning Workbench](../service/overview-what-is-azure-ml.md)
    - Ga als volgt de [installeren en het maken van de Quick Start](../service/quickstart-installation.md) voor het installeren van de Azure Machine Learning-Workbench en experimenteren en Model Management Accounts maken.
