---
title: Snelstart voor het installeren van de Azure Machine Learning-service | Microsoft Docs
...
De Azure Machine Learning-service (preview) is een geïntegreerde, end-to-end oplossing voor gegevenswetenschap en geavanceerde analyse. Het helpt professionele gegevenswetenschappers gegevens voor te bereiden, experimenten te ontwikkelen en modellen te implementeren op cloudschaal.

In deze snelstartgids leert u het volgende:

* Serviceaccounts maken voor de Azure Machine Learning-service
...
De Azure Machine Learning-service maakt deel uit van het portfolio van Microsoft Azure en vereist een Azure-abonnement. Als u nog geen abonnement op Azure hebt, maak dan een [gratis account](https://azure.microsoft.com/free/?WT.mc_id=A261C142F) aan voordat u begint.
...
## <a name="create-azure-machine-learning-service-accounts"></a>Serviceaccounts maken voor Azure Machine Learning
...
1. Vul de formuliervelden in en selecteer de knop **Maken** om een nieuw project te maken in Workbench.
   ...
   URL van GIT-opslagplaats Visualstudio.com |_leeg laten_ | Optioneel veld. Een project kan eventueel worden gekoppeld aan een Git-opslagplaats in Azure DevOps voor broncodebeheer en samenwerking. [Informatie over het instellen daarvan](../desktop-workbench/using-git-ml-project.md#step-3-set-up-a-machine-learning-project-and-git-repo). 
...
De Azure Machine Learning-opdrachtregelinterface (CLI) is ook geïnstalleerd. Met de CLI-interface werkt u met uw Azure Machine Learning-service met behulp van `az`-opdrachten om alle taken uit te voeren die nodig zijn voor een end-to-end gegevenswetenschapwerkstroom. [Meer informatie.](../desktop-workbench/tutorial-iris-azure-cli.md)
