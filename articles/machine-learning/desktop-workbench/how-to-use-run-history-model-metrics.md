...
Als u nog een project hebt, kunt u een van de [maken en snelstartgids installeren](quickstart-installation.md) van de **projectdashboard**, kunt u openen de **iris_sklearn.py** script () zoals wordt weergegeven.)
