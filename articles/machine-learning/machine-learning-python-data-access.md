...
9. Select the code snippet and copy it to your clipboard from the window that appears.
   
    ![Access Code][intermediate-dataset-access-code]
10. Paste the code in your notebook.
    
     ![Notebook][ipython-intermediate-dataset]
11. You can visualize the data using matplotlib. This displays in a histogram for the age column:
