---
title: Gegevens in SQL Server-VM op Azure verkennen | Microsoft Docs
description: Klik hier voor meer informatie over het verkennen van gegevens die zijn opgeslagen in een SQL Server-VM op Azure.
