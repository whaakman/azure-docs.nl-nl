...
| Koppelingen naar voorbeelden      | [Gebruikt AdlCopy] https://docs.microsoft.com/en-us/azure/data-lake-store/data-lake-store-copy-data-azure-storage-blob)      |
...
| Koppelingen naar voorbeelden      | [AzCopy in Windows](https://docs.microsoft.com/en-us/azure/storage/common/storage-use-azcopy)      |
...
| Koppelingen naar voorbeelden      | [Gegevens CosmosDB importeren](https://docs.microsoft.com/en-us/azure/cosmos-db/import-data)      |
| Bijbehorende hulpprogramma's op de DSVM      | AzCopy, AdlCopy      |
...
| Koppelingen naar voorbeelden      | [Hulpprogramma voor bulksgewijs kopiëren](https://docs.microsoft.com/en-us/sql/tools/bcp-utility)      |
