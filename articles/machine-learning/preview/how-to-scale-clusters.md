...
Dit duurt enkele minuten om te voltooien. Zie voor meer informatie over het schalen van het aantal knooppunten in het cluster [agent knooppunten in een Container Service-cluster schalen](https://docs.microsoft.com/en-us/azure/container-service/container-service-scale).
