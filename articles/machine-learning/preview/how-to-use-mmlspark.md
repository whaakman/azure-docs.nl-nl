...
- [Azure HDInsight Spark-cluster instellen](https://docs.microsoft.com/en-us/azure/hdinsight/hdinsight-apache-spark-jupyter-spark-sql)
...
Als u dit en de volgende stap, moet u eerst [maken van een Azure HDInsight Spark-cluster](https://docs.microsoft.com/en-us/azure/hdinsight/hdinsight-apache-spark-jupyter-spark-sql).
