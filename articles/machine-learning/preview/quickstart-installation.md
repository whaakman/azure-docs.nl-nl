...
Momenteel kan de desktop-app Azure Machine Learning Workbench alleen worden geïnstalleerd op de volgende besturingssystemen: 
- Windows 10
- Windows Server 2016
- macOS Sierra

>[!NOTE]
>macOS High Sierra wordt nog niet ondersteund.
