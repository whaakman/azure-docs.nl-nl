...
ms.locfileid: "53075111"
---
# <a name="enable-capturing-of-events-streaming-through-azure-event-event-hubs"></a>Vastleggen van streaming-gebeurtenissen via Azure gebeurtenis Event Hubs inschakelen
