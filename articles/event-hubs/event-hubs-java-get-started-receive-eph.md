---
title: Gebeurtenissen ontvangen met Java - Azure Event Hubs | Microsoft Docs
description: Dit artikel bevat een overzicht voor het maken van een Java-toepassing die gebeurtenissen uit Azure Event Hubs ontvangt.
services: event-hubs
