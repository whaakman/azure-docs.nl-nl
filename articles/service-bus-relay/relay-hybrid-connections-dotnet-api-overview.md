...
De [HybridConnectionStream] [ HCStream] klasse wederzijdse communicatie mogelijk maakt. In de meeste gevallen ontvangt u continu van de stroom. Als u tekst uit de stroom leest, u kunt ook gebruik van een [StreamReader](https://msdn.microsoft.com/library/system.io.streamreader(v=vs.110).aspx) object, waardoor u gemakkelijker bij het parseren van de gegevens. U kunt bijvoorbeeld gegevens lezen als tekst, in plaats van als `byte[]`.
