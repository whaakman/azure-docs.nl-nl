...
description: Een globale weergave in de status van de Azure-services.
...
De pagina Azure status wordt in realtime bijgewerkt als de status van de Azure-services wijzigen. Als u de pagina Azure status open laat, kunt u de snelheid waarmee de pagina wordt vernieuwd met nieuwe gegevens kunt beheren. Bovenaan ziet u de laatste keer dat de pagina is bijgewerkt.
...
* Meer informatie over hoe u een meer gedetailleerd overzicht kunt krijgen tot de status van uw specifieke Azure-resources met [resourcestatus](./resource-health-overview.md).
