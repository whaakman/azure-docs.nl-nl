...
# Azure Database voor PostgreSQL: .NET (C#) gebruiken om verbinding te maken en gegevens op te vragen
...
## Visual Studio en .NET installeren
...
### **Windows .NET Framework en .NET Core**
...
## Npgsql-verwijzingen installeren in uw Visual Studio-oplossing
