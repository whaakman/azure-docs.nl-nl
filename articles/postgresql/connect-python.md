...
2. Klik in het menu links in Azure-portal op **alle resources** en zoek naar **mypgserver 20170401** (de server die u hebt gemaakt).
...
> [!NOTE]
> Vanaf versie 3 Python, ziet u mogelijk de fout `SyntaxError: Missing parentheses in call to 'print'` bij het uitvoeren van de volgende codeblokken: als dit gebeurt, vervangt u elke aanroep van de opdracht `print "string"` met een functieaanroep met haakje, zoals `print("string")`.
