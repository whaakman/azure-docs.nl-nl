...
ms.locfileid: "38681603"
---
# <a name="azure-database-for-postgresql-migration-partners"></a>Azure Database for PostgreSQL-migratiepartners
Ter ondersteuning van ruim uw Azure Database voor PostgreSQL-oplossing, kiezen uit een groot aantal toonaangevende partners en hulpprogramma's. In dit artikel ziet u Microsoft partnerbedrijven met oplossingen voor cloudmigratie ondersteuning van Azure Database voor PostgreSQL.
...
| ![Pragmatische werkt][3] |**Pragmatische werkt**<br>Pragmatische Works is een training en advies van bedrijf met uitgebreide expertise in beheer van gegevens en prestaties, Business Intelligence, Big Data, Power BI en Azure, ligt de focus op de optimalisatie van gegevens en het verbeteren van de efficiëntie van SQL Server-en cloud.|[Website][pragmatic-works_website]<br>[Twitter][pragmatic-works_twitter]<br>[YouTube][pragmatic-works_youtube]<br>[Neem contact op met][pragmatic-works_contact] | |
| ![Infosys][4] |**Infosys**<br>Infosys is een wereldwijde leider in de meest recente digitale services en advies. Met meer dan drie tientallen jaren ervaring voor het beheren van de systemen van wereldwijd opererende ondernemingen, ossen Infosys vakkundig clients via hun digitale reis doordat organisaties met een core AI aangestuurde om te prioriteren van de uitvoering van de wijziging. Infosys biedt ook bedrijven met flexibele digitale op schaal te leveren, ongeëvenaarde niveaus qua prestaties en klanttevredenheid.|[Website][infosys_website]<br>[Twitter][infosys_twitter]<br>[YouTube][infosys_youtube]<br>[Neem contact op met][infosys_contact] | |
| ![credativ][5] |**credativ**<br>credativ is een onafhankelijke consulting services bedrijf en die sinds 1999 heeft zijn bieden uitgebreide services en technische ondersteuning voor de implementatie en het gebruik van Open Source-software in zakelijke toepassingen. De uitgebreide reeks services voorziet in strategische consulting, gezonde technisch advies, gekwalificeerde training en ondersteuning voor persoonlijke maximaal 24 uur per dag voor al uw IT-afdeling nodig heeft.|[Marketplace][credativ_marketplace]<br>[Website][credativ_website]<br>[Twitter][credative_twitter]<br>[YouTube][credativ_youtube]<br>[Neem contact op met][credativ_contact] | |
