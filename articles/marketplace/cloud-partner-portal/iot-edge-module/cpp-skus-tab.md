...
De volgende tabel beschrijft de doel-inhoud en opmaak voor velden onder **SKU-Details**. Verplichte velden zijn indicted met een asterisk (*).
...
De volgende tabel beschrijft het doel, inhoud en opmaak van de velden voor de secties **installatiekopie opslagplaats Details** en **Installatiekopieversie**.  Verplichte velden zijn indicted met een asterisk (*).
...
### <a name="help-your-customers-launch-by-using-default-settings"></a>Help die uw klanten starten door met de standaardinstellingen
...
Selecteer **opslaan** uw SKU-instellingen op te slaan. 
