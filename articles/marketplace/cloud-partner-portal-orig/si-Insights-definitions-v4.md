---
title: Definities van de verkoper Insights | Microsoft Docs
...
| Azure licentietype: Enterprise via Reseller  | De eindklant aanschaft Azure en uw Marketplace-aanbieding via een Reseller die vereenvoudigt het uitvoeren van hun Enterprise Agreement van Microsoft.     |
| Azure licentietype: betalen                | De eindklant aanschaft Azure en uw Marketplace-aanbieding via een betalen-overeenkomst, ondertekend rechtstreeks met Microsoft.                |
| Azure-abonnement GUID                          | De Global Unique Identifier (GUID) van de Azure-abonnement dat de klant gebruikt voor het kopen van uw Marketplace-aanbieding.                     |
| Bedrag kosten in rekening gebracht (CC)                               | Het bedrag in rekening gebracht voor de klant, in van de klant factureringsvaluta (CC).                                                                 |
| Bedrag kosten in rekening gebracht (PC)                               | Het bedrag in rekening gebracht voor de klant, in de *Payout valuta (PC)*.                                                                      |
| Datum van afschrijving                                      | De datum die van de klant kosten in rekening gebracht is berekend, volgen doorgaans onmiddellijk de gebruiksperiode.                                             |
| Naam van de cloud-exemplaar                              | De Microsoft-Cloud waarin een VM-implementatie is opgetreden. (Azure (overheid) - Microsoft-Cloud-exemplaar voor de Amerikaanse overheid; Azure China - Microsoft-Cloud-instanties binnen China; Azure Duitsland - exemplaar van de Microsoft Cloud in Duitsland. Azure Global - exemplaren van de Microsoft Cloud voor alle andere algemene locaties)                                                          |
| Aangepaste meten van het verbruik                               | Gemeten eenheden wordt gebruikt voor aangepaste meter-aanbiedingen.                                                                                        |
| Klant                                         | Elke Azure-klant of eindgebruiker die verkrijgt, gebruikt of anderszins bekijkt wordt een aanbieding gepubliceerd via de Marketplace. Klanten zijn geïdentificeerd door de unieke *Azure-abonnement-GUID*.                                                                                                                                                                        |
...
| Betalings-Status: Niet gereed voor Payout              | De transactie is niet gereed voor toekenning. (Zie *verzameling de definitieve Status* voor meer informatie)                                                    |
