---
title: Een aanbieding/SKU verwijderen uit Azure Marketplace
description: Een aanbieding/SKU verwijderen uit Azure Marketplace
...
U kunt een live SKU vanuit Azure Marketplace verwijderen door de volgende stappen:

1.  Aanmelden bij de [Cloud Partner-Portal](http://cloudpartner.azure.com).
2.  Selecteer uw aanbieding vanaf het tabblad alle aanbiedingen.
3.  In het deelvenster aan de linkerkant van het scherm, selecteer het tabblad SKU's.
4.  Selecteer de SKU die u wilt verwijderen en klik op de verwijderknop voor die SKU.
5.  De aanbieding op Azure Marketplace publiceren.
...
2.  Selecteer uw aanbieding vanaf het tabblad alle aanbiedingen.
3.  In het deelvenster aan de linkerkant van het scherm, selecteer het tabblad SKU's.
4.  De meest recente versie van pakket verwijderen uit de lijst met gepubliceerde pakketten.
5.  De aanbieding op Azure Marketplace publiceren.
...
Volg de stappen hieronder om begeleiding van het ondersteuningsteam om te verwijderen van een live-aanbieding van Azure Marketplace:

1.  Een ondersteuningsticket met behulp van dit verhogen [koppeling](https://go.microsoft.com/fwlink/?linkid=844975)
2.  Selecteer beheren-aanbiedingen in het probleem type lijst, wijzigen van een aanbieding en/of SKU al in de productieomgeving in de lijst met categorieën.
3.  De aanvraag indienen.

Het ondersteuningsteam leidt u door de verwijdering van de aanbieding.

Het verwijderen van een SKU/aanbieding heeft geen invloed op de huidige aankopen van de SKU /-aanbieding al uitgevoerd. Ze blijven werken als voorheen, maar niet meer beschikbaar voor alle nieuwe aankopen in de toekomst.
