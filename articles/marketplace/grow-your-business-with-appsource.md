...
| **Categorieën (max. 3)** | Selecteer maximaal drie categorieën die het beste zijn afgestemd op uw aanbieding. Kies deze categorieën zorgvuldig als gebruikers de categorieën gebruiken om te zoeken naar relevante apps. Controleer of aan te roepen hoe uw aanbieding categoriespecifieke behoeften in de beschrijving van de aanbieding ondersteunt. |
...
| **Zoekwoorden (max. 3)** | Trefwoorden helpen zakelijke gebruikers uw aanbieding vinden bij het zoeken op AppSource of met behulp van zoekmachines. Identiteit van de bovenste 3 zoekwoorden voor uw aanbieding gebruikmaken van de zoekwoorden in uw aanbieding samenvatting, beschrijving en de zoekwoorden hier weergeven. |

**Via details - Marketing artefacten**  

| Via instellingen | Aanbevolen procedures | 
|:--- |:--- |
| **Aanbieding-logo (PNG-indeling, 48 x 48)** | Uw logo moet worden ontworpen en geoptimaliseerd voor een digitaal medium.<br />Logo in PNG-indeling voor de zoekpagina van uw aanbieding uploaden. |
| **Aanbieding-logo (PNG. 216 x 216)** | Uw logo moet worden ontworpen en geoptimaliseerd voor een digitaal medium.<br />Logo uploaden in PNG-indeling voor de app-gegevens weergeven van pagina van de aanbieding. |
...
#### <a name="link-to-enable-lead-sharing"></a>Koppeling leiden delen inschakelen  
