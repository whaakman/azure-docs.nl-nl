...
## <a name="business-benefits-of-joining-a-cloud-marketplace"></a>Zakelijke voordelen van het lidmaatschap van een cloud-marketplace  
...
## <a name="how-to-grow-your-business-with-appsource"></a>Hoe u uw bedrijfsactiviteiten met AppSource  
...
Uw aanbieding in AppSource, kan uw eerste interactie met een potentiële klant zijn. Net als een eerste indruk u ervoor sterke en iets uw doelgroep wil moeten worden opgevolgd. Samen met uw marketing-team om te controleren of de berichten en ondersteunende inhoud in uw aanbieding van gedifferentieerde en helpt uw aanbieding opvalt. 

Hier volgen enkele elementaire zaken die u doen kunt voor een goede eerste indruk. 

![Vorm uw eerste indruk](./media/marketplace-appsource/appsourcefirstimpression.png)

De volgende sectie leidt u door de verschillende stappen die vereist voor het indienen van uw marketplace-vermelding. Lees deze zorgvuldig als het beste bevat procedures waarmee u kunnen uw app opvalt en verbeteren van zoeken engine classificaties. 

De volgende tabellen worden de details elke stap van het invullen van de aanbieding van uw aanbieding.

**Identiteit**  

| Instelling van de aanbieding | Aanbevolen procedures | 
|:---------------------------------------- |:----------------------------------------------------- |
| **Naam** | **Naamgeving van uw aanbieding**<br />Het kiezen van een naam voor uw app is een belangrijke beslissing. Op basis van een voordeel namen zijn efficiënter dan beschrijvende namen. Naam van uw app moet contact opnemen voor dat de core value-klanten worden ontvangen. Inclusief zoekwoorden in de titel van uw app, kunt ook uw app die hoger in zoekmachineresultaten wordt gerangschikt. Volg de Trademark van Microsoft en Merkrichtlijnen, evenals relevante productspecifieke richtlijnen met betrekking tot handelsmerken van Microsoft en de namen van Microsoft, software, producten en services.<ul> <li>Ga naar de Trademark van Microsoft voor meer informatie over handelsmerken van Microsoft en een huisstijl en Merkrichtlijnen van pagina zich bevindt op [www.microsoft.com/legal/intellectualproperty/trademarks/usage/general.aspx](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general.aspx).</li> </ul> |

**Details van StoreFront - details van aanbieding**  

| StoreFront-instellingen | Aanbevolen procedures | 
|:---------------------------------------- |:----------------------------------------------------- |
| **Naam van aanbieding** | De samenvatting van de aanbieding wordt weergegeven op de zoekpagina van de aanbieding op de AppSource-startpagina en app-galerie. Zoekwoorden in uw aanbieding samenvatting voor het verbeteren van de rangorde van uw app in zoekmachineresultaten opnemen. |
| **Beschrijving van aanbieding** | **Geef een beschrijving van de juiste aanbieding**<br />De toegevoegde waarde van uw aanbieding in de eerste paar zinnen van de beschrijving van uw duidelijk te beschrijven. Houd er rekening mee dat de eerste paar zinnen kunnen worden weergegeven in zoekmachineresultaten.<br />Vertrouw niet op de functies en functionaliteit om uw product te verkopen. In plaats daarvan richten op de waarde die u levert. Branchespecifieke vocabulaire of op basis van een voordeel bewoording zo veel mogelijk gebruiken.<br />Belangrijkste onderdelen van de toegevoegde waarde moeten bevatten informatie over:<ul> <li>Wat is het product</li>  <li>Die krijgt van deze het meest</li> <li>Welke nodig of pijn het adres.</li> </ul>Uw klanten vertellen hoe hun bedrijfs- of werk afwijken kan wanneer ze uw oplossing gebruiken.<br />Trefwoorden en sleutelwoord variaties in de beschrijving van uw aanbieding voor het verbeteren van de volgorde van uw aanbieding in zoekmachineresultaten opnemen.<br />Geef de beschrijving van de aanbieding met behulp van eenvoudige HTML.<br />Hier volgt een voorbeeld van een eenvoudige aanbieding pagina (zoals weergegeven in het bovenstaande voorbeeld aanbieding) die een overzicht van de aanbieding gevolgd door een lijst van de belangrijkste mogelijkheden biedt. Het maximum aantal tekens is 3000.<br />*HTML-voorbeelden*<br />Organisatie-inzicht voor Dynamics 365 (online) biedt belangrijke acceptatie en gebruik metrische gegevens voor uw Dynamics 365-organisatie en hulpprogramma's waarmee u problemen met prestaties en ondersteuning blijven. <ul> <li>**Dashboards aanpassen**<br />Instellen van uw dashboard om een rijke gebruikerservaring en momentopnamen van uw belangrijke gegevens te bieden.<ul> <li>**Goedkeuring controleren en gebruiken**<br />Identificatie van uw meest actieve gebruikers van pagina-aanvragen, meest gebruikte entiteiten en werkstromen.</li> </ul></li> </ul>Versie van de minimale ondersteunde platforms: `8.1.1` |

**Details van StoreFront - details van aanbieding**  

| StoreFront-instellingen | Aanbevolen procedures | 
|:--- |:--- |
| **Branches (max. 2)** | Selecteer maximaal twee branches als uw aanbieding branche-specifieke vereisten adressen. Zorg ervoor dat u deze branche-specifieke mogelijkheden in de beschrijving van de aanbieding belichten. |
| **Categorieën (maximaal 3)** | Selecteer maximaal drie categorieën die het beste zijn afgestemd op uw aanbieding. Deze categorieën zorgvuldig kiezen als gebruikers de categorieën gebruiken om te zoeken naar relevante apps. Zorg ervoor dat u houden hoe uw aanbieding categorie-specifieke behoeften in de beschrijving van de aanbieding ondersteunt. |
| **Producten die uw app met (maximaal 3 werkt)** | Lijst met aanvullende producten en technologieën die gebruikmaakt van uw oplossing. Azure IOT Hub, Azure Machine Learning, enzovoort. |
| **Trefwoorden (maximaal 3)** | Trefwoorden voor zoekopdrachten mogen help zakelijke gebruikers vinden van uw aanbieding bij het zoeken in AppSource of met behulp van zoekmachines. Identiteit de top 3 trefwoorden voor uw aanbod, de zoektrefwoorden in de samenvatting, beschrijving van uw aanbieding opnemen en de zoekwoorden hier weergeven. |

**Details van StoreFront - Marketing artefacten**  

| StoreFront-instellingen | Aanbevolen procedures | 
|:--- |:--- |
| **Logo van de aanbieding (PNG-indeling, 48 x 48)** | Uw logo moet worden ontworpen en geoptimaliseerd voor een digitaal medium.<br />Upload het logo in PNG-indeling voor de zoekpagina van uw aanbieding. |
...
### <a name="link-to-landing-page"></a>Koppeling naar startpagina
