---
title: Bepalen van het type van uw aanbieding in Azure Marketplace | Azure
...
Deze sectie beschrijft alle aanbiedingen die geen gebruikmaken van het type aanbieding Transact. 
...
#### <a name="requirements-azure-marketplace-list-contact-me"></a>Vereisten: Azure Marketplace: lijst: contact met mij opnemen  
...
U beschikt over een oplossing of een app met behulp van een gratis-naar-try, software as a service (SaaS)-proefversie gebaseerd. SaaS proefversie bieden type schijven leads van hoge kwaliteit van geïnteresseerd klanten, kunt u uw zakelijke vliegwiel starten. Gratis proefversie type kan worden aangeboden als een proefaccount gelimiteerde of beperkte duur. Gratis proefversie moet een aanroep van de actie voor conversie naar betaald gebruik van uw oplossing implementatietijd bevatten.  

| Voordeel | Vereiste |  
|:--- |:--- |  
| Hiermee kunt uw klant om te proberen het product voordat gebruik kopen bij een automatische methode voor het converteren naar een betaald. Bovendien kunnen bewijzen van concept voor de klant en gemeenschappelijke betrokkenheid bij sales-teams van Microsoft. | Uw oplossing is de virtuele machine of Azure apps: oplossing voor het type sjabloon aanbieding.<br /><br />Uw oplossing is SaaS type aanbieden en u een multitenant SaaS-product opgeven.<br /><br />U hebt een eerste sessie van de klant aan de slag wilt ophalen.<br /><br />U hebt een één-tenant, maar klanten als gast toevoegt. |  

#### <a name="requirements-azure-marketplace-trial-interactive-demo"></a>Vereisten: Azure Marketplace: proefversie: interactieve demo  
U kunt een begeleide ervaring voor uw oplossing bieden aan uw klanten met behulp van een interactieve demonstratie. Het voordeel van het aanbiedingtype interactieve demo is dat u een evaluatieversie bieden zonder ingewikkeld inrichting van uw complexe oplossing. Het aanbiedingtype interactieve demo biedt uw klant Bekijk uw oplossing. Het aanbiedingtype interactieve demo biedt uw potentiële klanten die de fundamentele aanbiedingen voor het starten van uw bedrijf vliegwiel moeten beheerinfrastructuur.  
...
U implementeert een of meer virtuele machines via infrastructure-as-a-service(IaaS) of SaaS-apps. Een voordeel van het station aanbieding testtype is de geautomatiseerde inrichting van een virtuele machine of de hele oplossing geleid door een partner gehost rondleiding. Een test-station biedt een evaluatie zonder extra kosten aan uw klant. De klant hoeft niet te worden van een bestaande Azure klant om de hogere kwaliteit leidt.  

| Voordeel | Vereiste |  
|:--- |:--- |  
| Hiermee kunt uw klant om te proberen het product voordat u koopt.<br /><br />Biedt een begeleide ervaring voor uw oplossing met behulp van vooraf geconfigureerde instellingen.<br /><br />De volgende zijn extra voordelen wanneer u een test-station.<ul> <li>27% van de gebruiker zoekopdrachten op marketplace worden verfijnd door klanten alleen weergeven aanbiedingen met test-stations.</li> <li>Aanbiedingen met test stations leads 38% meer dan aanbiedingen zonder genereren.</li> <li>36% van de nieuwe klant aankopen op marketplace is afkomstig van klanten die een test-station heeft.</li> <li>Test stations inschakelen Microsoft veld verkopers om uw product mede verkopen inspanningen beter te begrijpen.</li> </ul> | Uw oplossing is een virtuele machine, Apps van Azure: oplossingssjabloon, SaaS-app met een één tenant of is te ingewikkeld om in te richten. <br /><br />U beschikt niet over een methode voor uw proefversie omzetten naar een betaald abonnement. |  

---

## <a name="transact-specific-listings"></a>Transact-specifieke aanbiedingen
Deze sectie beschrijft alle aanbiedingen die gebruikmaken van het type aanbieding Transact.

### <a name="transact"></a>Handelen  
Het type van de aanbieding Transact bevat de volgende typen van de aanbieding op de winkelobjecten in de marketplace.  
...
Microsoft als host fungeert voor de handel-transactie. Microsoft stuklijsten uw klant namens jou. Als u wilt gebruiken als een abonnement factuur een SaaS-App gebruikt, moet u de API voor eigen abonnement management-service inschakelen. Uw API-abonnement management service moet communiceren rechtstreeks met de Azure Resource Manager-API's. API-service voor uw abonnement moet ondersteunen service inrichten, upgraden en annuleren.  
