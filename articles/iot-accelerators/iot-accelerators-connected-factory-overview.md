...
> [!NOTE]
> Als er problemen zijn met de implementatie van de oplossingsversneller, leest u [Machtigingen op de site azureiotsuite.com][lnk-permissions] en de [veelgestelde vragen over verbonden factory's](iot-accelerators-faq-cf.md). Als de problemen zich blijven voordoen, maakt u een serviceticket aan in de [portal][lnk-portal].
