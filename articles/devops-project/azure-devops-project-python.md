...
Het Azure DevOps-project biedt een vereenvoudigde ervaring voor het maken van Azure-resources en stelt een pijplijn in voor continue integratie (CI) en continue levering (CD) voor uw Python-app in Visual Studio Team Services (VSTS), de DevOps-oplossing voor Azure van Microsoft.  
...
1. Maak een **nieuw** VSTS-account of kies een **bestaand** account.  Kies een **naam** voor uw VSTS-project.  Selecteer uw **Azure-abonnement** en **locatie** en kies een **naam** voor uw toepassing.  Als u klaar bent, kiest u **Gereed**.
    ...
    ![VSTS-gegevens invoeren](_img/azure-devops-project-python/vstsazureinfo.png)
