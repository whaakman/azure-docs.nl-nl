...
Configureer continue integratie (CI) en continue levering (CD) voor uw **Go**-toepassing met het **Azure DevOps-project**.  Het Azure DevOps-project vereenvoudigt de eerste configuratie van een VSTS-build en -versiepijplijn.
...
1. Kies het pictogram **+ Resource maken** in de linkernavigatiebalk en zoek naar **DevOps-project**.  Kies **Maken**.
...
1. Maak gratis een **nieuw** VSTS-account of kies een **bestaand** account.  Kies een **naam** voor uw VSTS-project.  Selecteer uw **Azure-abonnement** en **locatie** en kies een **naam** voor uw toepassing.  Als u klaar bent, kiest u **Gereed**.
    ...
    ![VSTS-gegevens invoeren](_img/azure-devops-project-go/vstsazureinfo.png)
