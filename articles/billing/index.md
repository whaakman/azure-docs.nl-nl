        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>Opdrachtregel</h3>
                        <p><a href="/powershell/module/azurerm.billing/?view=azurermps-3.8.0">PowerShell voor het downloaden van facturen</a></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>Talen</h3>
                        <p><a href="/dotnet/api/microsoft.azure.management.billing">.NET-verwijzing voor het downloaden van facturen</a></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>REST</h3>
                        <p><a href="https://msdn.microsoft.com/library/azure/1ea5b323-54bb-423d-916f-190de96c6a3c">Gebruiks- en RateCard-API</a></p>
                        <p><a href="/rest/api/billing/">API voor facturen downloaden</a></p>
                    </div>
                </div>
            </div>
        </div>
