...
AccountOwnerId<sup>1</sup> | EA, PAYG | De unieke id voor het EA-inschrijvings account of het PAYG-facturerings account.
Extra informatie | Alle | Servicespecifieke meta gegevens. Bijvoorbeeld een afbeeldings type voor een virtuele machine.
BillingAccountId<sup>1</sup> | Alle | De unieke id voor het hoofd account van de facturering.
...
BillingProfileId<sup>1</sup> | Alle | De unieke id van de EA-inschrijving, het PAYG-abonnement, het MCA-facturerings profiel of het geconsolideerde AWS-account.
...
CostCenter<sup>1</sup> | EA, MCA | Het kosten centrum is voor het abonnement gedefinieerd voor het bijhouden van kosten (alleen beschikbaar in openstaande facturerings perioden voor MCA-accounts).
...
Datum<sup>1</sup> | Alle | Het gebruik of de aankoop datum van de kosten.
...
InvoiceSectionId<sup>1</sup> | EA, MCA | De unieke id voor de sectie EA Department of MCA invoice.
...
OfferId<sup>1</sup> | Alle | De naam van de gekochte aanbieding.
PartNumber<sup>1</sup> | EA, PAYG | Id die wordt gebruikt voor het ophalen van specifieke prijzen voor de meter.
...
_<sup>**1**</sup> velden die worden gebruikt om een unieke id voor één kosten record te maken._
