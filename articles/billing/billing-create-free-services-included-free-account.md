...
description: Informatie over het maken van services die deel uitmaakt van de gratis Azure-account.
documentationcenter: ''
...
Zie voor meer informatie over de beschikbaarheid van de Azure-service per regio, [producten die beschikbaar zijn in elke regio](https://azure.microsoft.com/regions/services/).

## <a name="multiple-instances-of-services-can-be-created-within-allowed-limits"></a>Meerdere exemplaren van services kunnen binnen de toegestane limieten worden gemaakt
U kunt meerdere exemplaren van services gratis maken, zolang de som van het gebruik van binnen de limiet voor het valt. Bijvoorbeeld, u 750 uren van een gratis B1S Windows virtuele machine elke maand met uw gratis Azure-account. U kunt 750 uren in elke combinatie die u wilt gebruiken. U kunt bijvoorbeeld 5 B1S Windows virtuele machines maken en deze worden gebruikt voor 150 uur. 
