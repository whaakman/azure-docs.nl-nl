...
1. Schakel het selectievakje naast de kaart die u wilt maken van de actieve betalingswijze wordt gebruikt.
1. Klik op **actief ingesteld**.
    ![Schermafbeelding van creditcard of betaalpas geselecteerd en actief ingesteld.](./media/billing-how-to-change-credit-card/sub-change-active-x.png)
