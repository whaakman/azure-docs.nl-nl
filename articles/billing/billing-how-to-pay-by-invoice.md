...
1. Selecteer **betalen met factuur** in de **probleemtype** vak.

1. Voer de volgende informatie in de **Details** vak en selecteer vervolgens **volgende**.

    * Bedrijfsnaam
    * Factuuradres
    * [E-mailadres van de administrator-account](billing-add-change-azure-subscription-administrator.md#check-the-account-administrator-of-the-subscription)
