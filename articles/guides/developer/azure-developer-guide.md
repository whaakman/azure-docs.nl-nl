...
-   **Service-principals**: naast toegang verlenen tot principals die gebruikers en groepen, kunt u dezelfde toegang verlenen aan een service-principal.
    ...
    > **Wanneer gebruikt u**: wanneer u programmatisch beheer van Azure-resources of verlenen van toegang voor toepassingen. Zie voor meer informatie [supplication van een Active Directory en service-principal](../../resource-group-create-service-principal-portal.md).
