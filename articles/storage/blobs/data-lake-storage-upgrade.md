...
ms.locfileid: "52975359"
---
# <a name="upgrade-your-big-data-analytics-solutions-from-azure-data-lake-gen1-to-azure-data-lake-storage-gen2-preview"></a>Upgrade van uw big data analytics-oplossingen van Azure Data Lake Gen1 naar Gen2 Preview van Azure Data Lake-opslag
...
| Java SDK-bestandssysteem                  | [Koppeling](https://docs.microsoft.com/java/api/overview/azure/datalakestore/client)                                                                                                                                                                                                                                         | *Nog niet beschikbaar*                                                | *Nog niet beschikbaar*                                                                                                                                             |
...
| PowerShell - beheer en bestandssysteem | [Link](https://docs.microsoft.com/powershell/module/azurerm.datalakestore/?view=azurermps-6.3.0)                                                                                                                                                                                                                        | Beheer: niet ondersteund bestandssysteem - *nog niet beschikbaar*        | Management – *beschikbaar nu -* [koppeling](https://docs.microsoft.com/powershell/module/azure.storage/?view=azurermps-6.13.0) bestandssysteem - *nog niet beschikbaar* |
...
|                      | Databricks Runtime 3.1 en hoger                                                                                                                                               | [Databricks Runtime 4.2 en hoger](https://docs.azuredatabricks.net/spark/latest/data-sources/azure/azure-datalake-gen2.html#azure-data-lake-storage-gen2) *- nu beschikbaar* | Databricks Runtime 5.1 en hoger: *nu beschikbaar*                                                                                              |
|                      | [SQL Data Warehouse ](https://docs.microsoft.com/azure/sql-data-warehouse/sql-data-warehouse-load-from-azure-data-lake-store)                                            | *Niet ondersteund*                                                                                                                                                              | **Er zijn nu beschikbaar -** [koppeling](https://docs.microsoft.com/sql/t-sql/statements/create-external-data-source-transact-sql?view=sql-server-2017) |
...
|                     | Cloudera     | Altus                | [Link](https://www.cloudera.com/more/news-and-blogs/press-releases/2017-09-27-cloudera-introduces-altus-data-engineering-microsoft-azure-hybrid-multi-cloud-data-analytic-workflows.html) | N.v.t.                                                                                                                   | *Nog niet beschikbaar*                                                                                                  |
...
* Data Lake Storage Gen2 alleen ondersteunt bestanden tot 5 TB in grootte. Om te upgraden naar Data Lake Storage Gen2, moet u mogelijk de bestanden in Data Lake Storage Gen1 vergroten of verkleinen zodat deze groter is dan 5 TB groot zijn.
