...
![Azure Databricks met Data Lake Store Gen2 en SQL Data Warehouse](./media/data-lake-storage-handle-data-using-databricks/databricks-extract-transform-load-sql-datawarehouse.png "Azure Databricks met Data Lake Store Gen2 en SQL Data Warehouse")
...
3. Voer in het dialoogvenster **Notitieblok maken** een naam voor het notitieblok in. Selecteer **Scala** als taal en selecteer het Spark-cluster dat u eerder hebt gemaakt.
    ...
    ![Een notitieblok maken in Databricks](./media/data-lake-storage-handle-data-using-databricks/databricks-notebook-details.png "Een notitieblok maken in Databricks")

    Selecteer **Maken**.

4. Voer de volgende code in de eerste cel in en voer de code uit. Vergeet niet de tijdelijke aanduidingen tussen haken in het voorbeeld te vervangen door uw eigen waarden:
...
5. Druk op **SHIFT+ENTER** om de codecel uit te voeren.
...
> [!NOTE]
> Als u nog geen account hebt dat geschikt is voor Azure Data Lake Storage Gen2, volgt u de [snelstart om er een te maken](./data-lake-storage-quickstart-create-account.md).
...
6. Maak verbinding met de SQL-database en controleer of u de **SampleTable** ziet.
    ...
    ![Voorbeeldtabel verifiëren](./media/data-lake-storage-handle-data-using-databricks/verify-sample-table.png "Voorbeeldtabel verifiëren")
...
7. Voer een Select-query uit om de inhoud van de tabel te controleren. Deze moet dezelfde gegevens bevatten als het **renamedColumnsDF**-dataframe.
    ...
    ![Inhoud van voorbeeldtabel controleren](./media/data-lake-storage-handle-data-using-databricks/verify-sample-table-content.png "Inhoud van voorbeeldtabel controleren")
