...
4. Vul het formulier voor opslagaccounts met de volgende informatie, zoals weergegeven in de volgende afbeelding, en selecteer **maken**:
   ...
   | **Naam van opslagaccount** | mystorageaccount | Een unieke naam voor uw opslagaccount |
   ...
   | **Toegangslaag** | Warm | Hot is voldoende voor het voorbeeldscenario. |
...
1. Open een shell en blader naar **storage-blobs-java-v10-tutorial-master** binnen de gekloonde map.
