...
## .NET
### [Blob, wachtrij, tabel en bestand](https://msdn.microsoft.com/library/azure/mt347887.aspx)
### [Resourceprovider](/dotnet/api/)
### [Gegevensverplaatsing](/dotnet/api/)

## REST
### [Blob, wachtrij, tabel en bestand](/rest/api/storageservices/fileservices/azure-storage-services-rest-api-reference)
