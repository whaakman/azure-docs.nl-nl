...
* <a id="why-files-useful"></a>**Hoe wordt Azure Files nuttig?**  
...
* <a id="tier-options"></a>**Welke opslaglagen worden ondersteund in Azure-bestanden?**  
...
* <a id="give-us-feedback"></a>**Ik wil een specifieke functie die is toegevoegd aan Azure-bestanden. Kunt u deze toevoegen?**  
...
* <a id="afs-change-detection"></a>**Ik heb een bestand rechtstreeks in mijn Azure-bestandsshare met behulp van SMB of in de portal gemaakt. Hoe lang duurt het voor het bestand wordt gesynchroniseerd met de servers in de groep voor synchronisatie?**  
...
* <a id="afs-storage-redundancy"></a>**Is geografisch redundante opslag voor Azure bestand synchronisatie ondersteund?**  
...
* <a id="is-my-file-tiered"></a>**Hoe kan ik zien of een bestand is gelaagd?**  
...
* <a id="afs-force-tiering"></a>**Hoe ik afdwingen dat een bestand of map tiers worden verdeeld?**  
...
* <a id="afs-os-support"></a>**Kan ik Azure bestand synchronisatie met Windows Server 2008 R2, Linux of mijn apparaat NAS-opslag (NAS) gebruiken?**  
...
* <a id="encryption-at-rest"></a>**Hoe zorgt dat mijn Azure-bestandsshare in rust versleuteld?**  
...
* <a id="data-compliance-policies"></a>**Welke gegevens nalevingsbeleid biedt ondersteuning voor Azure Files?**  
...
* <a id="what-are-snaphots"></a>**Wat zijn de momentopnamen van bestanden delen?**  
...
* <a id="snapshot-perf-impact"></a>**Zijn er geen gevolgen voor prestaties voor het gebruik van momentopnamen van de share?**  
    Share momentopnamen hoeft niet elke prestatieoverhead.

* <a id="snapshot-consistency"></a>**Share momentopnamen toepassingsconsistente zijn?**  
...
* <a id="snapshot-limits"></a>**Zijn er beperkingen met betrekking tot het aantal momentopnamen van de share die kan worden gebruikt?**  
...
* <a id="encypted-snapshots"></a>**Kan ik share momentopnamen van een gecodeerde bestandsshare maken?**  
...
* <a id="delete-share-keep-snapshots"></a>**Kan ik mijn share verwijderen maar niet verwijderen van mijn momentopnamen share?**  
...
* <a id="need-larger-share"></a>**Ik moet een grotere bestandsshare dan Azure Files is momenteel biedt. Kan ik het formaat van mijn Azure-bestandsshare verhogen?**  
...
* <a id="zip-slow-performance"></a>**Mijn is traag bij het uitpakken van bestanden in de Azure-bestanden. Wat moet ik doen?**  
...
* <a id="slow-perf-windows-81-2012r2"></a>**Waarom wordt mijn trage prestaties nadat ik mijn Azure-bestandsshare op Windows Server 2012 R2 of Windows 8.1 koppelen?**  
...
* <a id="containers"></a>**Kan ik een Azure-bestandsshare op een Azure-Container-exemplaar koppelen?**  
...
* <a id="nested-shares"></a>**Kan ik geneste shares instellen? Met andere woorden, een share onder een share?**  
    Nee. De bestandsshare *is* het virtuele stuurprogramma dat u koppelen kunt, zodat geneste shares worden niet ondersteund.

* <a id="ibm-mq"></a>**Hoe gebruik ik Azure-bestanden met IBM MQ**  
