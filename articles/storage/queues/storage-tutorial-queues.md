...
1. Installeer de **WindowsAzure. Opslag** pakket aan het project met de `dotnet add package` opdracht. De volgende dotnet-opdracht uitvoeren vanuit de projectmap in het consolevenster.
