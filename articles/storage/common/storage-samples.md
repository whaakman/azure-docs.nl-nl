...
* [Shared access signature voor](https://github.com/Azure/azure-storage-node/blob/master/examples/samples/sassample.js)
...
## <a name="api-reference-and-source-code"></a>API-verwijzing en de bron-code
