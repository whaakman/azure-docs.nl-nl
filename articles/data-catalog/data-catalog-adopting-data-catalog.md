<properties
    pageTitle="Overstappen op Azure Data Catalog | Microsoft Azure"
...
## Uw projectvisie voor Data Catalog definiëren
...
### Gegevensproducenten en -gebruikers identificeren
...
> [AZURE.NOTE] We hebben een voorbeeldprogramma geschreven dat gebruik maakt van de API van **Azure Data Catalog** API om een Excel-werkmap te migreren naar Data Catalog. Voor meer informatie over de API van Data Catalog en het voorbeeldprogramma, kunt u [De voorbeeldcode van de Ad Hoc-werkmap downloaden](https://azure.microsoft.com/documentation/samples/data-catalog-dotnet-excel-register-data-assets/) en de documentatie van de [REST API van Azure Data Catalog](https://msdn.microsoft.com/library/azure/mt267593.aspx) lezen.
...
## Meer informatie over Azure Data Catalog
