...
![Pagina Toepassing maken van Azure IoT Central](media/quick-deploy-iot-central-experimental/iotcentralcreate.png)
...
> [Volg een rondleiding door IoT Central](https://docs.microsoft.com/azure/iot-central/overview-iot-central-tour)
