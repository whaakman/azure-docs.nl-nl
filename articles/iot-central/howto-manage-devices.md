...
1. Het geëxporteerde CSV-bestand heeft de volgende informatie in de kolommen: **Apparaat-Id, de naam van apparaat, apparaat Priamry/secundaire sleutels en primaire/secundaire certificaatvingerafdrukken**
    *   IOTC_DEVICEID
    *   IOTC_DEVICENAME
    *   IOTC_SASKEY_PRIMARY
