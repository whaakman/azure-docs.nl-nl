...
3. Controleer of de geïnstalleerde versies van de modules.
      ...
      ```
4. Aanmelden bij Azure met de [Connect AzAccount](/powershell/module/az.profile/connect-azaccount) cmdlet.
