...
description: hoofdpagina voor de Microsoft Threat Modeling Tool, met informatie over aan de slag met het hulpprogramma, met inbegrip van het proces Threat Modeling
services: security
...
* Communiceren over het beveiligingsontwerp van de van hun systemen
* De modellen voor mogelijke beveiligingsproblemen met behulp van een bewezen methodologie analyseren
* Voorstellen en oplossingen voor beveiligingsproblemen met beheren
...
| **5** | [Zoeken om gegenereerde bedreigingen](./azure-security-threat-modeling-tool-mitigations.md) |

## <a name="resources"></a>Resources

Hier volgen enkele oudere artikelen nog steeds relevant zijn voor threat modeling vandaag:
