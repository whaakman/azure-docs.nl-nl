...
| **kenmerken**              | N/A  |
| **Verwijzingen**              | N/A  |
| **Stappen** | Om te controleren of deze fase via is uitgevoerd door een legitieme gebruiker die u wilt afdwingen van de toepassing alleen zakelijke logica processtromen in opeenvolgende volgorde, met alle stappen in de realistische menselijke tijd wordt verwerkt en niet verwerken volgorde, overgeslagen stappen , verwerkt de stappen van een andere gebruiker of transacties te snel verzonden.|
