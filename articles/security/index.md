            ...
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">Ik overweeg Azure voor mijn bedrijf. Wat heeft Azure te bieden?</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <a href="/azure/security/azure-isolation">
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">Hoe scheidt Azure mijn resources van die van andere Azure-klanten?</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <a href="/azure/security/azure-log-audit">
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">Welke controle- en logboekregistratie-opties zijn er beschikbaar in Azure?</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card">
                    <div class="cardText">
                        ...
                        <ul class="noBullet">
                            ...
                            <li style="list-style: none;">
                                <a class="barLink" href="/azure/security/azure-network-security">Azure-netwerkbeveiliging</a>
                            </li>
                        </ul>
                    </div>
                </div>
