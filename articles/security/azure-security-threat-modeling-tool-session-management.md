...
| **Azure Document DB** | <ul><li>[Minimale token levensduur voor tokens voor gegenereerde Resource gebruiken](#resource-tokens)</li></ul> |
| **ADFS** | <ul><li>[Juiste afmelding WsFederation methoden gebruiken wanneer u AD FS implementeren](#wsfederation-logout)</li></ul> |
| **Identity Server** | <ul><li>[Implementeren in de juiste afmelden bij gebruik van Identiteitsserver](#proper-logout)</li></ul> |
