...
![Diagram activiteiten logboek](./media/azure-log-audit/azure-log-audit-fig1.png)
...
![Diagrammen van Azure Diagnostics-logboeken](./media/azure-log-audit/azure-log-audit-fig2.png)
...
![Logboeken voor virtuele machines die gebruikmaken van Azure Diagnostics](./media/azure-log-audit/azure-log-audit-fig3.png)
...
![Azure-netwerk logboeken](./media/azure-log-audit/azure-log-audit-fig4.png)
...
|Azure Event hub-naam ruimte| Microsoft.EventHub/<br>naam ruimten|  Diagnostiek|    Diagnostiek||
...
|Service Bus-naamruimte| Microsoft.ServiceBus/<br>naam ruimten|    Diagnostiek|Diagnostiek|    [Service Bus-analyse (Preview)](https://github.com/Azure/azure-quickstart-templates/tree/master/oms-servicebus-solution)|
...
||||Diagnostiek||
|Virtuele-machineschaalsets|    Microsoft.Compute/<br>Informatie    ||Diagnostiek||
...
![Diagram voor logboek integratie](./media/azure-log-audit/azure-log-audit-fig9.png)
...
| Logboek type | Azure Monitor logboeken die JSON ondersteunen (Splunk, ArcSight en IBM QRadar) |
| :------- | :-------------------------------------------------------- |
