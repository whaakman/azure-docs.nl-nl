...
- Installeren of bijwerken naar de [nieuwste versie van de module Azure PowerShell](/powershell/azure/install-az-ps)
    - De AZ-module versie moet 1.0.0 of hoger zijn. Gebruik `Get-Module Az -ListAvailable | Select-Object -Property Name,Version,Path` om de versie te controleren.
...
![Het script met vereisten voor Azure Disk Encryption dat wordt uitgevoerd in PowerShell ISE](./media/quick-encrypt-vm-powershell/ade-prereq-script.PNG)
...
Nu u een sleutel kluis en een virtuele machine hebt gemaakt en geconfigureerd, kunt u de schijf versleutelen met de cmdlet **set-AzVmDiskEncryptionExtension** . 
