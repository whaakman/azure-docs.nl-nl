...
![alternatieve tekst](images/fedramp-iaaswa-architecture.png?raw=true "Azure-beveiliging en naleving blauwdruk - FedRAMP Web Applications Automation")
