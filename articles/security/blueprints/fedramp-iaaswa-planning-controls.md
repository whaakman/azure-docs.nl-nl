---
title: Azure-beveiliging en naleving blauwdruk - FedRAMP Web Applications Automation - plannen
description: FedRAMP Web Applications Automation - plannen
services: security
...
## <a name="nist-800-53-control-pl-1"></a>NIST 800 53 besturingselement PL-1

#### <a name="security-planning-policy-and-procedures"></a>Beveiligingsbeleid plannen en Procedures
...
|||
|---|---|
| **De klant** | Van de klant op bedrijfsniveau beveiligingsplanning beleid en procedures mogelijk onvoldoende voor het oplossen van dit besturingselement. |
| **Provider (Microsoft Azure)** | Niet van toepassing |


 ## <a name="nist-800-53-control-pl-2a"></a>NIST 800 53 besturingselement PL-2.

#### <a name="system-security-plan"></a>Systeem beveiligingsplan
...
|||
|---|---|
| **De klant** | De klant is verantwoordelijk voor het ontwikkelen van een systeem beveiligingsplan (SSP) die voldoet aan de criteria die zijn gedefinieerd door de doel-autorisatie (bijv, FedRAMP). Klanten kunnen verwijzen naar NIST Special Publication 800-18 R1, handleiding voor het ontwikkelen van beveiliging plannen van de Federal Information Systems. De klant SSP moet adres van de besturingselementen die zijn overgenomen van Microsoft Azure en Raadpleeg de Microsoft Azure-SSP voor implementatiegegevens. |
| **Provider (Microsoft Azure)** | Niet van toepassing |


 ## <a name="nist-800-53-control-pl-2b"></a>NIST 800 53 besturingselement PL-2.b
...
|||
|---|---|
| **De klant** | De klant is verantwoordelijk voor het distribueren van het systeem-beveiligingsplan. |
| **Provider (Microsoft Azure)** | Niet van toepassing |


 ## <a name="nist-800-53-control-pl-2c"></a>NIST 800 53 besturingselement PL-2.c
...
|||
|---|---|
| **De klant** | De klant is verantwoordelijk voor het controleren van het systeem-beveiligingsplan. |
| **Provider (Microsoft Azure)** | Niet van toepassing |


 ## <a name="nist-800-53-control-pl-2d"></a>NIST 800 53 besturingselement PL-2.d
...
|||
|---|---|
| **De klant** | De klant is verantwoordelijk voor het bijwerken van het systeem-beveiligingsplan. |
| **Provider (Microsoft Azure)** | Niet van toepassing |


 ## <a name="nist-800-53-control-pl-2e"></a>NIST 800 53 besturingselement PL-2.e
...
|||
|---|---|
| **De klant** | De klant is verantwoordelijk voor het beveiligen van het systeem-beveiligingsplan. |
| **Provider (Microsoft Azure)** | Niet van toepassing |


 ### <a name="nist-800-53-control-pl-2-3"></a>NIST 800 53 besturingselement PL-2 (3)

#### <a name="system-security-plan--plan--coordinate-with-other-organizational-entities"></a>Systeem beveiligingsplan | Plan / werkt u samen met andere organisatie-eenheden
...
|||
|---|---|
| **De klant** | De klant is verantwoordelijk voor het plannen en aan beveiliging gerelateerde activiteiten om te beperken van de impact op de andere organisatie entiteiten coördineren. |
| **Provider (Microsoft Azure)** | Niet van toepassing |


 ## <a name="nist-800-53-control-pl-4a"></a>NIST 800 53 besturingselement PL-4.

#### <a name="rules-of-behavior"></a>Regels van gedrag
...
|||
|---|---|
| **De klant** | Van de klant op bedrijfsniveau regels van gedrag mogelijk onvoldoende voor het oplossen van dit besturingselement. |
| **Provider (Microsoft Azure)** | Niet van toepassing |


 ## <a name="nist-800-53-control-pl-4b"></a>NIST 800 53 besturingselement PL-4.b
...
| **Provider (Microsoft Azure)** | Niet van toepassing |
 ...
 ## <a name="nist-800-53-control-pl-4c"></a>NIST 800 53 besturingselement PL-4.c
...
| **Provider (Microsoft Azure)** | Niet van toepassing |
 ...
 ## <a name="nist-800-53-control-pl-4d"></a>NIST 800 53 besturingselement PL-4.d
...
| **Provider (Microsoft Azure)** | Niet van toepassing |
 ...
 ### <a name="nist-800-53-control-pl-4-1"></a>NIST 800 53 besturingselement PL-4 (1)

#### <a name="rules-of-behavior--social-media-and-networking-restrictions"></a>Regels van gedrag | Sociale Media en beperkingen voor netwerken
...
|||
|---|---|
| **De klant** | De klant op bedrijfsniveau regels van de werking van gebruiksbeperkingen sociale media / sites netwerken. |
| **Provider (Microsoft Azure)** | Niet van toepassing |


 ## <a name="nist-800-53-control-pl-8a"></a>NIST 800 53 besturingselement PL-8.

#### <a name="information-security-architecture"></a>Informatie-beveiligingsarchitectuur
...
|||
|---|---|
| **De klant** | De klant is verantwoordelijk voor het ontwikkelen van een informatiearchitectuur beveiliging voor bronnen klant geïmplementeerd. |
| **Provider (Microsoft Azure)** | Niet van toepassing |


 ## <a name="nist-800-53-control-pl-8b"></a>NIST 800 53 besturingselement PL-8.b
...
|||
|---|---|
| **De klant** | De klant is verantwoordelijk voor het controleren en bijwerken van de beveiligingsarchitectuur informatie. |
| **Provider (Microsoft Azure)** | Niet van toepassing |


 ## <a name="nist-800-53-control-pl-8c"></a>NIST 800 53 besturingselement PL-8.c
...
|||
|---|---|
| **De klant** | De klant is verantwoordelijk voor accounting voor geplande wijzigingen aan de informatiearchitectuur voor beveiliging. |
| **Provider (Microsoft Azure)** | Niet van toepassing |
