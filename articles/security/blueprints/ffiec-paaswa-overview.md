...
**App Service Environment v2**: De Azure App Service-omgeving is een App Service-functie waarmee een volledig geïsoleerde en toegewezen omgeving voor App Service-toepassingen op een grote schaal veilig kunnen worden uitgevoerd. Deze functie isolatie is vereist om te voldoen aan nalevingsvereisten FFIEC.
