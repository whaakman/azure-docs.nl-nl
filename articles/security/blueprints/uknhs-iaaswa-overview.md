---
title: Azure-beveiliging en naleving blauwdruk - IaaS-webtoepassing voor UK NHS
description: Azure-beveiliging en naleving blauwdruk - IaaS-webtoepassing voor UK NHS
services: security
author: jomolesk
...
![IaaS-webtoepassing voor UK NHS verwijzing Architectuurdiagram](images/uknhs-iaaswa-architecture.png?raw=true "IaaS-webtoepassing voor UK NHS verwijzing Architectuurdiagram")
...
**Cloud-Witness**: [Cloud-Witness](https://docs.microsoft.com/windows-server/failover-clustering/whats-new-in-failover-clustering#BKMK_CloudWitness) is een type failovercluster-quorumwitness in Windows Server 2016 die gebruikmaakt van Azure als arbitragepunt. De Cloud-Witness, net als elke andere quorumwitness een stem opgehaald en kunt deelnemen aan de quorumberekeningen, maar hierbij de standaard openbare Azure Blob Storage. Dit elimineert de noodzaak extra onderhoud van virtuele machiness die wordt gehost in een openbare cloud.
...
Het diagram van de gegevensstroom voor deze referentiearchitectuur is beschikbaar voor [downloaden](https://aka.ms/uknhs-iaaswa-tm) of vindt u hieronder. Dit model kunt klanten inzicht krijgen in de punten van de mogelijke risico's in de infrastructuur van het systeem als u wijzigingen aanbrengt.

![IaaS-webtoepassing voor UK NHS risicomodel](images/uknhs-iaaswa-threat-model.png?raw=true "IaaS-webtoepassing voor UK NHS risicomodel")
...
De [Azure-beveiliging en naleving blauwdruk – Verenigd Koninkrijk NHS IaaS Web Application implementatie Matrix](https://aka.ms/uknhs-iaaswa-cim) biedt informatie over welke NHS UK vereisten worden verholpen door de IaaS-architectuur voor web-toepassing, met inbegrip van gedetailleerde beschrijvingen van hoe de implementatie voldoet aan de vereisten van elk principe besproken.
