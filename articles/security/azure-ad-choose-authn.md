...
* **Overwegingen:** Wachtwoordhashsynchronisatie worden niet onmiddellijk afgedwongen door wijzigingen in het lokale account statussen momenteel. In dit geval heeft een gebruiker toegang tot de cloud-apps totdat de status van de gebruiker is gesynchroniseerd met Azure AD. Als deze beperking ondervangen dat organisaties willen, is het raadzaam om een nieuwe synchronisatiecyclus wordt geactiveerd nadat beheerders bulksgewijs updates voor de lokale gebruiker account status, zoals het uitschakelen van accounts. 

> [!NOTE] 
> Het wachtwoord is verlopen en account vergrendeld statussen zijn momenteel niet gesynchroniseerd met Azure AD met Azure AD Connect. 
...
* **Geavanceerde scenario's:** Pass through-verificatie wordt het beleid van de account on-premises afgedwongen op het moment van aanmelden. Bijvoorbeeld: toegang is geweigerd, wanneer een lokale gebruikersaccount status is uitgeschakeld, vergrendeld, waardoor [wachtwoord verlopen](https://docs.microsoft.com/en-us/azure/active-directory/connect/active-directory-aadconnect-pass-through-authentication-faq#what-happens-if-my-users-password-has-expired-and-they-try-to-sign-in-by-using-pass-through-authentication ) of valt buiten de gebruiker zich kan aanmelden toegestaan.  Organisaties die behoefte hebben multi-factor authentication met Pass through-verificatie moeten gebruikmaken van Azure multi-factor Authentication (MFA) en een methode van derden of on-premises meervoudige verificatie niet gebruiken. Geavanceerde functies, zoals het rapport gelekte referenties van de beveiliging van de identiteit is vereist dat Wachtwoordhashsynchronisatie ongeacht wordt geïmplementeerd als u ervoor Pass through-verificatie kiest.
...
## <a name="comparing-the-authentication-methods"></a>Vergelijking van de verificatiemethoden

|Overweging|Wachtwoordhashsynchronisatie + naadloze eenmalige aanmelding|Pass through-verificatie + naadloze eenmalige aanmelding|Federatie met AD FS|
|:-----|:-----|:-----|:-----|
...
|Wat zijn de vereisten voor on-premises server buiten het provisioning-systeem: Azure AD Connect?|Geen|1-server voor elke aanvullende verificatie-agent|2 of meer AD FS-servers<br>2 of hoger WAP-servers in het perimeternetwerk/DMZ netwerk|
|Wat zijn lokale Internet- en netwerkvereisten afgezien van de inrichting system?|Geen|[Uitgaande toegang tot Internet](https://docs.microsoft.com/en-us/azure/active-directory/connect/active-directory-aadconnect-pass-through-authentication-quick-start) vanaf de servers met verificatie agents|[Toegang tot Internet voor binnenkomende](https://docs.microsoft.com/en-us/windows-server/identity/ad-fs/overview/ad-fs-requirements) naar WAP-servers in de perimeter<br>Inkomende netwerktoegang tot AD FS-servers van WAP-servers in de perimeter<br>Netwerktaakverdeling|
...
|Welke typen aanmelden worden ondersteund?|UserPrincipalName + wachtwoord<br>Met behulp van geïntegreerde Windows-verificatie [naadloze eenmalige aanmelding](https://docs.microsoft.com/en-us/azure/active-directory/connect/active-directory-aadconnect-sso)<br>[Alternatieve aanmeldings-ID](https://docs.microsoft.com/en-us/azure/active-directory/connect/active-directory-aadconnect-get-started-custom)|UserPrincipalName + wachtwoord<br>Met behulp van geïntegreerde Windows-verificatie [naadloze eenmalige aanmelding](https://docs.microsoft.com/en-us/azure/active-directory/connect/active-directory-aadconnect-sso)<br>[Alternatieve aanmeldings-ID](https://docs.microsoft.com/en-us/azure/active-directory/connect/active-directory-aadconnect-pass-through-authentication-faq)|UserPrincipalName + wachtwoord<br>sAMAccountName + wachtwoord<br>Geïntegreerde Windows-verificatie<br>[Certificaat- en Smartcard-verificatie](https://docs.microsoft.com/en-us/windows-server/identity/ad-fs/operations/configure-user-certificate-authentication)<br>[Alternatieve aanmeldings-ID](https://docs.microsoft.com/en-us/windows-server/identity/ad-fs/operations/configuring-alternate-login-id)|
|Is Windows Hello voor bedrijven ondersteund?|[Sleutel vertrouwensmodel](https://docs.microsoft.com/en-us/windows/security/identity-protection/hello-for-business/hello-identity-verification)<br>[Certificaat vertrouwensmodel met Intune](https://blogs.technet.microsoft.com/microscott/setting-up-windows-hello-for-business-with-intune/)|[Sleutel vertrouwensmodel](https://docs.microsoft.com/en-us/windows/security/identity-protection/hello-for-business/hello-identity-verification)<br>[Certificaat vertrouwensmodel met Intune](https://blogs.technet.microsoft.com/microscott/setting-up-windows-hello-for-business-with-intune/)|[Sleutel vertrouwensmodel](https://docs.microsoft.com/en-us/windows/security/identity-protection/hello-for-business/hello-identity-verification)<br>[Vertrouwensmodel van certificaat](https://docs.microsoft.com/en-us/windows/security/identity-protection/hello-for-business/hello-key-trust-adfs)|
|Wat zijn de opties voor meervoudige verificatie?|[Azure MFA](https://docs.microsoft.com/en-us/azure/multi-factor-authentication/)|[Azure MFA](https://docs.microsoft.com/en-us/azure/multi-factor-authentication/)|[Azure MFA](https://docs.microsoft.com/en-us/azure/multi-factor-authentication/)<br>[Azure MFA-Server](https://docs.microsoft.com/en-us/azure/active-directory/authentication/howto-mfaserver-deploy)<br>[MFA van derden](https://docs.microsoft.com/en-us/windows-server/identity/ad-fs/operations/configure-additional-authentication-methods-for-ad-fs)|
|Welke status voor het account van gebruikers worden ondersteund?|Uitgeschakelde accounts<br>(maximaal 30 minuten vertraging)|Uitgeschakelde accounts<br>Account vergrendeld<br>Wachtwoord is verlopen<br>Aanmeldingstijden|Uitgeschakelde accounts<br>Account vergrendeld<br>Wachtwoord is verlopen<br>Aanmeldingstijden|
|Wat zijn de opties voor voorwaardelijke toegang?|[Azure AD-voorwaardelijke toegang ](https://docs.microsoft.com/en-us/azure/active-directory/active-directory-conditional-access-azure-portal)|[Azure AD-voorwaardelijke toegang ](https://docs.microsoft.com/en-us/azure/active-directory/active-directory-conditional-access-azure-portal)|[Azure AD-voorwaardelijke toegang](https://docs.microsoft.com/en-us/azure/active-directory/active-directory-conditional-access-azure-portal)<br>[Claimregels van AD FS](https://adfshelp.microsoft.com/AadTrustClaims/ClaimsGenerator)|
...
|Welke geavanceerde scenario's worden ondersteund?|[Smart wachtwoord vergrendelen](https://docs.microsoft.com/en-us/azure/active-directory/active-directory-secure-passwords)<br>[Gelekte referenties rapporten](https://docs.microsoft.com/en-us/azure/active-directory/active-directory-reporting-risk-events)|[Smart wachtwoord vergrendelen](https://docs.microsoft.com/en-us/azure/active-directory/connect/active-directory-aadconnect-pass-through-authentication-smart-lockout)|Lage latentie voor meerdere locaties-verificatiesysteem.<br>[AD FS-extranetvergrendeling](https://docs.microsoft.com/en-us/windows-server/identity/ad-fs/operations/configure-ad-fs-extranet-lockout-protection)<br>[Integratie met systemen van derden-identiteit](https://docs.microsoft.com/en-us/azure/active-directory/connect/active-directory-aadconnect-federation-compatibility)|
...
Ten slotte op [Gartner](https://info.microsoft.com/landingIAMGartnerreportregistration.html), Microsoft heeft de meest uitgebreide reeks Identity and Access Management-functies. Microsoft-ingangen [450 miljard verificatieaanvragen](https://www.microsoft.com/en-us/security/intelligence-report) elke maand om toegang te bieden tot duizenden SaaS-toepassingen zoals Office 365 vanaf vrijwel elk apparaat. 
