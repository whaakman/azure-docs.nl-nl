---
title: Azure-Services in de FedRAMP- en DoD SRG Audit bereik
description: In dit artikel bevat tabellen voor openbare Azure- en Azure Government die laten welke FedRAMP (gemiddeld vs zien. Hoog) en audit-bereik voor Amerikaanse ministerie van defensie SRG (Impact level 2, 4 of 5) is een bepaalde service is bereikt.
author: davib
ms.author: davib
ms.date: 5/17/2019
ms.topic: article
...
ms.locfileid: "66743087"
---
# <a name="azure-services-by-fedramp-and-dod-cc-srg-audit-scope"></a>Azure-services per FedRAMP- en DoD CC SRG controleren scope

De Microsoft government cloud-services te voldoen aan de veeleisende behoeften van de VS Federal Risk & Authorization Management Program (FedRAMP) en van het Amerikaanse ministerie van defensie, van informatie impactniveau 2 t/m 5. Beveiligd door het implementeren van services zoals Azure Government, Office 365 US Overheids- en Dynamics 365 Government, federale en defense instanties kunnen gebruikmaken van een uitgebreide reeks compatibele services.

Dit artikel bevat een gedetailleerd overzicht van binnen de regeling vallen cloudservices voor Azure en Azure Government voor FedRAMP- en DoD CC SRG compliance-aanbiedingen.

#### <a name="terminologysymbols-used"></a>Terminologie/symbolen die worden gebruikt

* DoD CC SRG = Security Requirements Guide voor Cloudcomputing ministerie van defensie
* IIL = informatie invloedsniveau
* FedRAMP = Federal Risk and Authorization Management Program  
* : heavy_check_mark: = geeft aan dat de service heeft behaald dit bereik audit.

## <a name="azure-public-services-by-audit-scope"></a>Openbare Azure-services door een controlebeleid bereik
| _Laatst bijgewerkt: Mei 2019_ |

| Azure-service| DoD CC SRG IIL 2 | FedRAMP Gemiddeld | FedRAMP Hoog | Geplande 2019 |
| ------------ |:---------------:|:----------------:|:------------:|:------------:|
...
| [Azure Active Directory (gratis en Basic)](https://azure.microsoft.com/services/active-directory/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |  |
| [Azure Active Directory (Premium P1 en P2)](https://azure.microsoft.com/services/active-directory/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |  |
...
| [Azure Database migratieservice](https://azure.microsoft.com/services/database-migration/) |  |  |  | :heavy_check_mark: |
...
| [Stroom](https://docs.microsoft.com/flow/getting-started) |  | :heavy_check_mark: | :heavy_check_mark: |  |
| [Functies](https://azure.microsoft.com/services/functions/) |  |  |  | :heavy_check_mark: |
...
| [Opslag: Schijven (inclusief beheerde schijven)](https://azure.microsoft.com/services/storage/disks/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |  |
| [Opslag: Bestanden](https://azure.microsoft.com/services/storage/files/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |  |
| [Opslag: Queues](https://azure.microsoft.com/services/storage/queues/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |  |
| [Opslag: Tabellen](https://azure.microsoft.com/services/storage/tables/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |  |
...
| [Virtuele Machines (inclusief gereserveerde instanties)](https://azure.microsoft.com/services/virtual-machines/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |  |
...
&ast;&ast; Azure Databricks SOC attestation bevat alleen SOC 2 Type 2-rapport

## <a name="azure-government-services-by-audit-scope"></a>Azure government-services door een controlebeleid bereik
| _Laatst bijgewerkt: Mei 2019_ |

| Azure-service | DoD CC SRG IIL 2 | DoD CC SRG IIL 4 | DoD CC SRG IIL 5 | FedRAMP Hoog | Geplande 2019
| ------------- |:---------------:|:---------------:|:---------------:|:------------:|:------------:
...
| [Automation](https://azure.microsoft.com/services/automation/) | :heavy_check_mark: | :heavy_check_mark: |  | :heavy_check_mark: |
| [Azure Active Directory (gratis en Basic)](https://azure.microsoft.com/services/active-directory/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |
| [Azure Active Directory (Premium P1 en P2)](https://azure.microsoft.com/services/active-directory/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |
...
| [Cognitive Services: Aangepaste spraak](https://aka.ms/speechcustomization) |  |  |  |  |
...
| [Stroom](https://docs.microsoft.com/flow/getting-started) | :heavy_check_mark: | :heavy_check_mark: |  | :heavy_check_mark: | :heavy_check_mark:
...
| [Opslag: Schijven (inclusief beheerde schijven)](https://azure.microsoft.com/services/storage/disks/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |
| [Opslag: Bestanden](https://azure.microsoft.com/services/storage/files/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |
| [Opslag: Queues](https://azure.microsoft.com/services/storage/queues/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |
| [Opslag: Tabellen](https://azure.microsoft.com/services/storage/tables/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |
...
**&ast;** Sommige services zoals Azure portal en Azure Resource Manager niet opslaan of DoD CC SRG IIL 5 inhoud verwerken echter nog steeds nemen over de IIL5 besturingselement ingesteld.
