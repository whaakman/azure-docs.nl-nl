...
Retourneert een NULL-waarde. De functie syntax(null()) gebruiken als u de naam van een kolom met de naam 'null'. Elke bewerking die gebruikmaakt van leidt tot een null-waarde * ``custId = NULL (for derived field)``
* ``custId == NULL -> NULL``
* ``'nothing' + NULL -> NULL``
* ``10 * NULL -> NULL'``
* ``NULL == '' -> NULL'``
...
==============================
<code><b>log(<i>&lt;value1&gt;</i> : number, [<i>&lt;value2&gt;</i> : number]) => double</b></code><br/><br/>
Berekent de logaritmische waarde. Een optionele base kan worden opgegeven anders een nummer euler als gebruikt * ``log(100, 10) -> 2``
*********************************
<code>log10</code>
==============================
<code><b>log10(<i>&lt;value1&gt;</i> : number) => double</b></code><br/><br/>
