...
3. Vervang de **JSON** door het volgende codefragment.
   ...
   > [!NOTE]
   > Zie [Anatomie van een pijplijn](data-factory-create-pipelines.md#anatomy-of-a-pipeline) voor meer informatie over de JSON-eigenschappen die in het voorbeeld worden gebruikt. 
   > 
   > 
