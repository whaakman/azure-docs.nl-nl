---
title: Gegevens kopiëren van Greenplum met behulp van Azure Data Factory | Microsoft Docs
...
| connectionString | Een ODBC-verbindingsreeks verbinding maken met Greenplum. Dit veld markeren als een SecureString Bewaar deze zorgvuldig in Data Factory of [verwijzen naar een geheim dat is opgeslagen in Azure Key Vault](store-credentials-in-key-vault.md). | Ja |
