...
#### <a name="method1"></a> Van configuratiemethode 1: Stel pagina aan de slag
...
| **Samenwerking vertakking** | Uw vertakking van de VSTS-samenwerking die wordt gebruikt voor publicatie. Dit is standaard `master`. Wijzig deze in het geval u wilt publiceren van bronnen van een andere vertakking. | <your collaboration branch name> |
...
#### <a name="configuration-method-2-ux-authoring-canvas"></a>Van configuratiemethode 2: UX canvas voor ontwerpen
...
Wanneer u klaar met het ontwikkelen van functies in uw vertakking functie bent, kunt u klikken op **pull-aanvraag maken**. Hiermee gaat u VSTS GIT waar u kunt verhogen pull-aanvragen code voor beoordelingen en merge wijzigingen aan uw samenwerking-vertakking. (`master` is de standaardinstelling). U mag alleen publiceren naar de Data Factory-service vanuit uw vertakking samenwerking. 
