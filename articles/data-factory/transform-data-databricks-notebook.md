...
|linkedServiceName|Naam van de gekoppelde Service van Databricks waarop de Databricks Notebook wordt uitgevoerd. Zie voor meer informatie over deze gekoppelde service, [gekoppelde services berekenen](compute-linked-services.md) artikel.|Ja|
