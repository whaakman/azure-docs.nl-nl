...
1. You should see the output with details about the error (similar to the following):
    ...
    Type                    :
2. You can run **Save-AzureRmDataFactoryLog** cmdlet with Id value you see from the output and download the log files using the **-DownloadLogsoption** for the cmdlet.
