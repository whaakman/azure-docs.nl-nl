...
- [Met behulp van beheerde identiteiten voor verificatie van de Azure-resources](#managed-identity)
...
>[!NOTE]
>Bij het gebruik **hulpprogramma voor kopiëren-gegevens** kopieerpijplijn ontwerpen of gebruik **ADF UI** om uit te voeren tests verbinding/navigeren door mappen tijdens het ontwerpen, moet de machtiging van de service-principal wordtverleend**op hoofdniveau met de machtiging 'Uitvoeren'** in volgorde van de lijst met mappen starten van de hoofdmap. While, kunt uitvoering van activiteit kopiëren werken, zolang de machtiging te tot de gegevens krijgen moeten worden gekopieerd. Als u moet de machtiging beperken, kunt u de authoring bewerkingen overslaan.
...
>[!NOTE]
>Bij het gebruik **hulpprogramma voor kopiëren-gegevens** kopieerpijplijn ontwerpen of gebruik **ADF UI** om uit te voeren tests verbinding/navigeren door mappen tijdens het ontwerpen, moet de machtiging **in hoofdmap met de machtiging 'Uitvoeren'** in volgorde van de lijst met mappen starten van de hoofdmap. While, kunt uitvoering van activiteit kopiëren werken, zolang de machtiging te tot de gegevens krijgen moeten worden gekopieerd. Als u moet de machtiging beperken, kunt u de authoring bewerkingen overslaan.
...
| folderPath | Pad naar de map in de Data Lake Store. Filteren op jokerteken wordt niet ondersteund. Indien niet opgegeven, wordt deze verwijst naar de hoofdmap. Voorbeeld: rootfolder/submap / |Nee |
