...
| **abonnements-id** | Azure-abonnement-ID die de Data Lake Store-account behoort. | Vereist voor sink |
...
2. Zorg ervoor dat u ten minste verlenen "**lezer**' rol aan de gebruiker of service-principal op het data lake-account. Dit is het maken van:
    ...
    2. Klik op ' Access Control (IAM) ' op de blade van de Data Lake Store
    3. Klik op 'Toevoegen' in de blade van de ' Access Control (IAM) "
...
3. Als u niet wilt voor het verlenen van de rol 'Lezer' aan de gebruiker of service-principal, alternatieve gebruikersinvoer is [expliciet opgeven de uitvoeringslocatie van een](data-factory-data-movement-activities.md#global) in kopie activitywith de locatie van uw Data Lake Store. Voorbeeld:
