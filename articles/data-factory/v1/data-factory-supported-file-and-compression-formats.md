...
> [!NOTE]
> In dit artikel is van toepassing op versie 1 van Azure Data Factory. Als u de huidige versie van de Data Factory-service gebruikt, raadpleegt u [bestandsindelingen en compressiecodecs ondersteund in de Data Factory](../supported-file-formats-and-compression-codecs.md).
