...
## <a name="json-example-copy-data-from-odbc-data-store-to-azure-blob"></a>Voorbeeld van JSON: gegevens kopiëren van ODBC-gegevens opslaan naar Azure-Blob
