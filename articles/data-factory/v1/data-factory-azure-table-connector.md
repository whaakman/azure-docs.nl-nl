...
> [!NOTE]
> In dit artikel is van toepassing op versie 1 van de Data Factory. Als u de huidige versie van de Data Factory-service gebruikt, raadpleegt u [Azure Table Storage-connector in V2](../connector-azure-table-storage.md).
