...
ms.locfileid: "37046085"
---
# <a name="azure-data-factory---samples"></a>Azure Data Factory - voorbeelden
> [!NOTE]
> In dit artikel is van toepassing op versie 1 van de Data Factory. Als u de huidige versie van de Data Factory-service gebruikt, raadpleegt u [PowerShell-voorbeelden in de Data Factory](../samples-powershell.md) en [codevoorbeelden in de galerie van Azure-codevoorbeelden](https://azure.microsoft.com/resources/samples/?service=data-factory).
