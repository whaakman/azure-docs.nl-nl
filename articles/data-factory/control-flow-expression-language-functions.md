...
|-------------------|-----------------|  
|concat|Een combinatie van een willekeurig aantal tekenreeksen samen. Bijvoorbeeld, als parameter1 `foo,` geretourneerd met de volgende expressie `somevalue-foo-somevalue`:  `concat('somevalue-',pipeline().parameters.parameter1,'-somevalue')`<br /><br /> **Parameternummer**: 1... *n*<br /><br /> **Naam**: String *n*<br /><br /> **Beschrijving**: vereist. De tekenreeksen combineren tot één tekenreeks.|  
