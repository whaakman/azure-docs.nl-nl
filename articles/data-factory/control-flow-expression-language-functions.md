...
|matrix|De parameter converteren naar een matrix.  De volgende expressie retourneert bijvoorbeeld `["abc"]`: `array('abc')`<br /><br /> **Parameternummer**: 1<br /><br /> **Naam**: Value<br /><br /> **Beschrijving**: Vereist. De waarde die wordt geconverteerd naar een matrix.|
