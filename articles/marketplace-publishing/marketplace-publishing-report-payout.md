...
* VM's
* Biedt B + C
* Gegevens en Dev-Services die worden aangeboden onder EA
...
3. Klik op **toekenning samenvatting**.
...
Meld een probleem op voor andere vragen over ondersteuning, <https://portal.azure.com>.
