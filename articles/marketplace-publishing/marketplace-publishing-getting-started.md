...
1. Maken van uw aanbieding [marketing inhoud](marketplace-publishing-push-to-staging.md).

1. Test uw aanbieding in fasering.
...
1. Implementeren van uw aanbieding aan de [Marketplace](marketplace-publishing-push-to-production.md).
