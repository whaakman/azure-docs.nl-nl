...
> [!NOTE]
> Deze opdracht moet een lokale Storm-ontwikkelomgeving. Zie voor meer informatie [een ontwikkelomgeving instellen](http://storm.apache.org/releases/1.0.6/Setting-up-development-environment.html)
