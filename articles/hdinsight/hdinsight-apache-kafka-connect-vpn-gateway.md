...
* Voer de client in hetzelfde virtuele netwerk als Kafka op HDInsight. Deze configuratie wordt gebruikt in de [beginnen met Apache Kafka (preview) op HDInsight](hdinsight-apache-kafka-get-started.md) document. De client voert rechtstreeks op de clusterknooppunten HDInsight of op een andere virtuele machine in hetzelfde netwerk.
