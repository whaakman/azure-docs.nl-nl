...
|---|---|
|![HBase](./media/hdinsight-troubleshoot-guide/HBASE.png)<br>[HBase oplossen](hbase/apache-troubleshoot-hbase.md)|<br>[Hoe voer hbck opdracht rapporten met meerdere niet-toegewezen gebieden](hbase/apache-troubleshoot-hbase.md#how-do-i-run-hbck-command-reports-with-multiple-unassigned-regions)<br><br>[Hoe los ik problemen time-out bij gebruik van hbck opdrachten voor toewijzingen regio](hbase/apache-troubleshoot-hbase.md#how-do-i-fix-timeout-issues-with-hbck-commands-for-region-assignments)<br><br>[Hoe ik geforceerde-/ uitschakelen HDFS veilige modus op een cluster](hbase/apache-troubleshoot-hbase.md#how-do-i-force-disable-hdfs-safe-mode-in-a-cluster)<br><br>[Hoe los JDBC of SQLLine verbinding problemen met Apache Phoenix](hbase/apache-troubleshoot-hbase.md#how-do-i-fix-jdbc-or-sqlline-connectivity-issues-with-apache-phoenix)<br><br>[Wat zorgt ervoor dat een master server niet worden gestart](hbase/apache-troubleshoot-hbase.md#what-causes-a-master-server-to-fail-to-start)<br><br>[Wat veroorzaakt een fout opnieuw opstarten op een server regio](hbase/apache-troubleshoot-hbase.md#what-causes-a-restart-failure-on-a-region-server)|
...
|![Spark](./media/hdinsight-troubleshoot-guide/SPARK.png)<br>[Spark oplossen](hdinsight-troubleshoot-SPARK.md)|<br>[Hoe kan ik een Spark-toepassing configureren met behulp van Ambari op clusters](spark/apache-troubleshoot-spark.md#how-do-i-configure-a-spark-application-by-using-ambari-on-clusters)<br><br>[Hoe kan ik een Spark-toepassing configureren met behulp van een Jupyter-notebook in clusters](spark/apache-troubleshoot-spark.md#how-do-i-configure-a-spark-application-by-using-a-jupyter-notebook-on-clusters)<br><br>[Hoe kan ik een Spark-toepassing configureren met behulp van Livy op clusters](spark/apache-troubleshoot-spark.md#how-do-i-configure-a-spark-application-by-using-livy-on-clusters)<br><br>[Hoe configureer een toepassing met behulp van spark indienen Spark op clusters](spark/apache-troubleshoot-spark.md#how-do-i-configure-a-spark-application-by-using-spark-submit-on-clusters)<br><br>[Wat een Spark-toepassing OutOfMemoryError uitzondering veroorzaakt](spark/apache-troubleshoot-spark.md#what-causes-a-spark-application-outofmemoryerror-exception)|
|![Storm](./media/hdinsight-troubleshoot-guide/STORM.png)<br>[Storm oplossen](hdinsight-troubleshoot-STORM.md)|<br>[Hoe krijg ik toegang tot de Storm-gebruikersinterface op een cluster](storm/apache-troubleshoot-storm.md#how-do-i-access-the-storm-ui-on-a-cluster)<br><br>[Hoe worden ik Storm event hub spout controlepunt informatie uit een topologie overgedragen naar een andere](storm/apache-troubleshoot-storm.md#how-do-i-transfer-storm-event-hub-spout-checkpoint-information-from-one-topology-to-another)<br><br>[Hoe ik Storm binaire bestanden vinden op een cluster](storm/apache-troubleshoot-storm.md#how-do-i-locate-storm-binaries-on-a-cluster)<br><br>[Hoe bepaal ik de implementatietopologie van een Storm-cluster](storm/apache-troubleshoot-storm.md#how-do-i-determine-the-deployment-topology-of-a-storm-cluster)<br><br>[Hoe ik Storm event hub spout binaire bestanden voor de ontwikkeling van vinden](storm/apache-troubleshoot-storm.md#how-do-i-locate-storm-event-hub-spout-binaries-for-development)<br><br>[Hoe ik Storm Log4J configuratiebestanden op clusters vinden](storm/apache-troubleshoot-storm.md#how-do-i-locate-storm-log4j-configuration-files-on-clusters)|
