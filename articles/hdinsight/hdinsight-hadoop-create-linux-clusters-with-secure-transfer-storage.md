...
Voordat u dit artikel, moet u het volgende hebben:
...
In dit artikel hebt u geleerd hoe u een HDInsight-cluster maken en veilige overdracht naar de storage-accounts kunt inschakelen.
