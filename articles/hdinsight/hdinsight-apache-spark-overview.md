...
## <a name="a-namenext-stepsawhat-components-are-included-as-part-of-a-spark-cluster"></a><a name="next-steps"></a>Welke onderdelen zijn in een Spark-cluster opgenomen?
