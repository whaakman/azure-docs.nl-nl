...
* [Apache Spark met Machine Learning: Spark in HDInsight voor het analyseren van de gebouwtemperatuur met behulp van HVAC-gegevens gebruiken](spark/apache-spark-ipython-notebook-machine-learning.md)
