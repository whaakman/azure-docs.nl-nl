...
Er is een eenvoudige manier om te controleren van de logboeken met HDInsight Tools voor Visual Studio. Zie voor het installeren van de hulpprogramma's voor [aan de slag met Visual Studio Hadoop-hulpprogramma's voor HDInsight](hdinsight-hadoop-visual-studio-tools-get-started.md#install-data-lake-tools-for-visual-studio)
