...
1. Gebruik de volgende knop om te melden bij Azure en opent u de sjabloon in de Azure portal.
    ...
    De Azure Resource Manager-sjabloon bevindt zich op **https://hditutorialdata.blob.core.windows.net/armtemplates/create-linux-based-kafka-storm-cluster-in-vnet-v1.json**. Hiermee maakt u de volgende bronnen:
