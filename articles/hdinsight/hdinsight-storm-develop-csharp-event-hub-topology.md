...
Event Hubs is de gegevensbron voor dit voorbeeld. Gebruik de informatie in de sectie 'Een event hub maken' van [aan de slag met Event Hubs](../event-hubs/event-hubs-csharp-ephcs-getstarted.md).
...
1. Als u hebt niet is gebeurd de nieuwste versie van de HDInsight tools voor Visual Studio, Zie [aan de slag met HDInsight tools voor Visual Studio](hdinsight-hadoop-visual-studio-tools-get-started.md).
