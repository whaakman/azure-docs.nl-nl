...
ms.locfileid: "52315406"
---
# <a name="what-is-apache-hbase-in-hdinsight-a-nosql-database-that-provides-bigtable-like-capabilities-for-apache-hadoop"></a>Wat is Apache HBase in HDInsight: een NoSQL-database die zorgt voor BigTable gelijkende mogelijkheden voor Apache Hadoop
[Apache HBase](http://hbase.apache.org/) is een open-source NoSQL-database die is gebouwd op [Apache Hadoop](https://hadoop.apache.org/) en gemodelleerde na [Google BigTable](https://cloud.google.com/bigtable/). HBase biedt willekeurige toegang en een sterke consistentie voor grote hoeveelheden ongestructureerde en semigestructureerde gegevens in een database zonder schema die is georganiseerd op basis van kolomfamilies.
