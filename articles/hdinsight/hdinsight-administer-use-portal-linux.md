...
* HBase
    ...
    Zie voor meer informatie over het gebruik van de HBase-shell [aan de slag met een voorbeeld van Apache HBase in HDInsight](hdinsight-hbase-tutorial-get-started-linux.md).
