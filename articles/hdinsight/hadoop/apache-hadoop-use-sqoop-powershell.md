...
* Een HDInsight-cluster, Azure SQL-Server en database zoals gedefinieerd in [cluster en SQL-database maken](./hdinsight-use-sqoop.md#create-cluster-and-sql-database).
