...
>
> Voor HDInsight 3.4 of hoger, Zie [MapReduce gebruikt met SSH](apache-hadoop-use-mapreduce-ssh.md) voor meer informatie over verbinding maken met het HDInsight-cluster en MapReduce-taken uitvoeren.
