...
> [AZURE.NOTE] Zie voor meer informatie over de specifieke componenten en versie-informatie [Hadoop components, versioning, and service offerings in HDInsight (Hadoop-onderdelen, versiebeheer en serviceaanbiedingen in HDInsight)][versiebeheer voor onderdelen]
