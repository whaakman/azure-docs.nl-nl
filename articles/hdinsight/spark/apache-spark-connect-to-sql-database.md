...
6. Controleer of de gegevens wordt gestreamd naar de **hvactable** door de volgende query uit te voeren. Telkens wanneer u de query uitvoert, wordt het aantal rijen in de tabel verhogen.
