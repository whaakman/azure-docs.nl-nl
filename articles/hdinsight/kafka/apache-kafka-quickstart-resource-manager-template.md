...
description: In deze snelstartgids leert u hoe u met Azure Portal een Apache Kafka-cluster maakt in Azure HDInsight. Er wordt ook aandacht besteed aan Kafka-onderwerpen, -abonnees en -consumenten.
services: hdinsight
documentationcenter: ''
author: Blackmist
manager: cgronlun
