...
---
# <a name="use-mirrormaker-to-replicate-apache-kafka-topics-with-kafka-on-hdinsight-preview"></a>MirrorMaker gebruiken om te repliceren van Apache Kafka onderwerpen met Kafka op HDInsight (preview)
