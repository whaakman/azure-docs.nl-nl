...
2. Maken of importeren van Azure Key Vault.
...
4. HDInsight-cluster maken
   ...
   Tijdens het maken van een cluster, bieden u de volledige sleutel-URL, met inbegrip van de belangrijkste versie. Bijvoorbeeld `myakv.azure.com/KEK1/v1`. U moet ook de beheerde identiteit toewijzen aan het cluster en geef de sleutel-URI.
