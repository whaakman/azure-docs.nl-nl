...
ms.locfileid: "35344458"
---
# <a name="tutorial-single-page-web-app"></a>Zelfstudie: Single-page-Web-app

Dit is de volledige broncode besproken in de [één pagina app-zelfstudie](tutorial-bing-image-search-single-page-app.md) voor het zoeken naar Bing-afbeelding. Uitvoeren van de app kopiëren van de broncode in Kladblok of een andere teksteditor en sla het bestand als `bing.html`. Open het bestand opgeslagen in Microsoft Edge of een andere populaire browser.
