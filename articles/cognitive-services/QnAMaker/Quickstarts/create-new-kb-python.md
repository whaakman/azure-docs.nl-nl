...
Voor meer hulp met Visual Studio en Python: [Werken met Python en Visual Studio in Windows](https://docs.microsoft.com/visualstudio/python/overview-of-python-tools-for-visual-studio).
