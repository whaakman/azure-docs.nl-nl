---
title: Ga snel aan de slag voor Microsoft QnA Maker API (V4) - cognitieve Azure-Services | Microsoft Docs
...
ms.locfileid: "36301288"
---
# <a name="quickstart-for-microsoft-qna-maker-api-with-go"></a>Quick Start voor Microsoft QnA Maker API met Ga 
<a name="HOLTop"></a>

Dit artikel laat zien hoe u de [Microsoft QnA Maker API](../Overview/overview.md) met gaat u naar de volgende handelingen uit.
...
1. Maak een nieuwe Ga-project in uw favoriete IDE.
...
## <a name="get-answers-to-a-question-by-using-a-knowledge-base"></a>Vind antwoorden op een vraag met behulp van een knowledge base
