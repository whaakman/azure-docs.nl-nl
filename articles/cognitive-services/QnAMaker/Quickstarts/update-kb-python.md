...
Als u nog geen knowledge base hebt, kunt u een voorbeeldexemplaar maken om te gebruiken met deze snelstart: [Een nieuwe knowledge base maken](create-new-kb-python.md).
...
Zodra de knowledge base is bijgewerkt, kunt u deze weergeven in de QnA Maker-portal op de pagina [Mijn knowledge bases](https://www.qnamaker.ai/Home/MyServices). U ziet dat er een nieuw QnA-paar is toegevoegd. De naam van uw database is nu: Nieuwe KB-naam.
