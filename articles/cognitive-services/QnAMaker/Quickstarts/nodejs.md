---
title: Node.js-Quick Start voor Microsoft QnA Maker API (V4) - cognitieve Azure-Services | Microsoft Docs
...
ms.locfileid: "36301533"
---
# <a name="quickstart-for-microsoft-qna-maker-api-with-nodejs"></a>Quick Start voor Microsoft QnA Maker API met behulp van Node.js 
<a name="HOLTop"></a>

Dit artikel laat zien hoe u de [Microsoft QnA Maker API](../Overview/overview.md) met behulp van Node.js om het volgende te doen.
