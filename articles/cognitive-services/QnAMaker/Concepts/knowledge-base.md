...
|Stap|Doel|
|--|--|
|1|De clienttoepassing verzendt de gebruikersquery naar de [GenerateAnswer API](/azure/cognitive-services/qnamaker/how-to/metadata-generateanswer-usage).|
