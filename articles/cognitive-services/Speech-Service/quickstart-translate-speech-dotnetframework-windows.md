...
Snelstartgidsen zijn ook beschikbaar voor [spraak-naar-tekst](quickstart-csharp-dotnet-windows.md) en en [tekst naar spraak](quickstart-text-to-speech-dotnet-windows.md).
