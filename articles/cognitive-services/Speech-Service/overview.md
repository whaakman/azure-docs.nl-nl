...
Net zoals de andere Azure-spraakservices wordt de Speech-service mogelijk gemaakt door de spraaktechnologieën die worden gebruikt in producten zoals Cortana en Microsoft Office. U kunt rekenen op de kwaliteit van de resultaten en de betrouwbaarheid van het cloudplatform.
