...
Neem contact op met [spraakondersteuning](mailto:speechsupport@microsoft.com?subject=Request%20for%20higher%20concurrency%20for%20Speech-to-text) als u een hogere schaal nodig hebt.
...
**V: Hoe moet ik dan betalen voor dual-channel audio?**

**A**: Als u elk kanaal afzonderlijk indient (elk kanaal in een eigen bestand), u betaalt per de duur van de elk bestand. Als u een enkel bestand met elk kanaal multiplex samen verzenden, klikt u gefactureerd voor de duur van het bestand.
