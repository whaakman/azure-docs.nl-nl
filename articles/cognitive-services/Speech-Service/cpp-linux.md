...
> [!NOTE]
> Als u een Quick Start voor C++ en Windows zoekt, gaat u [hier](cpp-windows.md).
...
Vervang de abonnementssleutel in de code met de categorie die u hebt verkregen.
...
* Op een x64 machine, voer:

  ```sh
  export LD_LIBRARY_PATH="$LD_LIBRARY_PATH:$SPEECHSDK_ROOT/lib/x64"
  ```

* Op een x86 machine, voer:
...
Als alles goed gaat, ziet u uitvoer die vergelijkbaar is met het volgende:
