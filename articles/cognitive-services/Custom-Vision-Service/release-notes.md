...
- Verbeterde portal UX-ervaring die betrekking hebben op Azure-abonnementen, waardoor het gemakkelijker wordt om te selecteren van uw Azure-mappen.

## <a name="april-18-2019"></a>18 april 2019 

- Toegevoegd Objectdetectie-uitvoer voor de visie AI Dev Kit.
- UI-correcties, met inbegrip van project zoeken.

## <a name="april-3-2019"></a>3 april 2019

- Limiet voor het aantal selectiekader vakken per afbeelding tot 200 verhoogd. 
- Bugfixes, met inbegrip van de prestaties aanzienlijk update voor modellen naar TensorFlow geëxporteerd. 
...
- Volwassenen domein verwijderd. Algemene domein wordt in plaats daarvan aanbevolen.
- Aangekondigd [prijzen](https://azure.microsoft.com/pricing/details/cognitive-services/custom-vision-service/) voor algemene beschikbaarheid.  
...
Oplossingen voor problemen, met inbegrip van ONNX exporteren met speciale tekens.
...
- Oplossingen voor bugs en verbeteringen in back-end.
...
- De ingevoerde betaalde Preview-versie en onboarding naar de Azure-portal. Projecten kunnen nu worden gekoppeld aan Azure-resources met een F0-laag (gratis) of een S0-laag (Standard). Introductie van S0-laagprojecten die ruimte bieden voor maximaal 100 labels en 25.000 afbeeldingen.
