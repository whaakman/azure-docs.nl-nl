---
title: 'Zelfstudie: Maken, trainen en exporteren van een model met de Custom Vision REST-API'
...
ms.locfileid: "58351096"
---
# <a name="tutorial-create-train-and-export-a-model-with-rest"></a>Zelfstudie: Maken, trainen en exporteren van een model met REST
