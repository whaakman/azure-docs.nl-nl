...
Selecteer **Verzenden**. Als de bewerking is geslaagd, de **antwoordstatus** is `200 OK`, en de **antwoordinhoud** vak geeft de details van de toegangsbeoordeling in JSON-indeling, zoals de volgende:
