---
title: 'Snelstart: Zinlengtes, Ruby - Translator Text-API'
...
ms.locfileid: "49644705"
---
# <a name="quickstart-get-sentence-lengths-with-the-translator-text-rest-api-ruby"></a>Snelstart: Zinlengtes ophalen met de Translator Text REST API (Ruby)
