---
title: 'Snelstart: Tekstscript converteren, Ruby - Translator Text-API'
...
ms.locfileid: "49647082"
---
# <a name="quickstart-transliterate-text-with-the-translator-text-rest-api-ruby"></a>Snelstart: Transliteratie gebruiken voor tekst met de Translator Text REST API (Ruby)
