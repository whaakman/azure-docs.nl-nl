---
title: 'Snelstart: Tekst vertalen, Go - Translator Text-API'
...
ms.locfileid: "49648306"
---
# <a name="quickstart-translate-text-with-the-translator-text-rest-api-go"></a>Snelstart: Tekst vertalen met de Translator Text REST API (Go)
