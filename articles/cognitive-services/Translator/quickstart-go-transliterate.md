---
title: Het schrift van tekst converteren in Translator Text met Go | Microsoft Docs
titleSuffix: Microsoft Cognitive Services
description: In deze snelstart converteert u tekst in één taal van het ene schrift naar het andere met de Translator Text-API met Go in Cognitive Services.
...
ms.locfileid: "43769111"
---
# <a name="quickstart-transliterate-text-with-go"></a>Snelstart: tekst translitereren met Go
