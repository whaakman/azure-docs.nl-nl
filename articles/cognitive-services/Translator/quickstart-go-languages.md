---
title: 'Snelstart: Ondersteunde talen ophalen, Go - Translator Text-API'
...
ms.locfileid: "49648289"
---
# <a name="quickstart-get-supported-languages-with-the-translator-text-rest-api-go"></a>Snelstart: Ondersteunde talen ophalen met de Translator Text REST API (Go)
