...
> [!NOTE]
> Het proces van het maken en toepassen van momentopnamen worden niet verstoort de regelmatige aanroepen voor de bron- of doelentiteit **PersonGroup**s (of **FaceList**s). Echter niet aangeraden gelijktijdige aanroepen die het bronobject wijzigen ([FaceList beheeraanroepen](https://docs.microsoft.com/dotnet/api/microsoft.azure.cognitiveservices.vision.face.facelistoperations?view=azure-dotnet) of de [PersonGroup Train](https://docs.microsoft.com/dotnet/api/microsoft.azure.cognitiveservices.vision.face.persongroupoperations?view=azure-dotnet) aanroepen, bijvoorbeeld), omdat de momentopnamebewerking mogelijk vóór of na deze bewerkingen uit te voeren of kunnen fouten optreden.
