---
title: 'Snelstart: Gezichten in een afbeelding detecteren met de REST API en C#'
titleSuffix: Azure Cognitive Services
description: In deze snelstart detecteert u gezichten in een afbeelding met behulp van de Face-API met C#.
...
ms.locfileid: "49954518"
---
# <a name="quickstart-detect-faces-in-an-image-using-the-rest-api-and-c"></a>Snelstart: Gezichten in een afbeelding detecteren met de REST API en C#
...
6. Voer bij de prompt het pad naar een afbeelding in.
...
> [Zelfstudie: Aan de slag met de Face-API in C#](../Tutorials/FaceAPIinCSharpTutorial.md)
