...
Het akoestische model is een classificatie waarbij in een bepaalde taal korte audiofragmenten worden gekwalificeerd als een van verschillende fonemen, of klankeenheden. Het woord 'spraak' bijvoorbeeld bestaat uit vijf fonemen: 's p r aa k'. Deze classificaties worden gemaakt op het einde van 100 keer per seconde
