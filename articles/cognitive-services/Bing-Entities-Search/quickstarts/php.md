---
title: 'Snelstart: Bing Entiteiten zoeken-API, PHP'
...
ms.locfileid: "48815525"
---
# <a name="quickstart-for-bing-entity-search-api-with-php"></a>Snelstart voor Bing Entiteiten zoeken-API met PHP

In dit artikel leest u hoe u de API [Bing Entiteiten zoeken](https://docs.microsoft.com/azure/cognitive-services/bing-entities-search/search-the-web) gebruikt met PHP.
