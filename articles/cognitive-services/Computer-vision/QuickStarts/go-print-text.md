...
ms.locfileid: "67605946"
---
# <a name="quickstart-extract-printed-text-ocr-using-the-computer-vision-rest-api-with-go"></a>Quickstart: Haal de gedrukte tekst (OCR) met behulp van de Computer Vision REST-API met Go
