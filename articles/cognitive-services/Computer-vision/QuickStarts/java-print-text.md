...
description: In deze snelstart extraheert u afgedrukte tekst uit een afbeelding met behulp van Computer Vision met Java in Cognitive Services.
...
ms.locfileid: "43770219"
---
# <a name="quickstart-extract-printed-text-ocr---rest-java"></a>Snelstart: Afgedrukte tekst extraheren (OCR) - REST, Java
...
Een geslaagd antwoord wordt geretourneerd in JSON-indeling. De OCR-resultaten omvatten de gedetecteerde tekst en begrenzingsvakken voor regio's, lijnen en woorden.
