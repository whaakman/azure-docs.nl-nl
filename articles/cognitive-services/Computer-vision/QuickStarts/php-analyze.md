...
ms.locfileid: "67604305"
---
# <a name="quickstart-analyze-a-remote-image-using-the-computer-vision-rest-api-and-php"></a>Quickstart: Analyseren van een externe-installatiekopie met behulp van de Computer Vision REST-API en PHP
...
1. Sla de code op als een bestand met de extensie `.php`. Bijvoorbeeld `analyze-image.php`.
