---
title: Configureren van containers
...
ms.locfileid: "51635005"
---
# <a name="configure-containers"></a>Configureren van containers
...
Configuratie-instellingen van Computer Vision-containers zijn hiërarchische en alle containers gebruiken een gedeelde hiërarchie, op basis van de volgende structuur op het hoogste niveau:
...
Bijvoorbeeld de volgende opdracht wordt een container van de containerinstallatiekopie tekst herkennen en configureert u de console het niveau van logboekregistratie in LogLevel.Information, voorrang op de standaard-configuratie-instelling.
...
De `ApiKey` configuratie-instelling geeft de configuratiesleutel van de Computer Vision-resource op Azure gebruikt voor het bijhouden van informatie over facturering voor de container. U moet een waarde voor deze configuratie-instelling opgeven en de waarde moet een geldige configuratie-sleutel voor de Computer Vision-resource die is opgegeven voor de [ `Billing` ](#billing-configuration-setting) configuratie-instelling.
...
De `Authentication` configuratie-instellingen bieden opties voor Azure-beveiliging voor de container. Hoewel de configuratie-instellingen in deze sectie beschikbaar zijn, wordt de tekst herkennen-container in deze sectie niet gebruikt.

## <a name="billing-configuration-setting"></a>Facturering van configuratie-instelling

De `Billing` configuratie-instelling geeft aan welk eindpunt-URI van de Computer Vision-resource in Azure wordt gebruikt voor het bijhouden van informatie over facturering voor de container. U moet een waarde voor deze configuratie-instelling opgeven en de waarde moet een geldige URI van het eindpunt voor een Computer Vision-resource in Azure.
...
Invoer koppelingen biedt geen ondersteuning voor de container tekst herkennen en (optioneel) de koppelingen voor het uitvoeren van ondersteunt.
