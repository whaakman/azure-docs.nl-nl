...
1. Klik op [maken **Computer Vision** ](https://ms.portal.azure.com/#create/Microsoft.CognitiveServicesComputerVision) resource
...
1. Verzamelen geconfigureerd `endpoint` en een API-sleutel:
    ...
    |--|--|--|
    |**Overzicht**|Eindpunt|Kopieer het eindpunt. Het lijkt op `https://computer-vision.cognitiveservices.azure.com/`|
