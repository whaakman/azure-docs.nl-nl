---
title: 'Zelfstudie: Een LUIS-app (Language Understanding Intelligent Services) aanroepen met behulp van Node.js | Microsoft Docs'
...
ms.locfileid: "36263649"
---
# <a name="tutorial-call-a-luis-endpoint-using-nodejs"></a>Zelfstudie: Een LUIS-eindpunt aanroepen met behulp van Node.js
...
## <a name="consume-a-luis-result-using-the-endpoint-api-with-nodejs"></a>Een LUIS-resultaat gebruiken met behulp van de eindpunt-API met Node.js
...
2. Stel de omgevingsvariabele `LUIS_APP_ID` in zoals beschreven in de opmerkingen bij de code. 

3. Stel de omgevingsvariabele `LUIS_SUBSCRIPTION_KEY` in op uw abonnementssleutel van Cognitive Services.

4. Voer de code uit. Deze geeft de dezelfde waarden weer die u eerder hebt gezien in het browservenster.
<!-- 
