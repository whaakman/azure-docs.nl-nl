...
1. Selecteer rechtsboven op de website van LUIS de knop **Train**.
    ...
    ![De app trainen](./media/luis-quickstart-intent-and-list-entity/train-button.png)
