---
title: Een LUIS-app (Language Understanding) aanroepen met behulp van PHP | Microsoft Docs
...
ms.locfileid: "36265123"
---
# <a name="tutorial-call-a-luis-endpoint-using-php"></a>Zelfstudie: Een LUIS-eindpunt aanroepen met behulp van PHP
...
## <a name="consume-a-luis-result-using-the-endpoint-api-with-php"></a>Een LUIS-resultaat gebruiken met behulp van de eindpunt-API met PHP 
...
3. Voer de PHP-toepassing uit. De uitvoer bestaat uit de JSON die u eerder hebt gezien in het browservenster.
