...
1. Voeg een **getal** entiteit aan uw app, klikt u vervolgens [Train](interactive-test.md) en [publiceren](luis-how-to-publish-app.md) de app.
...
1. Voeg een **datetimeV2** entiteit aan uw app, klikt u vervolgens [Train](interactive-test.md) en [publiceren](luis-how-to-publish-app.md) de app.
2. Klik op de eindpunt-URL in de **App publiceren** pagina de LUIS-eindpunt in een webbrowser geopend. 
