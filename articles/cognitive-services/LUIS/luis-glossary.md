...
Spraak voorbereiden kan uw spraakherkenning service gereed worden gemaakt met uw LUIS-model. Zie [inschakelen spraak voorbereiden ](luis-how-to-publish-app.md#enable-speech-priming).
...
[Testen](interactive-test.md#test-your-app) een LUIS-app betekent een utterance wordt doorgegeven aan LUIS en het weergeven van de JSON-resultaten.
