...
2. Schakelen tussen de **Weergave Entiteiten** om de entiteiten met labels weer te geven. 
...
3. Selecteer voor de intentie `I'm looking for a job with Natual Language Processing` de correcte intentie, **GetJobInformation**, in de kolom **Uitgelijnde intentie** kolom. 
...
4. In de dezelfde uiting is de entiteit voor `Natural Language Processing` keyPhrase. Dit zou eigenlijk de entiteit **Job** moeten zijn. Selecteer `Natural Language Processing` en selecteer vervolgens in de lijst de entiteit **Job**.
...
5. Selecteer op dezelfde regel het omcirkelde vinkje in de kolom **Toevoegen aan uitgelijnde intentie**. 
...
6. Beoordeel de resterende uitingen in deze intentie, waarbij u de uitingen van een label kunt voorzien en de **Uitgelijnde intentie** kunt corrigeren als deze onjuist zijn.

7. Selecteer, wanneer alle uitingen correct zijn, het selectievakje op iedere rij en selecteer vervolgens **Selectie toevoegen** om de uitingen correct uit te lijnen. 
...
2. Als u deze app hebt geïmporteerd, dient u **Sentimentanalyse** te selecteren. 
