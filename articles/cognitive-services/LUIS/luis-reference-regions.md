...
| Azië | `westus`<br>[www.Luis.AI][www.luis.ai]| Azië - zuidoost<br>`souteastasia`     |   https://southeastasia.api.cognitive.microsoft.com/luis/v2.0/apps/YOUR-APP-ID?subscription-key=YOUR-SUBSCRIPTION-KEY   |
