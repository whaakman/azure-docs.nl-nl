---
title: Visual zoeken SDK Quickstart C# | Microsoft Docs
description: Setup voor Visual zoeken SDK C#-consoletoepassing.
...
---
# <a name="visual-search-sdk-c-quickstart"></a>SDK Visual zoeken C# Quick Start

De Bing-SDK voor Visual Search gebruikt de functionaliteit van de REST-API voor webaanvragen en parseren resultaten.
De [broncode voor voorbeelden van C# Bing Visual Search SDK](https://github.com/Azure-Samples/cognitive-services-dotnet-sdk-samples/tree/master/BingSearchv7/BingVisualSearch) beschikbaar is op de Git-Hub.
...
* Een cognitieve Services API-sleutel is vereist voor het verifiëren van de SDK-aanroepen. Aanmelden voor een [gratis proefabonnement sleutel](https://azure.microsoft.com/try/cognitive-services/?api=search-api-v7). De evaluatieversie sleutel is geschikt is voor de zeven dagen met één aanroep per seconde. Voor productiescenario's [kopen toegangssleutel](https://portal.azure.com/#create/Microsoft.CognitiveServicesBingSearch-v7). Zie ook [prijsgegevens](https://azure.microsoft.com/pricing/details/cognitive-services/search-api/visual/).
...
Als u een consoletoepassing met de Bing Web Search SDK instelt, blader naar de `Manage NuGet Packages` optie in Solution Explorer in Visual Studio.  Voeg de `Microsoft.Azure.CognitiveServices.Search.VisualSearch` pakket.
...
Maken van een exemplaar van de `VisualSearchAPI` -client toevoegen met behulp van instructies:
```
...
```
De client gebruiken om installatiekopieën te zoeken:
```
...
De volgende code verzendt een afbeeldings-url in de parameter knowledgeRequest samen met een gebied bijsnijden.  Vervolgens wordt de imageInsightsToken, het aantal tags, het aantal acties en de eerste actionType afgedrukt.
```
...
[Voorbeelden van cognitieve Services .NET SDK](https://github.com/Azure-Samples/cognitive-services-dotnet-sdk-samples/tree/master/BingSearchv7).