...
2. Maak een nieuwe `TextAnalyticsClient` object met `ApiKeyServiceClientCredentials` als een parameter en genereer vervolgens een lijst met `MultiLanguageInput` objecten, met de documenten die u wilt analyseren.
...
2. Maak een nieuwe `TextAnalyticsClient` object met `ApiKeyServiceClientCredentials` als een parameter en genereer vervolgens een lijst met `LanguageInput` objecten, die uw documenten.
...
2. Maak een nieuwe `TextAnalyticsClient` object met `ApiKeyServiceClientCredentials` als een parameter en genereer vervolgens een lijst met `MultiLanguageBatchInput` objecten, die uw documenten.
