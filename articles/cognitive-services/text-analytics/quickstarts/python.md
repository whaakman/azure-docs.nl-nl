...
* Als u de notebook Binder lokaal uitvoert, moet u mogelijk om bij te werken [IPython](https://ipython.org/install.html):
...
Voor het identificeren van bekende entiteiten (mensen, plaatsen en dingen) in tekstdocumenten append `keyPhrases` naar het base Text Analytics-eindpunt om de taal-detectie-URL. Bijvoorbeeld: `https://westcentralus.api.cognitive.microsoft.com/text/analytics/v2.1/keyPhrases`
