...
Gebruik deze Quick Start om te beginnen met het analyseren van taal met de Text Analytics-SDK voor Python. De Text Analytics REST-API is compatibel met de meeste moderne programmeertalen, biedt de SDK een eenvoudige manier om te integreren van de service in uw toepassingen zonder te serialiseren en deserialiseren van JSON.
