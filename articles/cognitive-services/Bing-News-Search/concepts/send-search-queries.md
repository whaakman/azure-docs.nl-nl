...
Zie [Headers](https://docs.microsoft.com/rest/api/cognitiveservices/bing-news-api-v7-reference#headers) voor een lijst met alle aanvraag- en antwoordheaders.
