...
2. Variabelen voor de API-eindpunt-host en pad, uw abonnementssleutel maken [code markt](https://docs.microsoft.com/rest/api/cognitiveservices/bing-autosuggest-api-v7-reference#market-codes), en een zoekterm.
