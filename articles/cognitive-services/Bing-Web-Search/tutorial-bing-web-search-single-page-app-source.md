---
title: Bing zoeken op het Web één pagina Web-app (broncode) | Microsoft Docs
description: De broncode voor de zelfstudie waarin wordt getoond hoe u de API van Bing Web zoeken gebruiken in een webtoepassing van één pagina.
...
ms.locfileid: "35344507"
---
# <a name="tutorial-single-page-web-app"></a>Zelfstudie: Single-page-Web-app

Dit is de volledige broncode besproken in de [één pagina app-zelfstudie](tutorial-bing-web-search-single-page-app.md) voor Bing zoeken op het Web. Uitvoeren van de app kopiëren van de broncode in Kladblok of een andere teksteditor en sla het bestand als `bing.html`. Open het bestand opgeslagen in Microsoft Edge of een andere populaire browser.
