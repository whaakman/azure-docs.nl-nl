---
title: Analyse van realtime video met de Emotion-API | Microsoft Docs
description: Gebruik de Emotion-API in cognitieve Services near-realtime analyses uitvoeren op frames die afkomstig zijn uit een live videostream.
