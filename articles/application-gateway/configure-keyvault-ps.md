---
title: Configureren van SSL-beëindiging met Key Vault-certificaten met behulp van Azure PowerShell
...
Dit artikel gebruikmaken van de Azure PowerShell-moduleversie 1.0.0 of hoger. Voer `Get-Module -ListAvailable Az` uit om de versie te bekijken. Als u PowerShell wilt upgraden, raadpleegt u [De Azure PowerShell-module installeren](/powershell/azure/install-az-ps). Als u wilt de opdrachten in dit artikel uitvoert, moet u ook om uit te voeren `Connect-AzAccount` voor het maken van een verbinding met Azure.

## <a name="prerequisites"></a>Vereisten

U moet de ManagedServiceIdentity module is geïnstalleerd voordat u begint.
