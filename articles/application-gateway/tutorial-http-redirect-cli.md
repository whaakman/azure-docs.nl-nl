...
![Waarschuwing beveiligen](./media/tutorial-http-redirect-cli/application-gateway-secure.png)
...
![Basis-URL te testen in de toepassingsgateway](./media/tutorial-http-redirect-cli/application-gateway-nginxtest.png)
