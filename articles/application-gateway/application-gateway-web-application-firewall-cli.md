...
Als u wilt de stappen in dit artikel uitvoert, moet u [installeren van de Azure-opdrachtregelinterface (Azure CLI) voor Mac, Linux en Windows](https://docs.microsoft.com/en-us/cli/azure/install-az-cli2).
