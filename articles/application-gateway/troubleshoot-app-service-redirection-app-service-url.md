...
ms.locfileid: "56808542"
---
# <a name="troubleshoot-application-gateway-with-app-service--redirection-to-app-services-url"></a>Application Gateway met App Service-omleiding naar de URL van App Service oplossen
...
Aanvraagheaders aan Application Gateway:

Aanvraag-URL: http://www.contoso.com/path
...
Statuscode: 301 permanent verplaatst

Locatie: http://example.azurewebsites.net/path/
...
- Stel uw aangepaste test 'Kies hostnaam van back-end-HTTP-instellingen' uitschakelen. Dit kan worden gedaan via de portal Hiervoor schakelt het selectievakje in de test-instellingen en Ga in PowerShell met behulp van niet - PickHostNameFromBackendHttpSettings.

  > [!NOTE]
  > Terwijl u deze stap uitvoert, zorg ervoor dat uw aangepaste test is niet gekoppeld aan uw back-end-HTTP-instellingen.

- Uw Application-Gateway HTTP-instellingen om uit te schakelen 'Kies hostnaam van back-end-adres' instellen. Dit kan worden gedaan via de portal Hiervoor schakelt het selectievakje in en Ga in PowerShell met behulp van niet - PickHostNameFromBackendAddress.
...
- Zodra dit is gebeurd, Application Gateway moet nu de dezelfde hostnaam 'www.contoso.com' doorsturen naar de App-Service en de omleiding wordt uitgevoerd op de dezelfde hostnaam. U kunt het voorbeeld van de aanvraag- en reactieheaders hieronder controleren.
  ...
  Locatie: http://www.contoso.com/path/
