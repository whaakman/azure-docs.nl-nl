...
U kunt cconfigure omleiding voor de listener met behulp van [Add-azurermapplicationgatewayredirectconfiguration is](/powershell/module/azurerm.network/add-azurermapplicationgatewayredirectconfiguration). 
