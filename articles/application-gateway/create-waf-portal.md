...
![Web application firewall voorbeeld](./media/create-waf-portal/scenario-waf.png)
...
3. Voer deze waarden voor de toepassingsgateway:
    ...
    ![Nieuwe toepassingsgateway maken](./media/create-waf-portal/application-gateway-create.png)
...
5. Klik op **Kies een virtueel netwerk**, klikt u op **nieuw**, en voer deze waarden voor het virtuele netwerk:
    ...
    ![Virtueel netwerk maken](./media/create-waf-portal/application-gateway-vnet.png)
...
2. Klik op **subnetten**, en klik vervolgens op **Subnet**.
    ...
    ![Subnet maken](./media/create-waf-portal/application-gateway-subnet.png)
...
1. Open de interactieve shell en zorg ervoor dat deze is ingesteld op **PowerShell**.
    ...
    ![Aangepaste extensie installeren](./media/create-waf-portal/application-gateway-extension.png)
...
3. Klik op **toevoegen doel** elke virtuele machine die u hebt gemaakt toevoegen aan de back-endpool.
    ...
    ![Back-endservers toevoegen](./media/create-waf-portal/application-gateway-backend.png)
...
7. Klik op **Opslaan**.
    ...
    ![Diagnostische gegevens configureren](./media/create-waf-portal/application-gateway-diagnostics.png)
...
1. Het openbare IP-adres vinden voor de toepassingsgateway op het scherm overzicht. Klik op **alle resources** en klik vervolgens op **myAGPublicIPAddress**.
    ...
    ![Record application gateway openbaar IP-adres](./media/create-waf-portal/application-gateway-record-ag-address.png)

2. Kopieer het openbare IP-adres en plak het in de adresbalk van de browser.

    ![Test toepassingsgateway](./media/create-waf-portal/application-gateway-iistest.png)
