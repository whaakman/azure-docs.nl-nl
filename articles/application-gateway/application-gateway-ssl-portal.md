...
5. Klik op **Kies een virtueel netwerk**, klikt u op **nieuw**, en voer deze waarden voor het virtuele netwerk:
    ...
    ![Virtueel netwerk maken](./media/application-gateway-ssl-portal/application-gateway-vnet.png)
...
10. Voer *mycert1* voor de naam van het certificaat en *Azure123456!* voor het wachtwoord en klik vervolgens op **OK**.
    ...
    ![Nieuwe toepassingsgateway maken](./media/application-gateway-ssl-portal/application-gateway-create.png)
...
2. Klik op **subnetten**, en klik vervolgens op **Subnet**.
    ...
    ![Subnet maken](./media/application-gateway-ssl-portal/application-gateway-subnet.png)
...
1. Open de interactieve shell en zorg ervoor dat deze is ingesteld op **PowerShell**.
    ...
    ![Aangepaste extensie installeren](./media/application-gateway-ssl-portal/application-gateway-extension.png)
...
5. Klik op **toevoegen doel** elke virtuele machine die u hebt gemaakt toevoegen aan de back-endpool.
    ...
    ![Back-endservers toevoegen](./media/application-gateway-ssl-portal/application-gateway-backend.png)
