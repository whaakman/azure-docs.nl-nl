...
- Zie [SQL Database zelfstudie: AAD-verificatie, aanmeldingen en gebruikersaccounts, databaserollen, machtigingen, firewallregels op serverniveau en firewallregels op databaseniveau](sql-database-control-access-aad-authentication-get-started.md) voor een zelfstudie met Azure Active Directory-verificatie.
