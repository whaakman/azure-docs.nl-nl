...
ms.locfileid: "47162998"
---
# <a name="configure-a-point-to-site-connection-to-connect-to-an-azure-sql-database-managed-instance-from-on-premises-computer"></a>Een punt-naar-site-verbinding verbinding maken met een Azure SQL Database Managed Instance vanaf on-premises computer configureren
...
5. Havigate naar de map WindowsAmd64 en open de **VpnClientSetupAmd64.exe** bestand.
