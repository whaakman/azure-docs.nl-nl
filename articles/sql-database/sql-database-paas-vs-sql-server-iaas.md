...
Voor **SQL-Database** Basic, Standard, Premium, algemeen gebruik en bedrijfskritische Servicelagen Microsoft een beschikbaarheids-SLA van 99,99 biedt %. Zie [Service Level Agreement](https://azure.microsoft.com/support/legal/sla/sql-database/) voor de meest recente informatie. Zie voor de nieuwste informatie over SQL Database Servicelagen en de ondersteunde plannen voor bedrijfscontinuïteit, [aankoopmodel DTU gebaseerde](sql-database-service-tiers-dtu.md) en [vCore gebaseerde aankoopmodel (preview)](sql-database-service-tiers-vcore.md).
