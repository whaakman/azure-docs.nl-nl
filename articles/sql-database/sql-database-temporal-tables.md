...
- Zie voor meer informatie over tijdelijke tabellen, Bekijk [tijdelijke tabellen](https://docs.microsoft.com/sql/relational-databases/tables/temporal-tables).
