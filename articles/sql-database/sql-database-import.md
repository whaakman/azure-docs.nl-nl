...
- Importeren in een database in een elastische pool wordt niet ondersteund. U kunt gegevens importeren in een singleton-database en vervolgens de database te verplaatsen naar een groep.
