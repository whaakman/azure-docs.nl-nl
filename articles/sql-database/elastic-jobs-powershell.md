...
- Naast de preview-module **AzureRM.Sql** 4.8.1, vereist deze zelfstudie de PowerShell-module *sqlserver*. Zie [SQL Server PowerShell-module installeren](https://docs.microsoft.com/sql/powershell/download-sql-server-ps-module) voor meer informatie.
