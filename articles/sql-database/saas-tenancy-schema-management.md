...
1. In SSMS, bladert u naar de *contosoconcerthall* database op de *tenants1-dpt -\<gebruiker\>*  server en de query de *VenueTypes* tabel naar Bevestig dat *motor race* en *zwemmen vereniging* **zijn** nu in de lijst met resultaten.
...
[Zelfstudie over ad-hocanalyses](saas-tenancy-adhoc-analytics.md)
