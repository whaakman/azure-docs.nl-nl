...
description: Geo-replicatie configureren voor Azure SQL Database in Azure portal en failover initiëren
...
Dit artikel leest u hoe u actieve geo-replicatie configureren voor SQL-Database in de [Azure-portal](http://portal.azure.com) en het starten van failover.

Zie voor het starten van failover met de Azure-portal, [een geplande of niet-geplande failover voor Azure SQL Database initiëren via Azure portal](sql-database-geo-replication-portal.md).
