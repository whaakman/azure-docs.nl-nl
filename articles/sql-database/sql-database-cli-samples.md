...
| [Een beheerd exemplaar maken en beheren](https://medium.com/azure-sqldb-managed-instance/working-with-sql-managed-instance-using-azure-cli-611795fe0b44) | Deze CLI-scripts bevatten informatie over het maken en beheren van een beheerd exemplaar met de Azure CLI |
|||
