...
In deze zelfstudie configureert u een Azure SQL-database en -toepassing voor failover naar een externe regio, waarna u het failoverschema gaat testen. Procedures voor: 
