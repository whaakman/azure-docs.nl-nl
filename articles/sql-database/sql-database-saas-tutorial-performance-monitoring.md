...
Blader naar **Pool2** (op het *tenants1* server) te openen van de groep zijn prestaties controleren. Als u deze niet ziet, wacht u totdat het inrichten van de nieuwe groep te voltooien.
