...
Deze zelfstudie gebruikt als uitgangspunt de resources die in deze zelfstudie zijn gemaakt: [Een beheerd exemplaar voor Azure SQL Database maken](sql-database-managed-instance-create-tutorial-portal.md).
