...
| [Change Data Capture](https://docs.microsoft.com/sql/relational-databases/track-changes/about-change-data-capture-sql-server) | Nee | Ja |
...
| [Query's tussen data bases](https://docs.microsoft.com/sql/relational-databases/linked-servers/linked-servers-database-engine) | Nee-Zie [elastische query's](sql-database-elastic-query-overview.md) | Ja, plus [elastische query's](sql-database-elastic-query-overview.md) |
...
| [Data base mail](https://docs.microsoft.com/sql/relational-databases/database-mail/database-mail) | Nee | Ja |
...
| [Data base terugzetten naar SQL Server](https://docs.microsoft.com/sql/relational-databases/backup-restore/back-up-and-restore-of-sql-server-databases#restore-data-backups) | Nee. | Nee, omdat SQL Server data base-engine die in het beheerde exemplaar wordt gebruikt, een hogere versie heeft dan een RTM-versie van SQL Server die on-premises wordt gebruikt. |
...
| [Inzicht in queryprestaties](sql-database-query-performance.md) | Ja | Nee. Gebruik ingebouwde rapporten in SQL Server Management Studio en Azure Data Studio. |
...
| [System Center-Operations Manager](https://docs.microsoft.com/system-center/scom/welcome) | [Ja](https://www.microsoft.com/download/details.aspx?id=38829) | Nee |
