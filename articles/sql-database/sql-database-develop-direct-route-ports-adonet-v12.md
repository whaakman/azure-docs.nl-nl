...
Wanneer de client wordt uitgevoerd binnen een grens van de Azure-cloud, gebruikt het kunt zogeheten een *direct route* om te communiceren met de Database van SQL server. Nadat een verbinding tot stand is gebracht, verdere inhouden interacties tussen de client en de database geen proxy middleware.
