...
> [!TIP]
> Als u wilt bewaken in voortgang van bewerkingen, Zie: [beheren met behulp van de REST-API voor SQL operations](https://docs.microsoft.com/rest/api/sql/databaseoperations/databaseoperations_listbydatabase
