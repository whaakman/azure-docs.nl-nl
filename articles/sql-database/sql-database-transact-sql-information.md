...
Hoge beschikbaarheid is bijvoorbeeld ingebouwd in Azure, zodat het configureren van AlwaysOn is niet nodig (Hoewel u configureren van actieve geo-replicatie voor sneller herstel in het geval van een ramp wilt). Dus T-SQL-instructies met betrekking tot de beschikbaarheidsgroepen worden niet ondersteund door SQL Database en de dynamische beheerweergaven voor Always On ook niet ondersteund.
