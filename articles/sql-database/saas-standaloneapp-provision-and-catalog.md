...
* De voorbeeld-apps voor drie tenant worden geïmplementeerd. Zie voor het implementeren van deze apps in minder dan vijf minuten [implementeren en verkennen van het patroon Wingtip Tickets SaaS-toepassing voor zelfstandige](https://docs.microsoft.com/azure/sql-database/saas-standaloneapp-get-started-deploy).
...
U kunt ontdekken hoe de catalogus wordt gebruikt ter ondersteuning van verschillende scenario's voor alle tenants met behulp van de database-per-tenant-versie van de [Wingtip Tickets SaaS-toepassing](https://docs.microsoft.com/azure/sql-database/saas-dbpertenant-wingtip-app-overview).  
