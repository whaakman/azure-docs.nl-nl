...
| [New-AzureRmSqlDatabase](/powershell/module/azurerm.sql/new-azurermsqldatabase) | Hiermee wordt een enkele database of een gegroepeerde database gemaakt. |
