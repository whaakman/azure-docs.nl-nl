...
| [AZ sql db maken](https://docs.microsoft.com/cli/azure/sql/db#az-sql-db-create) | Hiermee maakt u een individuele database of een andere database in een elastische pool. |
