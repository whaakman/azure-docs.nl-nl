...
| [az sql db show-usage](https://docs.microsoft.com/cli/azure/sql/db#az-sql-db-show-usage) | Toont de gebruikte grootte voor een individuele of gepoolde database. |
