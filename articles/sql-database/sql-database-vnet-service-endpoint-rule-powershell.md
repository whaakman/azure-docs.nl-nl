...
5. **Nieuwe AzureRmSqlServerVirtualNetworkRule**: nadat uw subnet een eindpunt is, voegt u uw subnet toe als een regel virtueel netwerk in de ACL van uw Azure SQL Database-server.
