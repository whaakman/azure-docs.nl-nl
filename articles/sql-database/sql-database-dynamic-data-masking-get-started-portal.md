---
title: 'Azure Portal: Dynamische gegevensmaskering voor SQL Database | Microsoft Docs'
...
* U kunt ook implementeren dynamische gegevens maskeren met [Azure SQL Database-cmdlets](https://docs.microsoft.com/powershell/module/az.sql/) of de [REST-API](https://docs.microsoft.com/rest/api/sql/).
