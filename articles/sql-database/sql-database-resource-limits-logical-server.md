...
description: In dit artikel biedt een overzicht van de logische Azure SQL Database-server resourcelimieten voor individuele databases en gepoolde databases met behulp van elastische pools. Het bevat ook informatie over wat er gebeurt wanneer deze resourcelimieten zijn bereikt of overschreden.
...
ms.locfileid: "51620887"
---
# <a name="sql-database-resource-limits-for-single-and-pooled-databases"></a>SQL Database-resourcebeperkingen voor één en gepoolde databases
...
| Maximum aantal toepassingen per server | Beperkt door het aantal dtu's of vCores. Bijvoorbeeld, als elke groep 1000 dtu's is, kan klikt u vervolgens een enkele server ondersteunen 54 pools.|
||||
