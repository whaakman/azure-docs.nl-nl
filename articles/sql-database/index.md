...
<div class="columnHolder">
    <div class="column50">
        ...
        <p>Bouw en implementeer SQL Database-toepassingen.</p>
        <ul class="spaced">
            <li><a href="/azure/sql-database/sql-database-design-first-database">Een database ontwerpen</a></li>
            <li><a href="/azure/sql-database/sql-database-migrate-your-sql-server-database">Een database migreren</a></li>
        </ul>
        <h2>Voorbeelden</h2>
        <p>Zoek scripts om algemene taken te beheren.</p>
        <ul class="spaced">
    ...
    <div class="column50" style="max-width: 400px">
        ...
        <a href="https://www.pluralsight.com/courses/developing-dotnet-microsoft-azure-getting-started?twoid=d6abac77-7dcc-4d33-9e03-f85e78989f02">
            ...
            <p style="margin-top: 0px">Gratis PluralSight-videotraining: Ontwikkelen met .NET</a></p>
    </div>
</div>
