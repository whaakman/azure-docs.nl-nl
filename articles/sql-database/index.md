---
title: Documentatie voor Azure SQL Database - zelfstudies, API-verwijzing | Microsoft Docs
description: Ontdek hoe u Azure SQL-databases gebruikt.
...
---
<div class="content">
    <h1>Documentatie voor SQL Database</h1>
    <div class="introHolder" style="justify-content: space-between;">
        <div class="intro" style="min-width: 200px">
            <p>Azure SQL Database is een op de Microsoft SQL Server Engine gebaseerde relationele database-als-een-service in de cloud. SQL Database is een krachtige, betrouwbare en veilige database die u kunt gebruiken om gegevensgestuurde toepassingen en websites te bouwen in de programmeertaal van uw keuze, zonder dat u hiervoor infrastructuur hoeft te beheren. Ontdek met onze snelstartgidsen, zelfstudies en voorbeelden hoe u SQL Database gebruikt.</p>
        </div>
        <a href="https://azure.microsoft.com/en-us/resources/videos/create-sql-database-on-azure/">
            <div class="calloutHolder" style="max-width: 250px">
                ...
                <div>
                    <p style="margin-top: 0; color: #6e6e6e">Maak een SQL-database in Azure. (3:12)</p>
                </div>
            </div>
        </a>
    </div>
<h2 style="margin-top: 18px; margin-bottom: 0px;">QuickStarts van vijf minuten</h2>
<p style="margin-top: 6px; margin-bottom: 6px;">Meer informatie over hoe u een SQL-database maakt, beheert met SQL Management Studio en gebruikt voor ontwikkeling in C#, Java, Python, Node.js en Ruby:</p>
<div class="ico48Case">
    <div class="ico48Link">
...
<p>Meer informatie over het maken, beheren en migreren van databases met SQL DB</p>
<ol>
...
<h2 style="margin-top: 36px">Voorbeelden</h2>
<p>Scripts zoeken om algemene taken te beheren</p>
<ul class="spaced">
            ...
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        ...
                        <p><a href="/powershell/elasticdatabasejobs/v0.8.33/elasticdatabasejobs">Azure PowerShell (elastische database)</a></p>
    ...
    <li>
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>SQL Server-hulpprogramma's</h3>
                        <p><a href="https://msdn.microsoft.com/library/mt238365.aspx">SQL Server-hulpprogramma's</a></p>
                        ...
                        <p><a href="https://www.nuget.org/packages/Microsoft.Azure.Management.Sql">Pakket met SQL Database-beheerbibliotheek</a></p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <li>
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>SQL Server-stuurprogramma's</h3>
                        <p><a href="https://msdn.microsoft.com/library/mt654049.aspx">SQL Server-stuurprogramma's</a></p>
