...
> [!NOTE]
> Deze instructies zijn van toepassing beide Time Series Insights algemeen beschikbaar en Time Series Insights bijwerken Private Preview-omgevingen.
...
1. Onder de **entiteiten** kop, selecteer **consumentengroepen**.
...
1. Selecteer **+ Consumergroep** om toe te voegen een nieuwe consumergroep. 

1. Op de **consumentengroepen** pagina, geeft u een nieuwe unieke **naam**.  Deze dezelfde naam gebruiken bij het maken van een nieuwe bron van gebeurtenis in de Time Series Insights-omgeving.

1. Selecteer **maken** te maken van de nieuwe consumergroep.
...
1. Geef een **naam van bron** uniek is voor deze Time Series Insights-omgeving, zoals **gebeurtenisstroom**.
...
1. Selecteer de **bron** als **Event Hub**.
...
1. Als u hebt geselecteerd de **gebruik Event Hub uit de beschikbare abonnementen** optie, de volgende tabel wordt uitgelegd dat de vereiste eigenschap:
...
1. Als u hebt geselecteerd de **bieden Event Hub-instellingen handmatig** optie, de volgende tabel wordt uitgelegd dat de vereiste eigenschap:
...
1. De toegewezen TSI consument groepsnaam die u hebt toegevoegd aan uw Event hub toevoegen.
