        ...
        <div class="cardSize"> 
            <div class="cardPadding"> 
                <div class="card"> 
                    ...
                    <div class="cardText"> 
                        <h3>Meer informatie over Time Series Insights</h3> 
                    </div> 
                </div> 
            </div> 
        </div> 
        ...
        <div class="cardSize"> 
            <div class="cardPadding"> 
                <div class="card"> 
                    ...
                    <div class="cardText"> 
                        <h3>Videobibliotheek voor Time Series Insights</h3> 
                    </div> 
                </div> 
            </div> 
        </div> 
        ...
        <div class="cardSize"> 
            <div class="cardPadding"> 
                <div class="card"> 
                    ...
                    <div class="cardText"> 
                        <h3>Ga aan de slag met Time Series Insights</h3> 
                    </div> 
                </div> 
            </div> 
        </div> 
        ...
        <div class="cardSize"> 
            <div class="cardPadding"> 
                <div class="card"> 
                    ...
                    <div class="cardText"> 
                        <h3>Probeer Time Series Insights op een verzameling voorbeeldgegevens</h3> 
                    </div> 
                </div> 
            </div> 
        </div> 
