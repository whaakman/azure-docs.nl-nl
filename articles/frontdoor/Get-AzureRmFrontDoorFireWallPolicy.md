...
## BESCHRIJVING
De **Get-AzureRmFrontDoorFireWallPolicy** cmdletGet WAF-beleid in een resourcegroep onder het huidige abonnement opgehaald

## VOORBEELDEN

### Voorbeeld 1: Een WAF-beleid met de naam $Name in $resourceGroup ophalen
```powershell
...
Een WAF-beleid met de naam $Name in $resourceGroup ophalen

### Voorbeeld 2: Beleid voor alle WAF in $resourceGroup ophalen
```powershell
...
Alle WAF-beleid in $resourceGroup ophalen
