...
ms.locfileid: "47047736"
---
# Set-AzureRmFrontDoor
Een voordeur load balancer bijwerken
...
## BESCHRIJVING
De **Set AzureRmFrontDoor** met de cmdlet een voordeur load balancer bijgewerkt. Als u invoerparameters zijn opgegeven, worden oude parameters van de bestaande voordeur wordt gebruikt.

## VOORBEELDEN

### Voorbeeld 1: een bestaande voordeur met FrontDoorName en ResourceGroupName bijwerken
```powershell
...
### Voorbeeld 2: werk een bestaande voordeur met PSFrontDoor-object.
```powershell
...
### Voorbeeld 3: een bestaande voordeur met ResourceId bijwerken
```powershell
...
### -EnabledState
Operationele status van de voordeur load balancer.
...
### -InputObject
Het object voordeur om bij te werken.
...
### -Naam
De naam van de voordeur om bij te werken.
...
### -ResourceId
Resource-Id van de voordeur om bij te werken
