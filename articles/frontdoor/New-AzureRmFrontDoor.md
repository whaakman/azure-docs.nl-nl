...
ms.locfileid: "47047673"
---
# Nieuwe AzureRmFrontDoor

Een nieuwe voordeur Azure load balancer maken
...
## BESCHRIJVING
De **New-AzureRmFrontDoor** cmdlet maakt een nieuwe voordeur Azure load balancer in de opgegeven resourcegroep onder het huidige abonnement

## VOORBEELDEN

### Voorbeeld 1: Maak een voordeur op basis van bepaalde parameters.
```powershell
...
Maak een voordeur op basis van bepaalde parameters.

## PARAMETERS

### -Hosts met de status
Backendpools beschikbaar voor de regel voor doorsturen.
...
### -EnabledState
EnabledState van de voordeur load balancer.
...
### -FrontendEndpoint
Frontend-eindpunten beschikbaar voor de regel voor doorsturen.
...
### -HealthProbeSetting
Health test-instellingen die zijn gekoppeld aan dit exemplaar van de voordeur.
...
Load balancing-instellingen die zijn gekoppeld aan dit exemplaar van de voordeur.
...
### -ResourceGroupName
Naam van de resourcegroep die de voordeur in worden gemaakt.
...
### -RoutingRule
Regels voor doorsturen die zijn gekoppeld aan deze FrontDoor
...
### -Tags
De labels koppelen aan de FrontDoor.
