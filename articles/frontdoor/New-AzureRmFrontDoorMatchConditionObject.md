...
ms.locfileid: "47047368"
---
# Nieuwe AzureRmFrontDoorMatchConditionObject
MatchCondition-Object voor het maken van de WAF-beleid maken
...
Een object MatchCondition maken
...
### -MatchVariable
Komt overeen met een variabele.
Mogelijke waarden zijn: 'RemoteAddr', 'RequestMethod', 'QueryString', 'PostArgs', 'RequestUri', 'RequestHeader', 'RequestBody'
...
### -NegateCondition
Hierin wordt beschreven of dit probleem is dat niet op de standaardwaarde is false
...
### -OperatorProperty
Hierin wordt beschreven operator worden vergeleken.
Mogelijke waarden zijn: 'Any', 'IPMatch', 'GeoMatch', 'Gelijk', 'Contains', 'LessThan', 'Groter dan', 'LessThanOrEqual', 'GreaterThanOrEqual', 'BeginsWith', ' EndsWith''
...
### -Selector
Naam van selector in RequestHeader of RequestBody worden vergeleken
