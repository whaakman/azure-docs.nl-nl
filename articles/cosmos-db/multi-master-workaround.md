---
title: Uitvoeren van meerdere landen/regio geschreven en gelezen door het recht partitiesleutel kiezen | Microsoft Docs
description: Meer informatie over het kiezen van een partitiesleutel toepassingsarchitecturen met lokale lees- en schrijfbewerkingen ontwerpen over meerdere geografische regio's met Azure Cosmos DB.
services: cosmos-db
author: SnehaGunda
manager: kfile
...
ms.locfileid: "34850358"
---
# <a name="perform-multi-region-writes-and-reads-by-choosing-the-right-partitioning-key"></a>Uitvoeren van meerdere landen/regio geschreven en gelezen door het recht partitiesleutel kiezen
...
![Azure meerdere masters Cosmos-DB-architectuur](./media/multi-master-workaround/multi-master.png)
