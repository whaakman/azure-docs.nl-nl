...
Azure Cosmos DB biedt de volgende mogelijkheden waarmee u eenvoudig globaal gedistribueerd om toepassingen te schrijven. Deze mogelijkheden zijn beschikbaar via de Azure Cosmos-DB resource provider gebaseerde [REST-API's](https://docs.microsoft.com/rest/api/cosmos-db-resource-provider/) en de Azure-portal.
...
**Een enkele container Azure Cosmos DB horizontaal gepartitioneerde (meerdere partities van de drie resource binnen een regio) en vervolgens globaal-verdeeld over drie Azure-regio 's**
...
Azure Cosmos DB blijft de hoge beschikbaarheid behouden wanneer wijzigingen zijn aangebracht aan de ingerichte doorvoer. Azure Cosmos DB transparant resource partities beheert (en gesplitste, samenvoegen en kloon-bewerkingen worden uitgevoerd) en zorgt ervoor dat de bewerkingen kunnen geen nadelige invloed op prestaties of beschikbaarheid, terwijl de toepassing elastisch verhoogt of verlaagt u Hiermee doorvoer. 
