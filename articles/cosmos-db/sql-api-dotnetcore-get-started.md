...
6. Selecteer op het tabblad **NuGet** de optie **Bladeren** boven in het venster en typ **azure documentdb** in het zoekvak.
...
![Sleutels ophalen uit de Azure-portal][keys]
