---
title: Azure Cosmos DB .NET Core API, SDK en Resources | Microsoft Docs
description: Meer informatie over de .NET Core API en de SDK, inclusief release datums, buiten gebruik stellen datums en wijzigingen die zijn aangebracht tussen elke versie van de Azure Cosmos DB .NET Core SDK.
services: cosmos-db
...
<tr><td>**Aan de slag**</td><td>[Aan de slag met Azure Cosmos DB .NET Core SDK](documentdb-dotnetcore-get-started.md)</td></tr>
...
De Azure Cosmos DB .NET Core SDK heeft functie pariteit met de nieuwste versie van de [Azure Cosmos DB .NET SDK](documentdb-sdk-dotnet.md).
...
* Interne wijzigingen die zijn gerelateerd aan ondersteunende [Microsoft.Azure.Graphs](https://docs.microsoft.com/en-us/azure/cosmos-db/graph-sdk-dotnet)
...
De Azure Cosmos DB .NET Core Preview SDK heeft functie pariteit met de nieuwste versie van de [Azure Cosmos DB .NET SDK](documentdb-sdk-dotnet.md) en ondersteunt de volgende:
