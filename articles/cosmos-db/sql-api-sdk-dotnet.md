...
* Vaste bug waar JsonProperty kenmerk in de component select voor LINQ-query's niet wordt wordt gehonoreerd.
...
* Wijzigingen in de interne voor Microsoft vrienden assembly's.
