...
ms.locfileid: "53792246"
---
# <a name="build-a-flask-app-using-azure-cosmos-dbs-api-for-mongodb"></a>Met de API van Azure Cosmos DB voor MongoDB een Flask-app maken
