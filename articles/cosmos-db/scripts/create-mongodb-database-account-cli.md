...
[!code-azurecli-interactive[belangrijkste](../../../cli_scripts/cosmosdb/create-cosmosdb-mongodb-account/create-cosmosdb-mongodb-account.sh?highlight=15-35 "een Azure Cosmos DB MongoDB-API-account, database en verzameling maken")]
