...
| [az cosmosdb list-keys](https://docs.microsoft.com/cli/azure/cosmosdb#az-cosmosdb-list-keys) | Hiermee wordt een logische server gemaakt waar de SQL Database wordt gehost. |
