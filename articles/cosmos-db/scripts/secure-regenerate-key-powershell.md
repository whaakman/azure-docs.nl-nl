...
[!code-powershell[belangrijkste](../../../powershell_scripts/cosmosdb/regenerate-account-keys/regenerate-account-keys.ps1?highlight=36-41 "Azure Cosmos-DB opnieuw genereren van sleutels")]
...
| [Aanroepen AzureRmResourceAction](https://docs.microsoft.com/powershell/module/azurerm.resources/invoke-azurermresourceaction?view=azurermps-3.8.0) | Hiermee wordt een actie op de CosmosDB Azure-account. |
