---
title: Azure CLI-script - Multi-regioreplicatie voor Azure Cosmos DB | Microsoft Docs
description: Azure CLI-voorbeeldscript - Multi-regioreplicatie voor Azure Cosmos-DB
services: cosmos-db
