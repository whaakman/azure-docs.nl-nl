---
title: Azure PowerShell-script - een container in een Azure Cosmos-account maken
description: Azure PowerShell-script - een container maken in een Azure Cosmos-account
author: markjbrown
...
---
# <a name="create-a-container-in-an-azure-cosmos-account-using-powershell"></a>Maak een container in een Azure Cosmos-account met behulp van PowerShell
