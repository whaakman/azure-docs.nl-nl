---
title: Azure PowerShell-script - Get-verbindingsreeksen voor een Azure Cosmos-account
description: Azure PowerShell-voorbeeldscript - Get-verbindingsreeksen voor een Azure Cosmos-account
author: markjbrown
...
---
# <a name="get-connection-strings-for-an-azure-cosmos-account-using-powershell"></a>Verbindingsreeksen verkrijgen voor een Azure Cosmos-account met behulp van PowerShell
