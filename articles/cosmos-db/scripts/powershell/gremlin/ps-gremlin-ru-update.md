...
ms.locfileid: "66247467"
---
# <a name="update-rus-for-a-database-or-graph-for-azure-cosmos-db---gremlin-api"></a>Update RU/s voor een database of een grafiek voor Azure Cosmos DB - Gremlin-API
