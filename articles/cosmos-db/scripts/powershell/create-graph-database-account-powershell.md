---
title: Azure PowerShell-script-een Gremlin-API van Azure Cosmos DB-account maken
description: Azure PowerShell-script - een Gremlin-API van Azure Cosmos DB-account maken
