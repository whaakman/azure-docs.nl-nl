...
ms.locfileid: "46969052"
---
# <a name="nodejs-tutorial-create-a-nodejs-console-application-with-javascript-sdk-to-manage-azure-cosmos-db-sql-api-data"></a>Node.js-zelfstudie: een Node.js-consoletoepassing maken met JavaScript SDK voor het beheren van gegevens in Azure Cosmos DB SQL API
