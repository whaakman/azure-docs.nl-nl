---
title: Gegevens importeren voor gebruik met de Azure Cosmos DB Table-API | Microsoft Docs
description: Meer informatie over het importeren van gegevens voor gebruik met de Azure Cosmos DB Table-API.
services: cosmos-db
author: SnehaGunda
manager: kfile
