...
# Azure Cosmos DB: een MongoDB-API-console-app ontwikkelen met Golang en Azure Portal
...
### Query's uitvoeren voor een document of een document lezen
...
## Uw document bekijken in Data Explorer
