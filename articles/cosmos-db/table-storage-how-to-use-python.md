...
- [Azure Storage-account](https://docs.microsoft.com/azure/storage/common/storage-create-storage-account#create-a-storage-account) of [Azure DB die Cosmos-account](https://azure.microsoft.com/try/cosmosdb/)
...
* [Veelgestelde vragen over - ontwikkelen met de tabel-API](https://docs.microsoft.com/azure/cosmos-db/faq#develop-with-the-table-api)
