...
---
# <a name="how-to-use-azure-table-storage-from-ruby"></a>Hoe Azure Table Storage gebruiken met Ruby
...
Voor instructies hoe een Ruby-toepassing maken, Zie [Ruby op Rails webtoepassing op een virtuele machine van Azure](../virtual-machines/linux/classic/virtual-machines-linux-classic-ruby-rails-web-app.md).
