...
De Azure Tools voor Visual Studio biedt een projectsjabloon waarmee u een Azure-cloud-service maken. Zodra het project is gemaakt, wordt Visual Studio kunt u configureren, fouten opsporen en implementeren van de cloudservice in Azure.
