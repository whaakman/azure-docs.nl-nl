...
- [Zone-redundante regio toevoegen voor Azure Cosmos DB](../cosmos-db/high-availability.md#availability-zone-support)
- [Aan de slag Azure Cache voor Redis-Beschikbaarheidszones](https://aka.ms/redis/az/getstarted)
