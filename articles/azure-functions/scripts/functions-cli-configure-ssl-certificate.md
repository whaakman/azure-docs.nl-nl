...
| [AZ appservice web config ssl-binding](https://docs.microsoft.com/en-us/cli/azure/appservice/web/config/ssl#az_appservice_web_config_ssl_bind) | Een geüploade SSL-certificaat koppelt aan een functie-app. |
