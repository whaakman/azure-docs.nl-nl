...
### <a name="f-template-example"></a>F#Voorbeeld van de sjabloon
...
|**name** |N.v.t.| Naam van de variabele in functiecode gebruikt voor de notification hub-bericht. |
