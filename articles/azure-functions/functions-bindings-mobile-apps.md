...
| **name**|| De naam van de invoerparameter in de functiehandtekening.|
|**tableName** |**TableName**|Naam van de mobiele app gegevenstabel|
...
| **name**|| De naam van de uitvoerparameter bij functiehandtekening.|
|**tableName** |**TableName**|Naam van de mobiele app gegevenstabel|
