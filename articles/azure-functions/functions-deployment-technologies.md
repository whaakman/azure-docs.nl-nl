...
__Wat het doet:__ Hiermee kunt u verwijzen naar een extern pakket (.zip)-bestand met de functie-app. Het bestand wordt gedownload van de opgegeven URL en de app wordt uitgevoerd [uitvoeren-van-Package](run-functions-from-deployment-package.md) modus.
...
__Wat het doet:__ Hiermee kunt u een zip-bestand met de functie-app naar Azure te pushen. (Optioneel) u kunt ook opgeven als u wilt dat uw app te starten in [uitvoeren-van-Package](run-functions-from-deployment-package.md) modus.
...
__Wat het doet:__ Geef een containerinstallatiekopie waarmee u Azure Functions ophalen en uitvoeren.
...
__Wat het doet:__ Pakketten maken en implementeren van uw Windows-toepassingen op een IIS-server, met inbegrip van uw Azure-functie-apps die worden uitgevoerd op Windows.
...
__Wat het doet:__ Hiermee kunt u uw functie-app tot een git-opslagplaats koppelen zodat updates van code in die opslagplaats implementatie wordt geactiveerd. Voor meer informatie, bekijk de [Kudu Wiki](https://github.com/projectkudu/kudu/wiki/VSTS-vs-Kudu-deployments).
...
__Wat het doet:__ Hiermee kunt u code van uw lokale computer pushen naar Azure Functions met behulp van Git.
...
__Wat het doet:__ Hiermee kunt u de inhoud van Dropbox en OneDrive naar Azure Functions synchroniseren.
...
__Wat het doet:__ Kunt u rechtstreeks en draagt bestanden asynchroon naar Azure Functions.
...
__Wat het doet:__ Met behulp van de editor op basis van een portal, kunt u rechtstreeks bewerken bestanden op uw functie-app (in feite implementeren telkens wanneer u klikt op **opslaan**).
...
#### <a name="portal-editing-availability"></a>Portal voor het bewerken van beschikbaarheid
...
<sup>1</sup> portal bewerken is ingeschakeld voor alleen HTTP- en Timer triggers voor Functions op Linux met behulp van de toegewezen plannen.
...
## <a name="other-relevant-information"></a>Andere relevante informatie
...
> [resource-implementatie voor uw functie-app in Azure Functions automatiseren](functions-infrastructure-as-code.md)
