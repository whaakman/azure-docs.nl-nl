...
U kunt ook Azure CLI 2.0 gebruiken om de Python HTTP-server te installeren in Linux met [az group deployment create](/cli/azure/group/deployment#az_group_deployment_create). Dit doet u als volgt:
