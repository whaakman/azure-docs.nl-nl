---
title: Azure CLI-voorbeeldscript - Azure CLI-voorbeeldscript - Batch AI-cluster met lage prioriteit maken | Microsoft Docs
description: Azure CLI-voorbeeldscript - Een Batch AI-cluster met knooppunten (virtuele machines) met lage prioriteit maken en beheren
services: batch-ai
documentationcenter: ''
author: dlepow
manager: jeconnoc
