---
title: Een CNTK-model trainen met Azure Batch AI - Python | Microsoft Docs
description: Een neuraal netwerk van Microsoft Cognitive Toolkit (CNTK) trainen met Azure Batch AI en met behulp van de Python SDK
services: batch-ai
...
In dit artikel leert u hoe u de Azure Python SDK gebruikt om een Microsoft Cognitive Toolkit-voorbeeldmodel (CNTK) traint met de Batch AI-service.
...
* Azure Python SDK: raadpleeg de [installatie-instructies](/python/azure/python-sdk-azure-install). Dit artikel vereist ten minste pakketversie 2.0.0 van azure-mgmt-batchai.
...
Maak een bestandsshare met de naam `batchaiquickstart`.
...
Een werkruimte is een verzameling op het hoogste niveau van alle soorten AI Batch-resources. U maakt een Batch-AI-cluster en experimenteert in een werkruimte.
...
## <a name="create-experiment-and-training-job"></a>Experiment en trainingstaak maken

Nadat het cluster is gemaakt, maakt u een experiment (een logische container voor een groep gerelateerde taken). Vervolgens configureert u een trainingstaak in het experiment en verzendt u deze:
...
Raadpleeg de [trainingsrecepten](https://github.com/Azure/BatchAI) voor meer informatie over het gebruik van Batch AI met verschillende raamwerken.