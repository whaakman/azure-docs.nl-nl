...
Als u het opdrachtregelprogramma uitvoeren op een ander platform wilt, Azure Cache voor Redis van downloaden [ http://redis.io/download ](https://redis.io/download).
