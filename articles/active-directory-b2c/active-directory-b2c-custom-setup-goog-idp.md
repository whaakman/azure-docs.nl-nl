...
2. Voeg de volgende **ClaimsExchange** element ervoor te zorgen dat u dezelfde waarde voor de ID die u hebt gebruikt voor **TargetClaimsExchangeId**:
