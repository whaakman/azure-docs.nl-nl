---
title: Hulpprogramma voor aanpassing helper Page UI in Azure Active Directory B2C | Microsoft Docs
description: Een helper-hulpprogramma gebruikt om te demonstreren van de functie pagina UI aanpassen in Azure Active Directory B2C.
