...
| ---- | ----------------------- | --------- | ----- |
| InputClaim | inputJson | tekenreeks | De ClaimTypes die door de claimtransformatie worden gebruikt om op te halen van het item. |
| Invoerparameters | claimToExtract | tekenreeks | de naam van de JSON-element moet worden geëxtraheerd. |
| outputClaim | extractedClaim | tekenreeks | Het ClaimType dat wordt gegenereerd nadat deze transformatie claims is aangeroepen, de elementwaarde die is opgegeven in de _claimToExtract_ invoerparameter. |
...
| Item | TransformationClaimType | Gegevenstype | Opmerkingen |
| ---- | ----------------------- | --------- | ----- |
| InputClaim | jsonSourceClaim | tekenreeks | De ClaimTypes die door de claimtransformatie worden gebruikt om op te halen van de claims. |
| Invoerparameters | errorOnMissingClaims | booleaans | Geeft aan of een fout is inzetten als een van de claims ontbreekt. |
| Invoerparameters | includeEmptyClaims | tekenreeks | Geef op of bevatten lege claims. |
| Invoerparameters | jsonSourceKeyName | tekenreeks | Sleutelnaam van element |
| Invoerparameters | jsonSourceValueName | tekenreeks | Waardenaam element |
...
| Item | TransformationClaimType | Gegevenstype | Opmerkingen |
| ---- | ----------------------- | --------- | ----- |
| InputClaim | inputJson | tekenreeks | De ClaimTypes die door de claimtransformatie worden gebruikt om op te halen van de claim. |
| Invoerparameters | claimToExtract | tekenreeks | De naam van de JSON-element om op te halen. |
| outputClaim | extractedClaim | lengte | Het ClaimType dat wordt gegenereerd nadat deze ClaimsTransformation is aangeroepen, van het element waarde opgegeven in de _claimToExtract_ -invoerparameters. |
...
| Item | TransformationClaimType | Gegevenstype | Opmerkingen |
| ---- | ----------------------- | --------- | ----- |
| InputClaim | inputJsonClaim | tekenreeks | De ClaimTypes die door de claimtransformatie worden gebruikt voor het item ophalen uit de JSON-matrix. |
| outputClaim | extractedClaim | tekenreeks | Het ClaimType dat wordt gegenereerd nadat deze ClaimsTransformation is aangeroepen, het eerste element in de JSON-matrix. |
...
| Item | TransformationClaimType | Gegevenstype | Opmerkingen |
| ---- | ----------------------- | --------- | ----- |
| InputClaim | xml | tekenreeks | De ClaimTypes die worden gebruikt door de claimtransformatie voor de gegevens uit XML converteren naar JSON-indeling. |
| outputClaim | json | tekenreeks | Het ClaimType dat wordt gegenereerd nadat deze ClaimsTransformation is aangeroepen, worden de gegevens in JSON-indeling. |
