...
4. Een tekstvak wordt weergegeven onder de **Blobcontainers** map. Voer een naam in voor de blobcontainer. Zie [maken van een container](storage/blobs/storage-quickstart-blobs-dotnet.md#create-a-container) voor meer informatie over regels en beperkingen voor namen van blobcontainers.
...
7. Volg hieronder de stappen voor de bewerking die u wilt uitvoeren:
   ...
   * **Bestanden uploaden naar een blob-container**
     ...
     3. Geef het type **Blobtype**. Zie [maken van een container](storage/blobs/storage-quickstart-blobs-dotnet.md#create-a-container) voor meer informatie.
