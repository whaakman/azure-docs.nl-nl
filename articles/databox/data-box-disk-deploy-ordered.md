...
ms.locfileid: "39126538"
---
# <a name="tutorial-order-an-azure-data-box-disk-preview"></a>Zelfstudie: een Azure Data Box Disk (preview) bestellen

Azure Data Box Disk is een cloudoplossing waarmee u uw on-premises gegevens snel, eenvoudig en betrouwbaar in Azure importeert. U zet uw gegevens op SSD-schijven (solid-state drives) die Microsoft naar u heeft verstuurd en u stuurt de schijven terug. Deze gegevens worden vervolgens geüpload in Azure. 
...
> - Tijdens de preview-fase wordt Data Box Disk verzonden naar klanten in de Verenigde Staten en de Europese Unie. Ga naar [Beschikbaarheid in de regio](data-box-disk-overview.md#region-availability) voor meer informatie.
...
6.  Voer in **Bestellen** de **Orderdetails** in. Voer de volgende informatie in of selecteer deze.
    ...
    |Doel-Azure-regio| Selecteer een regio voor uw opslagaccount.<br> Momenteel worden alleen opslagaccounts in alle regio's in de VS en in West- en Noord-Europa ondersteund. |
