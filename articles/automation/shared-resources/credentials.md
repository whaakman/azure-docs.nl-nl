...
| Cmdlets | Description |
|:--- |:--- |
| [Get-AzureRmAutomationCredential](/powershell/module/azurerm.automation/get-azurermautomationcredential) |Haalt informatie op over een referentie-element. Dit resulteert niet in een PSCredential-object.  |
...
> [!NOTE]
> **Get-AzureRmAutomationCredential** resulteert niet in een **PSCredential** die kunnen worden gebruikt voor verificatie. Het bevat alleen informatie over de referentie. Als u wilt een referentie gebruiken in een runbook moet u de **Get-AutomationPSCredential** om op te halen de **PSCredential** object.
...
![Referentie voor canvas-toevoegen](../media/credentials/credential-add-canvas.png)
...
![Referentie voor canvas-toevoegen](../media/credentials/get-credential.png)
