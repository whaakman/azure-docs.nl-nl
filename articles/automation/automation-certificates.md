...
Als u een certificaat, gebruikt de **Get-AutomationCertificate** activiteit. U kunt geen gebruiken de [Get-AzureRmAutomationCertificate](https://docs.microsoft.com/powershell/module/azurerm.automation/get-azurermautomationcertificate) cmdlet omdat deze informatie over het certificaatasset, maar niet het certificaat zelf retourneert.
