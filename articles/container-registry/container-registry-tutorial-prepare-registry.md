...
Ga naar de volgende zelfstudie voor meer informatie over het implementeren van de container op meerdere exemplaren van Azure App Service, met behulp van geo-replicatie voor de installatiekopieën van het lokaal.

> [!div class="nextstepaction"]
> [Implementeer containers naar Azure App Services](container-registry-tutorial-deploy-app.md)
