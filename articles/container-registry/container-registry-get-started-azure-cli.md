...
# Een privé-Docker-containerregister maken met de Azure CLI 2.0
...
De volgende opdracht maakt gebruik van de minimale parameters om containerregister `myRegistry1` te maken in de resourcegroep `myResourceGroup` met de SKU *Basic*:
...
## Een service-principal toewijzen
...
### Een service-principal maken en toegang tot het register toewijzen
...
### Een bestaande service-principal toewijzen
...
### Beheerder inschakelen voor een bestaand register
```azurecli
...
### Beheerder uitschakelen voor een bestaand register
```azurecli
...
## Installatiekopieën en tags weergeven
