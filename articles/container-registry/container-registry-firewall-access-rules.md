...
* Meer informatie over [Aanbevolen procedures voor Azure voor netwerk beveiliging](../security/azure-security-network-security-best-practices.md)

* Meer informatie over [beveiligings groepen](https://docs.microsoft.com/en-us/azure/virtual-network/security-overview.md) in een virtueel Azure-netwerk
