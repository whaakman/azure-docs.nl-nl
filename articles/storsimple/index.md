...
ms.locfileid: "60929994"
---
# <a name="storsimple-documentation"></a>Documentatie voor StorSimple

Meer informatie over het gebruik van Azure StorSimple, een geïntegreerde opslagoplossing voor het beheer van opslagtaken tussen on-premises apparaten en Azure-cloudopslag. Zelfstudies en andere documentatie laten zien hoe u opslagbeheer, locatieonafhankelijke back-ups en herstel na noodgevallen instelt.
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>StorSimple vergelijken met Azure File Sync en Data Box Edge</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Meer informatie over de StorSimple 8000-serie</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Meer informatie over de StorSimple Virtual Array</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Aan de slag met de StorSimple 8000-serie</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Aan de slag met StorSimple Virtual Array</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Releaseopmerkingen bij de StorSimple 8000-serie</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Releaseopmerkingen bij StorSimple Virtual Array</h3>
                    </div>
                </div>
            </div>
        </div>
