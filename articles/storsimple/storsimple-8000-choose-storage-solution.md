...
- Meer informatie over [Azure Data Box Edge](/azure/databox-online/data-box-edge-overview.md) en [Azure Data Box-Gateway](/azure/databox-online/data-box-gateway-overview.md)
- Meer informatie over [Azure File Sync](/azure/storage/files/storage-sync-files-deployment-guide.md)
