...
| Aanstaande stationsfout gedetecteerd. | Aanstaande stationsfout gedetecteerd. |Er is vastgesteld dat een aanstaande stationsfout voor de hardwareonderdeel ' station in sleuf <*sleuf ID*>, behuizing <*behuizing ID*>'. Houd rekening met het vervangen van de schijf. <br> Voordat u de schijf is vervangen, moet u de volgende informatie bekijken.<br><br>Als uw apparaat meer dan één niet-werkende schijf heeft, verwijder niet meer dan één SSD of harde schijf op elk gewenst moment. Dit kan leiden tot verlies van gegevens.<br><br>Zorg ervoor dat u een vervangende SSD plaatsen in een sleuf dat eerder een SSD bevatte. Hetzelfde geldt voor een harde schijf.<br><br>Sleuven zijn genummerd van 0 tot en met 11. Een niet-werkende schijf in sleuf 2 wordt toegewezen aan een niet-werkende schijf in sleuf 3 van het apparaat (van de linksboven).<br><br>Voor meer informatie over de nieuwe schijf, gaat u naar https://go.microsoft.com/fwlink/?linkid=838653. Als het probleem zich blijft voordoen, neem dan contact op met Microsoft ondersteuning via https://go.microsoft.com/fwlink/?linkid=838654. |
