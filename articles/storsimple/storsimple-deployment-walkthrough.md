---
title: Een on-premises StorSimple-apparaat implementeren | Microsoft Docs
...
> [!IMPORTANT]
> Sla deze stap over als u al een StorSimple Manager-service hebt en u uw StorSimple-apparaat met die service wilt implementeren.
> 
> 
...
> [!IMPORTANT]
> Koppel alle netwerkinterfaces, behalve Data 0, los op beide (actieve en passieve) controllers voordat u deze configuratie uitvoert.
> 
> 
...
> [!NOTE]
> Als er een gateway is geconfigureerd op een andere netwerkinterface dan Data 0, moet u Data 2- en Data 3-netwerkinterfaces uitschakelen voordat u de update installeert. Ga naar **Apparaten > Configureren** en schakel Data 2- en Data 3-interfaces uit. U moet deze interfaces weer inschakelen wanneer het apparaat is bijgewerkt.
> 
> 
...
3. Er wordt een updatetaak gemaakt. U bewaakt de status van de update door te navigeren naar **Taken**.
   ...
   > [!NOTE]
   > Wanneer de update start, wordt onmiddellijk de status als 50 procent weergegeven. De status verandert vervolgens in 100 procent wanneer de update is voltooid. Er is geen realtime-status voor het updateproces.
   > 
   > 
