...
Beschrijving | Beschrijving van de gebeurtenis.
eventDataId | De unieke id van een gebeurtenis.
...
| Beschrijving |De beschrijving van de statische tekst van de waarschuwing gebeurtenis. |
...
| correlationId | Een GUID in de indeling van de tekenreeks. |
| Beschrijving |De beschrijving van de statische tekst van de gebeurtenis met automatisch schalen. |
