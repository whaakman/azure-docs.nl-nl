...
Zie [Azure Monitor metrics overview](../azure-monitor/platform/data-collection.md) (Overzicht van metrische gegevens in Azure Monitor) en [Azure Monitor alerts overview](./monitoring-overview-alerts.md) (Overzicht van Azure Monitor-waarschuwingen) voor meer informatie over metrische gegevens en waarschuwingen voor metrische gegevens. 
