...
![Een deelvenster waarschuwingsregel toevoegen](./media/insights-webhooks-alerts/Alertwebhook.png)

U kunt ook een waarschuwing te posten naar de URI van een webhook met behulp van [Azure PowerShell-cmdlets](insights-powershell-samples.md#create-metric-alerts), een [platformoverschrijdende CLI](insights-cli-samples.md#work-with-alerts), of [Azure Monitor REST API's](https://msdn.microsoft.com/library/azure/dn933805.aspx).
