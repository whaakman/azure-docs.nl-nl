...
3. **Onder de voorwaarde voor waarschuwing definiëren,** geeft u de volgende informatie en op **gedaan**.
    ...
    - **Waarschuwingsdoel:** gebruiken om te bekijken en selecteer het doel voor de nieuwe waarschuwing, **filteren op abonnement** / **filteren op resourcetype** en selecteer de resource of resourcegroep van de een lijst weergegeven.
...
5. Onder **actiegroep**, uit de vervolgkeuzelijst, geef de actiegroep die u wilt toewijzen aan deze nieuwe waarschuwingsregel. U kunt ook [maken van een nieuwe actiegroep](monitoring-action-groups.md) en toewijzen aan de nieuwe regel. Klik op om een nieuwe groep **+ nieuwe groep**.
...
- [Webhook-schema voor activiteitenlogboeken](monitoring-activity-log-alerts-webhook.md)
- [Overzicht van activiteitenlogboeken](monitoring-activity-log-alerts.md) 
