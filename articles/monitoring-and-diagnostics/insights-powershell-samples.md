---
title: Azure PowerShell Monitor snel starten-voorbeelden
...
> [!NOTE]
> Monitor voor Azure is de nieuwe naam voor wat 'Azure Insights' is aangeroepen tot 25 september 2016. Echter, de naamruimten, en daarom de volgende opdrachten nog steeds het woord 'insights'.
> 
> 
...
Veel Azure-services bieden extra logboeken en telemetrie die een of meer van de volgende kunt doen: 
 ...
 - verzonden naar een werkruimte voor logboekanalyse. 
...
Schakel de diagnostische instelling voor logboekanalyse
