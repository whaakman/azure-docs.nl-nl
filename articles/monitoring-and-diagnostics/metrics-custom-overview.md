...
- De uitbreiding voor de Windows Azure Diagnostics (WAD) installeren op uw [virtuele Azure-machine](metrics-store-custom-guestos-resource-manager-vm.md), [virtuele-machineschaalset](metrics-store-custom-guestos-resource-manager-vmss.md), [klassieke VM](metrics-store-custom-guestos-classic-vm.md), of [klassieke Cloudservices](metrics-store-custom-guestos-classic-cloud-service.md) en prestatiemeteritems verzenden naar Azure Monitor. 
- Installeer de [InfluxData Telegraf agent](metrics-store-custom-linux-telegraf.md) uitvoer invoegtoepassing op uw virtuele Azure Linux-machine en de metrische gegevens verzenden met behulp van de Azure Monitor.
- Aangepaste metrische gegevens verzenden [rechtstreeks naar de Azure Monitor REST API](metrics-store-custom-rest-api.md), `https://<azureregion>.monitoring.azure.com/<AzureResourceID>/metrics`.
...
* **Min**: de minimale waarde van de voorbeelden en metingen in de minuut waargenomen.
* **Maximale**: de maximale waarde van de voorbeelden en metingen in de minuut waargenomen.
...
Aangepaste metrische gegevens van andere services gebruiken: 
 - [Virtuele machines](metrics-store-custom-guestos-resource-manager-vm.md)
 - [Virtuele-machineschaalset](metrics-store-custom-guestos-resource-manager-vmss.md)
 - [Virtuele Azure-Machines (klassiek)](metrics-store-custom-guestos-classic-vm.md)
 - [Met behulp van de agent Telegraf virtuele Linux-Machine](metrics-store-custom-linux-telegraf.md)
 - [REST API](metrics-store-custom-rest-api.md)
 - [Klassieke Cloudservices](metrics-store-custom-guestos-classic-cloud-service.md)
