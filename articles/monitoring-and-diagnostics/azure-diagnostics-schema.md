...
[Configuratieschema van Diagnostics 1.0](azure-diagnostics-schema-1dot0.md)  

[Configuratieschema van Diagnostics 1.2](azure-diagnostics-schema-1dot2.md)  

[Diagnostics 1.3 en hoger configuratieschema](azure-diagnostics-schema-1dot3-and-later.md)  
...
* Waarschuwingen voor alle prestatiemeteritems verzonden naar Azure Monitor via de nieuwe [ervaring voor waarschuwingen van geïntegreerde](monitoring-overview-alerts.md) in Azure Monitor
...
>
> Meer informatie gaat u naslaginformatie over de [gedetailleerde diagnostische extensie schemadocumentatie.](azure-diagnostics-schema-1dot3-and-later.md)
