---
title: Codefragmenten voor het migreren van inhoud in Power BI werkruimte verzamelingen | Microsoft Docs
description: Hier volgen enkele codefragmenten van basisbewerkingen uit die nodig zijn voor migratie van inhoud.
...
ms.locfileid: "31407711"
---
# <a name="code-snippets-for-migrating-content-from-power-bi-workspace-collections"></a>Codefragmenten voor het migreren van inhoud in Power BI werkruimte verzamelingen

In dit artikel biedt een aantal codefragmenten van basisbewerkingen uit die nodig zijn voor migratie van inhoud. Zie voor verwante stromen voor bepaalde rapporttypen [Power BI Embedded werkruimte verzameling inhoud migreren naar Power BI](migrate-from-power-bi-workspace-collections.md#content-migration).

Een **hulpprogramma voor migratie van** is beschikbaar voor u moet gebruiken om u te helpen bij het kopiëren van inhoud van Power BI werkruimte verzamelingen naar Power BI Embedded. Met name als u veel inhoud hebben. Zie voor meer informatie [hulpprogramma voor migratie van Power BI Embedded](migrate-tool.md).

De onderstaande code ziet u voorbeelden met C# en de [Power BI .NET SDK](https://www.nuget.org/profiles/powerbi).
...
## <a name="export-report-from-a-power-bi-workspace-collection-workspace"></a>Rapport exporteren vanuit een Power BI-Werkruimteverzameling-werkruimte
...
## <a name="import-report-to-power-bi-embedded"></a>Rapport importeren naar Power BI Embedded
...
## <a name="extract-directquery-connection-string-from-power-bi-workspace-collections"></a>Haal de DirectQuery-verbindingsreeks uit Power BI werkruimte verzamelingen

Dit is voor het bijwerken van de PBIX na de migratie naar Power BI Embedded.
...
## <a name="update-directquery-connection-string-in-power-bi-embedded"></a>Bijwerken van de verbindingsreeks DirectQuery in Power BI Embedded
...
## <a name="set-directquery-credentials-in-power-bi-embedded"></a>DirectQuery referenties instellen in Power BI Embedded

In dit fragment we niet-versleutelde referenties gebruiken voor eenvoud, verzenden van versleutelde referenties ondersteund ook.
...
In dit fragment gaan we ervan uit dat de pushable gegevensset al in een werkruimte app in Power BI is. Zie voor meer informatie over de API-push [Push-gegevens in een Power BI-gegevensset](https://powerbi.microsoft.com/documentation/powerbi-developer-walkthrough-push-data/).
...
Zie voor informatie over het migratieproces, [Power BI-Werkruimteverzameling inhoud migreren naar Power BI Embedded](migrate-from-power-bi-workspace-collections.md).
