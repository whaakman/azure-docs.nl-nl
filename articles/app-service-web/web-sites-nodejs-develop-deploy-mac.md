...
In dit artikel wordt Azure Portal gebruikt om een web-app te maken. Met de [Azure-opdrachtregelinterface](../cli-install-nodejs.md) of [Azure PowerShell](/powershell/azureps-cmdlets-docs) kunt u dezelfde bewerkingen uitvoeren.
