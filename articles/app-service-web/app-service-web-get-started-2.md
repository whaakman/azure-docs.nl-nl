...
In [In vijf minuten uw eerste web-app implementeren in Azure](app-service-web-get-started-cli-nodejs.md) hebt u een voorbeeld-web-app geïmplementeerd in [Azure App Service](../app-service/app-service-value-prop-what-is.md). In dit artikel gaat u snel een aantal handige functies aan uw geïmplementeerde web-app toevoegen. U gaat zo dadelijk het volgende doen:
