---
title: Uw eerste HTML-web-app in vijf minuten in Azure implementeren | Microsoft Docs
...
4. Schakel naar een werkmap (`CD`) en ga als volgt te werk om de HTML-voorbeeldsite te kopiëren:
