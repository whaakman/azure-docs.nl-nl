---
title: Uw eerste .NET-web-app in vijf minuten implementeren in Azure | Microsoft Docs
...
---
# <a name="deploy-your-first-net-web-app-to-azure-in-five-minutes"></a>Uw eerste .NET-web-app in vijf minuten implementeren in Azure
Deze zelfstudie helpt u om een eenvoudige .NET-web-app te implementeren in [Azure App Service](../app-service/app-service-value-prop-what-is.md).
...
4. Schakel naar een werkmap (`CD`) en kopieer de voorbeeld-app.
