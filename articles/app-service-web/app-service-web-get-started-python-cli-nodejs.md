...
description: Ontdek hoe eenvoudig het is om web-apps in App Service uit te voeren door een voorbeeld-app voor Python te implementeren. U kunt snel een app gaan ontwikkelen en onmiddellijk de resultaten bekijken.
...
4. Schakel naar een werkmap (`CD`) en ga als volgt te werk om de voorbeeld-app voor Python te kopiëren:
