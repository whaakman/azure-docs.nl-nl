---
title: In vijf minuten uw eerste Python-web-app implementeren in Azure (CLI 2.0 Preview) | Microsoft Docs
description: Ontdek door implementatie van een Python-voorbeeld-app hoe eenvoudig het is om web-apps in App Service uit te voeren. U kunt snel een app gaan ontwikkelen en onmiddellijk de resultaten bekijken.
...
---
# <a name="deploy-your-first-python-web-app-to-azure-in-five-minutes-cli-20-preview"></a>In vijf minuten uw eerste Python-web-app implementeren in Azure (CLI 2.0 Preview)
...
- [Azure CLI 1.0](app-service-web-get-started-python-cli-nodejs.md): onze CLI voor het klassieke implementatiemodel en het Resource Manager-implementatiemodel
- [Azure CLI 2.0 (Preview)](app-service-web-get-started-python.md): onze CLI van de volgende generatie voor het Resource Manager-implementatiemodel
...
4. Vervolgens krijgt u de Python-voorbeeldcode die u gaat implementeren. Schakel naar een werkmap (`CD`) en ga als volgt te werk om de voorbeeld-app te kopiëren:
