...
## <a name="a-idcreatecacheacreate-the-cache"></a><a id="createcache"></a>De cache maken
Volg [deze instructies](../redis-cache/cache-dotnet-how-to-use-azure-redis-cache.md#create-cache) om de cache te maken.

## <a name="a-idconfigureprojectaadd-the-redissessionstateprovider-nuget-package-to-your-web-app"></a><a id="configureproject"></a>Het NuGet-pakket van RedisSessionStateProvider toevoegen aan uw web-app
...
## <a name="a-idconfigurewebconfigamodify-the-webconfig-file"></a><a id="configurewebconfig"></a>Het bestand Web.Config wijzigen
...
## <a name="a-idusesessionobjecta-use-the-session-object-in-code"></a><a id="usesessionobject"></a>Het sessieobject in code gebruiken
...
Zie voor meer informatie over het gebruik van ASP.NET-sessiestatus [Overzicht van ASP.NET-sessiestatus][Overzicht van ASP.NET-sessiestatus].
...
[Sleutels beheren]: ./media/web-sites-dotnet-session-state-caching/CachingScreenshot_ManageAccessKeys.png
