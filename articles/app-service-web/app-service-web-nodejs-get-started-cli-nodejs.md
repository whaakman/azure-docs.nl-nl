...
- [Azure CLI 2.0](app-service-web-nodejs-get-started.md): onze CLI van de volgende generatie voor het Resource Manager-implementatiemodel
...
3. Stel de implementatiegebruiker in voor App Service. U gaat later code implementeren met behulp van de referenties.
...
5. Controleer of u zich nog steeds in de hoofdmap van de app bevindt. Maak vervolgens met de volgende opdracht de resource voor de App Service-app in Azure met een unieke app-naam. Bijvoorbeeld: http://{appnaam}.azurewebsites.net
    ...
    Volg de aanwijzing om een Azure-regio voor de implementatie te selecteren. 
...
8. Sla de wijzigingen op en gebruik git om de app te implementeren in Azure. Wanneer het wordt gevraagd, gebruikt u de gebruikersreferenties die u eerder hebt gemaakt.
