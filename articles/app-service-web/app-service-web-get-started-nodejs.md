---
title: In vijf minuten uw eerste Node.js-web-app implementeren in Azure (CLI 2.0 Preview) | Microsoft Docs
...
---
# <a name="deploy-your-first-nodejs-web-app-to-azure-in-five-minutes-cli-20-preview"></a>In vijf minuten uw eerste Node.js-web-app implementeren in Azure (CLI 2.0 Preview)
...
4. Vervolgens krijgt u de Node.js-voorbeeldcode die u gaat implementeren. Schakel naar een werkmap (`CD`) en ga als volgt te werk om de voorbeeld-app te kopiëren:
