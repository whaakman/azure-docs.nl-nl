...
4. Configureer de Linux-container voor het gebruik van de standaard-image van Node.js 6.9.3.

    ```azurecli
    az appservice web config update --node-version 6.9.3 --name <app_name> --resource-group myResourceGroup
    ```

4. Implementeer een voorbeeld van een Node.js-app vanuit GitHub.
