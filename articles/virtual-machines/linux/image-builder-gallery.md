...
Dit artikel leest u hoe u de Azure-Image Builder kunt gebruiken om te maken van de versie van een installatiekopie in een [gedeelde afbeeldingengalerie](https://docs.microsoft.com/en-us/azure/virtual-machines/windows/shared-image-galleries), klikt u vervolgens de installatiekopie van het wereldwijd distribueren.
