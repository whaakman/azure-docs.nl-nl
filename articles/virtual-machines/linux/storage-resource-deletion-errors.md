---
title: Storage resource verwijdering fouten in een Azure Resource Manager-implementatie op een virtuele Linux-machines oplossen | Microsoft Docs
...
De VHD's in Azure VM's zijn VHD-bestanden die zijn opgeslagen als pagina-blobs in een standard- of premium storage-account in Azure. Zie voor meer informatie over Azure-schijven, [over niet-beheerd en beheerde schijfopslag voor Microsoft Azure Linux VM's](about-disks-and-vhds.md). 
