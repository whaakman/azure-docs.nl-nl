...
Aanmelden bij uw Azure-abonnement met de [az aanmelding](/cli/azure/reference-index#az_login) opdracht in en volg de op het scherm richtingen, of klik op **Try it** Cloud Shell gebruiken.
