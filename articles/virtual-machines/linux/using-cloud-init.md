...
Raadpleeg voor meer informatie over cloud-init-logboekregistratie, het [cloud-init-documentatie](https://cloudinit.readthedocs.io/en/latest/topics/logging.html) 
