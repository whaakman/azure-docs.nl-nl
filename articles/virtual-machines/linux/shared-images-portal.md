---
title: Gedeelde virtuele Azure-Machine-installatiekopieën voor Linux met behulp van de portal maken | Microsoft Docs
...
1. Onder **Administrator-account**, selecteer **wachtwoord** of **openbare SSH-sleutel**, voert u uw gegevens.
1. Als u wilt toestaan van externe toegang tot de virtuele machine, onder **openbare binnenkomende poorten**, kiest u **geselecteerde poorten toestaat** en selecteer vervolgens **SSH (22)** in de vervolgkeuzelijst. Als u niet dat externe toegang tot de virtuele machine toestaan wilt, laat u **geen** voor geselecteerde **openbare binnenkomende poorten**.
