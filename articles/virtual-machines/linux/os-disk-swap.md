...
Gebruik [az vm stop](/cli/azure/vm) aan de virtuele machine voordat u de schijven wisselen stop\deallocate.
...
Start opnieuw op de virtuele machine met behulp van [az vm start](/cli/azure/vm).
