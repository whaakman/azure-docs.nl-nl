...
- [FreeBSD 10.3 op Azure Marketplace](https://azure.microsoft.com/marketplace/partners/microsoft/freebsd103)
- [FreeBSD 10.4 op Azure Marketplace](https://azuremarketplace.microsoft.com/en-us/marketplace/apps/Microsoft.FreeBSD104)
- [FreeBSD 11.1 op Azure Marketplace](https://azuremarketplace.microsoft.com/marketplace/apps/Microsoft.FreeBSD111)

### <a name="create-a-freebsd-vm-through-azure-cli-20-on-freebsd"></a>Een FreeBSD virtuele machine via de Azure CLI 2.0 op FreeBSD maken
U moet eerst installeren [Azure CLI 2.0](https://docs.microsoft.com/cli/azure/get-started-with-azure-cli) al de volgende opdracht op een machine FreeBSD.
