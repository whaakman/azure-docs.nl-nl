...
> [!NOTE]
> Azure hybride voordeel voor Windows Server kan niet worden gebruikt met virtuele machines die worden in rekening gebracht voor aanvullende software zoals SQL Server of een van de derde partij marketplace-installatiekopieën. U krijgt, zoals een 409 fout: het wijzigen van de eigenschap 'LicenseType' is niet toegestaan; Als u probeert te converteren van een Windows Server-VM met aanvullende software kosten. 
>
...
> [!NOTE]
> Converteren van een bestaande virtuele machine of virtuele-machineschaalset ingesteld voor gebruik van Azure hybride voordeel voor Windows Server wordt momenteel niet ondersteund
>
...
Lees meer over [Azure hybride voordeel voor Windows Server-licentieverlening](https://azure.microsoft.com/pricing/hybrid-use-benefit/).
