...
Als u met behulp van PowerShell en de Aure PowerShell-module geïnstalleerd hebt u mogelijk ook verbinding maken met behulp van de `Get-AzRemoteDesktopFile` cmdlet, zoals hieronder wordt weergegeven.
