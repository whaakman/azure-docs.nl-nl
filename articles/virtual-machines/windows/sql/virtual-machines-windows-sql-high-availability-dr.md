...
| --- | --- |
| **Beschikbaarheidsgroepen** |Beschikbare replica's die worden uitgevoerd in virtuele Azure-machines in dezelfde regio bieden hoge beschikbaarheid. U moet configureren van een domeincontroller-VM, omdat Windows failover clustering is vereist voor Active Directory-domein.<br/> ![Beschikbaarheidsgroepen](./media/virtual-machines-windows-sql-high-availability-dr/azure-only-ha-always-on.png)<br/>Zie voor meer informatie, [beschikbaarheidsgroepen configureren in Azure (GUI)](virtual-machines-windows-portal-sql-alwayson-availability-groups.md). |
