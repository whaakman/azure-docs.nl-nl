...
1. Selecteer de **Azure Hybrid Benefit** optie en Bevestig dat u een SQL Server-licentie met Software Assurance hebt. 
...
Registreren van SQL Server-VM met behulp van Azure CLI met het volgende codefragment: 
