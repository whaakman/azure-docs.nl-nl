...
Zie voor meer informatie over het kiezen tussen deze programming methoden [Azure Web Apps, Cloud Services en virtuele machines: Wanneer gebruikt u welk](../../../app-service/overview-compare.md).
