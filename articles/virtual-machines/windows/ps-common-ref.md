...
| Een gegevensschijf toevoegen aan een VM |[Voeg AzureRmVMDataDisk](https://docs.microsoft.com/powershell/module/azurerm.compute/add-azurermvmdatadisk) - VM $vm-https://mystore1.blob.core.windows.net/vhds/myDataDisk.vhd' Name 'myDataDisk' - VhdUri' - LUN #-Caching ReadWrite - DiskSizeinGB # - CreateOption leeg<BR></BR><BR></BR>Gebruik Get-AzureRmVM voor het VM-object. Geef het aantal LUN en de grootte van de schijf. Update-AzureRmVM om de configuratiewijzigingen toepassen voor de virtuele machine worden uitgevoerd. De schijf die u toevoegt, is niet geïnitialiseerd. |
| Een gegevensschijf verwijderen van een VM |[Verwijder AzureRmVMDataDisk](https://docs.microsoft.com/powershell/module/azurerm.compute/remove-azurermvmdatadisk) - VM $vm-naam 'myDataDisk'<BR></BR><BR></BR>Gebruik Get-AzureRmVM voor het VM-object. Update-AzureRmVM om de configuratiewijzigingen toepassen voor de virtuele machine worden uitgevoerd. |
