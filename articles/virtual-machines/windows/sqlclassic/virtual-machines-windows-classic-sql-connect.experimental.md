...
Meerdere virtuele machines kunnen worden gemaakt in dezelfde cloudservice. Zie voor meer informatie over dit scenario virtuele machines, [verbinding maken tussen virtuele machines met een virtueel netwerk of cloudservice](../classic/connect-vms-classic.md#connect-vms-in-a-standalone-cloud-service). In dit scenario wordt een client op een virtuele machine probeert verbinding maken met SQL Server die wordt uitgevoerd op een andere virtuele machine in dezelfde cloudservice.
