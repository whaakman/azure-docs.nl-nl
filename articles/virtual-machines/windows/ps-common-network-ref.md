...
| Lijst met subnetten in een virtueel netwerk |Get-AzureRmVirtualNetwork-naam 'myVNet' - ResourceGroupName $myResourceGroup &#124; subnetten selecteren |
