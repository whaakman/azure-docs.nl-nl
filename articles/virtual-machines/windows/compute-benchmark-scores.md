...
ms.locfileid: "64866287"
---
# <a name="compute-benchmark-scores-for-windows-vms"></a>COMPUTE benchmarkscores voor Windows-VM 's
De volgende SPECInt benchmarkscores weergeven computerprestaties voor bepaalde Azure-VM's met Windows Server. COMPUTE benchmarkscores zijn ook beschikbaar voor [virtuele Linux-machines](../linux/compute-benchmark-scores.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json).


## <a name="av2---general-compute"></a>Av2 - algemene Compute
| Grootte | vcpu 's | NUMA-knooppunten | CPU | Uitvoerbewerkingen | Basistarief Gem. | StdDev | 
| ---- | ----: | ---------: | --- | ---: | ------------: | -----: | 
