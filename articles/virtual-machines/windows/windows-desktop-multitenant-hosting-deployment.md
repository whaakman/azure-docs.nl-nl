...
> [!NOTE]
> Dit artikel ziet u de licentiegegevens benefit voor Windows 10 Desktop-installatiekopieën implementeren. U kunt verwijzen naar de volgende onderwerpen voor [hybride Azure gebruiken voordelen voor installatiekopieën van Windows Server](hybrid-use-benefit-licensing.md).
>
