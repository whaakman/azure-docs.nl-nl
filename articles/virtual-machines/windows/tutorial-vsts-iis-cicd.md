...
In deze zelfstudie maakt u een ASP.NET-webtoepassing in een Team Services gemaakt en geconfigureerd build en release definities voor het implementeren van nieuwe web implementeren van pakketten naar IIS op elke doorvoer code. U hebt geleerd hoe u:
...
Ga naar de volgende zelfstudie voor meer informatie over het installeren van een SQL- &#92; IIS &#92;. NET stack op een combinatie van VM's van Windows.
