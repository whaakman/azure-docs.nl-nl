---
title: Rekenintensieve Java-toepassing op een virtuele machine
...
2. Klik op **maken van een resource**, klikt u op **Compute**, klikt u op **virtuele machine**, en klik vervolgens op **uit galerie**.
