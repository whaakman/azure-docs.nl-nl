...
> [!IMPORTANT]
> Zie voor meer informatie over versie 2.3 en oudere [dit document](../linux/classic/diagnostic-extension-v2.md).
...
![Afbeelding](./media/diagnostics-linux/make_sas.png)
...
![Afbeelding](./media/diagnostics-linux/graph_metrics.png)
...
![Afbeelding](./media/diagnostics-linux/stg_explorer.png)
...
* Meer informatie over hoe [maken van een virtuele-machineschaalset](../linux/tutorial-create-vmss.md) metrische gegevens van uw met automatisch schalen controleren.
