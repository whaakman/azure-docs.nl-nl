...
Gebruik voor marketplace-installatiekopieën [Set AzureRmVMPlan](https://docs.microsoft.com/powershell/module/azurerm.compute/set-azurermvmplan?view=azurermps-6.7.0) om de plangegevens in te stellen
```powershell
