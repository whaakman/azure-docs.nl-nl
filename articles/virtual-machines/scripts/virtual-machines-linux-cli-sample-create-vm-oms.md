---
title: Voorbeeld van Azure CLI-script - Een virtuele Linux-machine maken met OMS-controle | Microsoft Docs
description: Voorbeeld van Azure CLI-script - Een virtuele Linux-machine maken met OMS-controle
