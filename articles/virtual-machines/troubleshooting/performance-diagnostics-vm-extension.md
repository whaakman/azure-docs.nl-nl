...
De `Set-AzVMExtension` opdracht kan worden gebruikt voor het implementeren van VM-extensie voor Azure prestaties diagnostische gegevens naar een bestaande virtuele machine.
