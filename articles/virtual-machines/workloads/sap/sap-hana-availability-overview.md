...
- Meer informatie over [SAP HANA-beschikbaarheid binnen één Azure-regio](https://docs.microsoft.com/en-us/azure/virtual-machines/workloads/sap/sap-hana-availability-one-region).
- Meer informatie over [SAP HANA-beschikbaarheid volledige Azure-regio's](https://docs.microsoft.com/en-us/azure/virtual-machines/workloads/sap/sap-hana-availability-across-regions). 
