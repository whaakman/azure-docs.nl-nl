---
title: HB-serie VM-grootte prestaties - Azure Virtual Machines | Microsoft Docs
description: Meer informatie over de prestaties van testresultaten bij HB-serie VM-grootten in Azure.
...
Verschillende prestatietests zijn uitgevoerd op HB-serie beschikbaar. Hier volgen enkele van de resultaten van deze prestatietests.


| Workload                                        | HB                    |
|-------------------------------------------------|-----------------------|
| Drie vakken STREAM                                    | ~260 GB/s (32-33 GB/s per CCX)  |
| High-Performance Linpackuitvoer (HPL)                  | ~ 1000 GigaFLOPS (Rpeak), ~ 860 GigaFLOPS (Rmax) |
| RDMA-latentie en bandbreedte                        | 2.35usec, 96.5 Gb/s   |
| FIO op lokale NVMe SSD                           | ~1.7 GB/s leest, ~1.0 GB/s schrijft      |  
| IOR op 4 * Azure Premium SSD (P30 beheerde schijven, RAID 0) **  | ~ 725 MB/s leest, ~ 780 MB/schrijft   |
...
| #bytes  | Latentie [wachttijden van microseconden] (MPICH 3.3 + H4) | Latentie [wachttijden van microseconden] (OpenMPI 4.0.0) | Latentie [wachttijden van microseconden] (MVAPICH2 2.3) | Latency [microsecond] (Intel MPI 2019) |
|------|----------|----------|----------|----------|
