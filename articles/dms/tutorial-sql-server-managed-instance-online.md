...
1. Geef in het scherm **Migratie-instellingen configureren** de volgende instellingen op:
    ...
    |**Abonnement van de Azure Storage-Account** | Selecteer het abonnement met het Azure Storage-account. |
