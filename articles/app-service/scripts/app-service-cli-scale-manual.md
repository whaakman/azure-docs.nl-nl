...
| [`az appservice plan update`](/cli/azure/appservice/plan?view=azure-cli-latest#az_appservice_plan_update) | Hiermee werkt u de eigenschappen van het App Service-abonnement bij. |
