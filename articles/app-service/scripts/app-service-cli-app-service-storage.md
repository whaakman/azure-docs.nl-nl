---
title: Voorbeeld van Azure CLI-script - Een web-app verbinden met een opslagaccount | Microsoft Docs
description: Voorbeeld van Azure CLI-script - Een web-app verbinden met een opslagaccount
services: appservice
...
Met dit voorbeeldscript maakt u een Azure-opslagaccount en een Azure-web-app. Vervolgens wordt het opslagaccount aan de web-app gekoppeld met behulp van app-instellingen.
...
Dit script maakt gebruik van de volgende opdrachten voor het maken van een resourcegroep, web-app, opslagaccount en alle gerelateerde resources. Elke opdracht in de tabel is een koppeling naar specifieke documentatie over de opdracht.
...
| [`az storage account show-connection-string`](/cli/azure/storage/account?view=azure-cli-latest#az_storage_account_show_connection_string) | Hiermee haalt u de verbindingsreeks op voor een opslagaccount. |
