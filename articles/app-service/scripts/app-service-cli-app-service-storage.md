...
| [AZ storage-account maken](https://docs.microsoft.com/cli/azure/storage/account#az_storage_account_create) | Hiermee maakt u een opslagaccount. Dit is waar de statische bedrijfsmiddelen worden opgeslagen. |
| [AZ account weergeven--verbindingsreeks voor opslag](https://docs.microsoft.com/cli/azure/storage/account#az_storage_account_show_connection_string) | |
