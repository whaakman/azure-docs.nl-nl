...
| [`az redis create`](/cli/azure/redis?view=azure-cli-latest#az-redis-create) | Hiermee maakt u een nieuw redis-cache-exemplaar. |
| [`az redis list-keys`](/cli/azure/redis?view=azure-cli-latest#az-redis-list-keys) | Hiermee geeft u een lijst van de toegangssleutels voor de redis-cache-instantie weer. |
