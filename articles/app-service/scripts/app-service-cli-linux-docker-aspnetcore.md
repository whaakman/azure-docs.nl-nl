...
Met dit voorbeeldscript maakt u een resourcegroep, een Linux-App Service-abonnement en een web-app. Vervolgens wordt er een ASP.NET Core-toepassing geïmplementeerd met behulp van een Docker-Container.
