---
title: Voorbeeld van Azure CLI-script - Een web-app maken en bestanden implementeren met FTP | Microsoft Docs
description: Voorbeeld van Azure CLI-script - Een web-app maken en bestanden implementeren met FTP
...
ms.locfileid: "30281695"
---
# <a name="create-a-web-app-and-deploy-files-with-ftp"></a>Een web-app maken en bestanden implementeren met FTP

Met dit voorbeeldscript wordt er een web-app gemaakt in App Service, inclusief de bijbehorende resources, en wordt er vervolgens een statische HTML-pagina geïmplementeerd met behulp van FTP. Voor de upload via FTP wordt in het script [cURL](https://en.wikipedia.org/wiki/CURL) gebruikt als voorbeeld. U kunt echter elk FTP-programma gebruiken om uw bestanden te uploaden.
...
| [`az webapp deployment list-publishing-profiles`](/cli/azure/webapp/deployment?view=azure-cli-latest#az-webapp-deployment-list-publishing-profiles) | Hiermee vraagt u de details op van beschikbare implementatieprofielen voor web-apps. |
