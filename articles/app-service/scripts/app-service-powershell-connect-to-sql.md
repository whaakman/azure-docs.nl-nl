---
title: Azure PowerShell-voorbeeldscript - Een web-app verbinden met een SQL-database | Microsoft Docs
description: Azure PowerShell-voorbeeldscript - Een web-app verbinden met een SQL-database
...
ms.locfileid: "39324742"
---
# <a name="connect-a-web-app-to-a-sql-database"></a>Een web-app verbinden met een SQL-database

In dit scenario leert u hoe u een Azure SQL-database en een Azure-web-app maakt. Vervolgens wordt de SQL-database aan de web-app gekoppeld met behulp van app-instellingen.
