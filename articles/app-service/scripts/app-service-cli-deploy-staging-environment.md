...
| [AZ webapp implementatiesleuf maken](https://docs.microsoft.com/cli/azure/webapp/deployment/slot#az_webapp_deployment_slot_create) | Een implementatiesleuf te maken. |
...
| [AZ webapp implementatiesleuf wisselen](https://docs.microsoft.com/cli/azure/webapp/deployment/slot#az_webapp_deployment_slot_swap) | Een opgegeven implementatiesleuf wisselen naar de productie. |
