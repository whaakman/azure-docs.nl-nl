---
title: Voorbeeld van Azure CLI-script - Een app maken en bestanden implementeren met FTP | Microsoft Docs
description: Voorbeeld van Azure CLI-script - Een App Service-app maken en bestanden implementeren met FTP
