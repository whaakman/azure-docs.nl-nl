---
title: Voorbeeld van Azure CLI-script - Een web-app van ASP.NET Core maken in een Docker-container vanuit Azure Container Registry | Microsoft Docs
description: Voorbeeld van Azure CLI-script - Een web-app van ASP.NET Core maken in een Docker-container vanuit Azure Container Registry
services: appservice
...
Met dit voorbeeldscript maakt u een resourcegroep, een Linux-App Service-abonnement en een web-app. Vervolgens wordt er vanuit Azure Container Registry een ASP.NET Core-toepassing geïmplementeerd met behulp van een Docker-container.
...
| [`az webapp config container set`](/cli/azure/webapp/config/container?view=azure-cli-latest#az-webapp-config-container-set) | Hiermee stelt u de Docker-container voor de Azure-web-app in. |
