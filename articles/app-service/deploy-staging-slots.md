...
Wisselen van de duurt soms even om te voltooien, zoals wanneer de app die wordt gewisseld bestaat uit een tijd lang warmen. Krijgt u meer informatie over het wisselen van bewerkingen in de [activiteitenlogboek](../azure-monitor/platform/activity-logs-overview.md) in de [Azure-portal](https://portal.azure.com).
