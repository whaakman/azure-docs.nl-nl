---
title: Een PHP-app maken met MySQL op Linux - Azure App Service | Microsoft Docs
...
Zodra `git push` is voltooid, gaat u naar de Azure-app en probeert u de nieuwe functionaliteit.
