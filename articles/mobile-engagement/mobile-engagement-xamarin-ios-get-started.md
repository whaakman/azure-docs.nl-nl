---
title: Aan de slag met Azure Mobile Engagement voor Xamarin.iOS
...
> [!NOTE]
> U hebt een actief Azure-account nodig om deze zelfstudie te voltooien. Als u geen account hebt, kunt u binnen een paar minuten een account voor de gratis proefversie maken. Zie [Gratis proefversie van Azure](https://azure.microsoft.com/pricing/free-trial/?WT.mc_id=A0E0E5C02&amp;returnurl=http%3A%2F%2Fazure.microsoft.com%2Fen-us%2Fdocumentation%2Farticles%2Fmobile-engagement-xamarin-ios-get-started) voor meer informatie.
> 
> 
...
3. Vul de velden **App Name** en **Organization Identifier** in en klik op **Next**. 
   ...
   > [!IMPORTANT]
   > Zorg ervoor dat het publicatieprofiel dat u gaat gebruiken voor het implementeren van uw iOS-app gebruikmaakt van een app-id die exact overeenkomt met de bundel-id op deze locatie. 
   > 
   > 
