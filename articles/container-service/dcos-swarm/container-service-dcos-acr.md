---
title: ACR gebruiken met een Azure DC/OS-cluster
...
Maak zo nodig een Azure Container Registry met de opdracht [az acr create](/cli/azure/acr#az_acr_create). 
