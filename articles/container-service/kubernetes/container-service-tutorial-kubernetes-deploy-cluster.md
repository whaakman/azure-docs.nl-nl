...
Als u Azure CloudShell gebruikt, is kubectl al geïnstalleerd. Als u het lokaal wilt installeren, gebruikt u de opdracht [az acs kubernetes install-cli](/cli/azure/acs/kubernetes#install-cli).
