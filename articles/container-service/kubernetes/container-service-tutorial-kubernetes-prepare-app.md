...
In volgende zelfstudies leert de installatiekopie van de container is geüpload naar een Azure Container Registry en klik vervolgens op uitvoeren in een Azure Kubernetes cluster wordt gehost.
