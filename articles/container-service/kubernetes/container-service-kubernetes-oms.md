...
U kunt ook gebruiken [Azure Cloud Shell](https://docs.microsoft.com/en-us/azure/cloud-shell/overview), die de `az` Azure cli en `kubectl` hulpprogramma's voor u hebt geïnstalleerd.  
