...
Raadpleeg [Networking considerations for Azure AD Domain Services](network-considerations.md) (Overwegingen voor netwerken voor Azure AD Domain Services).
