---
title: 'Azure Active Directory Domain Services preview: Administration Guide | Microsoft Docs'
...
3. Click **WORKGROUP** under the **PROPERTIES** section. This opens the **System Properties** property page. To join the domain, click **Change**.
