...
> [!NOTE]
> Deze standaardinstelling NSG wordt de toegang tot de poort die wordt gebruikt voor beveiligde LDAP niet vergrendeld. Als u wilt vergrendelen beveiligde LDAP toegang via het internet, Zie [in dit artikel](active-directory-ds-troubleshoot-ldaps.md).
>
