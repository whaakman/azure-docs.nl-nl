...
1. Aanmelden bij de Windows-VM die u gebruikt voor het beheren van uw beheerde domein. Als u niet hebt, volgt u de instructies voor het [beheren van een Azure AD Domain Services-domein](manage-domain.md).
