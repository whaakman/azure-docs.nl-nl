...
Zie voor meer informatie, [het oplossen van waarschuwingen in een beheerd domein](troubleshoot-alerts.md).
...
* Een of meer kritieke waarschuwingen nog niet zijn opgelost in 15 dagen. Kritieke waarschuwingen kunnen worden veroorzaakt door een onjuiste configuratie die blokkeert de toegang tot resources die nodig zijn voor Azure AD DS.
    * Bijvoorbeeld, de waarschuwing [AADDS104: Netwerkfout](alert-nsg.md) heeft is niet opgelost gedurende meer dan 15 dagen in het beheerde domein.
...
U ziet een [waarschuwing](troubleshoot-alerts.md) op de pagina Azure status van de AD DS in Azure portal waarmee u verklaart dat het domein is onderbroken. Ook ziet u de status van het domein 'Onderbroken'.
...
- [Los waarschuwingen voor uw beheerde domein](troubleshoot-alerts.md)
- [Lees meer over Azure Active Directory Domain Services](overview.md)
