...
* [Voorbereidingstaak voor Shell-scripts](https://github.com/shwetams/azure-batchclient-sample-nodejs/blob/master/startup_prereq.sh)
* [Python-verwerker voor CSV naar JSON](https://github.com/shwetams/azure-batchclient-sample-nodejs/blob/master/processcsv.py)
