...
De indeling is enigszins verschillen op Linux-knooppunten. Punten (.), afbreekstreepjes (-) en hekjes (#) worden samengevoegd tot onderstrepingstekens in de omgevingsvariabele. Houd er ook rekening mee dat het geval van de toepassings-ID behouden blijft. Bijvoorbeeld:
...
Geef de omgevingsvariabele in deze indeling op Linux-knooppunten. Plat punten (.), afbreekstreepjes (-) en hekjes (#) in onderstrepingstekens en behoud het geval van de toepassings-ID:
