...
|enableAutoScale|Booleaans|Hiermee geeft u op of de poolgrootte automatisch wordt aangepast gedurende een bepaalde periode.|
|isAutoPool|Booleaans|Hiermee geeft u op of de groep is gemaakt via een taak AutoPool mechanisme.|
|startTime|DateTime|De tijd die het formaat van de groep van toepassingen is gestart.|
|endTime|DateTime|De tijd formaat van de groep van toepassingen is voltooid.|
