---
title: Zelfstudie - Aan de slag met de Azure Batch-bibliotheek voor .NET | Microsoft Docs
description: Leer de basisconcepten van Azure Batch en hoe u voor de Batch-service ontwikkelt aan de hand van een voorbeeldscenario.
services: batch
...
---
# <a name="get-started-with-the-azure-batch-library-for-net"></a>Aan de slag met de Azure Batch-bibliotheek voor .NET
...
Daarna wordt een pool van rekenknooppunten gemaakt in het Batch-account met een aanroep naar `CreatePoolIfNotExistsAsync`. `CreatePoolIfNotExistsAsync` maakt gebruik van de methode [BatchClient.PoolOperations.CreatePool][net_pool_create] om een pool te maken in de Batch-service.
