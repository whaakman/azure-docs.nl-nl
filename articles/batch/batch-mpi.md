...
1. De eerste twee stappen in [compileren en uitvoeren van een eenvoudig MS MPI-programma][msmpi_howto]. Dit voldoet aan de prerequesites voor de volgende stap.
...
5. *Optionele*: Gebruik de [Azure-portal] [ portal] of de [Batch Explorer] [ batch_explorer] om te onderzoeken van de voorbeeld-pool, Jobs en taak (' MultiInstanceSamplePool', 'MultiInstanceSampleJob', "MultiInstanceSampleTask") voordat u de resources verwijderen.
